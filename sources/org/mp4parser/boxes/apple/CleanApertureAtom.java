...
public class CleanApertureAtom extends AbstractFullBox {
    ...
    public static final String f3795a = "clef";
    ...
    private static void g() {
        ...
        d = factory.a("method-execution", (Signature) factory.a("1", "getWidth", "org.mp4parser.boxes.apple.CleanApertureAtom", "", "", "", "double"), 45);
        e = factory.a("method-execution", (Signature) factory.a("1", "setWidth", "org.mp4parser.boxes.apple.CleanApertureAtom", "double", "width", "", "void"), 49);
        f = factory.a("method-execution", (Signature) factory.a("1", "getHeight", "org.mp4parser.boxes.apple.CleanApertureAtom", "", "", "", "double"), 53);
        g = factory.a("method-execution", (Signature) factory.a("1", "setHeight", "org.mp4parser.boxes.apple.CleanApertureAtom", "double", "height", "", "void"), 57);
    }
