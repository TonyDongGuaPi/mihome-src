...
public class TrackEncodedPixelsDimensionsAtom extends AbstractFullBox {
    ...
    public static final String f3802a = "enof";
    ...
    private static void g() {
        ...
        d = factory.a("method-execution", (Signature) factory.a("1", "getWidth", "org.mp4parser.boxes.apple.TrackEncodedPixelsDimensionsAtom", "", "", "", "double"), 44);
        e = factory.a("method-execution", (Signature) factory.a("1", "setWidth", "org.mp4parser.boxes.apple.TrackEncodedPixelsDimensionsAtom", "double", "width", "", "void"), 48);
        f = factory.a("method-execution", (Signature) factory.a("1", "getHeight", "org.mp4parser.boxes.apple.TrackEncodedPixelsDimensionsAtom", "", "", "", "double"), 52);
        g = factory.a("method-execution", (Signature) factory.a("1", "setHeight", "org.mp4parser.boxes.apple.TrackEncodedPixelsDimensionsAtom", "double", "height", "", "void"), 56);
    }
