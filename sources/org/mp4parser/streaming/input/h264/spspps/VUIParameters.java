...
public class VUIParameters {
    ...
    public static class BitstreamRestriction {
        ...
        public String toString() {
            return "BitstreamRestriction{" + "motion_vectors_over_pic_boundaries_flag=" + this.f4087a + ", max_bytes_per_pic_denom=" + this.b + ", max_bits_per_mb_denom=" + this.c + ", log2_max_mv_length_horizontal=" + this.d + ", log2_max_mv_length_vertical=" + this.e + ", num_reorder_frames=" + this.f + ", max_dec_frame_buffering=" + this.g + Operators.BLOCK_END;
        }
    }
}
