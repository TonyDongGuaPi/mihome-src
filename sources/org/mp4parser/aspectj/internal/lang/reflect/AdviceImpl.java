...
public class AdviceImpl implements Advice {
    ...
    private static final String f3735a = "org.mp4parser.aspectj.runtime.internal";
    ...
    public Type[] b() {
        if (this.f == null) {
            ...
            for (Type type : genericParameterTypes) {
                if ((type instanceof Class) && ((Class) type).getPackage().getName().equals(f3735a)) {
                    i++;
                }
            }
    ...
    public AjType<?>[] c() {
        if (this.g == null) {
            ...
            for (Class cls : parameterTypes) {
                if (cls.getPackage().getName().equals(f3735a)) {
                    i++;
                }
            }
