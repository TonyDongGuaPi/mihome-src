...
public class AjTypeImpl<T> implements AjType<T> {
    ...
    private static final String f3436a = "ajc$";
    private Class<T> b;
    ...
    public Field a(String str) throws NoSuchFieldException {
        ...
        if (!declaredField.getName().startsWith(f3436a)) {
    ...
    public Field[] q() {
        ...
        for (Field field : declaredFields) {
            if (!field.getName().startsWith(f3436a) && !field.isAnnotationPresent(DeclareWarning.class) && !field.isAnnotationPresent(DeclareError.class)) {
                arrayList.add(field);
            }
        }
    ...
    public Field b(String str) throws NoSuchFieldException {
        ...
        if (!field.getName().startsWith(f3436a)) {
            return field;
        }
        throw new NoSuchFieldException(str);
    }
    ...
    private boolean a(Method method) {
        if (method.getName().startsWith(f3436a)) {
            return false;
        }
    ...
    private org.aspectj.lang.reflect.Pointcut b(java.lang.reflect.Method r9) {
        /*
            r8 = this;
        ...
        L_0x0034:
            ...
            org.aspectj.lang.reflect.AjType r6 = org.aspectj.lang.reflect.AjTypeSystem.a(r2)
        ...
        L_0x004d:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: org.aspectj.internal.lang.reflect.AjTypeImpl.b(java.lang.reflect.Method):org.aspectj.lang.reflect.Pointcut");
    }
    ...
    public org.aspectj.lang.reflect.DeclareParents[] D() {
        ArrayList arrayList = new ArrayList();
        for (Method method : this.b.getDeclaredMethods()) {
        ...
        a((List<org.aspectj.lang.reflect.DeclareParents>) arrayList);
        if (f().P()) {
    ...
    private void a(List<org.aspectj.lang.reflect.DeclareParents> list) {
        for (Field field : this.b.getDeclaredFields()) {
    ...
    public DeclarePrecedence[] G() {
        ArrayList arrayList = new ArrayList();
        if (this.b.isAnnotationPresent(org.aspectj.lang.annotation.DeclarePrecedence.class)) {
            arrayList.add(new DeclarePrecedenceImpl(((org.aspectj.lang.annotation.DeclarePrecedence) this.b.getAnnotation(org.aspectj.lang.annotation.DeclarePrecedence.class)).value(), this));
        }
        for (Method method : this.b.getDeclaredMethods()) {
