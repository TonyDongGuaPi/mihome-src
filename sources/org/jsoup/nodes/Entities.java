...
public class Entities {
    ...
    static final int f3668a = 36;
    private static final int b = -1;
    private static final String c = "";
    private static final char[] d = {',', ';'};
    private static final HashMap<String, String> e = new HashMap<>();
    private static final Document.OutputSettings f = new Document.OutputSettings();
    ...
    static void a(Appendable appendable, String str, Document.OutputSettings outputSettings, boolean z, boolean z2, boolean z3) throws IOException {
        EscapeMode a2 = outputSettings.a();
        CharsetEncoder d2 = outputSettings.d();
        CoreCharset coreCharset = outputSettings.f3663a;
    ...
    private static void a(Appendable appendable, EscapeMode escapeMode, int i) throws IOException {
        ...
        if (nameForCodepoint != "") {
            appendable.append(Typography.c).append(nameForCodepoint).append(';');
        } else {
    ...
    public static void b(EscapeMode escapeMode, String str, int i) {
        ...
        boolean z = false;
        int i3 = 0;
        while (!characterReader.b()) {
            String b2 = characterReader.b('=');
            characterReader.f();
            int parseInt = Integer.parseInt(characterReader.a(d), 36);
            char c2 = characterReader.c();
            characterReader.f();
            if (c2 == ',') {
                i2 = Integer.parseInt(characterReader.b(';'), 36);
                characterReader.f();
            } else {
                i2 = -1;
            }
            int parseInt2 = Integer.parseInt(characterReader.b((char) Typography.c), 36);
            characterReader.f();
            ...
            if (i2 != -1) {
                e.put(b2, new String(new int[]{parseInt, i2}, 0, 2));
            }
            i3++;
        }
        if (i3 == i) {
        ...
        Validate.a(z, "Unexpected count of entities loaded");
    }
}
