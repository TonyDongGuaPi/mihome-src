...
public abstract class Enum implements Serializable, Comparable {
    ...
    private static final Map f3382a = Collections.unmodifiableMap(new HashMap(0));
    ...
    private static class Entry {
        ...
        /* renamed from: a  reason: collision with root package name */
        final Map f3383a = new HashMap();
        final Map b = Collections.unmodifiableMap(this.f3383a);
        ...
        if (!StringUtils.a(str)) {
            ...
            if (enumClass != null) {
                ...
                if (z) {
                    ...
                    if (!entry.f3383a.containsKey(str)) {
                        entry.f3383a.put(str, this);
                        entry.c.add(this);
                        return;
                    }
    ...
    public Object readResolve() {
        ...
        return entry.f3383a.get(getName());
    }
    ...
    private static Entry b(Class cls) {
        ...
        while (true) {
            ...
            if (entry2 != null) {
                ...
                entry.f3383a.putAll(entry2.f3383a);
                break;
            }
