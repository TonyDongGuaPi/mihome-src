...
public abstract class ToStringStyle implements Serializable {
    ...
    private static final ThreadLocal f3381a = new ThreadLocal();
    private boolean arrayContentDetail = true;
    private String arrayEnd = "}";
    private String arraySeparator = ",";
    private String arrayStart = Operators.BLOCK_START_STR;
    private String contentEnd = Operators.ARRAY_END_STR;
    private String contentStart = Operators.ARRAY_START_STR;
    ...
    private static final class MultiLineToStringStyle extends ToStringStyle {
        ...
        MultiLineToStringStyle() {
            setContentStart(Operators.ARRAY_START_STR);
            StringBuffer stringBuffer = new StringBuffer();
            stringBuffer.append(SystemUtils.F);
            stringBuffer.append("  ");
            setFieldSeparator(stringBuffer.toString());
            setFieldSeparatorAtStart(true);
            StringBuffer stringBuffer2 = new StringBuffer();
            stringBuffer2.append(SystemUtils.F);
