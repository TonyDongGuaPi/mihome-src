...
public class GifTextView extends TextView {
    ...
    private void init(AttributeSet attributeSet, int i, int i2) {
        if (attributeSet != null) {
            ...
            setBackground(getGifOrDefaultDrawable(attributeSet.getAttributeResourceValue("http://schemas.android.com/apk/res/android", AppStateModule.APP_STATE_BACKGROUND, 0)));
    ...
    private void applyGifViewAttributes() {
        if (this.viewAttributes.d >= 0) {
            for (Drawable a2 : getCompoundDrawables()) {
                GifViewUtils.a(this.viewAttributes.d, a2);
            }
            for (Drawable a3 : getCompoundDrawablesRelative()) {
                GifViewUtils.a(this.viewAttributes.d, a3);
            }
            GifViewUtils.a(this.viewAttributes.d, getBackground());
        }
    }
    ...
    private Drawable getGifOrDefaultDrawable(int i) {
        ...
        if (!isInEditMode() && GifViewUtils.b.contains(resourceTypeName)) {
            try {
