...
public class Button extends android.widget.Button implements TouchEffectDrawable.PerformClicker, TouchEffectDrawable.PerformLongClicker {
    ...
    private void init(AttributeSet attributeSet, int i, int i2) {
        ...
        if (attributeSet != null) {
            ...
            int color = obtainStyledAttributes.getColor(R.styleable.Button_gTouchColor, Ui.b);
            ...
            float dimensionPixelOffset5 = (float) obtainStyledAttributes.getDimensionPixelOffset(R.styleable.Button_gTouchCornerRadiusBR, dimensionPixelOffset);
            ...
            if (i3 != 0) {
                ...
                touchEffectDrawable.a(f4);
                touchEffectDrawable.b(f4);
                touchEffectDrawable.b(i4);
                if (!isInEditMode()) {
                    touchEffectDrawable.a((TouchEffectDrawable.ClipFactory) clipFilletFactory);
                }
