...
public class ResolutionAnchor extends ResolutionNode {
    ...
    public String toString() {
        if (this.state != 1) {
            ...
            return Operators.ARRAY_START_STR + this.myAnchor + ", RESOLVED: " + this.resolvedOffset + "]  type: " + sType(this.type);
        } else {
            return Operators.ARRAY_START_STR + this.myAnchor + ", RESOLVED: " + this.resolvedTarget + ":" + this.resolvedOffset + "] type: " + sType(this.type);
        }
    }
