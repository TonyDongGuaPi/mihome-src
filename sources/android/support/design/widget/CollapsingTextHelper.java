...
public final class CollapsingTextHelper {
    ...
    static {
        if (DEBUG_DRAW_PAINT != null) {
            ...
            DEBUG_DRAW_PAINT.setColor(Color.k);
        }
    }
    ...
    private static int blendColors(int i, int i2, float f) {
        float f2 = 1.0f - f;
        return android.graphics.Color.argb((int) ((((float) android.graphics.Color.alpha(i)) * f2) + (((float) android.graphics.Color.alpha(i2)) * f)), (int) ((((float) android.graphics.Color.red(i)) * f2) + (((float) android.graphics.Color.red(i2)) * f)), (int) ((((float) android.graphics.Color.green(i)) * f2) + (((float) android.graphics.Color.green(i2)) * f)), (int) ((((float) android.graphics.Color.blue(i)) * f2) + (((float) android.graphics.Color.blue(i2)) * f)));
    }
