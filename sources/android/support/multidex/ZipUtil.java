        ...
        if (length >= 0) {
            ...
            do {
                ...
                if (randomAccessFile.readInt() == reverseBytes) {
                    ...
                    centralDirectory.size = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & MessageHead.SERIAL_MAK;
                    centralDirectory.offset = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & MessageHead.SERIAL_MAK;
