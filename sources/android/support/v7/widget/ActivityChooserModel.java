    ...
    private final class PersistHistoryAsyncTask extends AsyncTask<Object, Void, Void> {
        ...
        public java.lang.Void doInBackground(java.lang.Object... r12) {
            /*
                ...
                r3 = 0
                android.support.v7.widget.ActivityChooserModel r4 = android.support.v7.widget.ActivityChooserModel.this     // Catch:{ FileNotFoundException -> 0x00ea }
                android.content.Context r4 = r4.mContext     // Catch:{ FileNotFoundException -> 0x00ea }
                java.io.FileOutputStream r4 = r4.openFileOutput(r12, r0)     // Catch:{ FileNotFoundException -> 0x00ea }
                org.xmlpull.v1.XmlSerializer r12 = android.util.Xml.newSerializer()
                r12.setOutput(r4, r3)     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                java.lang.String r5 = "UTF-8"
                java.lang.Boolean r6 = java.lang.Boolean.valueOf(r2)     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                r12.startDocument(r5, r6)     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                java.lang.String r5 = "historical-records"
                r12.startTag(r3, r5)     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                int r5 = r1.size()     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                r6 = 0
            L_0x002d:
                if (r6 >= r5) goto L_0x0065
                java.lang.Object r7 = r1.remove(r0)     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                android.support.v7.widget.ActivityChooserModel$HistoricalRecord r7 = (android.support.v7.widget.ActivityChooserModel.HistoricalRecord) r7     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                java.lang.String r8 = "historical-record"
                r12.startTag(r3, r8)     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                java.lang.String r8 = "activity"
                android.content.ComponentName r9 = r7.activity     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                java.lang.String r9 = r9.flattenToString()     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                r12.attribute(r3, r8, r9)     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                java.lang.String r8 = "time"
                long r9 = r7.time     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                java.lang.String r9 = java.lang.String.valueOf(r9)     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                r12.attribute(r3, r8, r9)     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                java.lang.String r8 = "weight"
                float r7 = r7.weight     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                java.lang.String r7 = java.lang.String.valueOf(r7)     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                r12.attribute(r3, r8, r7)     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                java.lang.String r7 = "historical-record"
                r12.endTag(r3, r7)     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                int r6 = r6 + 1
                goto L_0x002d
            L_0x0065:
                java.lang.String r0 = "historical-records"
                r12.endTag(r3, r0)     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
                r12.endDocument()     // Catch:{ IllegalArgumentException -> 0x00bd, IllegalStateException -> 0x009b, IOException -> 0x0079 }
            ...
            L_0x0079:
                r12 = move-exception
                java.lang.String r0 = android.support.v7.widget.ActivityChooserModel.LOG_TAG     // Catch:{ all -> 0x0077 }
                ...
                r1.append(r5)     // Catch:{ all -> 0x0077 }
                android.support.v7.widget.ActivityChooserModel r5 = android.support.v7.widget.ActivityChooserModel.this     // Catch:{ all -> 0x0077 }
                java.lang.String r5 = r5.mHistoryFileName     // Catch:{ all -> 0x0077 }
                r1.append(r5)     // Catch:{ all -> 0x0077 }
                java.lang.String r1 = r1.toString()     // Catch:{ all -> 0x0077 }
                android.util.Log.e(r0, r1, r12)     // Catch:{ all -> 0x0077 }
                android.support.v7.widget.ActivityChooserModel r12 = android.support.v7.widget.ActivityChooserModel.this
                r12.mCanReadHistoricalData = r2
                if (r4 == 0) goto L_0x00df
                goto L_0x0073
