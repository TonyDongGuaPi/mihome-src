...
public final class NotificationManagerCompat {
    ...
    private final NotificationManager mNotificationManager = ((NotificationManager) this.mContext.getSystemService(PushManager.MESSAGE_TYPE_NOTI));
    ...
    private static class NotifyTask implements Task {
        ...
        public String toString() {
            return "NotifyTask[" + "packageName:" + this.packageName + ", id:" + this.id + ", tag:" + this.tag + Operators.ARRAY_END_STR;
        }
    }
    ...
    private static class CancelTask implements Task {
        ...
        public String toString() {
            return "CancelTask[" + "packageName:" + this.packageName + ", id:" + this.id + ", tag:" + this.tag + ", all:" + this.all + Operators.ARRAY_END_STR;
        }
    }
}
