...
public final class LinkifyCompat {
    ...
    public static boolean addLinks(@NonNull Spannable spannable, int i) {
        ...
        if ((i & 1) != 0) {
            gatherLinks(arrayList, spannable, PatternsCompat.AUTOLINK_WEB_URL, new String[]{ConnectionHelper.HTTP_PREFIX, "https://", "rtsp://"}, Linkify.sUrlMatchFilter, (Linkify.TransformFilter) null);
        }
        if ((i & 2) != 0) {
