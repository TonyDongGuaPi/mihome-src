...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j, int i) {
        ...
        boolean z = i7 != 0;
        int i12 = i11;
        int printField = printField(cArr, i2, PatternFormatter.DATE_CONVERSION_CHAR, i11, false, 0);
        int printField2 = printField(cArr, i3, 'h', printField, printField != i12, z ? 2 : 0);
        int printField3 = printField(cArr, i5, PatternFormatter.MESSAGE_CONVERSION_CHAR, printField2, printField2 != i12, z ? 2 : 0);
        int printField4 = printField(cArr, i4, 's', printField3, printField3 != i12, z ? 2 : 0);
        int printField5 = printField(cArr, i9, PatternFormatter.MESSAGE_CONVERSION_CHAR, printField4, true, (!z || printField4 == i12) ? 0 : 3);
        cArr[printField5] = 's';
    ...
    public static void formatDuration(long j, long j2, PrintWriter printWriter) {
        if (j == 0) {
            printWriter.print(HelpFormatter.f);
        } else {
