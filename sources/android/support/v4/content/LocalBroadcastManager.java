...
public final class LocalBroadcastManager {
    ...
    public boolean sendBroadcast(@android.support.annotation.NonNull android.content.Intent r22) {
        /*
            ...
            monitor-enter(r2)
            java.lang.String r10 = r22.getAction()     // Catch:{ all -> 0x016e }
            android.content.Context r3 = r1.mAppContext     // Catch:{ all -> 0x016e }
            android.content.ContentResolver r3 = r3.getContentResolver()     // Catch:{ all -> 0x016e }
            java.lang.String r11 = r0.resolveTypeIfNeeded(r3)     // Catch:{ all -> 0x016e }
            android.net.Uri r12 = r22.getData()     // Catch:{ all -> 0x016e }
            java.lang.String r13 = r22.getScheme()     // Catch:{ all -> 0x016e }
            java.util.Set r14 = r22.getCategories()     // Catch:{ all -> 0x016e }
            int r3 = r22.getFlags()     // Catch:{ all -> 0x016e }
            r3 = r3 & 8
        ...
        L_0x002e:
            ...
            r4.append(r5)     // Catch:{ all -> 0x016e }
            r4.append(r11)     // Catch:{ all -> 0x016e }
            java.lang.String r5 = " scheme "
            r4.append(r5)     // Catch:{ all -> 0x016e }
            r4.append(r13)     // Catch:{ all -> 0x016e }
            java.lang.String r5 = " of intent "
            r4.append(r5)     // Catch:{ all -> 0x016e }
            r4.append(r0)     // Catch:{ all -> 0x016e }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x016e }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x016e }
        L_0x0056:
            java.util.HashMap<java.lang.String, java.util.ArrayList<android.support.v4.content.LocalBroadcastManager$ReceiverRecord>> r3 = r1.mActions     // Catch:{ all -> 0x016e }
            java.lang.String r4 = r22.getAction()     // Catch:{ all -> 0x016e }
            java.lang.Object r3 = r3.get(r4)     // Catch:{ all -> 0x016e }
            r8 = r3
            java.util.ArrayList r8 = (java.util.ArrayList) r8     // Catch:{ all -> 0x016e }
        ...
        L_0x007d:
            ...
            r7 = 0
        L_0x0080:
            int r3 = r8.size()     // Catch:{ all -> 0x016e }
            if (r7 >= r3) goto L_0x013b
            java.lang.Object r3 = r8.get(r7)     // Catch:{ all -> 0x016e }
            r5 = r3
            android.support.v4.content.LocalBroadcastManager$ReceiverRecord r5 = (android.support.v4.content.LocalBroadcastManager.ReceiverRecord) r5     // Catch:{ all -> 0x016e }
            if (r16 == 0) goto L_0x00a7
            java.lang.String r3 = "LocalBroadcastManager"
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ all -> 0x016e }
            r4.<init>()     // Catch:{ all -> 0x016e }
            java.lang.String r9 = "Matching against filter "
            r4.append(r9)     // Catch:{ all -> 0x016e }
            android.content.IntentFilter r9 = r5.filter     // Catch:{ all -> 0x016e }
            r4.append(r9)     // Catch:{ all -> 0x016e }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x016e }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x016e }
        L_0x00a7:
            boolean r3 = r5.broadcasting     // Catch:{ all -> 0x016e }
        ...
        L_0x00b4:
            ...
            goto L_0x0130
        L_0x00c0:
            android.content.IntentFilter r3 = r5.filter     // Catch:{ all -> 0x016e }
            ...
            r20 = r11
            r11 = 1
            int r3 = r3.match(r4, r5, r6, r7, r8, r9)     // Catch:{ all -> 0x016e }
            ...
            java.lang.String r3 = java.lang.Integer.toHexString(r3)     // Catch:{ all -> 0x016e }
            r5.append(r3)     // Catch:{ all -> 0x016e }
            java.lang.String r3 = r5.toString()     // Catch:{ all -> 0x016e }
            android.util.Log.v(r4, r3)     // Catch:{ all -> 0x016e }
        L_0x00f6:
        ...
        L_0x00fe:
            r6 = r10
        L_0x00ff:
            r6.add(r15)     // Catch:{ all -> 0x016e }
            r15.broadcasting = r11     // Catch:{ all -> 0x016e }
            goto L_0x0131
        L_0x0105:
        ...
        L_0x0140:
            ...
            java.lang.Object r4 = r10.get(r3)     // Catch:{ all -> 0x016e }
            android.support.v4.content.LocalBroadcastManager$ReceiverRecord r4 = (android.support.v4.content.LocalBroadcastManager.ReceiverRecord) r4     // Catch:{ all -> 0x016e }
            r5 = 0
            r4.broadcasting = r5     // Catch:{ all -> 0x016e }
            int r3 = r3 + 1
            goto L_0x0140
        L_0x0152:
            java.util.ArrayList<android.support.v4.content.LocalBroadcastManager$BroadcastRecord> r3 = r1.mPendingBroadcasts     // Catch:{ all -> 0x016e }
            android.support.v4.content.LocalBroadcastManager$BroadcastRecord r4 = new android.support.v4.content.LocalBroadcastManager$BroadcastRecord     // Catch:{ all -> 0x016e }
            r4.<init>(r0, r10)     // Catch:{ all -> 0x016e }
            r3.add(r4)     // Catch:{ all -> 0x016e }
            android.os.Handler r0 = r1.mHandler     // Catch:{ all -> 0x016e }
            boolean r0 = r0.hasMessages(r11)     // Catch:{ all -> 0x016e }
            if (r0 != 0) goto L_0x0169
            android.os.Handler r0 = r1.mHandler     // Catch:{ all -> 0x016e }
            r0.sendEmptyMessage(r11)     // Catch:{ all -> 0x016e }
        L_0x0169:
