    ...
    private static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            if (Build.VERSION.SDK_INT > 21) {
                ...
                SERVICES.put(CameraManager.class, UserAvatarUpdateActivity.CAMERA);
            ...
            if (Build.VERSION.SDK_INT > 19) {
                ...
                SERVICES.put(PrintManager.class, SharePatchInfo.f);
            }
            if (Build.VERSION.SDK_INT > 18) {
                SERVICES.put(BluetoothManager.class, BleDevice.f14751a);
            }
            ...
            SERVICES.put(ClipboardManager.class, ShareChannel.d);
            SERVICES.put(ConnectivityManager.class, "connectivity");
            SERVICES.put(DevicePolicyManager.class, "device_policy");
            SERVICES.put(DownloadManager.class, Constants.TitleMenu.MENU_DOWNLOAD);
            ...
            SERVICES.put(NfcManager.class, AnalyticManager.CATEGORY_NFC);
            SERVICES.put(NotificationManager.class, PushManager.MESSAGE_TYPE_NOTI);
            SERVICES.put(PowerManager.class, CameraPropertyBase.l);
