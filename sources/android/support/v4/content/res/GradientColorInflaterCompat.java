...
final class GradientColorInflaterCompat {
    ...
    static Shader createFromXmlInner(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws IOException, XmlPullParserException {
        ...
        if (name.equals("gradient")) {
            ...
            float namedFloat = TypedArrayUtils.getNamedFloat(obtainAttributes, xmlPullParser2, Constant.KEY_STARTPOSITION_X, R.styleable.GradientColor_android_startX, 0.0f);
            float namedFloat2 = TypedArrayUtils.getNamedFloat(obtainAttributes, xmlPullParser2, Constant.KEY_STARTPOSITION_Y, R.styleable.GradientColor_android_startY, 0.0f);
