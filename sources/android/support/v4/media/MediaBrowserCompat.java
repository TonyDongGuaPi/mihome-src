...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        ...
        public String toString() {
            return "MediaItem{" + "mFlags=" + this.mFlags + ", mDescription=" + this.mDescription + Operators.BLOCK_END;
        }
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void connect() {
            ...
            throw new IllegalStateException("connect() called while neigther disconnecting nor disconnected (state=" + getStateLabel(this.mState) + Operators.BRACKET_END_STR);
        }
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException("getServiceComponent() called while not connected (state=" + this.mState + Operators.BRACKET_END_STR);
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException("getRoot() called while not connected(state=" + getStateLabel(this.mState) + Operators.BRACKET_END_STR);
        }
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException("getExtras() called while not connected (state=" + getStateLabel(this.mState) + Operators.BRACKET_END_STR);
        }
        ...
        public void search(@NonNull final String str, final Bundle bundle, @NonNull final SearchCallback searchCallback) {
            if (isConnected()) {
                ...
                throw new IllegalStateException("search() called while not connected (state=" + getStateLabel(this.mState) + Operators.BRACKET_END_STR);
            }
        }
            ...
            if (this.mCallback != null) {
                ...
                switch (i) {
                    ...
                    case 1:
                        ...
                        return;
                    default:
                        Log.w(MediaBrowserCompat.TAG, "Unknown result code: " + i + " (extras=" + this.mExtras + ", resultData=" + bundle + Operators.BRACKET_END_STR);
                        return;
                }
            }
        }
