...
public class SelfDestructiveThread {
    ...
    public <T> T postAndWait(java.util.concurrent.Callable<T> r13, int r14) throws java.lang.InterruptedException {
        /*
            ...
            r12.post(r11)
            r7.lock()
            boolean r13 = r10.get()     // Catch:{ all -> 0x005e }
            if (r13 != 0) goto L_0x0034
            java.lang.Object r13 = r9.get()     // Catch:{ all -> 0x005e }
            r7.unlock()
            return r13
        L_0x0034:
            java.util.concurrent.TimeUnit r13 = java.util.concurrent.TimeUnit.MILLISECONDS     // Catch:{ all -> 0x005e }
            long r0 = (long) r14     // Catch:{ all -> 0x005e }
            long r13 = r13.toNanos(r0)     // Catch:{ all -> 0x005e }
        L_0x003b:
            long r0 = r8.awaitNanos(r13)     // Catch:{ InterruptedException -> 0x0040 }
            r13 = r0
        L_0x0040:
            boolean r0 = r10.get()     // Catch:{ all -> 0x005e }
        ...
        L_0x004e:
            ...
            goto L_0x003b
        L_0x0055:
            java.lang.InterruptedException r13 = new java.lang.InterruptedException     // Catch:{ all -> 0x005e }
            java.lang.String r14 = "timeout"
            r13.<init>(r14)     // Catch:{ all -> 0x005e }
            throw r13     // Catch:{ all -> 0x005e }
        L_0x005e:
            r13 = move-exception
            r7.unlock()
            throw r13
