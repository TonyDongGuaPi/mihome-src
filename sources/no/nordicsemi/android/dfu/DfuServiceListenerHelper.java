            ...
            if (dfuProgressListener != null || dfuProgressListener2 != null) {
                ...
                switch (c) {
                    ...
                    case 1:
                        ...
                        if (intExtra5 == 1) {
                            if (dfuProgressListener != null) {
                                dfuProgressListener.onError(stringExtra, intExtra4, intExtra5, GattError.a(intExtra4));
                            }
                            if (dfuProgressListener2 != null) {
                                dfuProgressListener2.onError(stringExtra, intExtra4, intExtra5, GattError.a(intExtra4));
                                return;
                            }
                            return;
                        } else if (intExtra5 != 3) {
                            if (dfuProgressListener != null) {
                                dfuProgressListener.onError(stringExtra, intExtra4, intExtra5, GattError.b(intExtra4));
                            }
                            if (dfuProgressListener2 != null) {
                                dfuProgressListener2.onError(stringExtra, intExtra4, intExtra5, GattError.b(intExtra4));
                                return;
                            }
                            return;
                        } else {
                            if (dfuProgressListener != null) {
                                dfuProgressListener.onError(stringExtra, intExtra4, intExtra5, GattError.c(intExtra4));
                            }
                            if (dfuProgressListener2 != null) {
                                dfuProgressListener2.onError(stringExtra, intExtra4, intExtra5, GattError.c(intExtra4));
                                return;
                            }
                            return;
                        }
