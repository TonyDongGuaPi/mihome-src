...
public final class OkHttpsURLConnection extends DelegatingHttpsURLConnection {
    ...
    public class AjcClosure1 extends AroundClosure {
        ...
        public Object run(Object[] objArr) {
            ...
            return OkHttpsURLConnection.build_aroundBody0((OkHttpsURLConnection) objArr2[0], (OkHttpClient.Builder) objArr2[1], (JoinPoint) objArr2[2]);
        }
    }
    ...
    public class AjcClosure3 extends AroundClosure {
        ...
        public Object run(Object[] objArr) {
            Object[] objArr2 = this.state;
            return OkHttpsURLConnection.build_aroundBody2((OkHttpsURLConnection) objArr2[0], (OkHttpClient.Builder) objArr2[1], (JoinPoint) objArr2[2]);
        }
    }
    ...
    private static void ajc$preClinit() {
        Factory factory = new Factory("OkHttpsURLConnection.java", OkHttpsURLConnection.class);
        ajc$tjp_0 = factory.a("method-call", (Signature) factory.a("1", "build", "okhttp3.OkHttpClient$Builder", "", "", "", "okhttp3.OkHttpClient"), 53);
        ajc$tjp_1 = factory.a("method-call", (Signature) factory.a("1", "build", "okhttp3.OkHttpClient$Builder", "", "", "", "okhttp3.OkHttpClient"), 67);
    }
    ...
    public void setHostnameVerifier(HostnameVerifier hostnameVerifier) {
        ...
        OkHttpClient.Builder hostnameVerifier2 = this.delegate.client.newBuilder().hostnameVerifier(hostnameVerifier);
        JoinPoint a2 = Factory.a(ajc$tjp_0, (Object) this, (Object) hostnameVerifier2);
        okHttpURLConnection.client = (OkHttpClient) OkHttp3Aspect.d().a(new AjcClosure1(new Object[]{this, hostnameVerifier2, a2}).linkClosureAndJoinPoint(4112));
    }

    static final OkHttpClient build_aroundBody0(OkHttpsURLConnection okHttpsURLConnection, OkHttpClient.Builder builder, JoinPoint joinPoint) {
    ...
    public void setSSLSocketFactory(SSLSocketFactory sSLSocketFactory) {
        if (sSLSocketFactory != null) {
            OkHttpURLConnection okHttpURLConnection = this.delegate;
            OkHttpClient.Builder sslSocketFactory = this.delegate.client.newBuilder().sslSocketFactory(sSLSocketFactory);
            JoinPoint a2 = Factory.a(ajc$tjp_1, (Object) this, (Object) sslSocketFactory);
            okHttpURLConnection.client = (OkHttpClient) OkHttp3Aspect.d().a(new AjcClosure3(new Object[]{this, sslSocketFactory, a2}).linkClosureAndJoinPoint(4112));
            return;
        }
        throw new IllegalArgumentException("sslSocketFactory == null");
    }

    static final OkHttpClient build_aroundBody2(OkHttpsURLConnection okHttpsURLConnection, OkHttpClient.Builder builder, JoinPoint joinPoint) {
        HawkEyeAspect.a().a(joinPoint);
        return builder.build();
    }
