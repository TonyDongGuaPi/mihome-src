...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public class AjcClosure1 extends AroundClosure {
        ...
        public Object run(Object[] objArr) {
            ...
            return RealWebSocket.build_aroundBody0((RealWebSocket) objArr2[0], (OkHttpClient.Builder) objArr2[1], (JoinPoint) objArr2[2]);
        }
    }

    private static void ajc$preClinit() {
        Factory factory = new Factory("RealWebSocket.java", RealWebSocket.class);
        ajc$tjp_0 = factory.a("method-call", (Signature) factory.a("1", "build", "okhttp3.OkHttpClient$Builder", "", "", "", "okhttp3.OkHttpClient"), 184);
    }
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        JoinPoint a2 = Factory.a(ajc$tjp_0, (Object) this, (Object) protocols);
        OkHttp3Aspect d = OkHttp3Aspect.d();
        Object[] objArr = {this, protocols, a2};
        final Request build = this.originalRequest.newBuilder().header(HttpHeaders.UPGRADE, "websocket").header("Connection", HttpHeaders.UPGRADE).header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", "13").build();
        this.call = Internal.instance.newWebSocketCall((OkHttpClient) d.a(new AjcClosure1(objArr).linkClosureAndJoinPoint(4112)), build);
            ...
            public void onResponse(Call call, Response response) {
                try {
                    ...
                    try {
                        ...
                        RealWebSocket.this.initReaderAndWriter("OkHttp WebSocket " + build.url().redact(), newWebSocketStreams);
    ...
    static final OkHttpClient build_aroundBody0(RealWebSocket realWebSocket, OkHttpClient.Builder builder, JoinPoint joinPoint) {
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x0058:
            ...
            okio.BufferedSink r0 = okio.Okio.buffer((okio.Sink) r0)     // Catch:{ all -> 0x0056 }
            r0.write((okio.ByteString) r1)     // Catch:{ all -> 0x0056 }
