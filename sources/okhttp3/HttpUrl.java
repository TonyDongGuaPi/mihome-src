...
public final class HttpUrl {
    ...
    public List<String> encodedPathSegments() {
        ...
        while (indexOf < delimiterOffset) {
            int i = indexOf + 1;
            int delimiterOffset2 = Util.delimiterOffset(this.url, i, delimiterOffset, (char) IOUtils.f15883a);
                ...
                while (true) {
                    ...
                    if (!(charAt == 65535 || charAt == c || charAt == '/' || charAt == '\\')) {
                        switch (charAt) {
                            ...
                            case '@':
                                if (!z) {
                                    int delimiterOffset2 = Util.delimiterOffset(str2, i2, delimiterOffset, (char) Operators.CONDITION_IF_MIDDLE);
