...
public class IjkMediaMeta {
    ...
    public static class IjkStreamMeta {
        ...
        public String getCodecLongNameInline() {
            ...
            return !TextUtils.isEmpty(this.mCodecName) ? this.mCodecName : SensorsDataManager.u;
        }
        ...
        public String getFpsInline() {
            return (this.mFpsNum <= 0 || this.mFpsDen <= 0) ? SensorsDataManager.u : String.valueOf(((float) this.mFpsNum) / ((float) this.mFpsDen));
        }
