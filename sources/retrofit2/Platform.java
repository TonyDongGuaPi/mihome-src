    ...
    static class Android extends Platform {
        ...
        public List<? extends CallAdapter.Factory> defaultCallAdapterFactories(@Nullable Executor executor) {
            if (executor != null) {
                ...
                if (Build.VERSION.SDK_INT < 24) {
                    return Collections.singletonList(executorCallAdapterFactory);
                }
                return Arrays.asList(new CallAdapter.Factory[]{CompletableFutureCallAdapterFactory.INSTANCE, executorCallAdapterFactory});
            }
