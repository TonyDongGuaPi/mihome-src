...
final class RequestFactory {
    ...
    static final class Builder {
        ...
        private void parseHttpMethodAndPath(String str, String str2, boolean z) {
            ...
            throw Utils.methodError(this.method, "Only one HTTP method is allowed. Found: %s and %s.", this.httpMethod, str);
        }
            ...
            if (annotation instanceof Url) {
                ...
                if (Map.class.isAssignableFrom(rawType3)) {
                    ...
                    if (supertype instanceof ParameterizedType) {
                        ...
                        throw Utils.parameterError(method4, i, "@QueryMap keys must be of type String: " + parameterUpperBound, new Object[0]);
                    }
                ...
                if (Iterable.class.isAssignableFrom(rawType4)) {
                    ...
                    throw Utils.parameterError(method5, i, rawType4.getSimpleName() + " must include generic type (e.g., " + rawType4.getSimpleName() + "<String>)", new Object[0]);
                ...
                if (Map.class.isAssignableFrom(rawType5)) {
                    ...
                    if (supertype2 instanceof ParameterizedType) {
                        ...
                        throw Utils.parameterError(method6, i, "@HeaderMap keys must be of type String: " + parameterUpperBound2, new Object[0]);
                    }
                    throw Utils.parameterError(this.method, i, "Map must include generic types (e.g., Map<String, String>)", new Object[0]);
                }
                ...
                if (this.isFormEncoded) {
                    ...
                    if (Iterable.class.isAssignableFrom(rawType6)) {
                        ...
                        throw Utils.parameterError(method7, i, rawType6.getSimpleName() + " must include generic type (e.g., " + rawType6.getSimpleName() + "<String>)", new Object[0]);
                ...
                if (this.isFormEncoded) {
                    ...
                    if (Map.class.isAssignableFrom(rawType7)) {
                        ...
                        if (supertype3 instanceof ParameterizedType) {
                            ...
                            throw Utils.parameterError(method8, i, "@FieldMap keys must be of type String: " + parameterUpperBound3, new Object[0]);
                        }
                        throw Utils.parameterError(this.method, i, "Map must include generic types (e.g., Map<String, String>)", new Object[0]);
                    }
                ...
                if (this.isMultipart) {
                    ...
                    if (!value5.isEmpty()) {
                        ...
                        if (!(type instanceof ParameterizedType)) {
                            ...
                            throw Utils.parameterError(method10, i, rawType8.getSimpleName() + " must include generic type (e.g., " + rawType8.getSimpleName() + "<String>)", new Object[0]);
                ...
                if (this.isMultipart) {
                    ...
                    if (Map.class.isAssignableFrom(rawType9)) {
                        ...
                        if (supertype4 instanceof ParameterizedType) {
                            ...
                            throw Utils.parameterError(method11, i, "@PartMap keys must be of type String: " + parameterUpperBound5, new Object[0]);
                        }
                        throw Utils.parameterError(this.method, i, "Map must include generic types (e.g., Map<String, String>)", new Object[0]);
                    }
