...
final class Utils {
    ...
    static RuntimeException parameterError(Method method, Throwable th, int i, String str, Object... objArr) {
        return methodError(method, th, str + " (parameter #" + (i + 1) + Operators.BRACKET_END_STR, objArr);
    }

    static RuntimeException parameterError(Method method, int i, String str, Object... objArr) {
        return methodError(method, str + " (parameter #" + (i + 1) + Operators.BRACKET_END_STR, objArr);
    }
    ...
    private static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return Utils.typeToString(this.componentType) + XMPConst.ai;
        }
    }
