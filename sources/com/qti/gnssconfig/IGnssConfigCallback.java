...
public interface IGnssConfigCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGnssConfigCallback {
        private static final String DESCRIPTOR = "com.qti.gnssconfig.IGnssConfigCallback";
        static final int TRANSACTION_getGnssSvTypeConfigCb = 1;
        ...
        private static class Proxy implements IGnssConfigCallback {
