...
public interface IWiFiDBProvider extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWiFiDBProvider {
        private static final String DESCRIPTOR = "com.qti.wifidbprovider.IWiFiDBProvider";
        static final int TRANSACTION_registerResponseListener = 1;
        static final int TRANSACTION_removeResponseListener = 3;
        static final int TRANSACTION_requestAPObsLocData = 2;
        ...
        private static class Proxy implements IWiFiDBProvider {
