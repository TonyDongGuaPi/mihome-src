...
public interface IWWANDBProvider extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWWANDBProvider {
        private static final String DESCRIPTOR = "com.qti.wwandbprovider.IWWANDBProvider";
        static final int TRANSACTION_registerResponseListener = 1;
        static final int TRANSACTION_removeResponseListener = 3;
        static final int TRANSACTION_requestBSObsLocData = 2;
        ...
        private static class Proxy implements IWWANDBProvider {
