...
public class StorageDir extends StorageFile {
    ...
    public void writeBytes(String str, byte[] bArr) {
        new StorageFile((File) this, str).writeBytes(bArr);
    }

    public byte[] readBytes(String str) {
        return new StorageFile((File) this, str).readBytes();
    }

    public void writeObject(String str, Serializable serializable) {
        new StorageFile((File) this, str).writeObject(serializable);
    }

    public Serializable readObject(String str) {
        return new StorageFile((File) this, str).readObject();
    }

    public void write(String str, String str2) {
        new StorageFile((File) this, str).write(str2);
    }

    public void append(String str, String str2) {
        new StorageFile((File) this, str).append(str2);
    }

    public String read(String str) {
        return new StorageFile((File) this, str).read();
    }

    public ArrayList<String> readAndSplit(String str) {
        return new StorageFile((File) this, str).readAndSplit();
    }

    public boolean delete(String str) {
        return new StorageFile((File) this, str).delete();
    }
    ...
    public long lastModified(String str) {
        return new StorageFile((File) this, str).lastModified();
    }

    public long getFileLength(String str) {
        return new StorageFile((File) this, str).length();
    }
    ...
    public StorageFile[] listFiles() {
        synchronized (getFileLock(this)) {
            ...
            for (int i = 0; i < length; i++) {
                storageFileArr[i] = new StorageFile((File) this, list[i]);
            }
