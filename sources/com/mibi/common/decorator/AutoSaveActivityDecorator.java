...
public class AutoSaveActivityDecorator extends ActivityDecoratorAdapter {
    ...
    public void b(Bundle bundle) {
        super.b(bundle);
        if (bundle != null) {
            for (Field field : this.f7447a.getClass().getDeclaredFields()) {
                if (field.isAnnotationPresent(AutoSave.AutoSavable.class)) {
                    field.setAccessible(true);
                    Object obj = bundle.get(b + field.getName());
                    if (obj != null) {
                        try {
                            field.set(this.f7447a, field.getType().cast(obj));
    ...
    public void c(android.os.Bundle r8) {
        /*
            r7 = this;
            super.c(r8)
            com.mibi.common.base.DecoratableActivity r0 = r7.f7447a
        ...
        L_0x000f:
            ...
            r5 = 0
            com.mibi.common.base.DecoratableActivity r6 = r7.f7447a     // Catch:{ IllegalAccessException -> 0x0030, IllegalArgumentException -> 0x002b }
        ...
        L_0x0077:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mibi.common.decorator.AutoSaveActivityDecorator.c(android.os.Bundle):void");
    }
}
