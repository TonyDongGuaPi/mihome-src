...
public class SvgView extends ReactViewGroup implements ReactCompoundView, ReactCompoundViewGroup {
    ...
    public void setBbWidth(Dynamic dynamic) {
        this.mbbWidth = SVGLength.a(dynamic);
        invalidate();
        clearChildCache();
    }
    ...
    public void setBbHeight(Dynamic dynamic) {
        this.mbbHeight = SVGLength.a(dynamic);
        invalidate();
        clearChildCache();
    }
    ...
    public synchronized void drawChildren(Canvas canvas) {
        ...
        if (this.mAlign != null) {
            ...
            if (z) {
                width = (float) PropHelper.a(this.mbbWidth, (double) width, 0.0d, (double) this.mScale, 12.0d);
                height = (float) PropHelper.a(this.mbbHeight, (double) height, 0.0d, (double) this.mScale, 12.0d);
            }
            RectF rectF = new RectF(0.0f, 0.0f, width, height);
            if (z) {
                canvas.clipRect(rectF);
            }
            Matrix a2 = ViewBox.a(viewBox, rectF, this.mAlign, this.mMeetOrSlice);
