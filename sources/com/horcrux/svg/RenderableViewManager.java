...
class RenderableViewManager extends ViewGroupManager<VirtualView> {
    ...
    static class MatrixDecompositionContext extends MatrixMathHelper.MatrixDecompositionContext {
        ...
        final double[] f5823a = new double[4];
    ...
    private static void decomposeMatrix() {
        double[] dArr = sMatrixDecompositionContext.f5823a;
        ...
        if (!isZero(sTransformDecompositionArray[15])) {
            ...
            if (!isZero(MatrixMathHelper.determinant(dArr7))) {
                ...
                dArr5[2] = MatrixMathHelper.roundTo3Places((-Math.atan2(dArr8[1][0], dArr8[0][0])) * 57.29577951308232d);
            }
        }
    }
    ...
    static class GroupViewManager extends RenderableViewManager {
        ...
        public void setFontSize(GroupView groupView, Dynamic dynamic) {
            ...
            switch (AnonymousClass2.f5822a[dynamic.getType().ordinal()]) {
                case 1:
    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ int[] f5822a = new int[ReadableType.values().length];
        ...
        static {
            ...
            L_0x0062:
                int[] r2 = b     // Catch:{ NoSuchFieldError -> 0x006e }
            ...
            L_0x006e:
                int[] r2 = b     // Catch:{ NoSuchFieldError -> 0x007a }
            ...
            L_0x007a:
                int[] r2 = b     // Catch:{ NoSuchFieldError -> 0x0086 }
            ...
            L_0x0086:
                int[] r2 = b     // Catch:{ NoSuchFieldError -> 0x0092 }
            ...
            L_0x0092:
                int[] r2 = b     // Catch:{ NoSuchFieldError -> 0x009e }
            ...
            L_0x009e:
                int[] r2 = b     // Catch:{ NoSuchFieldError -> 0x00aa }
            ...
            L_0x00aa:
                int[] r2 = b     // Catch:{ NoSuchFieldError -> 0x00b6 }
            ...
            L_0x00b6:
                int[] r2 = b     // Catch:{ NoSuchFieldError -> 0x00c2 }
            ...
            L_0x00c2:
                int[] r2 = b     // Catch:{ NoSuchFieldError -> 0x00ce }
            ...
            L_0x00ce:
                int[] r2 = b     // Catch:{ NoSuchFieldError -> 0x00da }
            ...
            L_0x00da:
                ...
                int[] r2 = new int[r2]
                f5822a = r2
                int[] r2 = f5822a     // Catch:{ NoSuchFieldError -> 0x00ed }
            ...
            L_0x00ed:
                int[] r0 = f5822a     // Catch:{ NoSuchFieldError -> 0x00f7 }
