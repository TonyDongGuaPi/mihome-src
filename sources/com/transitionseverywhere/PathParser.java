...
public class PathParser {
    ...
    static final String f9462a = "PathParser";
    ...
    public static boolean a(PathDataNode[] pathDataNodeArr, PathDataNode[] pathDataNodeArr2) {
        ...
        for (int i = 0; i < pathDataNodeArr.length; i++) {
            if (pathDataNodeArr[i].f9464a != pathDataNodeArr2[i].f9464a || pathDataNodeArr[i].b.length != pathDataNodeArr2[i].b.length) {
                return false;
            }
        }
        return true;
    ...
    public static void b(PathDataNode[] pathDataNodeArr, PathDataNode[] pathDataNodeArr2) {
        for (int i = 0; i < pathDataNodeArr2.length; i++) {
            char unused = pathDataNodeArr[i].f9464a = pathDataNodeArr2[i].f9464a;
    ...
    private static float[] c(String str) {
        ...
        try {
            ...
            int i2 = 1;
            while (i2 < length) {
                a(str, i2, extractFloatResult);
                int i3 = extractFloatResult.f9463a;
                if (i2 < i3) {
                    fArr[i] = Float.parseFloat(str.substring(i2, i3));
                    i++;
                }
                i2 = extractFloatResult.b ? i3 : i3 + 1;
            }
    ...
    private static void a(java.lang.String r8, int r9, com.transitionseverywhere.PathParser.ExtractFloatResult r10) {
        /*
            r0 = 0
            r10.b = r0
            r1 = r9
        ...
        L_0x003d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.transitionseverywhere.PathParser.a(java.lang.String, int, com.transitionseverywhere.PathParser$ExtractFloatResult):void");
    }
    ...
    public static class PathDataNode {
        ...
        private PathDataNode(PathDataNode pathDataNode) {
            this.f9464a = pathDataNode.f9464a;
        ...
        public static void a(PathDataNode[] pathDataNodeArr, Path path) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                a(path, fArr, c, pathDataNodeArr[i].f9464a, pathDataNodeArr[i].b);
                c = pathDataNodeArr[i].f9464a;
            }
        }
        ...
        private static void a(android.graphics.Path r27, float[] r28, char r29, char r30, float[] r31) {
            ...
            L_0x02f0:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.transitionseverywhere.PathParser.PathDataNode.a(android.graphics.Path, float[], char, char, float[]):void");
        }
        ...
        private static void a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d24 == 0.0d) {
                Log.w(PathParser.f9462a, " Points are coincident");
                return;
            }
            double d25 = (1.0d / d24) - 0.25d;
            if (d25 < 0.0d) {
                String str = PathParser.f9462a;
                Log.w(str, "Points are too far apart " + d24);
