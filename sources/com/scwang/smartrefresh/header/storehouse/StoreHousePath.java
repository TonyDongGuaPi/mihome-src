...
public class StoreHousePath {
    ...
    private static final SparseArray<float[]> f8760a = new SparseArray<>();
    ...
    static {
        ...
        for (int i = 0; i < fArr.length; i++) {
            f8760a.append(i + 65, fArr[i]);
        }
        for (int i2 = 0; i2 < fArr.length; i2++) {
            f8760a.append(i2 + 65 + 32, fArr[i2]);
        }
        for (int i3 = 0; i3 < fArr2.length; i3++) {
            f8760a.append(i3 + 48, fArr2[i3]);
        }
        f8760a.append(32, new float[0]);
        f8760a.append(45, new float[]{0.0f, 36.0f, 47.0f, 36.0f});
        f8760a.append(46, new float[]{24.0f, 60.0f, 24.0f, 72.0f});
    }
    ...
    public static List<float[]> a(String str, float f, int i) {
        ...
        for (int i2 = 0; i2 < str.length(); i2++) {
            ...
            if (f8760a.indexOfKey(charAt) != -1) {
                float[] fArr = f8760a.get(charAt);
