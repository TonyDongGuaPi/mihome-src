...
public class DeliveryHeader extends InternalAbstract implements RefreshHeader {
    ...
    public DeliveryHeader(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (!pathsDrawable.a(cloudPaths)) {
            pathsDrawable.a(0, 0, 99, 32);
        }
        pathsDrawable.a(cloudColors);
        pathsDrawable.b(DensityUtil.a(20.0f));
        PathsDrawable pathsDrawable2 = new PathsDrawable();
        if (!pathsDrawable2.a(umbrellaPaths)) {
            pathsDrawable2.a(2, 4, 265, 355);
        }
        pathsDrawable2.a(umbrellaColors);
        pathsDrawable2.a(DensityUtil.a(200.0f));
        PathsDrawable pathsDrawable3 = new PathsDrawable();
        if (!pathsDrawable3.a(boxPaths)) {
            pathsDrawable3.a(0, 1, 95, 92);
        }
        pathsDrawable3.a(boxColors);
        pathsDrawable3.a(DensityUtil.a(50.0f));
        ...
        if (isInEditMode()) {
            ...
            this.mCloudX1 = (int) (((float) this.mCloudDrawable.getBounds().width()) * 3.5f);
            this.mCloudX2 = (int) (((float) this.mCloudDrawable.getBounds().width()) * 0.5f);
            this.mCloudX3 = (int) (((float) this.mCloudDrawable.getBounds().width()) * 2.0f);
        }
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        canvas.save();
        double d = (double) (this.mHeaderHeight / 13);
        double sin = Math.sin((double) this.mAppreciation);
        Double.isNaN(d);
        int i = (int) (d * sin);
        if (this.mState == RefreshState.Refreshing || this.mState == RefreshState.RefreshFinish) {
            ...
            this.mCloudDrawable.draw(canvas);
            canvas.rotate(((float) Math.sin((double) (this.mAppreciation / 2.0f))) * 5.0f, (float) (width / 2), (float) ((this.mHeaderHeight / 2) - this.mUmbrellaDrawable.getBounds().height()));
            a(width);
        }
        int i2 = (height - (this.mHeaderHeight / 2)) + i;
        int i3 = width / 2;
        this.mBoxDrawable.getBounds().offsetTo(i3 - (this.mBoxDrawable.getBounds().width() / 2), ((((this.mHeaderHeight / 2) - this.mBoxDrawable.getBounds().height()) + i2) - Math.min((this.mHeaderHeight / 2) - this.mBoxDrawable.getBounds().height(), DensityUtil.a(this.mAppreciation * 100.0f))) - (this.mBoxDrawable.getBounds().height() / 4));
        this.mBoxDrawable.draw(canvas);
        if (this.mState == RefreshState.Refreshing || this.mState == RefreshState.RefreshFinish) {
            Rect bounds = this.mUmbrellaDrawable.getBounds();
            this.mUmbrellaDrawable.getBounds().offsetTo(i3 - (bounds.width() / 2), ((i2 - this.mHeaderHeight) + Math.min(this.mHeaderHeight, DensityUtil.a(this.mAppreciation * 100.0f))) - bounds.height());
    ...
    private void a(int i) {
        this.mCloudX1 += DensityUtil.a(9.0f);
        this.mCloudX2 += DensityUtil.a(5.0f);
        this.mCloudX3 += DensityUtil.a(12.0f);
    ...
    public void setPrimaryColors(@ColorInt int... iArr) {
        if (iArr.length > 0) {
            ...
            if (iArr.length > 1 && (this.mCloudDrawable instanceof PathsDrawable)) {
                ((PathsDrawable) this.mCloudDrawable).a(iArr[1]);
            }
        }
    }
