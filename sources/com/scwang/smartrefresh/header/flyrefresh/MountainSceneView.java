...
public class MountainSceneView extends View {
    ...
    public MountainSceneView(Context context, AttributeSet attributeSet) {
        ...
        a(this.mMoveFactor, 180);
        a(this.mMoveFactor, true);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        a(this.mMoveFactor, measuredHeight);
        a(this.mMoveFactor, true);
    }
        ...
        if (f != this.mTreeBendFactor || z) {
            ...
            for (int i4 = 0; i4 < 17; i4++) {
                if (i4 < i3) {
                    ...
                    this.mTrunk.lineTo(fArr[i4] - ((((float) (17 - i4)) * 5.0f) / f5), fArr2[i4]);
                }
            }
            for (int i5 = 16; i5 >= 0; i5--) {
                if (i5 < i3) {
                    ...
                    this.mTrunk.lineTo(fArr[i5] + ((((float) (17 - i5)) * 5.0f) / f5), fArr2[i5]);
                }
            }
            this.mTrunk.close();
            this.mBranch.reset();
    ...
    public void onDraw(Canvas canvas) {
        ...
        a(canvas, this.mScaleX * 0.12f, this.mScaleX * 180.0f, ((this.mMoveFactor * 20.0f) + 93.0f) * this.mScaleY, this.COLOR_TREE_3_BRINK, this.COLOR_TREE_3_BRANCH);
        a(canvas, this.mScaleX * 0.1f, this.mScaleX * 200.0f, ((this.mMoveFactor * 20.0f) + 96.0f) * this.mScaleY, this.COLOR_TREE_3_BRINK, this.COLOR_TREE_3_BRANCH);
        canvas.restore();
        this.mMountPaint.setColor(this.COLOR_MOUNTAIN_2);
        canvas.drawPath(this.mMount2, this.mMountPaint);
        a(canvas, this.mScaleX * 0.2f, this.mScaleX * 160.0f, ((this.mMoveFactor * 30.0f) + 105.0f) * this.mScaleY, this.COLOR_TREE_1_BRINK, this.COLOR_TREE_1_BRANCH);
        a(canvas, this.mScaleX * 0.14f, this.mScaleX * 180.0f, ((this.mMoveFactor * 30.0f) + 105.0f) * this.mScaleY, this.COLOR_TREE_2_BRINK, this.COLOR_TREE_2_BRANCH);
        a(canvas, this.mScaleX * 0.16f, this.mScaleX * 140.0f, ((this.mMoveFactor * 30.0f) + 105.0f) * this.mScaleY, this.COLOR_TREE_2_BRINK, this.COLOR_TREE_2_BRANCH);
