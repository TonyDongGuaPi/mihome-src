...
class PathParser {
    ...
    private static final String f8754a = "PathParser";

    PathParser() {
    }

    static float[] a(@NonNull float[] fArr, int i, int i2) {
        int i3 = i2 - i;
    ...
    private static void a(float f, float f2, PathDataNode[] pathDataNodeArr) {
        for (PathDataNode pathDataNode : pathDataNodeArr) {
            a(f, f2, pathDataNode.f8756a, pathDataNode.b);
        }
    }
    ...
    public static Path a(String str) {
        Path path = new Path();
        PathDataNode[] b = b(str);
        if (b == null) {
            return null;
        }
        try {
            PathDataNode.a(b, path);
            return path;
    ...
    public static PathDataNode[] b(String str) {
        if (str == null) {
            return null;
        }
        ArrayList arrayList = new ArrayList();
        ...
        while (i < str.length()) {
            ...
            if (trim.length() > 0) {
                a((List<PathDataNode>) arrayList, trim.charAt(0), c(trim));
            }
            i2 = a2;
            i = a2 + 1;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            a((List<PathDataNode>) arrayList, str.charAt(i2), new float[0]);
        }
    ...
    private static void a(List<PathDataNode> list, char c, float[] fArr) {
    ...
    private static float[] c(String str) {
        ...
        try {
            ...
            while (i < length) {
                ...
                int i3 = extractFloatResult.f8755a;
                if (i < i3) {
    ...
    private static void a(java.lang.String r8, int r9, com.scwang.smartrefresh.header.internal.pathview.PathParser.ExtractFloatResult r10) {
        /*
            r0 = 0
            r10.b = r0
            r1 = r9
        ...
        L_0x003d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.scwang.smartrefresh.header.internal.pathview.PathParser.a(java.lang.String, int, com.scwang.smartrefresh.header.internal.pathview.PathParser$ExtractFloatResult):void");
    }
    ...
    public static class PathDataNode {
        ...
        public static void a(PathDataNode[] pathDataNodeArr, Path path) {
            ...
            char c = PatternFormatter.MESSAGE_CONVERSION_CHAR;
            for (PathDataNode pathDataNode : pathDataNodeArr) {
                a(path, fArr, c, pathDataNode.f8756a, pathDataNode.b);
                c = pathDataNode.f8756a;
            }
        }
        ...
        private static void a(android.graphics.Path r27, float[] r28, char r29, char r30, float[] r31) {
            ...
            L_0x02f0:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.scwang.smartrefresh.header.internal.pathview.PathParser.PathDataNode.a(android.graphics.Path, float[], char, char, float[]):void");
        }
        ...
        private static void a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d23 != 0.0d) {
                ...
                Double.isNaN(d11);
                double d29 = d * d11;
                a(path, (d28 * cos) - (d29 * d27), (d28 * d27) + (d29 * cos), d16, d11, d5, d10, radians, atan2, atan22);
            }
        }
