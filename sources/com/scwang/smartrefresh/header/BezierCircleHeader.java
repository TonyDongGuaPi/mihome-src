...
public class BezierCircleHeader extends InternalAbstract implements RefreshHeader {
    ...
    public BezierCircleHeader(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mOuterPaint.setStrokeWidth((float) DensityUtil.a(2.0f));
        this.mPath = new Path();
    }
    ...
    private void b(Canvas canvas, int i) {
        if (this.mShowBoll) {
            ...
            a(canvas, i, (this.mHeadHeight + this.mWaveHeight) / this.mHeadHeight);
        }
    }
    ...
    private void d(Canvas canvas, int i) {
        ...
        if (this.mFinishRatio > 0.0f) {
            ...
            if (((double) this.mFinishRatio) < 0.3d) {
                ...
                canvas.drawArc(new RectF((float) (i3 - strokeWidth), this.mBollY - f, (float) (i3 + strokeWidth), this.mBollY + f), 0.0f, 360.0f, false, this.mOuterPaint);
            }
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                if (this.d == 0 && floatValue <= 0.0f) {
                    this.d = 1;
                    this.f8724a = Math.abs(floatValue - BezierCircleHeader.this.mWaveHeight);
                }
                if (this.d == 1) {
                    this.c = (-floatValue) / min;
                    if (this.c >= BezierCircleHeader.this.mSpringRatio) {
                        BezierCircleHeader.this.mSpringRatio = this.c;
                        ...
                        this.b = BezierCircleHeader.this.mBollY;
                    }
                }
                if (this.d == 2 && BezierCircleHeader.this.mBollY > BezierCircleHeader.this.mHeadHeight / 2.0f) {
                    BezierCircleHeader.this.mBollY = Math.max(BezierCircleHeader.this.mHeadHeight / 2.0f, BezierCircleHeader.this.mBollY - this.f8724a);
                    float animatedFraction = (valueAnimator.getAnimatedFraction() * ((BezierCircleHeader.this.mHeadHeight / 2.0f) - this.b)) + this.b;
