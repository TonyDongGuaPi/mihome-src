...
public class FlyRefreshHeader extends FalsifyHeader implements RefreshHeader {
    ...
    public void onReleased(@NonNull RefreshLayout refreshLayout, int i, int i2) {
        ...
        if (this.mFlyView != null && !this.mIsRefreshing) {
            ...
            ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(this.mFlyView, "translationX", new float[]{0.0f, (float) width});
            ...
            ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(this.mFlyView, ViewProps.ROTATION, new float[]{this.mFlyView.getRotation(), 0.0f});
    ...
    public void onInitialized(@NonNull RefreshKernel refreshKernel, int i, int i2) {
        ...
        this.mRefreshLayout = refreshKernel.a();
    ...
    public void finishRefresh(AnimatorListenerAdapter animatorListenerAdapter) {
        if (this.mFlyView != null && this.mIsRefreshing && this.mRefreshLayout != null) {
            ...
            float f2 = (float) (-DensityUtil.a(10.0f));
            ...
            ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(this.mFlyView, ViewProps.ROTATION, new float[]{this.mFlyView.getRotation(), 0.0f});
            ...
            animatorSet2.playTogether(new Animator[]{ObjectAnimator.ofFloat(this.mFlyView, "translationX", new float[]{f, 0.0f}), ObjectAnimator.ofFloat(this.mFlyView, "translationY", new float[]{f2, 0.0f}), ObjectAnimator.ofFloat(this.mFlyView, "rotationX", new float[]{30.0f, 0.0f}), ObjectAnimator.ofFloat(this.mFlyView, "scaleX", new float[]{0.9f, 1.0f}), ObjectAnimator.ofFloat(this.mFlyView, "scaleY", new float[]{0.9f, 1.0f})});
