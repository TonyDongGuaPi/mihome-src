...
public class FunGameBattleCityHeader extends FunGameView {
    ...
    public void resetConfigParams() {
        ...
        this.enemySpeed = DensityUtil.a(1.0f);
        this.bulletSpeed = DensityUtil.a(4.0f);
        this.levelNum = 8;
        this.wipeOutNum = 0;
        this.once = true;
    ...
    public void upLevel() {
        this.levelNum += 8;
        this.enemySpeed += DensityUtil.a(1.0f);
        this.bulletSpeed += DensityUtil.a(1.0f);
        this.wipeOutNum = 0;
    ...
    public void drawGame(Canvas canvas, int i, int i2) {
        ...
        if (isInEditMode()) {
            drawTank(canvas, new RectF((float) this.controllerSize, 0.0f, (float) (this.controllerSize * 2), (float) this.controllerSize));
            drawTank(canvas, new RectF(0.0f, (float) this.controllerSize, (float) this.controllerSize, (float) (this.controllerSize * 2)));
    ...
    public void drawBulletPath(Canvas canvas, int i) {
        ...
        for (Point point2 : this.mBulletList) {
            if (checkWipeOutETank(point2)) {
                ...
                if (((float) point2.x) + this.bulletRadius <= 0.0f) {
                    z = true;
                }
