...
public class WaterDropHeader extends InternalAbstract implements RefreshHeader {
    ...
    public WaterDropHeader(Context context, AttributeSet attributeSet, int i) {
        ...
        progressDrawable.setBounds(0, 0, densityUtil.b(20.0f), densityUtil.b(20.0f));
        ...
        addView(this.mImageView, densityUtil.b(30.0f), densityUtil.b(30.0f));
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.mState == RefreshState.Refreshing) {
            canvas.save();
            canvas.translate((float) ((getWidth() / 2) - (progressDrawable.getBounds().width() / 2)), (float) ((this.mWaterDropView.getMaxCircleRadius() + waterDropView.getPaddingTop()) - (progressDrawable.getBounds().height() / 2)));
    ...
    public void onMoving(boolean z, float f, int i, int i2, int i3) {
        ...
        if (z) {
            ...
            this.mProgress.b((((0.4f * max) - 16.0f) + (((float) (max2 - pow)) * 2.0f * 2.0f)) * 0.5f);
        }
    }
