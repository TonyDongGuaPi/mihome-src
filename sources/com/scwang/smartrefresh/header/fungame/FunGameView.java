...
public abstract class FunGameView<T extends FunGameView> extends FunGameBase {
    ...
    public FunGameView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (!isInEditMode()) {
            ...
            this.mHalfHeaderHeight = (int) (((float) a2) * 0.5f);
    ...
    private void a(Canvas canvas, int i, int i2) {
        ...
        float f2 = (float) i;
        canvas2.drawRect(0.0f, 0.0f, f2, f, this.mPaint);
        this.mPaint.setColor(this.mBoundaryColor);
        canvas2.drawLine(0.0f, 0.0f, f2, 0.0f, this.mPaint);
        canvas2.drawLine(0.0f, f - this.DIVIDING_LINE_SIZE, f2, f - this.DIVIDING_LINE_SIZE, this.mPaint);
    }
    ...
    private void b(Canvas canvas, int i, int i2) {
        switch (this.status) {
            case 0:
            case 1:
                this.mPaintText.setTextSize((float) DensityUtil.a(25.0f));
                a(canvas, this.mTextLoading, i, i2);
                return;
            case 2:
                this.mPaintText.setTextSize((float) DensityUtil.a(25.0f));
                a(canvas, this.mTextGameOver, i, i2);
                return;
            case 3:
                this.mPaintText.setTextSize((float) DensityUtil.a(20.0f));
                a(canvas, this.mTextLoadingFinish, i, i2);
                return;
            case 4:
                this.mPaintText.setTextSize((float) DensityUtil.a(20.0f));
                a(canvas, this.mTextLoadingFailed, i, i2);
                return;
            default:
                return;
        }
