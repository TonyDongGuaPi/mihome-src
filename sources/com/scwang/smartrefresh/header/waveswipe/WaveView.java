...
public class WaveView extends View implements ViewTreeObserver.OnPreDrawListener {
    ...
    public void onDraw(Canvas canvas) {
        ...
        this.mDropRect.set((f - ((this.mDropCircleRadius * f2) * floatValue2)) + ((this.mDropCircleRadius * floatValue4) / 2.0f), (((this.mDropCircleRadius * f3) * floatValue2) + floatValue) - ((this.mDropCircleRadius * floatValue3) / 2.0f), (((this.mDropCircleRadius * f2) * floatValue2) + f) - ((this.mDropCircleRadius * floatValue4) / 2.0f), (floatValue - ((this.mDropCircleRadius * f3) * floatValue2)) + ((this.mDropCircleRadius * floatValue3) / 2.0f));
        ...
        Double.isNaN(d4);
        double d5 = pow2 / d4;
        double d6 = (double) this.mWidth;
        Double.isNaN(d6);
        double d7 = (d6 * -2.0d) / 2.0d;
        Double.isNaN(d3);
        double d8 = -d7;
        double pow3 = (d7 * d7) - (((Math.pow(d5 - d3, 2.0d) + Math.pow((double) f, 2.0d)) - Math.pow((double) this.mDropCircleRadius, 2.0d)) * 4.0d);
        float f4 = (float) d5;
        this.mDropTangentPath.lineTo((float) ((Math.sqrt(pow3) + d8) / 2.0d), f4);
        this.mDropTangentPath.lineTo((float) ((d8 - Math.sqrt(pow3)) / 2.0d), f4);
    ...
    public void beginPhase(float f) {
        ...
        this.mWavePath.cubicTo(((float) this.mWidth) * BEGIN_PHASE_POINTS[0][0], BEGIN_PHASE_POINTS[0][1], BEGIN_PHASE_POINTS[1][0] * ((float) this.mWidth), (BEGIN_PHASE_POINTS[1][1] + f) * ((float) this.mWidth), BEGIN_PHASE_POINTS[2][0] * ((float) this.mWidth), (BEGIN_PHASE_POINTS[2][1] + f) * ((float) this.mWidth));
        ...
        this.mWavePath.cubicTo(((float) this.mWidth) - (((float) this.mWidth) * BEGIN_PHASE_POINTS[1][0]), (BEGIN_PHASE_POINTS[1][1] + f) * ((float) this.mWidth), ((float) this.mWidth) - (((float) this.mWidth) * BEGIN_PHASE_POINTS[0][0]), BEGIN_PHASE_POINTS[0][1], (float) this.mWidth, 0.0f);
    ...
    public void startWaveAnimation(float f) {
        this.mWaveReverseAnimator = ValueAnimator.ofFloat(new float[]{Math.min(f, 0.2f) * ((float) this.mWidth), 0.0f});
        ...
        this.mWaveReverseAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                WaveView.this.mWavePath.quadTo(((float) WaveView.this.mWidth) * 0.25f, 0.0f, ((float) WaveView.this.mWidth) * 0.333f, f);
                WaveView.this.mWavePath.quadTo(((float) WaveView.this.mWidth) * 0.5f, floatValue * 1.4f, ((float) WaveView.this.mWidth) * 0.666f, f);
                WaveView.this.mWavePath.quadTo(((float) WaveView.this.mWidth) * 0.75f, 0.0f, (float) WaveView.this.mWidth, 0.0f);
                WaveView.this.postInvalidate();
            }
        });
