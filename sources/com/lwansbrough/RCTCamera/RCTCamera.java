...
public class RCTCamera {
    ...
    private static final Resolution RESOLUTION_480P = new Resolution(KeyType.SHUTTER_TWO, 480);
    ...
    public void adjustPreviewLayout(int i) {
        ...
        if (camera != null) {
            ...
            int i4 = cameraInfoWrapper.info.orientation;
            if (cameraInfoWrapper.info.facing == 1) {
                i2 = ((this._actualDeviceOrientation * 90) + i4) % 360;
                i3 = ((720 - i4) - (this._actualDeviceOrientation * 90)) % 360;
            } else {
