...
public class AsyncWeiboRunner {
    ...
    private void addAction(Context context, String str) {
        try {
            Class.forName("com.sina.weibo.sdk.cmd.WbAppActivator").getMethod("getInstance", new Class[]{Context.class, String.class}).invoke((Object) null, new Object[]{context, str}).getClass().getMethod("activateApp", new Class[0]).invoke((Object) null, new Object[0]);
