...
public class NetStateManager {
    ...
    public static Pair<String, Integer> getAPN() {
        ...
        Cursor query = mContext != null ? mContext.getContentResolver().query(Uri.parse("content://telephony/carriers/preferapn"), (String[]) null, (String) null, (String[]) null, (String) null) : null;
    ...
    public static boolean isNetworkConnected(Context context) {
        ...
        if (context == null) {
            LogUtil.c("Weibosdk", "unexpected null context in isNetworkConnected");
            return false;
