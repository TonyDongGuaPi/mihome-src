    ...
    public TransResourceResult doInBackground(WeiboMultiMessage... weiboMultiMessageArr) {
        ...
        try {
            if (WbSdk.isWbInstall(context)) {
                ...
                if (b == null || b.getSupportVersion() < 10772) {
                ...
                if (weiboMultiMessage.multiImageObject != null) {
                    ...
                    while (it.hasNext()) {
                        Uri next = it.next();
                        if (next != null && FileUtils.a(context, next)) {
                ...
                if (!(weiboMultiMessage.videoSourceObject == null || (uri = weiboMultiMessage.videoSourceObject.videoPath) == null || !FileUtils.b(context, uri))) {
                    ...
                    weiboMultiMessage.videoSourceObject.during = ImageUtils.a(copyFileToWeiboTem2);
                }
            }
