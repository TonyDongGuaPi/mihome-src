...
public class WbUserInfoHelper {
    ...
    public WbUserInfo getUserInfo(Context context) {
        ...
        if (this.userInfo == null) {
            ...
            String string = sharedPreferences.getString("uid", (String) null);
            String string2 = sharedPreferences.getString("gsid", (String) null);
            String string3 = sharedPreferences.getString("token", (String) null);
