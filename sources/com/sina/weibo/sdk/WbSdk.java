...
public class WbSdk {
    ...
    public static void install(Context context, AuthInfo authInfo2) {
        ...
        WeiboSsoManager.a().a(context, authInfo2.getAppKey());
        init = true;
    }
    ...
    public static boolean isWbInstall(Context context) {
        Intent intent = new Intent(WeiboAppManager.f8818a);
    ...
    public static boolean supportMultiImage(Context context) {
        WbAppInfo a2;
        if (!isWbInstall(context) || (a2 = WeiboAppManager.a(context).a()) == null || a2.getSupportVersion() < 10772) {
            return false;
        }
        return true;
    }
