...
public class AuthInfo implements Parcelable, Serializable {
    ...
    public AuthInfo(Context context, String str, String str2, String str3) {
        ...
        this.mKeyHash = Utility.a(context, this.mPackageName);
    }
    ...
    public Bundle getAuthBundle() {
        ...
        bundle.putString(WBConstants.k, this.mRedirectUrl);
    ...
    public static AuthInfo parseBundleData(Context context, Bundle bundle) {
        return new AuthInfo(context, bundle.getString("appKey"), bundle.getString(WBConstants.k), bundle.getString("scope"));
    }
