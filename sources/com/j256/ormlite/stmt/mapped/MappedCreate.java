...
public class MappedCreate<T, ID> extends BaseMappedStatement<T, ID> {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:43:0x009b A[Catch:{ SQLException -> 0x0122, SQLException -> 0x013c }] */
    ...
    public int insert(com.j256.ormlite.db.DatabaseType r10, com.j256.ormlite.support.DatabaseConnection r11, T r12, com.j256.ormlite.dao.ObjectCache r13) throws java.sql.SQLException {
        ...
        L_0x00af:
            ...
            r3.debug((java.lang.String) r5, (java.lang.Object) r6, (java.lang.Object) r7, (java.lang.Object) r8)     // Catch:{ SQLException -> 0x013c }
            int r3 = r0.length     // Catch:{ SQLException -> 0x013c }
            if (r3 <= 0) goto L_0x00d3
            com.j256.ormlite.logger.Logger r3 = logger     // Catch:{ SQLException -> 0x013c }
            java.lang.String r5 = "insert arguments: {}"
            r3.trace((java.lang.String) r5, (java.lang.Object) r0)     // Catch:{ SQLException -> 0x013c }
        L_0x00d3:
        ...
        L_0x00f8:
            ...
            java.lang.String r11 = "generated-id key must not be 0 value, maybe a schema mismatch between entity and database table?"
            r10.<init>(r11)     // Catch:{ SQLException -> 0x013c }
            throw r10     // Catch:{ SQLException -> 0x013c }
        L_0x0100:
            java.sql.SQLException r10 = new java.sql.SQLException     // Catch:{ SQLException -> 0x013c }
            java.lang.String r11 = "generated-id key was not set by the update call, maybe a schema mismatch between entity and database table?"
            r10.<init>(r11)     // Catch:{ SQLException -> 0x013c }
            throw r10     // Catch:{ SQLException -> 0x013c }
        L_0x0108:
        ...
        L_0x0122:
            ...
            r11.debug((java.lang.String) r13, (java.lang.Object) r1, (java.lang.Object) r2, (java.lang.Object) r10)     // Catch:{ SQLException -> 0x013c }
            int r11 = r0.length     // Catch:{ SQLException -> 0x013c }
            if (r11 <= 0) goto L_0x013b
            com.j256.ormlite.logger.Logger r11 = logger     // Catch:{ SQLException -> 0x013c }
            java.lang.String r13 = "insert arguments: {}"
            r11.trace((java.lang.String) r13, (java.lang.Object) r0)     // Catch:{ SQLException -> 0x013c }
        L_0x013b:
            throw r10     // Catch:{ SQLException -> 0x013c }
        L_0x013c:
            r10 = move-exception
