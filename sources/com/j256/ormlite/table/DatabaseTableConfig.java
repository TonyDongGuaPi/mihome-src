...
public class DatabaseTableConfig<T> {
    ...
    public DatabaseTableConfig(DatabaseType databaseType2, Class<T> cls, List<DatabaseFieldConfig> list) {
    ...
    public void initialize() {
        if (this.dataClass == null) {
            ...
            this.tableName = extractTableName(this.databaseType, this.dataClass);
        }
    }
    ...
    public static <T> String extractTableName(DatabaseType databaseType2, Class<T> cls) {
        ...
        if (tableName2 == null && javaxPersistenceConfigurer != null) {
            tableName2 = javaxPersistenceConfigurer.getEntityName(cls);
        }
        if (tableName2 != null) {
            return tableName2;
        }
