...
public final class LocalIrDb {
    ...
    public native String[] getAirIRPNameAndRemotes(byte[] bArr, long j);

    public native int getAirRemoteModeMask(String str);

    public native long getBrandId(String str);

    public native String getIRMarkData(byte[] bArr, int i);

    public native String getIRPName(byte[] bArr, int i);
    ...
    private static final class DbBrand {
        String brand_cn = "";
        String brand_en = "";
        long brand_id;
        String brand_pinyin = "";
    ...
    private static final class DbInfrared {
        int freq = 0;
        int functionType;
        byte[] infaredValue;
        int ir_mark = 0;
        ...
        /* access modifiers changed from: package-private */
        public Infrared toInfrared(long j, int i) {
            ...
            infrared.setFreq(this.freq == 0 ? InifraredContants.b : this.freq);
    ...
    private static final class DbIrKey {
        DbInfrared[] irList;
        int keyType;
        String name = "";
        int protocol = 0;
        ...
        /* access modifiers changed from: package-private */
        public Key toKey(String str, long j, int i) {
            Key key = new Key();
            key.setId(j);
    ...
    private static final class DbRemote {
        long author_id = 1;
        DbBrand brand;
        long brand_id = 0;
        String id;
        ...
        public Remote toRemote() {
            ...
            if (this.brand != null) {
                Brand brand2 = this.brand.toBrand();
            ...
            if (dbRemote != null) {
                ...
                if (!z) {
                    ...
                    if (dbIrKeyArr == null || dbIrKeyArr.length == 0) {
                        ...
                        int i2 = 0;
                        while (i2 < dbIrKeyArr.length) {
                            DbIrKey dbIrKey = dbIrKeyArr[i2];
                            long nextId = nextId();
                            int i3 = dbIrKey.keyType;
                            Key key = dbIrKey.toKey(str, nextId, i3);
                            arrayList2.add(key);
                            DbInfrared[] dbInfraredArr = dbIrKey.irList;
                            ArrayList arrayList3 = new ArrayList();
                            if (dbInfraredArr != null) {
                                for (DbInfrared infrared : dbInfraredArr) {
                                    arrayList3.add(infrared.toInfrared(nextId, i3));
                                }
                            }
                            key.setInfrareds(arrayList3);
                            i2++;
                            DbRemote[] dbRemoteArr3 = dbRemoteArr;
                        }
                        remote.setKeys(arrayList2);
                        arrayList.add(remote);
                    }
    ...
    private int prepareMatch(MatchPage matchPage, boolean z) {
        ...
        int i = 0;
        if (!z && PhoneHelper.checkNet()) {
            i = 1;
        }
        int irdbInitKeyMatch = irdbInitKeyMatch(appliance_type, lang, brand_id, copyMarks, copyMarks2, next_key, i << 8);
        resetSearchResult();
    ...
    public SearchCount getSearchCount(Page page, boolean z, boolean z2) {
        if (page == null) {
            return null;
        }
        ...
        searchCount.degree = this.prevResultString == null ? 0 : this.prevResultString.length();
        return searchCount;
    }
    ...
    private int getSearchCount0(Page page, boolean z, boolean z2) {
        ...
        if (appliance_type == this.prevMachineType && this.prevBrandId == brand_id) {
            ...
            } else if (str.equals(this.prevSearchString) || str.equals(this.prevResultString)) {
                return this.prevSearchCount;
            } else {
                if (this.prevResultString != null && !this.prevResultString.equals(this.prevSearchString) && str.startsWith(this.prevResultString)) {
                    return this.prevSearchCount;
                }
            }
        }
        this.prevSearchString = i > 0 ? str : null;
        this.prevMachineType = appliance_type;
        this.prevBrandId = brand_id;
        int lang = page.getLang();
        int prepareSerach = prepareSerach(str, appliance_type, lang, brand_id, z, z2);
        while (prepareSerach == 0 && i > 1) {
            str = str.substring(0, i - 1).trim();
            i = str.length();
            if (i == 0) {
                break;
            }
            prepareSerach = prepareSerach(str, appliance_type, lang, brand_id, z, z2);
        }
        if (i <= 0) {
            str = null;
        }
        this.prevResultString = str;
    ...
    public SearchCount getSearchCount(Page page, boolean z) {
