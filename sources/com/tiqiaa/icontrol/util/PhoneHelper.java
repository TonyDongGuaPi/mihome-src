...
public class PhoneHelper {
    ...
    public static String getPhoneIMEI(Context context) {
        if (IMEI == null) {
            ...
            if (IMEI == null || IMEI.equals("") || isSpecialImei(IMEI)) {
    ...
    public static boolean checkNet() {
        ...
        if (connectivity == null || (activeNetworkInfo = connectivity.getActiveNetworkInfo()) == null) {
            z = false;
        } else {
            z = activeNetworkInfo.isAvailable();
        }
        LogUtil.w(TAG, "checkNet.....检查网络连接......end...netOk = " + z + " , usedTime = " + (new Date().getTime() - date.getTime()));
        return z;
    }
    ...
    private static class GsmHelper {
        ...
        public final boolean setMobileNetEnable(boolean z) {
            ...
            try {
                boolean invokeMethod = invokeMethod("getMobileDataEnabled", (Object[]) null);
        ...
        public Object invokeBooleanArgMethod(String str, boolean z) throws Exception {
            ConnectivityManager connectivityManager = (ConnectivityManager) this.context.getSystemService("connectivity");
            return connectivityManager.getClass().getMethod(str, new Class[]{Boolean.TYPE}).invoke(connectivityManager, new Object[]{Boolean.valueOf(z)});
        }
    }
