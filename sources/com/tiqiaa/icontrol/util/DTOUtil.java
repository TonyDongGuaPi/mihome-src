...
public class DTOUtil {
    ...
    public static String getResponesJson(ResponseDTO responseDTO) throws DataProcessException {
        byte[] bArr;
        String jSONString = JSON.toJSONString((Object) responseDTO, SerializerFeature.WriteNullStringAsEmpty);
        try {
    ...
    public static String getRequestJson(RequestDTO requestDTO) throws DataProcessException {
        byte[] bArr;
        String jSONString = JSON.toJSONString((Object) requestDTO, SerializerFeature.WriteNullStringAsEmpty);
