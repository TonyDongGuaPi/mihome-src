...
public class Mp4Dictionary {
    ...
    private static HashMap<Integer, HashMap<String, String>> f5248a = new HashMap<>();
    ...
    static {
        ...
        c.put("y420", "YUV420");
        c.put(VisualSampleEntry.c, "H.264");
        c.put(VisualSampleEntry.f3955a, "MPEG-4");
        c.put("MP4V", "MPEG-4");
        ...
        d.put("ulaw", "uLaw 2:1");
        d.put("alaw", "uLaw 2:1");
        d.put(new String(new byte[]{Constants.TagName.PUBLISH_END_TIME, Constants.TagName.ELECTRONIC_TYPE, 0, 2}), "Microsoft ADPCM-ACM code 2");
        d.put(new String(new byte[]{Constants.TagName.PUBLISH_END_TIME, Constants.TagName.ELECTRONIC_TYPE, 0, 17}), "DVI/Intel IMAADPCM-ACM code 17");
        d.put("dvca", "DV Audio");
        d.put("QDMC", "QDesign music");
        d.put("QDM2", "QDesign music version 2");
        d.put("Qclp", "QUALCOMM PureVoice");
        d.put(new String(new byte[]{Constants.TagName.PUBLISH_END_TIME, Constants.TagName.ELECTRONIC_TYPE, 0, Constants.TagName.TERMINAL_BACK_CHILDREN_ID}), "MPEG-1 layer 3, CBR only (pre-QT4.1)");
        d.put(".mp3", "MPEG-1 layer 3, CBR & VBR (QT4.1 and later)");
        d.put(AudioSampleEntry.c, "MPEG-4, Advanced Audio Coding (AAC)");
        d.put(AudioSampleEntry.g, "Digital Audio Compression Standard (AC-3, Enhanced AC-3)");
        ...
        d.put("MS\u0000\u0011", "DV IMA");
        d.put(new String(new byte[]{77, 83, 0, Constants.TagName.TERMINAL_BACK_CHILDREN_ID}), "MPEG3");
        ...
        b.put(VisualSampleEntry.c, "MP4 Base w/ AVC ext [ISO 14496-12:2005]");
    ...
    public static String a(int i, String str) {
        return (!f5248a.containsKey(Integer.valueOf(i)) || !f5248a.get(Integer.valueOf(i)).containsKey(str)) ? AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN : (String) f5248a.get(Integer.valueOf(i)).get(str);
    }

    public static void a(int i, String str, Mp4Directory mp4Directory) {
        mp4Directory.a(i, a(i, str));
    }
}
