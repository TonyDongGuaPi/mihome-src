...
public class OlympusEquipmentMakernoteDescriptor extends TagDescriptor<OlympusEquipmentMakernoteDirectory> {
    ...
    @Nullable
    public String b() {
        String s = ((OlympusEquipmentMakernoteDirectory) this.f5211a).s(256);
        if (s == null) {
            return null;
        }
    ...
    @Nullable
    public String c() {
        return ((OlympusEquipmentMakernoteDirectory) this.f5211a).s(259) + " mm";
    }

    @Nullable
    public String d() {
        Integer c2 = ((OlympusEquipmentMakernoteDirectory) this.f5211a).c(260);
        if (c2 == null) {
            return null;
        }
        String format = String.format("%04X", new Object[]{c2});
        return String.format("%s.%s", new Object[]{format.substring(0, format.length() - 3), format.substring(format.length() - 3)});
    }

    @Nullable
    public String e() {
        String s = ((OlympusEquipmentMakernoteDirectory) this.f5211a).s(513);
        if (s == null) {
            return null;
        }
        ...
        try {
            ...
            return c.get(String.format("%X %02X %02X", new Object[]{Integer.valueOf(parseInt), Integer.valueOf(parseInt2), Integer.valueOf(parseInt3)}));
    ...
    @Nullable
    public String f() {
        Integer c2 = ((OlympusEquipmentMakernoteDirectory) this.f5211a).c(516);
        if (c2 == null) {
            return null;
        }
        String format = String.format("%04X", new Object[]{c2});
    ...
    @Nullable
    public String g() {
        Integer c2 = ((OlympusEquipmentMakernoteDirectory) this.f5211a).c(517);
        if (c2 == null) {
            return null;
        }
        return new DecimalFormat("0.#").format(j(c2.intValue()));
    }

    @Nullable
    public String h() {
        Integer c2 = ((OlympusEquipmentMakernoteDirectory) this.f5211a).c(518);
        if (c2 == null) {
            return null;
        }
        return new DecimalFormat("0.#").format(j(c2.intValue()));
    ...
    @Nullable
    public String i() {
        Integer c2 = ((OlympusEquipmentMakernoteDirectory) this.f5211a).c(522);
        if (c2 == null) {
            return null;
        }
        return new DecimalFormat("0.#").format(j(c2.intValue()));
    ...
    private static double j(int i) {
        ...
        double d2 = (double) i;
        Double.isNaN(d2);
        return Math.pow(sqrt, d2 / 256.0d);
    }

    @Nullable
    public String j() {
        Integer c2 = ((OlympusEquipmentMakernoteDirectory) this.f5211a).c(523);
        if (c2 == null) {
            return null;
        }
        return String.format("0x%04X", new Object[]{c2});
    }

    @Nullable
    public String k() {
        String s = ((OlympusEquipmentMakernoteDirectory) this.f5211a).s(769);
        if (s == null) {
            return null;
        }
        String[] split = s.split(" ");
        ...
        try {
            return d.get(String.format("%X %02X", new Object[]{Integer.valueOf(Integer.parseInt(split[0])), Integer.valueOf(Integer.parseInt(split[2]))}));
        } catch (NumberFormatException unused) {
            return null;
        }
    }
    ...
    @Nullable
    public String l() {
        return a(4096, "None", null, "Simple E-System", "E-System");
    }

    @Nullable
    public String m() {
        return a(4097, "None", "FL-20", "FL-50", "RF-11", "TF-22", "FL-36", "FL-50R", "FL-36R");
    }
