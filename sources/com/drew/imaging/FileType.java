...
public enum FileType {
    Unknown(AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN, AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN, (String) null, new String[0]),
    ...
    Wav("WAV", "Waveform Audio File Format", "audio/vnd.wave", "wav", AppleWaveBox.f3793a),
    ...
    Zip("ZIP", "ZIP Archive", DfuBaseService.MIME_TYPE_ZIP, ".zip", ".zipx");
    ...
    private FileType(String str, String str2, @NotNull String str3, @NotNull String... strArr) {
        this._name = str;
        this._longName = str2;
        this._mimeType = str3;
