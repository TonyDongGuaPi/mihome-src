...
public interface IXmPlayHistoryListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IXmPlayHistoryListener {
        private static final String DESCRIPTOR = "com.ximalaya.ting.android.opensdk.player.service.IXmPlayHistoryListener";
        static final int TRANSACTION_onPlayHistoryChanged = 1;
        ...
        private static class Proxy implements IXmPlayHistoryListener {
