...
public class RiskInfo implements Parcelable {
    ...
    public static class Builder {
        ...
        public RiskInfo build() {
            ...
            List<String> sIMNumber = DeviceUtils.getSIMNumber((CardInfo) null);
            this.mRiskInfo.setFullDeviceNumber(sIMNumber);
            this.mRiskInfo.setDeviceSIMNumber(sIMNumber.size());
            this.mRiskInfo.setDeviceName(DeviceUtils.getDeviceModel((CardInfo) null));
    ...
    public void writeToParcel(Parcel parcel, int i) {
        int i2 = -1;
        parcel.writeInt(this.mDeviceType == null ? -1 : this.mDeviceType.ordinal());
        parcel.writeString(this.mDeviceLanguage);
        parcel.writeString(this.mDeviceName);
        parcel.writeInt(this.mApplyChannel == null ? -1 : this.mApplyChannel.ordinal());
        parcel.writeString(this.mDeviceLocation);
        parcel.writeString(this.mExtensiveDeviceLocation);
        if (this.mCaptureMethod != null) {
            i2 = this.mCaptureMethod.ordinal();
        }
        parcel.writeInt(i2);
