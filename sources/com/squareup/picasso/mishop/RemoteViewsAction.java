...
abstract class RemoteViewsAction extends Action<RemoteViewsTarget> {
    ...
    static class NotificationAction extends RemoteViewsAction {
        ...
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        NotificationAction(Picasso picasso, Request request, RemoteViews remoteViews, int i, int i2, Notification notification2, String str, int i3, int i4, String str2, Object obj, int i5) {
        ...
        /* access modifiers changed from: package-private */
        public void update() {
            ((NotificationManager) Utils.getService(this.picasso.context, PushManager.MESSAGE_TYPE_NOTI)).notify(this.notificationTag, this.notificationId, this.notification);
        }
    }
}
