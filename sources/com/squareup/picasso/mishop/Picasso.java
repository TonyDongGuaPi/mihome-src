...
import com.squareup.picasso.mishop.Action;
        ...
        public void handleMessage(Message message) {
            ...
            if (i != 3) {
                ...
                if (action2.getPicasso().loggingEnabled) {
                    Utils.log("Main", PrinterParmater.q, action2.request.logId(), "target got garbage collected");
                }
    ...
    public static class Builder {
        ...
        public Builder memoryCache(Cache cache2) {
            if (cache2 == null) {
                ...
                this.cache = cache2;
                MishopWeaker.enableMishop(cache2 instanceof MishopLruCache);
                return this;
            } else {
