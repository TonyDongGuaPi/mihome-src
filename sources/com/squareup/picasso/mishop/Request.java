...
public final class Request {
    ...
    private Request(Uri uri2, int i, String str, List<Transformation> list, int i2, int i3, boolean z, boolean z2, boolean z3, float f, float f2, float f3, boolean z4, boolean z5, Bitmap.Config config2, Picasso.Priority priority2) {
        this.uri = uri2;
        this.resourceId = i;
        this.stableKey = str;
        if (list == null) {
    ...
    public String logId() {
        ...
        return plainId() + '+' + TimeUnit.NANOSECONDS.toMillis(nanoTime) + d.H;
    }

    /* access modifiers changed from: package-private */
    public String plainId() {
        return "[R" + this.id + Operators.ARRAY_END;
    }
    ...
    public static final class Builder {
        ...
        public Request build() {
            if (this.centerInside && this.centerCrop) {
                ...
                Request request = r2;
                Request request2 = new Request(this.uri, this.resourceId, this.stableKey, this.transformations, this.targetWidth, this.targetHeight, this.centerCrop, this.centerInside, this.onlyScaleDown, this.rotationDegrees, this.rotationPivotX, this.rotationPivotY, this.hasRotationPivot, this.purgeable, this.config, this.priority);
                return request;
            }
        }
    }
