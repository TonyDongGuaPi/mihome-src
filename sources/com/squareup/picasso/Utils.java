...
final class Utils {
    ...
    static final int THREAD_LEAK_CLEANING_MS = 10000;
    ...
    private static final ByteString WEBP_FILE_HEADER_WEBP = ByteString.encodeUtf8(WebpDirectory.o);
    ...
    static void flushStackLocalLeaks(Looper looper) {
        ...
        r0.sendMessageDelayed(r0.obtainMessage(), 10000);
    }
