    ...
    public static final class Builder {
        ...
        public ParseResult parse(HttpUrl httpUrl, String str) {
                        ...
                        switch (charAt) {
                            ...
                            case '@':
                                if (!z) {
                                    ...
                                    int i3 = access$200;
                                    String canonicalize = HttpUrl.canonicalize(str, i2, access$200, " \"':;<=>@[]^`{}|/\\?#", true, false, true);
                                    if (z2) {
            ...
            if (access$2002 < skipTrailingAsciiWhitespace && str2.charAt(access$2002) == '?') {
                ...
                this.encodedQueryNamesAndValues = HttpUrl.queryStringToNamesAndValues(HttpUrl.canonicalize(str, access$2002 + 1, access$2003, HttpUrl.QUERY_ENCODE_SET, true, true, true));
                access$2002 = access$2003;
            }
            if (access$2002 < skipTrailingAsciiWhitespace && str2.charAt(access$2002) == '#') {
                this.encodedFragment = HttpUrl.canonicalize(str, 1 + access$2002, skipTrailingAsciiWhitespace, "", true, false, false);
            }
        ...
        private static String canonicalizeHost(String str, int i, int i2) {
            ...
            if (!percentDecode.startsWith(Operators.ARRAY_START_STR) || !percentDecode.endsWith(Operators.ARRAY_END_STR)) {
