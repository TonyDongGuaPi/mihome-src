        ...
        if (this.state == 1 || this.state == 3) {
            do {
                try {
                    ...
                    IOException iOException = new IOException("unexpected end of stream on " + this.connection + " (recycle count=" + Internal.instance.recycleCount(this.connection) + Operators.BRACKET_END_STR);
