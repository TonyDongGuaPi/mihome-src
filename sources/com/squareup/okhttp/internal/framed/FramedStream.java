...
public final class FramedStream {
    ...
    private final class FramedDataSource implements Source {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:18:0x0092, code lost:
            if (com.squareup.okhttp.internal.framed.FramedStream.access$500(r8.this$0).unacknowledgedBytesRead < ((long) (com.squareup.okhttp.internal.framed.FramedStream.access$500(r8.this$0).okHttpSettings.getInitialWindowSize(65536) / 2))) goto L_0x00ae;
         */
        ...
        public long read(okio.Buffer r9, long r10) throws java.io.IOException {
            /*
                ...
                monitor-enter(r2)
                r8.waitUntilReadable()     // Catch:{ all -> 0x00b3 }
                r8.checkNotClosed()     // Catch:{ all -> 0x00b3 }
                okio.Buffer r3 = r8.readBuffer     // Catch:{ all -> 0x00b3 }
                long r3 = r3.size()     // Catch:{ all -> 0x00b3 }
            ...
            L_0x001d:
                okio.Buffer r3 = r8.readBuffer     // Catch:{ all -> 0x00b3 }
                okio.Buffer r4 = r8.readBuffer     // Catch:{ all -> 0x00b3 }
                long r4 = r4.size()     // Catch:{ all -> 0x00b3 }
                long r10 = java.lang.Math.min(r10, r4)     // Catch:{ all -> 0x00b3 }
                long r9 = r3.read(r9, r10)     // Catch:{ all -> 0x00b3 }
                ...
                long r3 = r11.unacknowledgedBytesRead     // Catch:{ all -> 0x00b3 }
                r5 = 0
                long r3 = r3 + r9
                r11.unacknowledgedBytesRead = r3     // Catch:{ all -> 0x00b3 }
                com.squareup.okhttp.internal.framed.FramedStream r11 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b3 }
                long r3 = r11.unacknowledgedBytesRead     // Catch:{ all -> 0x00b3 }
                com.squareup.okhttp.internal.framed.FramedStream r11 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b3 }
                com.squareup.okhttp.internal.framed.FramedConnection r11 = r11.connection     // Catch:{ all -> 0x00b3 }
                com.squareup.okhttp.internal.framed.Settings r11 = r11.okHttpSettings     // Catch:{ all -> 0x00b3 }
                r5 = 65536(0x10000, float:9.18355E-41)
                int r11 = r11.getInitialWindowSize(r5)     // Catch:{ all -> 0x00b3 }
                int r11 = r11 / 2
                long r6 = (long) r11     // Catch:{ all -> 0x00b3 }
                int r11 = (r3 > r6 ? 1 : (r3 == r6 ? 0 : -1))
                if (r11 < 0) goto L_0x0065
                com.squareup.okhttp.internal.framed.FramedStream r11 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b3 }
                com.squareup.okhttp.internal.framed.FramedConnection r11 = r11.connection     // Catch:{ all -> 0x00b3 }
                com.squareup.okhttp.internal.framed.FramedStream r3 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b3 }
                int r3 = r3.id     // Catch:{ all -> 0x00b3 }
                com.squareup.okhttp.internal.framed.FramedStream r4 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b3 }
                long r6 = r4.unacknowledgedBytesRead     // Catch:{ all -> 0x00b3 }
                r11.writeWindowUpdateLater(r3, r6)     // Catch:{ all -> 0x00b3 }
                com.squareup.okhttp.internal.framed.FramedStream r11 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b3 }
                r11.unacknowledgedBytesRead = r0     // Catch:{ all -> 0x00b3 }
            L_0x0065:
                monitor-exit(r2)     // Catch:{ all -> 0x00b3 }
                ...
                monitor-enter(r11)
                com.squareup.okhttp.internal.framed.FramedStream r2 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b0 }
                com.squareup.okhttp.internal.framed.FramedConnection r2 = r2.connection     // Catch:{ all -> 0x00b0 }
                long r3 = r2.unacknowledgedBytesRead     // Catch:{ all -> 0x00b0 }
                r6 = 0
                long r3 = r3 + r9
                r2.unacknowledgedBytesRead = r3     // Catch:{ all -> 0x00b0 }
                com.squareup.okhttp.internal.framed.FramedStream r2 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b0 }
                com.squareup.okhttp.internal.framed.FramedConnection r2 = r2.connection     // Catch:{ all -> 0x00b0 }
                long r2 = r2.unacknowledgedBytesRead     // Catch:{ all -> 0x00b0 }
                com.squareup.okhttp.internal.framed.FramedStream r4 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b0 }
                com.squareup.okhttp.internal.framed.FramedConnection r4 = r4.connection     // Catch:{ all -> 0x00b0 }
                com.squareup.okhttp.internal.framed.Settings r4 = r4.okHttpSettings     // Catch:{ all -> 0x00b0 }
                int r4 = r4.getInitialWindowSize(r5)     // Catch:{ all -> 0x00b0 }
                int r4 = r4 / 2
                long r4 = (long) r4     // Catch:{ all -> 0x00b0 }
                ...
                com.squareup.okhttp.internal.framed.FramedStream r4 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b0 }
                com.squareup.okhttp.internal.framed.FramedConnection r4 = r4.connection     // Catch:{ all -> 0x00b0 }
                long r4 = r4.unacknowledgedBytesRead     // Catch:{ all -> 0x00b0 }
                r2.writeWindowUpdateLater(r3, r4)     // Catch:{ all -> 0x00b0 }
                com.squareup.okhttp.internal.framed.FramedStream r2 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b0 }
                com.squareup.okhttp.internal.framed.FramedConnection r2 = r2.connection     // Catch:{ all -> 0x00b0 }
                r2.unacknowledgedBytesRead = r0     // Catch:{ all -> 0x00b0 }
            L_0x00ae:
