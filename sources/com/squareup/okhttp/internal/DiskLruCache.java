...
public final class DiskLruCache implements Closeable {
    ...
    public synchronized com.squareup.okhttp.internal.DiskLruCache.Editor edit(java.lang.String r6, long r7) throws java.io.IOException {
        /*
            ...
            long r2 = r0.sequenceNumber     // Catch:{ all -> 0x0067 }
    ...
    public synchronized void completeEdit(com.squareup.okhttp.internal.DiskLruCache.Editor r10, boolean r11) throws java.io.IOException {
        /*
            r9 = this;
            monitor-enter(r9)
            com.squareup.okhttp.internal.DiskLruCache$Entry r0 = r10.entry     // Catch:{ all -> 0x0119 }
            com.squareup.okhttp.internal.DiskLruCache$Editor r1 = r0.currentEditor     // Catch:{ all -> 0x0119 }
            ...
            r2 = 0
        L_0x0015:
            int r3 = r9.valueCount     // Catch:{ all -> 0x0119 }
            if (r2 >= r3) goto L_0x0051
            boolean[] r3 = r10.written     // Catch:{ all -> 0x0119 }
            boolean r3 = r3[r2]     // Catch:{ all -> 0x0119 }
            if (r3 == 0) goto L_0x0037
            com.squareup.okhttp.internal.io.FileSystem r3 = r9.fileSystem     // Catch:{ all -> 0x0119 }
            java.io.File[] r4 = r0.dirtyFiles     // Catch:{ all -> 0x0119 }
            r4 = r4[r2]     // Catch:{ all -> 0x0119 }
            boolean r3 = r3.exists(r4)     // Catch:{ all -> 0x0119 }
            if (r3 != 0) goto L_0x0034
            r10.abort()     // Catch:{ all -> 0x0119 }
            monitor-exit(r9)
            return
        L_0x0034:
            int r2 = r2 + 1
        ...
        L_0x0037:
            ...
            r11.append(r2)     // Catch:{ all -> 0x0119 }
            java.lang.String r11 = r11.toString()     // Catch:{ all -> 0x0119 }
            r10.<init>(r11)     // Catch:{ all -> 0x0119 }
            throw r10     // Catch:{ all -> 0x0119 }
        L_0x0051:
            int r10 = r9.valueCount     // Catch:{ all -> 0x0119 }
            if (r1 >= r10) goto L_0x0092
            java.io.File[] r10 = r0.dirtyFiles     // Catch:{ all -> 0x0119 }
            r10 = r10[r1]     // Catch:{ all -> 0x0119 }
            if (r11 == 0) goto L_0x008a
            com.squareup.okhttp.internal.io.FileSystem r2 = r9.fileSystem     // Catch:{ all -> 0x0119 }
            boolean r2 = r2.exists(r10)     // Catch:{ all -> 0x0119 }
            if (r2 == 0) goto L_0x008f
            java.io.File[] r2 = r0.cleanFiles     // Catch:{ all -> 0x0119 }
            r2 = r2[r1]     // Catch:{ all -> 0x0119 }
            com.squareup.okhttp.internal.io.FileSystem r3 = r9.fileSystem     // Catch:{ all -> 0x0119 }
            r3.rename(r10, r2)     // Catch:{ all -> 0x0119 }
            long[] r10 = r0.lengths     // Catch:{ all -> 0x0119 }
            r3 = r10[r1]     // Catch:{ all -> 0x0119 }
            com.squareup.okhttp.internal.io.FileSystem r10 = r9.fileSystem     // Catch:{ all -> 0x0119 }
            long r5 = r10.size(r2)     // Catch:{ all -> 0x0119 }
            long[] r10 = r0.lengths     // Catch:{ all -> 0x0119 }
            r10[r1] = r5     // Catch:{ all -> 0x0119 }
            long r7 = r9.size     // Catch:{ all -> 0x0119 }
            r10 = 0
            long r7 = r7 - r3
            long r7 = r7 + r5
            r9.size = r7     // Catch:{ all -> 0x0119 }
            goto L_0x008f
        L_0x008a:
            com.squareup.okhttp.internal.io.FileSystem r2 = r9.fileSystem     // Catch:{ all -> 0x0119 }
            r2.delete(r10)     // Catch:{ all -> 0x0119 }
        L_0x008f:
            int r1 = r1 + 1
            goto L_0x0051
        L_0x0092:
            int r10 = r9.redundantOpCount     // Catch:{ all -> 0x0119 }
            r1 = 1
            int r10 = r10 + r1
            r9.redundantOpCount = r10     // Catch:{ all -> 0x0119 }
            r10 = 0
            com.squareup.okhttp.internal.DiskLruCache.Editor unused = r0.currentEditor = r10     // Catch:{ all -> 0x0119 }
            boolean r10 = r0.readable     // Catch:{ all -> 0x0119 }
            r10 = r10 | r11
            r2 = 10
            r3 = 32
            if (r10 == 0) goto L_0x00d5
            boolean unused = r0.readable = r1     // Catch:{ all -> 0x0119 }
            okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x0119 }
            java.lang.String r1 = "CLEAN"
            okio.BufferedSink r10 = r10.writeUtf8(r1)     // Catch:{ all -> 0x0119 }
            r10.writeByte(r3)     // Catch:{ all -> 0x0119 }
            okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x0119 }
            java.lang.String r1 = r0.key     // Catch:{ all -> 0x0119 }
            r10.writeUtf8(r1)     // Catch:{ all -> 0x0119 }
            okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x0119 }
            r0.writeLengths(r10)     // Catch:{ all -> 0x0119 }
            okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x0119 }
            r10.writeByte(r2)     // Catch:{ all -> 0x0119 }
            if (r11 == 0) goto L_0x00f7
            long r10 = r9.nextSequenceNumber     // Catch:{ all -> 0x0119 }
            r1 = 1
            long r1 = r1 + r10
            r9.nextSequenceNumber = r1     // Catch:{ all -> 0x0119 }
            long unused = r0.sequenceNumber = r10     // Catch:{ all -> 0x0119 }
            goto L_0x00f7
        L_0x00d5:
            java.util.LinkedHashMap<java.lang.String, com.squareup.okhttp.internal.DiskLruCache$Entry> r10 = r9.lruEntries     // Catch:{ all -> 0x0119 }
            java.lang.String r11 = r0.key     // Catch:{ all -> 0x0119 }
            r10.remove(r11)     // Catch:{ all -> 0x0119 }
            okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x0119 }
            java.lang.String r11 = "REMOVE"
            okio.BufferedSink r10 = r10.writeUtf8(r11)     // Catch:{ all -> 0x0119 }
            r10.writeByte(r3)     // Catch:{ all -> 0x0119 }
            okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x0119 }
            java.lang.String r11 = r0.key     // Catch:{ all -> 0x0119 }
            r10.writeUtf8(r11)     // Catch:{ all -> 0x0119 }
            okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x0119 }
            r10.writeByte(r2)     // Catch:{ all -> 0x0119 }
        L_0x00f7:
            okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x0119 }
            r10.flush()     // Catch:{ all -> 0x0119 }
            long r10 = r9.size     // Catch:{ all -> 0x0119 }
            long r0 = r9.maxSize     // Catch:{ all -> 0x0119 }
            int r2 = (r10 > r0 ? 1 : (r10 == r0 ? 0 : -1))
            if (r2 > 0) goto L_0x010a
            boolean r10 = r9.journalRebuildRequired()     // Catch:{ all -> 0x0119 }
            if (r10 == 0) goto L_0x0111
        L_0x010a:
            java.util.concurrent.Executor r10 = r9.executor     // Catch:{ all -> 0x0119 }
            java.lang.Runnable r11 = r9.cleanupRunnable     // Catch:{ all -> 0x0119 }
