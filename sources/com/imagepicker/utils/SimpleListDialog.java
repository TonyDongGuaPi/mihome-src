    ...
    private class SimpleListAdapter extends BaseAdapter {
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                ...
                viewHolder.f6077a = (TextView) view.findViewById(R.id.textview);
                viewHolder.b = (ImageView) view.findViewById(R.id.icon);
                view.setTag(viewHolder);
            } else {
                viewHolder = (ViewHolder) view.getTag();
            }
            viewHolder.f6077a.setText((CharSequence) getItem(i));
            if (SimpleListDialog.this.p == 0) {
                viewHolder.f6077a.setTextColor(Color.parseColor("#333333"));
            } else if (SimpleListDialog.this.p == 1) {
                viewHolder.f6077a.setTextColor(SimpleListDialog.this.mContext.getResources().getColor(R.color.select_dialog_single_color));
