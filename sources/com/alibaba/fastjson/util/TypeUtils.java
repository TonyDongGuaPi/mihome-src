...
public class TypeUtils {
    ...
    static {
        ...
        mappings.put(InstrSupport.e, boolean[].class);
    ...
    public static Type checkPrimitiveArray(GenericArrayType genericArrayType) {
        ...
        try {
            if (cls2 == Boolean.TYPE) {
                cls = Class.forName(str + miuipub.reflect.Field.f3009a);
            } else if (cls2 == Character.TYPE) {
                cls = Class.forName(str + miuipub.reflect.Field.c);
            } else if (cls2 == Byte.TYPE) {
                cls = Class.forName(str + miuipub.reflect.Field.b);
            } else if (cls2 == Short.TYPE) {
                cls = Class.forName(str + "S");
            } else if (cls2 == Integer.TYPE) {
                cls = Class.forName(str + miuipub.reflect.Field.e);
            } else if (cls2 == Long.TYPE) {
                cls = Class.forName(str + miuipub.reflect.Field.f);
            } else if (cls2 == Float.TYPE) {
                cls = Class.forName(str + miuipub.reflect.Field.g);
            } else if (cls2 != Double.TYPE) {
                return genericArrayType;
            } else {
                cls = Class.forName(str + miuipub.reflect.Field.h);
            }
            return cls;
