    ...
    public final void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type) throws IOException {
        ...
        if (obj != null) {
            ...
            if (obj instanceof boolean[]) {
                ...
                if (length == -1) {
                    serializeWriter.append((CharSequence) XMPConst.ai);
                    return;
                }
                serializeWriter.write(91);
                while (i < length) {
                ...
                try {
                    ...
                    while (i < length3) {
                        ...
                        if (obj3 == null) {
                            ...
                            this.compObjectSerializer.write(jSONSerializer, obj3, Integer.valueOf(i), (Type) null);
                        } else {
                            jSONSerializer.config.get(obj3.getClass()).write(jSONSerializer, obj3, Integer.valueOf(i), (Type) null);
                        }
                        i++;
                    }
                    serializeWriter.write(93);
            ...
            serializeWriter.write(XMPConst.ai);
        } else {
            serializeWriter.writeNull();
        }
    }
