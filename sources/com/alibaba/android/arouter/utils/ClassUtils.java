...
public class ClassUtils {
    ...
    private static final String f731a = ".classes";
    ...
    public static Set<String> a(Context context, final String str) throws PackageManager.NameNotFoundException, IOException, InterruptedException {
        ...
        for (final String next : a2) {
            DefaultPoolExecutor.a().execute(new Runnable() {
            ...
            try {
                ...
                if (file.exists() && file.isDirectory()) {
                    for (File file2 : file.listFiles()) {
                        if (file2 != null && file2.exists() && file2.isFile() && file2.getName().endsWith(ShareConstants.w)) {
    ...
    private static boolean a() {
        /*
            r0 = 0
            r1 = 0
            boolean r2 = b()     // Catch:{ Exception -> 0x0051 }
            r3 = 1
