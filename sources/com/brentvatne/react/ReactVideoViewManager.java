...
public class ReactVideoViewManager extends SimpleViewManager<ReactVideoView> {
    ...
    public void setSrc(ReactVideoView reactVideoView, @Nullable ReadableMap readableMap) {
        ...
        int i4 = i2 < 0 ? 0 : i2;
        if (i3 > 0) {
            reactVideoView.setSrc(readableMap.getString("uri"), readableMap.getString("type"), readableMap.getBoolean(PROP_SRC_IS_NETWORK), readableMap.getBoolean(PROP_SRC_IS_ASSET), i3, i4);
        } else {
            reactVideoView.setSrc(readableMap.getString("uri"), readableMap.getString("type"), readableMap.getBoolean(PROP_SRC_IS_NETWORK), readableMap.getBoolean(PROP_SRC_IS_ASSET));
        }
    }
