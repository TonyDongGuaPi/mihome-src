...
public final class c {
    ...
    private static String f1162a = new String("idnjfhncnsfuobcnt847y929o449u474w7j3h22aoddc98euk#%&&)*&^%#");

    public static String a() {
        String str = new String();
        for (int i = 0; i < f1162a.length() - 1; i += 4) {
            str = str + f1162a.charAt(i);
        }
        return str;
    }
    ...
    private static byte[] a(byte[] bArr) {
        ...
        Object invoke = cls.getMethod("getInstance", new Class[]{String.class, String.class}).invoke((Object) null, new Object[]{a.c, a.d});
