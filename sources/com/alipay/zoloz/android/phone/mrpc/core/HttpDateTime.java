...
public final class HttpDateTime {
    ...
    private static final Pattern f1184a = Pattern.compile("([0-9]{1,2})[- ]([A-Za-z]{3,9})[- ]([0-9]{2,4})[ ]([0-9]{1,2}:[0-9][0-9]:[0-9][0-9])");
    ...
    public static long parse(String str) {
        ...
        if (matcher.find()) {
            ...
            if (matcher2.find()) {
                ...
                int a3 = a(matcher2.group(2));
                TimeOfDay d = d(matcher2.group(3));
                i = c(matcher2.group(4));
                i2 = b3;
                i3 = a3;
                timeOfDay = d;
            } else {
