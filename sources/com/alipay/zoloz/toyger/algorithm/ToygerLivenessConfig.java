...
public class ToygerLivenessConfig {
    ...
    public String toString() {
        return "ToygerLivenessConfig{livenessCombinations='" + this.livenessCombinations + Operators.SINGLE_QUOTE + ", collection='" + this.collection + Operators.SINGLE_QUOTE + ", eyeHwRatio=" + this.eyeHwRatio + ", difference=" + this.difference + ", yunqiQuality=" + this.yunqiQuality + ", batLivenessThreshold=" + this.batLivenessThreshold + ", dragonflyMin=" + this.dragonflyMin + ", dragonflyMax=" + this.dragonflyMax + ", geminiMin=" + this.geminiMin + ", geminiMax=" + this.geminiMax + Operators.BLOCK_END;
    }
}
