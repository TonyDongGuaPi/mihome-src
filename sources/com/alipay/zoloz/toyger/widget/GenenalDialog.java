...
public class GenenalDialog extends Dialog {
    ...
    public GenenalDialog(Context context2, String str, String str2, String str3, DialogInterface.OnClickListener onClickListener, String str4, DialogInterface.OnClickListener onClickListener2, boolean z, boolean z2) {
    ...
    private void initViews() {
        setContentView(LayoutInflater.from(this.context).inflate(R.layout.toyger_general_dialog, (ViewGroup) null));
