...
public class AlertTypeHelper {
    ...
    public AlertContext getAlertContext(AlertType alertType, int i) {
        ...
        int i2 = 202;
        switch (b.f1218a[alertType.ordinal()]) {
            case 1:
                dialogTypeIndex = DialogTypeIndex.DIALOG_TYPE_INDEX_SYSTEM_ERROR;
                str = getAlertString(this.faceRemoteConfig.getFaceTips().getSystemErrorAlert().getTitle(), resources.getString(R.string.face_detect_dialog_algorithm_init_error));
            ...
            case 4:
                ...
                str5 = "timeout";
                i2 = getAlertCode(this.faceRemoteConfig.getFaceTips().getTimeoutAlert().getReturnCode(), 203);
                break;
            case 5:
            ...
            case 8:
                ...
                i2 = getAlertCode(this.faceRemoteConfig.getFaceTips().getSystemVersionErrorAlert().getReturnCode(), 101);
                break;
            case 9:
            case 10:
                ...
                str5 = "serverFail";
                i2 = getAlertCode(this.faceRemoteConfig.getFaceTips().getFailAlert().getReturnCode(), 202);
                break;
            case 11:
            case 12:
                ...
                str5 = "serverFail";
                i2 = getAlertCode(this.faceRemoteConfig.getFaceTips().getLimitAlert().getReturnCode(), 209);
                break;
            case 13:
