...
public class AlertHelper implements DialogInterface.OnClickListener, View.OnClickListener {
    ...
    public void alert(AlertType alertType) {
        if (!this.isAuthInBackground && !this.isAlertRunning) {
            ...
            AlertType alertType2 = this.mRetryTime >= this.mToygerCallback.getRemoteConfig().getColl().getRetry() ? AlertType.ALERT_FACE_FAIL_OVER_MAX_TIME : alertType;
            AlertTypeHelper.AlertContext alertContext = this.mAlertTypeHelper.getAlertContext(alertType2, this.mRetryTime);
    ...
    public void pressAlertButton(DialogTypeIndex dialogTypeIndex, boolean z) {
        switch (a.f1217a[dialogTypeIndex.ordinal()]) {
            case 1:
