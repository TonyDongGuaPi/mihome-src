...
public class CherryCaptureTask extends ToygerBaseTask {
    ...
    public ActionType action(ActionFrame actionFrame) {
        ...
        BioLog.w(ToygerService.TAG, "CherryCaptureTask.action(): frameType = " + toygerFrame.frameType);
        if (toygerFrame.frameType == FrameType.COMPLETED) {
            ...
            BioLog.e(ToygerService.TAG, "FrameType.FRAME : mBestToygerFrame = toygerFrame : " + this.mBestToygerFrame);
