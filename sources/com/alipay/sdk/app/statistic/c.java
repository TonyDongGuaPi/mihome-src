...
public class c {
    ...
    public static final String f1081a = "net";
    ...
    private String b(String str) {
        ...
        return str.replace(Operators.ARRAY_START_STR, "【").replace(Operators.ARRAY_END_STR, "】").replace(Operators.BRACKET_START_STR, "（").replace(Operators.BRACKET_END_STR, "）").replace(",", "，").replace("-", "=").replace("^", Constants.J);
    }
    ...
    private String b(Context context) {
        return String.format("%s,%s,%s,%s,%s,%s,%s,%s,%s,-", new Object[]{b(com.alipay.sdk.util.a.d(context)), "android", b(Build.VERSION.RELEASE), b(Build.MODEL), "-", b(com.alipay.sdk.util.a.a(context).a()), b(com.alipay.sdk.util.a.b(context).b()), "gw", b(com.alipay.sdk.util.a.a(context).b())});
    }
}
