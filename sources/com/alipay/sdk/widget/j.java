...
public class j extends g implements WebViewWindow.a, WebViewWindow.b, WebViewWindow.c {
    ...
    private boolean c() {
        try {
            this.x = new WebViewWindow(this.f1148a);
    ...
    public boolean a(WebViewWindow webViewWindow, String str, String str2, String str3, JsPromptResult jsPromptResult) {
        if (str2.startsWith("<head>") && str2.contains(s)) {
            this.f1148a.runOnUiThread(new k(this));
        }
    ...
    public boolean b(WebViewWindow webViewWindow, String str) {
        ...
        if (str.startsWith(b)) {
            ...
            try {
                ...
                com.alipay.sdk.app.statistic.a.a(c.b, th);
                return true;
            }
        }
    }
    ...
    public boolean a(WebViewWindow webViewWindow, int i2, String str, String str2) {
        com.alipay.sdk.app.statistic.a.a("net", c.r, "onReceivedError:" + str2);
        webViewWindow.getRefreshButton().setVisibility(0);
        return false;
    }

    public boolean a(WebViewWindow webViewWindow, SslErrorHandler sslErrorHandler, SslError sslError) {
        com.alipay.sdk.app.statistic.a.a("net", c.r, String.valueOf(sslError));
        if (this.w) {
            sslErrorHandler.proceed();
            this.w = false;
            return true;
        }
        this.f1148a.runOnUiThread(new n(this, sslErrorHandler));
        return true;
    }

    private void b(String str) {
        Map<String, String> c2 = n.c(str);
        if (str.startsWith(i)) {
    ...
    private void a(String str, String str2, String str3) {
        ...
        if ("title".equals(str) && d2.has("title")) {
            ...
            int i2 = 0;
            if ("exit".equals(str)) {
                com.alipay.sdk.app.j.a(d2.optString("result", (String) null));
                ...
                ImageView refreshButton = this.x.getRefreshButton();
                if (!optBoolean2) {
                    i2 = 4;
                }
                refreshButton.setVisibility(i2);
            } else if (q.equals(str) && d2.optString("url", (String) null) != null) {
