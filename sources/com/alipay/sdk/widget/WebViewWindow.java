...
public class WebViewWindow extends LinearLayout {
    ...
    private void a(Context context) {
        ...
        this.f1141a = new ImageView(context);
        this.f1141a.setOnClickListener(this.j);
        this.f1141a.setScaleType(ImageView.ScaleType.CENTER);
        this.f1141a.setImageDrawable(k.a(k.f1134a, context));
        this.f1141a.setPadding(a(12), 0, a(12), 0);
        linearLayout.addView(this.f1141a, new LinearLayout.LayoutParams(-2, -2));
