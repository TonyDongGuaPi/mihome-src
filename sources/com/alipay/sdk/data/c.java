...
public class c {
    ...
    private static final String f1107a = "virtualImeiAndImsi";
    ...
    public String a(com.alipay.sdk.tid.b bVar) {
        ...
        if (TextUtils.isEmpty(this.e)) {
            ...
            String e2 = n.e(b2);
            String b4 = b(b2);
            this.e = "Msp/15.6.2" + " (" + b3 + com.alipay.sdk.util.i.b + c2 + com.alipay.sdk.util.i.b + d2 + com.alipay.sdk.util.i.b + g2 + com.alipay.sdk.util.i.b + e2 + com.alipay.sdk.util.i.b + b4;
        }
    ...
    public String c() {
        String b2;
        Context b3 = b.a().b();
        SharedPreferences sharedPreferences = b3.getSharedPreferences(f1107a, 0);
    ...
    public String d() {
        String str;
        Context b2 = b.a().b();
        SharedPreferences sharedPreferences = b2.getSharedPreferences(f1107a, 0);
