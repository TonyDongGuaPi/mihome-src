...
public class TidHelper {
    public static Tid loadTID(Context context) {
        ...
        if (a2 == null) {
            ...
            c.b("TidHelper.loadTID", "TidHelper:::loadTID > " + a2.toString());
        }
        return a2;
    }
    ...
    public static synchronized com.alipay.sdk.tid.Tid loadOrCreateTID(android.content.Context r4) {
        /*
            ...
            com.alipay.sdk.util.c.b(r1, r2)     // Catch:{ all -> 0x0039 }
            if (r4 != 0) goto L_0x0017
            java.lang.String r1 = "tid"
            java.lang.String r2 = "tid_context_null"
            java.lang.String r3 = ""
            com.alipay.sdk.app.statistic.a.a((android.content.Context) r4, (java.lang.String) r1, (java.lang.String) r2, (java.lang.String) r3)     // Catch:{ all -> 0x0039 }
        L_0x0017:
            a(r4)     // Catch:{ all -> 0x0039 }
            com.alipay.sdk.tid.Tid r1 = loadTID(r4)     // Catch:{ all -> 0x0039 }
            boolean r2 = com.alipay.sdk.tid.Tid.isEmpty(r1)     // Catch:{ all -> 0x0039 }
            if (r2 == 0) goto L_0x0036
            android.os.Looper r2 = android.os.Looper.myLooper()     // Catch:{ all -> 0x0039 }
            android.os.Looper r3 = android.os.Looper.getMainLooper()     // Catch:{ all -> 0x0039 }
            if (r2 != r3) goto L_0x0031
            r4 = 0
            monitor-exit(r0)
            return r4
        L_0x0031:
            com.alipay.sdk.tid.Tid r4 = b(r4)     // Catch:{ Throwable -> 0x0036 }
            goto L_0x0037
        L_0x0036:
            r4 = r1
        L_0x0037:
