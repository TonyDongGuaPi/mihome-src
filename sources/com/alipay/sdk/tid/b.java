...
public class b {
    ...
    public static final String f1124a = "alipay_tid_storage";
    ...
    private void k() {
        ...
        L_0x0019:
            ...
            com.alipay.sdk.util.c.b(r2, r3)     // Catch:{ Throwable -> 0x0076, all -> 0x0073 }
            com.alipay.sdk.tid.a r2 = new com.alipay.sdk.tid.a     // Catch:{ Throwable -> 0x0076, all -> 0x0073 }
            r2.<init>(r0)     // Catch:{ Throwable -> 0x0076, all -> 0x0073 }
            com.alipay.sdk.util.a r1 = com.alipay.sdk.util.a.a((android.content.Context) r0)     // Catch:{ Throwable -> 0x0071 }
            java.lang.String r1 = r1.b()     // Catch:{ Throwable -> 0x0071 }
            com.alipay.sdk.util.a r3 = com.alipay.sdk.util.a.a((android.content.Context) r0)     // Catch:{ Throwable -> 0x0071 }
            java.lang.String r3 = r3.a()     // Catch:{ Throwable -> 0x0071 }
            java.lang.String r4 = r2.a(r1, r3)     // Catch:{ Throwable -> 0x0071 }
            java.lang.String r1 = r2.b(r1, r3)     // Catch:{ Throwable -> 0x0071 }
            boolean r3 = android.text.TextUtils.isEmpty(r4)     // Catch:{ Throwable -> 0x0071 }
            if (r3 != 0) goto L_0x006d
            boolean r3 = android.text.TextUtils.isEmpty(r1)     // Catch:{ Throwable -> 0x0071 }
            if (r3 != 0) goto L_0x006d
            java.lang.String r3 = "TidStorage"
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ Throwable -> 0x0071 }
            r5.<init>()     // Catch:{ Throwable -> 0x0071 }
            java.lang.String r6 = "transferTidFromOldDb: tid from db is "
            r5.append(r6)     // Catch:{ Throwable -> 0x0071 }
            r5.append(r4)     // Catch:{ Throwable -> 0x0071 }
            java.lang.String r6 = ", "
            r5.append(r6)     // Catch:{ Throwable -> 0x0071 }
            r5.append(r1)     // Catch:{ Throwable -> 0x0071 }
            java.lang.String r5 = r5.toString()     // Catch:{ Throwable -> 0x0071 }
            com.alipay.sdk.util.c.b(r3, r5)     // Catch:{ Throwable -> 0x0071 }
            r8.a(r4, r1)     // Catch:{ Throwable -> 0x0071 }
        L_0x006d:
            r2.close()
            goto L_0x0080
        L_0x0071:
        ...
        L_0x0076:
            ...
            r1 = r7
        L_0x007a:
            com.alipay.sdk.util.c.a(r1)     // Catch:{ all -> 0x00b8 }
            if (r2 == 0) goto L_0x0080
            goto L_0x006d
        L_0x0080:
            java.lang.String r1 = "TidStorage"
            java.lang.String r3 = "transferTidFromOldDb: removing database table"
            com.alipay.sdk.util.c.b(r1, r3)     // Catch:{ Throwable -> 0x009c }
            com.alipay.sdk.tid.a r1 = new com.alipay.sdk.tid.a     // Catch:{ Throwable -> 0x009c }
            r1.<init>(r0)     // Catch:{ Throwable -> 0x009c }
            r1.a()     // Catch:{ Throwable -> 0x0097, all -> 0x0094 }
            r1.close()
            goto L_0x00a5
        L_0x0094:
            r0 = move-exception
        ...
        L_0x009c:
            r0 = move-exception
        L_0x009d:
            com.alipay.sdk.util.c.a(r0)     // Catch:{ all -> 0x009a }
    ...
    private void l() {
        /*
            ...
            r4 = 1
            java.lang.String r2 = com.alipay.sdk.tid.b.a.a((java.lang.String) r2, (java.lang.String) r3, (boolean) r4)     // Catch:{ Exception -> 0x0066 }
            boolean r3 = android.text.TextUtils.isEmpty(r2)     // Catch:{ Exception -> 0x0066 }
            if (r3 != 0) goto L_0x0062
            org.json.JSONObject r3 = new org.json.JSONObject     // Catch:{ Exception -> 0x0066 }
            r3.<init>(r2)     // Catch:{ Exception -> 0x0066 }
            java.lang.String r2 = "tid"
            java.lang.String r4 = ""
            java.lang.String r2 = r3.optString(r2, r4)     // Catch:{ Exception -> 0x0066 }
            java.lang.String r4 = "client_key"
            java.lang.String r5 = ""
            java.lang.String r4 = r3.optString(r4, r5)     // Catch:{ Exception -> 0x005f }
            java.lang.String r5 = "timestamp"
            long r6 = java.lang.System.currentTimeMillis()     // Catch:{ Exception -> 0x005c }
            long r5 = r3.optLong(r5, r6)     // Catch:{ Exception -> 0x005c }
            java.lang.Long r5 = java.lang.Long.valueOf(r5)     // Catch:{ Exception -> 0x005c }
            java.lang.String r0 = "vimei"
            java.lang.String r6 = ""
            java.lang.String r0 = r3.optString(r0, r6)     // Catch:{ Exception -> 0x0059 }
    ...
    private void p() {
        try {
            ...
            a.a(f1124a, b, jSONObject.toString(), true);
        } catch (Exception e2) {
            c.a(e2);
        }
    }
    ...
    public static class a {
        ...
        public static void a(String str, String str2, String str3, boolean z) {
            if (b.i != null) {
                ...
                if (z) {
                    String b = b();
                    String a2 = com.alipay.sdk.encrypt.b.a(str3, b);
