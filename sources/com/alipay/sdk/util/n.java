...
public class n {
    ...
    static final String f1137a = "com.alipay.android.app";
    ...
    public static a a(Context context, List<a.C0029a> list) {
        a a2;
        if (list == null) {
            return null;
        }
        for (a.C0029a next : list) {
            if (next != null && (a2 = a(context, next.f1105a, next.b, next.c)) != null && !a2.a() && !a2.b()) {
                return a2;
            }
        }
        return null;
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final PackageInfo f1138a;
        public final int b;
        public final String c;

        public a(PackageInfo packageInfo, int i, String str) {
            this.f1138a = packageInfo;
            this.b = i;
            this.c = str;
        }

        public boolean a() {
            Signature[] signatureArr = this.f1138a.signatures;
        ...
        public boolean b() {
            return this.f1138a.versionCode < this.b;
        }
    }

    public static boolean a(Context context) {
        try {
            if (context.getPackageManager().getPackageInfo(f1137a, 128) == null) {
                return false;
            }
            return true;
    ...
    public static boolean b(Context context, List<a.C0029a> list) {
        try {
            for (a.C0029a next : list) {
                if (next != null) {
                    String str = next.f1105a;
                    if (EnvUtils.isSandBox() && "com.eg.android.AlipayGphone".equals(str)) {
                        str = "com.eg.android.AlipayGphoneRC";
                    }
                    try {
    ...
    public static String c(Context context) {
        ...
        String d2 = d(context);
        String e2 = e(context);
        return " (" + b2 + i.b + c2 + i.b + d2 + i.b + i.b + e2 + Operators.BRACKET_END_STR + "(sdk android)";
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:16:0x00dd A[Catch:{ Throwable -> 0x00f8 }] */
    ...
    public static android.webkit.WebView a(android.app.Activity r5, java.lang.String r6, java.lang.String r7) {
        ...
        L_0x00bf:
            ...
            goto L_0x00f8
        L_0x00cf:
            java.lang.Class r7 = r5.getClass()     // Catch:{ Throwable -> 0x00f8 }
            java.lang.String r0 = "removeJavascriptInterface"
            java.lang.Class[] r1 = new java.lang.Class[r3]     // Catch:{ Throwable -> 0x00f8 }
            java.lang.reflect.Method r7 = r7.getMethod(r0, r1)     // Catch:{ Throwable -> 0x00f8 }
            if (r7 == 0) goto L_0x00f8
            java.lang.Object[] r0 = new java.lang.Object[r2]     // Catch:{ Throwable -> 0x00f8 }
            java.lang.String r1 = "searchBoxJavaBridge_"
            r0[r3] = r1     // Catch:{ Throwable -> 0x00f8 }
            r7.invoke(r5, r0)     // Catch:{ Throwable -> 0x00f8 }
            java.lang.Object[] r0 = new java.lang.Object[r2]     // Catch:{ Throwable -> 0x00f8 }
    ...
    public static boolean a(WebView webView, String str, @Nullable Activity activity) {
        ...
        if (str.toLowerCase().startsWith(com.alipay.sdk.cons.a.j.toLowerCase()) || str.toLowerCase().startsWith(com.alipay.sdk.cons.a.k.toLowerCase())) {
            try {
                a a2 = a((Context) activity, i.f1076a);
                if (a2 != null && !a2.b()) {
                    if (!a2.a()) {
