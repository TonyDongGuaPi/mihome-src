...
public class i {
    ...
    public static final String f1132a = "pref_trade_token";
    ...
    public static String a(String str) {
        ...
        for (int i = 0; i < split.length; i++) {
            if (split[i].startsWith(c) && split[i].endsWith("}")) {
                String[] split2 = split[i].substring(c.length(), split[i].length() - "}".length()).split(com.alipay.sdk.sys.a.b);
                int i2 = 0;
                while (true) {
                    if (i2 < split2.length) {
