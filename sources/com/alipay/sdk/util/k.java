    ...
    public static Drawable a(String str, Context context, int i) {
        ...
        try {
            ...
            try {
                ...
                BitmapDrawable bitmapDrawable = new BitmapDrawable(context.getResources(), BitmapFactory.decodeStream(byteArrayInputStream, (Rect) null, options));
