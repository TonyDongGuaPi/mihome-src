...
public class AuthActivity extends Activity {
    ...
    static final String f1083a = "params";
    ...
    /* JADX WARNING: Can't wrap try/catch for region: R(9:13|(3:15|16|(1:18))|19|20|21|22|(1:24)|25|(2:28|35)(1:36)) */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:24:0x012b A[Catch:{ Throwable -> 0x014c }] */
    ...
    public void onCreate(android.os.Bundle r6) {
        /*
            r5 = this;
            super.onCreate(r6)
            android.content.Intent r6 = r5.getIntent()     // Catch:{ Exception -> 0x0160 }
            android.os.Bundle r6 = r6.getExtras()     // Catch:{ Exception -> 0x0160 }
            if (r6 != 0) goto L_0x0011
            r5.finish()
            return
        L_0x0011:
            java.lang.String r0 = "redirectUri"
            java.lang.String r0 = r6.getString(r0)     // Catch:{ Exception -> 0x015c }
            r5.d = r0     // Catch:{ Exception -> 0x015c }
            java.lang.String r0 = "params"
            java.lang.String r6 = r6.getString(r0)     // Catch:{ Exception -> 0x015c }
        ...
        L_0x0105:
            ...
            goto L_0x014c
        L_0x011b:
            android.webkit.WebView r6 = r5.c     // Catch:{ Throwable -> 0x014c }
            java.lang.Class r6 = r6.getClass()     // Catch:{ Throwable -> 0x014c }
            java.lang.String r1 = "removeJavascriptInterface"
            java.lang.Class[] r2 = new java.lang.Class[r4]     // Catch:{ Throwable -> 0x014c }
            java.lang.reflect.Method r6 = r6.getMethod(r1, r2)     // Catch:{ Throwable -> 0x014c }
            if (r6 == 0) goto L_0x014c
            android.webkit.WebView r1 = r5.c     // Catch:{ Throwable -> 0x014c }
            java.lang.Object[] r2 = new java.lang.Object[r0]     // Catch:{ Throwable -> 0x014c }
            java.lang.String r3 = "searchBoxJavaBridge_"
            r2[r4] = r3     // Catch:{ Throwable -> 0x014c }
            r6.invoke(r1, r2)     // Catch:{ Throwable -> 0x014c }
            android.webkit.WebView r1 = r5.c     // Catch:{ Throwable -> 0x014c }
            java.lang.Object[] r2 = new java.lang.Object[r0]     // Catch:{ Throwable -> 0x014c }
    ...
    private class c extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView webView, String str) {
            if (str.toLowerCase().startsWith(com.alipay.sdk.cons.a.j.toLowerCase()) || str.toLowerCase().startsWith(com.alipay.sdk.cons.a.k.toLowerCase())) {
                try {
                    n.a a2 = n.a((Context) AuthActivity.this, i.f1076a);
                    if (a2 != null && !a2.a()) {
                        if (!a2.b()) {
    ...
    public boolean a(String str) {
        if (TextUtils.isEmpty(str) || str.startsWith(ConnectionHelper.HTTP_PREFIX) || str.startsWith("https://")) {
            return false;
        }
    ...
    private static final class a implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final WeakReference<AuthActivity> f1084a;
        ...
        private a(AuthActivity authActivity) {
            this.f1084a = new WeakReference<>(authActivity);
        }

        public void run() {
            AuthActivity authActivity = (AuthActivity) this.f1084a.get();
    ...
    public void a() {
        try {
            if (this.e == null) {
                this.e = new com.alipay.sdk.widget.a(this, com.alipay.sdk.widget.a.f1142a);
            }
            this.e.b();
