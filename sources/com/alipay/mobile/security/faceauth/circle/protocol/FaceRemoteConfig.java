...
public class FaceRemoteConfig {
    ...
    private SceneEnv f1040a = new SceneEnv();
    ...
    public String toString() {
        return "FaceRemoteConfig{sceneEnv=" + this.f1040a + ", navi=" + this.b + ", coll=" + this.c + ", upload=" + this.d + ", algorithm=" + this.e + ", faceTips=" + this.f + ", deviceSettings=" + StringUtil.array2String(this.g) + ", env=" + this.h + ", ui=" + this.i + Operators.BLOCK_END;
    }
}
