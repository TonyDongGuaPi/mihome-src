...
public class Coll {
    ...
    public String toString() {
        return "Coll{retry=" + this.f985a + ", minangle=" + this.b + ", maxangle=" + this.c + ", near=" + this.d + ", far=" + this.e + ", minlight=" + this.f + ", time=" + this.g + ", light=" + this.h + ", imageIndex=" + this.i + ", mineDscore=" + this.j + ", mineVideo=" + this.k + ", topText='" + this.l + Operators.SINGLE_QUOTE + ", bottomText='" + this.m + Operators.SINGLE_QUOTE + ", topText_noface='" + this.n + Operators.SINGLE_QUOTE + ", topText_light='" + this.o + Operators.SINGLE_QUOTE + ", topText_rectwidth='" + this.p + Operators.SINGLE_QUOTE + ", topText_integrity='" + this.q + Operators.SINGLE_QUOTE + ", topText_angle='" + this.r + Operators.SINGLE_QUOTE + ", topText_blur='" + this.s + Operators.SINGLE_QUOTE + ", topText_quality='" + this.t + Operators.SINGLE_QUOTE + ", topText_blink='" + this.u + Operators.SINGLE_QUOTE + ", topText_stay='" + this.v + Operators.SINGLE_QUOTE + ", topText_max_rectwidth='" + this.w + Operators.SINGLE_QUOTE + ", uploadMonitorPic=" + this.x + ", uploadLivePic=" + this.y + ", progressbar=" + this.z + ", uploadBestPic=" + this.A + ", uploadPoseOkPic=" + this.B + ", uploadBigPic=" + this.C + ", uploadDepthData=" + this.D + ", actionMode=" + Arrays.toString(this.F) + Operators.BLOCK_END;
    }
