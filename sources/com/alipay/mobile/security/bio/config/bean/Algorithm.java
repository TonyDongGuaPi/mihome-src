...
public class Algorithm {
    ...
    public String toString() {
        return "Algorithm{differ=" + this.f984a + ", eyeHwratio=" + this.b + ", blink=" + this.c + ", mouth=" + this.d + ", facesize=" + this.e + ", yunqiQuality=" + this.f + ", minpose=" + this.g + ", disWeight=" + this.h + ", yawWeight=" + this.i + ", pitchWeight=" + this.j + ", liveness_combinations='" + this.k + Operators.SINGLE_QUOTE + ", matching_score=" + this.l + ", pose_motion=" + this.m + ", pose_rectwidth=" + this.n + ", pose_pitch=" + this.o + ", pose_yaw=" + this.p + ", pose_light=" + this.q + ", pose_integrity=" + this.r + ", pose_gaussian=" + this.s + ", pose_distanceMin=" + this.t + ", pose_distanceMax=" + this.u + ", pose_yawMin=" + this.v + ", pose_pitchMin=" + this.w + ", log_level=" + this.x + ", quality_min_quality=" + this.y + ", stack_size=" + this.z + ", stack_time=" + this.A + ", batLivenessThreshold=" + this.B + ", liveness_combination=" + Arrays.toString(this.C) + ", threshold=" + this.D + Operators.BLOCK_END;
    }
}
