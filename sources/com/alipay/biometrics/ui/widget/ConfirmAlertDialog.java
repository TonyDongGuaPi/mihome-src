...
public class ConfirmAlertDialog extends Dialog {
    ...
    public ConfirmAlertDialog(Context context, String str, String str2, String str3) {
        super(context, a.e.ConfirmAlertDialog);
    ...
    public void init() {
        View inflate = LayoutInflater.from(this.mContext).inflate(a.d.bio_alert_dialog, (ViewGroup) null);
        try {
    ...
    private class SetDialogContext {
        ...
        public SetDialogContext invoke() {
            ...
            this.tvMessage = (TextView) this.view.findViewById(a.c.dialog_msg);
            View findViewById = this.view.findViewById(a.c.dialog_split);
            View unused = ConfirmAlertDialog.this.mBtnPositive = ConfirmAlertDialog.this.findViewById(a.c.dialog_ok);
            View unused2 = ConfirmAlertDialog.this.mBtnNegative = ConfirmAlertDialog.this.findViewById(a.c.dialog_cancel);
            View unused3 = ConfirmAlertDialog.this.mIconsContainer = ConfirmAlertDialog.this.findViewById(a.c.dialog_msg_icons);
            View unused4 = ConfirmAlertDialog.this.mButtonsContainer = ConfirmAlertDialog.this.findViewById(a.c.dialog_button_container);
            initSubView((TextView) this.view.findViewById(a.c.dialog_ok_text), (TextView) this.view.findViewById(a.c.dialog_cancel_text), (TextView) this.view.findViewById(a.c.dialog_msg_2), (TextView) this.view.findViewById(a.c.dialog_title), findViewById, true);
