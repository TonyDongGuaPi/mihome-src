...
public class CircleFrameLayout extends FrameLayout {
    ...
    public CircleFrameLayout(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a.f.bio_circle_frrameLayout);
        this.isEnable = obtainStyledAttributes.getBoolean(a.f.bio_circle_frrameLayout_bio_facesdk_enabled, false);
    ...
    public void dispatchDraw(Canvas canvas) {
        if (this.isEnable) {
            ...
            Path path = new Path();
            path.addCircle(this.circleX, this.circleY, this.circleX, Path.Direction.CCW);
