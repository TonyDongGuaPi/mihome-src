...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    static class AdSwitchTask implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final WeakReference<ConvenientBanner> f4789a;

        AdSwitchTask(ConvenientBanner convenientBanner) {
            this.f4789a = new WeakReference<>(convenientBanner);
        }

        public void run() {
            ConvenientBanner convenientBanner = (ConvenientBanner) this.f4789a.get();
    ...
    public ConvenientBanner setPages(CBViewHolderCreator cBViewHolderCreator, List<T> list) {
        this.f4788a = list;
        this.f = new CBPageAdapter(cBViewHolderCreator, this.f4788a);
    ...
    public ConvenientBanner setPageIndicator(int[] iArr) {
        ...
        for (int i2 = 0; i2 < this.f4788a.size(); i2++) {
