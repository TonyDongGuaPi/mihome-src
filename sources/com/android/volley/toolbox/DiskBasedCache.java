...
public class DiskBasedCache implements Cache {
    ...
    public synchronized com.android.volley.Cache.Entry get(java.lang.String r9) {
        ...
        L_0x000e:
            ...
            com.android.volley.Cache$Entry r0 = r0.toCacheEntry(r4)     // Catch:{ IOException -> 0x0039 }
    ...
    public synchronized void initialize() {
        /*
            r8 = this;
            monitor-enter(r8)
            java.io.File r0 = r8.mRootDirectory     // Catch:{ all -> 0x0069 }
            ...
            java.io.File r3 = r8.mRootDirectory     // Catch:{ all -> 0x0069 }
            java.lang.String r3 = r3.getAbsolutePath()     // Catch:{ all -> 0x0069 }
            r2[r1] = r3     // Catch:{ all -> 0x0069 }
            com.android.volley.VolleyLog.e(r0, r2)     // Catch:{ all -> 0x0069 }
        L_0x0022:
            monitor-exit(r8)
            return
        L_0x0024:
            java.io.File r0 = r8.mRootDirectory     // Catch:{ all -> 0x0069 }
            java.io.File[] r0 = r0.listFiles()     // Catch:{ all -> 0x0069 }
        ...
        L_0x002f:
            ...
            r3 = r0[r1]     // Catch:{ all -> 0x0069 }
            r4 = 0
            java.io.FileInputStream r5 = new java.io.FileInputStream     // Catch:{ IOException -> 0x0053 }
            r5.<init>(r3)     // Catch:{ IOException -> 0x0053 }
            com.android.volley.toolbox.DiskBasedCache$CacheHeader r4 = com.android.volley.toolbox.DiskBasedCache.CacheHeader.readHeader(r5)     // Catch:{ IOException -> 0x004e, all -> 0x004c }
            long r6 = r3.length()     // Catch:{ IOException -> 0x004e, all -> 0x004c }
            r4.size = r6     // Catch:{ IOException -> 0x004e, all -> 0x004c }
            java.lang.String r6 = r4.key     // Catch:{ IOException -> 0x004e, all -> 0x004c }
            r8.putEntry(r6, r4)     // Catch:{ IOException -> 0x004e, all -> 0x004c }
