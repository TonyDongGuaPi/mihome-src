...
public class CrashReport {
    ...
    public static CrashReport initialize(Context context2) {
        return initialize(context2, (String) null);
    }
    ...
    public static void postCrash(Thread thread, Throwable th) {
        if (!isForSdk) {
            get().sendCrashData(thread, th, (String) null);
        }
    }

    public static void postCrash(Throwable th) {
        if (!isForSdk) {
            get().sendCrashData((Thread) null, th, (String) null);
        }
    }
    ...
    public static void postRNCrash(Throwable th, String str) {
        if (!isForSdk) {
            get().sendCrashData((Thread) null, th, str);
        }
    }
    ...
    public static class Builder {
        ...
        public CrashReport build() {
            boolean unused = CrashReport.isForSdk = this.isForSdk;
