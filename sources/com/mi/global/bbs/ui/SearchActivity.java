...
public class SearchActivity extends BaseActivity implements SearchKeyAdapter.OnSearchListener {
    ...
    /* access modifiers changed from: private */
    public SearchFragment userFragment;
    ...
    private void initResultView() {
        ...
        this.threadFragment = SearchFragment.newInstance(0);
        arrayList.add(this.threadFragment);
        this.userFragment = SearchFragment.newInstance(1);
    ...
    private void setSearchEditView() {
        ...
        this.searchView.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            public boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                ...
                SearchActivity.this.search(SearchActivity.this.getSearchKey());
                return false;
            }
        });
