...
import com.mi.global.shop.base.utils.FontUtil;
...
public class BadgeView extends CustomTextView {
    ...
    public BadgeView(Context context, View view) {
        this(context, (AttributeSet) null, 16842884, view, 0);
    }

    public BadgeView(Context context, TabWidget tabWidget, int i) {
        this(context, (AttributeSet) null, 16842884, tabWidget, i);
    }

    public BadgeView(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, (View) null, 0);
    }
    ...
    private void init(Context context, View view, int i) {
        ...
        mFadeInAnim.setInterpolator(new DecelerateInterpolator());
        mFadeInAnim.setDuration(200);
        mFadeOutAnim = new AlphaAnimation(1.0f, 0.0f);
        mFadeOutAnim.setInterpolator(new AccelerateInterpolator());
    ...
    private void applyLayoutParams() {
        ...
        if (this.mCounterHeight > 0.0f) {
            layoutParams = new FrameLayout.LayoutParams(-2, dipToPixels(this.mCounterHeight));
        } else {
