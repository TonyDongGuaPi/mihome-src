...
public class SearchResultListAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            view = LayoutInflater.from(this.mContext).inflate(R.layout.feature_search_search_result_item, viewGroup, false);
        ...
        if (TextUtils.isEmpty(dataBean.image)) {
            ...
            if (!TextUtils.isEmpty(dataBean.price)) {
                ...
                customTextView.setText(this.localeService.b() + dataBean.price);
            } else {
            ...
            if (!TextUtils.isEmpty(dataBean.price_before)) {
                ...
                customTextView2.setText(this.localeService.b() + dataBean.price_before);
            } else {
                titleViewHolder.itemOldPrice.setVisibility(8);
            }
            ImageLoader.a().a(dataBean.image, (ImageView) titleViewHolder.itemImage);
        }
        return view;
    }
