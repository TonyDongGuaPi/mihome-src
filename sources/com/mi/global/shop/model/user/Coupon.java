...
public final class Coupon extends Message<Coupon, Builder> {
    ...
    public Coupon(Integer num, String str, Coupons coupons) {
        this(num, str, coupons, ByteString.EMPTY);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Internal.equals(unknownFields(), coupon.unknownFields()) || !Internal.equals(this.errno, coupon.errno) || !Internal.equals(this.errmsg, coupon.errmsg) || !Internal.equals(this.data, coupon.data)) {
            return false;
        }
        return true;
    }
    ...
    public static final class Builder extends Message.Builder<Coupon, Builder> {
        ...
        public Builder data(Coupons coupons) {
            this.data = coupons;
            return this;
        }
    ...
    private static final class ProtoAdapter_Coupon extends ProtoAdapter<Coupon> {
        ...
        public int encodedSize(Coupon coupon) {
            ...
            return encodedSizeWithTag + i + coupon.unknownFields().size();
        }
