...
public final class CouponData extends Message<CouponData, Builder> {
    ...
    public static final String DEFAULT_COUPONNAMEDESC = "";
    ...
    public static final String DEFAULT_USABLERANGE = "";
    public static final String DEFAULT_VALUE = "";
    public static final String DEFAULT_VALUEDESC = "";
    ...
    public CouponData(String str, String str2, Integer num, Integer num2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11) {
        this(str, str2, num, num2, str3, str4, str5, str6, str7, str8, str9, str10, str11, ByteString.EMPTY);
    }
    ...
    public int hashCode() {
        ...
        int i2 = 0;
        int hashCode = ((((((((((((((((((((((((unknownFields().hashCode() * 37) + (this.couponId != null ? this.couponId.hashCode() : 0)) * 37) + (this.value != null ? this.value.hashCode() : 0)) * 37) + (this.beginTime != null ? this.beginTime.hashCode() : 0)) * 37) + (this.endTime != null ? this.endTime.hashCode() : 0)) * 37) + (this.couponName != null ? this.couponName.hashCode() : 0)) * 37) + (this.couponNameDesc != null ? this.couponNameDesc.hashCode() : 0)) * 37) + (this.stat != null ? this.stat.hashCode() : 0)) * 37) + (this.additional != null ? this.additional.hashCode() : 0)) * 37) + (this.type != null ? this.type.hashCode() : 0)) * 37) + (this.type_id != null ? this.type_id.hashCode() : 0)) * 37) + (this.order_id != null ? this.order_id.hashCode() : 0)) * 37) + (this.valueDesc != null ? this.valueDesc.hashCode() : 0)) * 37;
        if (this.usableRange != null) {
            i2 = this.usableRange.hashCode();
        }
        int i3 = hashCode + i2;
        this.hashCode = i3;
        return i3;
    ...
    public static final class Builder extends Message.Builder<CouponData, Builder> {
        ...
        public Builder couponNameDesc(String str) {
        ...
        public Builder valueDesc(String str) {
            this.valueDesc = str;
            return this;
        }

        public Builder usableRange(String str) {
    ...
    private static final class ProtoAdapter_CouponData extends ProtoAdapter<CouponData> {
        ProtoAdapter_CouponData() {
            super(FieldEncoding.LENGTH_DELIMITED, CouponData.class);
        }

        public int encodedSize(CouponData couponData) {
            int i = 0;
            ...
            return encodedSizeWithTag + i + couponData.unknownFields().size();
        }

        public void encode(ProtoWriter protoWriter, CouponData couponData) throws IOException {
        ...
        public CouponData decode(ProtoReader protoReader) throws IOException {
            Builder builder = new Builder();
        ...
        public CouponData redact(CouponData couponData) {
