...
public final class ResultData extends Message<ResultData, Builder> {
    ...
    public ResultData(Integer num, String str, Result result) {
        this(num, str, result, ByteString.EMPTY);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Internal.equals(unknownFields(), resultData.unknownFields()) || !Internal.equals(this.errno, resultData.errno) || !Internal.equals(this.errmsg, resultData.errmsg) || !Internal.equals(this.data, resultData.data)) {
            return false;
        }
        return true;
    }
    ...
    public static final class Builder extends Message.Builder<ResultData, Builder> {
        ...
        public Builder data(Result result) {
            this.data = result;
            return this;
        }
