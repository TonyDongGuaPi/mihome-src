...
public class UserInfo implements Parcelable {
    ...
    public String toString() {
        return "UserInfo{mUserId='" + this.mUserId + Operators.SINGLE_QUOTE + ", mUserName='" + this.mUserName + Operators.SINGLE_QUOTE + ", mAvatarUrl='" + this.mAvatarUrl + Operators.SINGLE_QUOTE + ", mTips=" + this.mTips + Operators.BLOCK_END;
    }
}
