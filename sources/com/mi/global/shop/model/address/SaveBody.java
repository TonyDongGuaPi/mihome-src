...
public final class SaveBody extends Message<SaveBody, Builder> {
    ...
    public SaveBody(Integer num, String str, ResultData resultData) {
        this(num, str, resultData, ByteString.EMPTY);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Internal.equals(unknownFields(), saveBody.unknownFields()) || !Internal.equals(this.errno, saveBody.errno) || !Internal.equals(this.errmsg, saveBody.errmsg) || !Internal.equals(this.data, saveBody.data)) {
            return false;
        }
        return true;
    }
    ...
    public static final class Builder extends Message.Builder<SaveBody, Builder> {
        ...
        public Builder data(ResultData resultData) {
            this.data = resultData;
            return this;
        }

        public SaveBody build() {
            return new SaveBody(this.errno, this.errmsg, this.data, buildUnknownFields());
        }
    }

    private static final class ProtoAdapter_SaveBody extends ProtoAdapter<SaveBody> {
        ProtoAdapter_SaveBody() {
            super(FieldEncoding.LENGTH_DELIMITED, SaveBody.class);
        }

        public int encodedSize(SaveBody saveBody) {
            int i = 0;
            ...
            return encodedSizeWithTag + i + saveBody.unknownFields().size();
        }

        public void encode(ProtoWriter protoWriter, SaveBody saveBody) throws IOException {
        ...
        public SaveBody decode(ProtoReader protoReader) throws IOException {
            Builder builder = new Builder();
        ...
        public SaveBody redact(SaveBody saveBody) {
