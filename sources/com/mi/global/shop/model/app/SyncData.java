...
public final class SyncData extends Message<SyncData, Builder> {
    ...
    public static final Boolean DEFAULT_SUBWARHOUSE = false;
    ...
    public SyncData(VerInfo verInfo, StPage stPage, PackInfo packInfo, CacheConf cacheConf, ActivityConf activityConf, List<String> list, List<String> list2, List<String> list3, List<String> list4, Resurfacing resurfacing, Boolean bool, CentralHeader centralHeader2, PageMessage pageMessage, List<PushType> list5, PassPortInfo passPortInfo2, SwitchInfo switchInfo2) {
        this(verInfo, stPage, packInfo, cacheConf, activityConf, list, list2, list3, list4, resurfacing, bool, centralHeader2, pageMessage, list5, passPortInfo2, switchInfo2, ByteString.EMPTY);
    }
    ...
    public SyncData(VerInfo verInfo, StPage stPage, PackInfo packInfo, CacheConf cacheConf, ActivityConf activityConf, List<String> list, List<String> list2, List<String> list3, List<String> list4, Resurfacing resurfacing, Boolean bool, CentralHeader centralHeader2, PageMessage pageMessage, List<PushType> list5, PassPortInfo passPortInfo2, SwitchInfo switchInfo2, ByteString byteString) {
        ...
        this.download = Internal.immutableCopyOf(Constants.TitleMenu.MENU_DOWNLOAD, list);
    ...
    public Builder newBuilder() {
        ...
        builder.download = Internal.copyOf(Constants.TitleMenu.MENU_DOWNLOAD, this.download);
    ...
    public int hashCode() {
        ...
        int i2 = 0;
        int i3 = 1;
        int hashCode = ((((((((((((((((((((((((((unknownFields().hashCode() * 37) + (this.versionInfo != null ? this.versionInfo.hashCode() : 0)) * 37) + (this.startPage != null ? this.startPage.hashCode() : 0)) * 37) + (this.packageInfo != null ? this.packageInfo.hashCode() : 0)) * 37) + (this.cacheConfig != null ? this.cacheConfig.hashCode() : 0)) * 37) + (this.activityConfig != null ? this.activityConfig.hashCode() : 0)) * 37) + (this.download != null ? this.download.hashCode() : 1)) * 37) + (this.inBrowserUrls != null ? this.inBrowserUrls.hashCode() : 1)) * 37) + (this.inHardAccelerUrls != null ? this.inHardAccelerUrls.hashCode() : 1)) * 37) + (this.inAppUrls != null ? this.inAppUrls.hashCode() : 1)) * 37) + (this.resurface != null ? this.resurface.hashCode() : 0)) * 37) + (this.subWarhouse != null ? this.subWarhouse.hashCode() : 0)) * 37) + (this.centralHeader != null ? this.centralHeader.hashCode() : 0)) * 37) + (this.pagemsg != null ? this.pagemsg.hashCode() : 0)) * 37;
        if (this.pushTypeList != null) {
            i3 = this.pushTypeList.hashCode();
        }
        int hashCode2 = (((hashCode + i3) * 37) + (this.passPortInfo != null ? this.passPortInfo.hashCode() : 0)) * 37;
        if (this.switchInfo != null) {
            i2 = this.switchInfo.hashCode();
        }
        int i4 = hashCode2 + i2;
        this.hashCode = i4;
        return i4;
    ...
    public static final class Builder extends Message.Builder<SyncData, Builder> {
        ...
        public Builder centralHeader(CentralHeader centralHeader2) {
            this.centralHeader = centralHeader2;
            return this;
        }
        ...
        public Builder switchInfo(SwitchInfo switchInfo2) {
            this.switchInfo = switchInfo2;
            return this;
        }
    ...
    private static final class ProtoAdapter_SyncData extends ProtoAdapter<SyncData> {
        ...
        public int encodedSize(SyncData syncData) {
            ...
            return encodedSizeWithTag + i + syncData.unknownFields().size();
        }

        public void encode(ProtoWriter protoWriter, SyncData syncData) throws IOException {
        ...
        public SyncData decode(ProtoReader protoReader) throws IOException {
            Builder builder = new Builder();
