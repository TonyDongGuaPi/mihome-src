...
public final class BlockData extends Message<BlockData, Builder> {
    ...
    public int hashCode() {
        ...
        int i2 = 1;
        int hashCode = ((((((((((((((((unknownFields().hashCode() * 37) + (this.gallery != null ? this.gallery.hashCode() : 1)) * 37) + (this.products != null ? this.products.hashCode() : 1)) * 37) + (this.index_ad != null ? this.index_ad.hashCode() : 1)) * 37) + (this.hotbuy != null ? this.hotbuy.hashCode() : 1)) * 37) + (this.gamerecommend != null ? this.gamerecommend.hashCode() : 1)) * 37) + (this.phonelist != null ? this.phonelist.hashCode() : 1)) * 37) + (this.accessorieslist != null ? this.accessorieslist.hashCode() : 1)) * 37) + (this.productrecommend != null ? this.productrecommend.hashCode() : 1)) * 37;
        if (this.hdrecommend != null) {
            i2 = this.hdrecommend.hashCode();
        }
        int i3 = hashCode + i2;
        this.hashCode = i3;
        return i3;
    ...
    private static final class ProtoAdapter_BlockData extends ProtoAdapter<BlockData> {
        ...
        public void encode(ProtoWriter protoWriter, BlockData blockData) throws IOException {
        ...
        public BlockData decode(ProtoReader protoReader) throws IOException {
            Builder builder = new Builder();
