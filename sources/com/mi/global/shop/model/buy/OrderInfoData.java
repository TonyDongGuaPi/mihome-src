...
public final class OrderInfoData extends Message<OrderInfoData, Builder> {
    ...
    public OrderInfoData(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, List<OrderItemsData> list, String str10) {
        this(str, str2, str3, str4, str5, str6, str7, str8, str9, list, str10, ByteString.EMPTY);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Internal.equals(unknownFields(), orderInfoData.unknownFields()) || !Internal.equals(this.order_id, orderInfoData.order_id) || !Internal.equals(this.consignee, orderInfoData.consignee) || !Internal.equals(this.address, orderInfoData.address) || !Internal.equals(this.zipcode, orderInfoData.zipcode) || !Internal.equals(this.tel, orderInfoData.tel) || !Internal.equals(this.goods_amount, orderInfoData.goods_amount) || !Internal.equals(this.original_price, orderInfoData.original_price) || !Internal.equals(this.shipment_expense, orderInfoData.shipment_expense) || !Internal.equals(this.reduce_price, orderInfoData.reduce_price) || !Internal.equals(this.orderItems, orderInfoData.orderItems) || !Internal.equals(this.remaining_time, orderInfoData.remaining_time)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        int i2 = 0;
        int hashCode = ((((((((((((((((((((unknownFields().hashCode() * 37) + (this.order_id != null ? this.order_id.hashCode() : 0)) * 37) + (this.consignee != null ? this.consignee.hashCode() : 0)) * 37) + (this.address != null ? this.address.hashCode() : 0)) * 37) + (this.zipcode != null ? this.zipcode.hashCode() : 0)) * 37) + (this.tel != null ? this.tel.hashCode() : 0)) * 37) + (this.goods_amount != null ? this.goods_amount.hashCode() : 0)) * 37) + (this.original_price != null ? this.original_price.hashCode() : 0)) * 37) + (this.shipment_expense != null ? this.shipment_expense.hashCode() : 0)) * 37) + (this.reduce_price != null ? this.reduce_price.hashCode() : 0)) * 37) + (this.orderItems != null ? this.orderItems.hashCode() : 1)) * 37;
    ...
    public static final class Builder extends Message.Builder<OrderInfoData, Builder> {
        ...
        public Builder orderItems(List<OrderItemsData> list) {
    ...
    private static final class ProtoAdapter_OrderInfoData extends ProtoAdapter<OrderInfoData> {
        ProtoAdapter_OrderInfoData() {
            super(FieldEncoding.LENGTH_DELIMITED, OrderInfoData.class);
        }

        public int encodedSize(OrderInfoData orderInfoData) {
            int i = 0;
            ...
            return encodedSizeWithTag + i + orderInfoData.unknownFields().size();
        }

        public void encode(ProtoWriter protoWriter, OrderInfoData orderInfoData) throws IOException {
        ...
        public OrderInfoData decode(ProtoReader protoReader) throws IOException {
            Builder builder = new Builder();
        ...
        public OrderInfoData redact(OrderInfoData orderInfoData) {
