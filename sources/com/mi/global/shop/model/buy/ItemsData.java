...
public final class ItemsData extends Message<ItemsData, Builder> {
    ...
    public ItemsData(String str, String str2, String str3, Integer num2, String str4, String str5, String str6, String str7, String str8, String str9, String str10, Boolean bool, String str11, String str12, String str13, PropertiesData propertiesData, Boolean bool2) {
        this(str, str2, str3, num2, str4, str5, str6, str7, str8, str9, str10, bool, str11, str12, str13, propertiesData, bool2, ByteString.EMPTY);
    }
    ...
    public int hashCode() {
        ...
        int i2 = 0;
        int hashCode = ((((((((((((((((((((((((((((((((unknownFields().hashCode() * 37) + (this.itemId != null ? this.itemId.hashCode() : 0)) * 37) + (this.goodsId != null ? this.goodsId.hashCode() : 0)) * 37) + (this.getType != null ? this.getType.hashCode() : 0)) * 37) + (this.num != null ? this.num.hashCode() : 0)) * 37) + (this.salePrice != null ? this.salePrice.hashCode() : 0)) * 37) + (this.commodity_id != null ? this.commodity_id.hashCode() : 0)) * 37) + (this.goods_dealer != null ? this.goods_dealer.hashCode() : 0)) * 37) + (this.subtotal != null ? this.subtotal.hashCode() : 0)) * 37) + (this.product_name != null ? this.product_name.hashCode() : 0)) * 37) + (this.image_url != null ? this.image_url.hashCode() : 0)) * 37) + (this.showType != null ? this.showType.hashCode() : 0)) * 37) + (this.item_timeout != null ? this.item_timeout.hashCode() : 0)) * 37) + (this.item_type_name != null ? this.item_type_name.hashCode() : 0)) * 37) + (this.salePrice_txt != null ? this.salePrice_txt.hashCode() : 0)) * 37) + (this.subtotal_txt != null ? this.subtotal_txt.hashCode() : 0)) * 37) + (this.properties != null ? this.properties.hashCode() : 0)) * 37;
        if (this.isInsurance != null) {
            i2 = this.isInsurance.hashCode();
        }
        int i3 = hashCode + i2;
        this.hashCode = i3;
        return i3;
