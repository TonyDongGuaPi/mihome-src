...
public final class PayWalletData extends Message<PayWalletData, Builder> {
    ...
    public static final String DEFAULT_CHECKSUM_URL = "";
    public static final String DEFAULT_MERCHANT_NAME = "";
    public static final String DEFAULT_MID = "";
    public static final String DEFAULT_ORDER_ID = "";
    public static final String DEFAULT_PAYMENT_TYPE = "";
    public static final String DEFAULT_PG_RESPONSE_URL = "";
    ...
    public int hashCode() {
        ...
        int i2 = 0;
        int hashCode = ((((((((((((((((((((unknownFields().hashCode() * 37) + (this.order_id != null ? this.order_id.hashCode() : 0)) * 37) + (this.amount != null ? this.amount.hashCode() : 0)) * 37) + (this.total_fee != null ? this.total_fee.hashCode() : 0)) * 37) + (this.payment_type != null ? this.payment_type.hashCode() : 0)) * 37) + (this.mid != null ? this.mid.hashCode() : 0)) * 37) + (this.checksum_url != null ? this.checksum_url.hashCode() : 0)) * 37) + (this.pg_response_url != null ? this.pg_response_url.hashCode() : 0)) * 37) + (this.response_code != null ? this.response_code.hashCode() : 0)) * 37) + (this.response_message != null ? this.response_message.hashCode() : 0)) * 37) + (this.sign != null ? this.sign.hashCode() : 0)) * 37;
        if (this.merchant_name != null) {
            i2 = this.merchant_name.hashCode();
        }
        int i3 = hashCode + i2;
        this.hashCode = i3;
        return i3;
    ...
    public static final class Builder extends Message.Builder<PayWalletData, Builder> {
        ...
        public Builder checksum_url(String str) {
            this.checksum_url = str;
            return this;
        }

        public Builder pg_response_url(String str) {
            this.pg_response_url = str;
            return this;
        }

        public Builder response_code(String str) {
    ...
    private static final class ProtoAdapter_PayWalletData extends ProtoAdapter<PayWalletData> {
        ProtoAdapter_PayWalletData() {
            super(FieldEncoding.LENGTH_DELIMITED, PayWalletData.class);
        }

        public int encodedSize(PayWalletData payWalletData) {
            int i = 0;
            ...
            return encodedSizeWithTag + i + payWalletData.unknownFields().size();
        }

        public void encode(ProtoWriter protoWriter, PayWalletData payWalletData) throws IOException {
        ...
        public PayWalletData decode(ProtoReader protoReader) throws IOException {
            Builder builder = new Builder();
        ...
        public PayWalletData redact(PayWalletData payWalletData) {
