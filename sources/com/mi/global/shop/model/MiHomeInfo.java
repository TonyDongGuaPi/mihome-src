...
public class MiHomeInfo {
    ...
    public static ArrayList<MiHomeInfo> fromJSONObject(JSONObject jSONObject) throws JSONException {
        ...
        if (Tags.isJSONResultOK(jSONObject) && (jSONObject2 = jSONObject.getJSONObject("data")) != null) {
            arrayList.add(new MiHomeInfo(jSONObject2.getString("name"), jSONObject2.getString("address"), jSONObject2.getString("tel"), jSONObject2.getString("city_name"), jSONObject2.getInt("city"), jSONObject2.getString(Tags.MiHome.PROVINCE_NAME), jSONObject2.getInt("province"), jSONObject2.getInt("home_id"), jSONObject2.getString("longitude_latitude"), jSONObject2.getInt("reserve")));
        }
        return arrayList;
    }
}
