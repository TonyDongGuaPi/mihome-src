...
public class HomeThemeItem implements Serializable {
    ...
    public String toString() {
        return "HomeThemeItem{mBigImageUrl=" + this.mBigImageUrl + ", mColumn=" + this.mColumn + ", mColumnSpan=" + this.mColumnSpan + ", mRow=" + this.mRow + ", mRowSpan=" + this.mRowSpan + ", mProductId=" + this.mProductId + ", mProductName=" + this.mProductName + ", mProductPrice=" + this.mProductPrice + ", mProductMarketPrice=" + this.mProductMarketPrice + ", mImageUrl=" + this.mImageUrl + ", mOpenType=" + this.mOpenType + ", mLinkUrl=" + this.mLinkUrl + Operators.BLOCK_END;
    }
}
