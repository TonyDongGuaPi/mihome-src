...
public final class ActivitysData extends Message<ActivitysData, Builder> {
    ...
    public ActivitysData(List<GiftData> list, List<ReductionData> list2, List<CouponsData> list3, PostFreeData postFreeData) {
        this(list, list2, list3, postFreeData, ByteString.EMPTY);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Internal.equals(unknownFields(), activitysData.unknownFields()) || !Internal.equals(this.gift, activitysData.gift) || !Internal.equals(this.reduction, activitysData.reduction) || !Internal.equals(this.coupons, activitysData.coupons) || !Internal.equals(this.postFree, activitysData.postFree)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        int i2 = 1;
        int hashCode = ((((unknownFields().hashCode() * 37) + (this.gift != null ? this.gift.hashCode() : 1)) * 37) + (this.reduction != null ? this.reduction.hashCode() : 1)) * 37;
        if (this.coupons != null) {
            i2 = this.coupons.hashCode();
        }
        int hashCode2 = ((hashCode + i2) * 37) + (this.postFree != null ? this.postFree.hashCode() : 0);
    ...
    private static final class ProtoAdapter_ActivitysData extends ProtoAdapter<ActivitysData> {
        ...
        public void encode(ProtoWriter protoWriter, ActivitysData activitysData) throws IOException {
        ...
        public ActivitysData decode(ProtoReader protoReader) throws IOException {
            Builder builder = new Builder();
