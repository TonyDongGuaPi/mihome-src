...
public final class ActivityContent extends Message<ActivityContent, Builder> {
    ...
    public ActivityContent(String str, String str2, BombBox bombBox, String str3, String str4) {
        this(str, str2, bombBox, str3, str4, ByteString.EMPTY);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Internal.equals(unknownFields(), activityContent.unknownFields()) || !Internal.equals(this.prompt, activityContent.prompt) || !Internal.equals(this.icon, activityContent.icon) || !Internal.equals(this.bombbox, activityContent.bombbox) || !Internal.equals(this.starttime, activityContent.starttime) || !Internal.equals(this.endtime, activityContent.endtime)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        int i2 = 0;
        int hashCode = ((((((((unknownFields().hashCode() * 37) + (this.prompt != null ? this.prompt.hashCode() : 0)) * 37) + (this.icon != null ? this.icon.hashCode() : 0)) * 37) + (this.bombbox != null ? this.bombbox.hashCode() : 0)) * 37) + (this.starttime != null ? this.starttime.hashCode() : 0)) * 37;
        if (this.endtime != null) {
            i2 = this.endtime.hashCode();
        }
        int i3 = hashCode + i2;
        this.hashCode = i3;
        return i3;
    ...
    private static final class ProtoAdapter_ActivityContent extends ProtoAdapter<ActivityContent> {
        ...
        public int encodedSize(ActivityContent activityContent) {
            ...
            return encodedSizeWithTag + i + activityContent.unknownFields().size();
        }
