...
public final class AddrIndiaData extends Message<AddrIndiaData, Builder> {
    ...
    public boolean equals(Object obj) {
        ...
        if (!Internal.equals(unknownFields(), addrIndiaData.unknownFields()) || !Internal.equals(this.addr, addrIndiaData.addr) || !Internal.equals(this.landmark, addrIndiaData.landmark) || !Internal.equals(this.city, addrIndiaData.city)) {
            return false;
        }
        return true;
    }
    ...
    private static final class ProtoAdapter_AddrIndiaData extends ProtoAdapter<AddrIndiaData> {
        ...
        public int encodedSize(AddrIndiaData addrIndiaData) {
            ...
            return encodedSizeWithTag + i + addrIndiaData.unknownFields().size();
        }

        public void encode(ProtoWriter protoWriter, AddrIndiaData addrIndiaData) throws IOException {
        ...
        public AddrIndiaData decode(ProtoReader protoReader) throws IOException {
            Builder builder = new Builder();
