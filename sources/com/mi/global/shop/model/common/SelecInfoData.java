...
public final class SelecInfoData extends Message<SelecInfoData, Builder> {
    ...
    public SelecInfoData(Boolean bool, String str, String str2, String str3, String str4, List<String> list, String str5, String str6, String str7, String str8) {
        this(bool, str, str2, str3, str4, list, str5, str6, str7, str8, ByteString.EMPTY);
    }
    ...
    public int hashCode() {
        ...
        int i2 = 0;
        int hashCode = ((((((((((((((((((unknownFields().hashCode() * 37) + (this.is_cos != null ? this.is_cos.hashCode() : 0)) * 37) + (this.product_id != null ? this.product_id.hashCode() : 0)) * 37) + (this.commodity_id != null ? this.commodity_id.hashCode() : 0)) * 37) + (this.product_name != null ? this.product_name.hashCode() : 0)) * 37) + (this.image_url != null ? this.image_url.hashCode() : 0)) * 37) + (this.adapt != null ? this.adapt.hashCode() : 1)) * 37) + (this.style_value != null ? this.style_value.hashCode() : 0)) * 37) + (this.goodsId != null ? this.goodsId.hashCode() : 0)) * 37) + (this.salePrice != null ? this.salePrice.hashCode() : 0)) * 37;
        if (this.actId != null) {
            i2 = this.actId.hashCode();
        }
        int i3 = hashCode + i2;
        this.hashCode = i3;
        return i3;
    ...
    private static final class ProtoAdapter_SelecInfoData extends ProtoAdapter<SelecInfoData> {
        ProtoAdapter_SelecInfoData() {
            super(FieldEncoding.LENGTH_DELIMITED, SelecInfoData.class);
        }

        public int encodedSize(SelecInfoData selecInfoData) {
            int i = 0;
            ...
            return encodedSizeWithTag + i + selecInfoData.unknownFields().size();
        }

        public void encode(ProtoWriter protoWriter, SelecInfoData selecInfoData) throws IOException {
        ...
        public SelecInfoData decode(ProtoReader protoReader) throws IOException {
            Builder builder = new Builder();
        ...
        public SelecInfoData redact(SelecInfoData selecInfoData) {
