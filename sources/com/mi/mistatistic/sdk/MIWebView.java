...
public class MIWebView extends WebView {
    ...
    private WebViewClient f7317a = new WebViewClient();

    public MIWebView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        setWebViewClient(this.f7317a);
    }
    ...
    public void setWebViewClient(WebViewClient webViewClient) {
        super.setWebViewClient(new MIWebViewClient(webViewClient));
    }
    ...
    class MIWebViewClient extends WebViewClient {
        ...
        public MIWebViewClient() {
        }

        public MIWebViewClient(WebViewClient webViewClient) {
        ...
        public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
            ...
            this.c.put(str, Long.valueOf(TimeUtil.a().b()));
        }
