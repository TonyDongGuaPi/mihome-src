...
public class CommonButton extends FrameLayout {
    ...
    private static final String f7435a = "CommonButton";
    private TextView b;
    private ViewGroup c;
    ...
    private void a(Context context, AttributeSet attributeSet, int i) {
        ...
        try {
            if (!TextUtils.isEmpty(obtainStyledAttributes.getString(R.styleable.v6CommonButton_android_textColor))) {
                this.b.setTextColor(obtainStyledAttributes.getColor(R.styleable.v6CommonButton_android_textColor, R.color.mini_text_white));
            }
            if (!TextUtils.isEmpty(obtainStyledAttributes.getString(R.styleable.v6CommonButton_android_text))) {
                this.b.setText(obtainStyledAttributes.getString(R.styleable.v6CommonButton_android_text));
            }
            if (!TextUtils.isEmpty(obtainStyledAttributes.getString(R.styleable.v6CommonButton_android_textSize))) {
                this.b.setTextSize(0, obtainStyledAttributes.getDimension(R.styleable.v6CommonButton_android_textSize, 14.0f));
            } else {
