...
class ContactsWriteTest implements PermissionTest {
    ...
    private static final String f2413a = "PERMISSION";
    ...
    public boolean a() throws Throwable {
        Cursor query = this.b.query(ContactsContract.Data.CONTENT_URI, new String[]{"raw_contact_id"}, "mimetype=? and data1=?", new String[]{"vnd.android.cursor.item/name", f2413a}, (String) null);
        if (query == null) {
            return false;
        }
    ...
    private boolean b() {
        ...
        contentValues.put("data1", f2413a);
        contentValues.put("data2", f2413a);
