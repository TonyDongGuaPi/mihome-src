...
final class ActivityStubs {
    ...
    static final String f9236a = ActivityStubs.class.getPackage().getName();
    static final String b = (f9236a + "." + ActivityStubs.class.getSimpleName() + "$STDStub_%02X");
    static final String c = (f9236a + "." + ActivityStubs.class.getSimpleName() + "$SGTStub_%02X");
    static final String d = (f9236a + "." + ActivityStubs.class.getSimpleName() + "$SGTKStub_%02X");
    static final String e = (f9236a + "." + ActivityStubs.class.getSimpleName() + "$SIStub_%02X");
    static final String f = "_T";
