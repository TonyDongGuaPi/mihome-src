...
class bc extends SQLiteOpenHelper {
    ...
    public bc(Context context, String str) {
        ...
        if (StatConfig.b()) {
            StatLogger e = au.h;
            e.b((Object) "SQLiteOpenHelper " + this.f9310a);
        }
    }
    ...
    private void a(android.database.sqlite.SQLiteDatabase r10) {
        /*
            ...
            java.lang.String r3 = com.tencent.wxop.stat.common.q.b((java.lang.String) r0)     // Catch:{ Throwable -> 0x0048, all -> 0x0046 }
        ...
        L_0x004f:
            ...
            r1.b((java.lang.Throwable) r10)     // Catch:{ all -> 0x004b }
    ...
    private void b(android.database.sqlite.SQLiteDatabase r12) {
        ...
        L_0x0040:
            ...
            java.lang.String r7 = com.tencent.wxop.stat.common.q.b((java.lang.String) r7)     // Catch:{ Throwable -> 0x0071, all -> 0x006f }
            ...
            long r9 = r5.f9311a     // Catch:{ Throwable -> 0x0071, all -> 0x006f }
        ...
        L_0x0078:
            ...
            r1.b((java.lang.Throwable) r12)     // Catch:{ all -> 0x0074 }
    ...
    public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        StatLogger e = au.h;
        e.i("upgrade DB from oldVersion " + i + " to newVersion " + i2);
        if (i == 1) {
            sQLiteDatabase.execSQL("create table if not exists keyvalues(key TEXT PRIMARY KEY NOT NULL, value TEXT)");
            a(sQLiteDatabase);
            b(sQLiteDatabase);
