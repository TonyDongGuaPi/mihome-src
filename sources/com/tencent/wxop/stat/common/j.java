...
class j extends h {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0058, code lost:
        ...
        r4[1] = r3[(r2 >> 12) & 63];
        r4[2] = r3[(r2 >> 6) & 63];
        r4[3] = r3[r2 & cn.com.fmsh.tsm.business.constants.Constants.TagName.CARD_APP_ACTIVATION_STATUS];
        r5 = r5 - 1;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0094, code lost:
        ...
        r4[r5 + 1] = r3[(r7 >> 12) & 63];
        r4[r5 + 2] = r3[(r7 >> 6) & 63];
        r4[r5 + 3] = r3[r7 & cn.com.fmsh.tsm.business.constants.Constants.TagName.CARD_APP_ACTIVATION_STATUS];
        r5 = r5 + 4;
        r2 = r2 - 1;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:41:0x0120, code lost:
        r1 = r5 + 1;
        r4[r5] = cn.com.fmsh.tsm.business.constants.Constants.TagName.CARD_APP_VERSION;
        r5 = r1 + 1;
        r4[r1] = cn.com.fmsh.tsm.business.constants.Constants.TagName.CARD_APP_VERSION;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:61:0x0197, code lost:
        r1 = r7 + 1;
        r4[r7] = cn.com.fmsh.tsm.business.constants.Constants.TagName.CARD_APP_VERSION;
     */
