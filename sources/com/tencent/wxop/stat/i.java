...
class i {
    ...
    private i(android.content.Context r5) {
        /*
            ...
            r0 = 0
            r4.g = r0
            android.content.Context r5 = r5.getApplicationContext()     // Catch:{ Throwable -> 0x008d }
            f = r5     // Catch:{ Throwable -> 0x008d }
            long r0 = java.lang.System.currentTimeMillis()     // Catch:{ Throwable -> 0x008d }
            r2 = 1000(0x3e8, double:4.94E-321)
            long r0 = r0 / r2
            r4.g = r0     // Catch:{ Throwable -> 0x008d }
            com.tencent.wxop.stat.common.e r5 = new com.tencent.wxop.stat.common.e     // Catch:{ Throwable -> 0x008d }
            r5.<init>()     // Catch:{ Throwable -> 0x008d }
            r4.b = r5     // Catch:{ Throwable -> 0x008d }
            boolean r5 = com.tencent.wxop.stat.StatConfig.b()     // Catch:{ Throwable -> 0x008d }
            if (r5 == 0) goto L_0x006a
            java.lang.String r5 = "org.apache.http.wire"
            java.util.logging.Logger r5 = java.util.logging.Logger.getLogger(r5)     // Catch:{ Throwable -> 0x006a }
            java.util.logging.Level r0 = java.util.logging.Level.FINER     // Catch:{ Throwable -> 0x006a }
            ...
            java.lang.System.setProperty(r5, r0)     // Catch:{ Throwable -> 0x006a }
        L_0x006a:
            org.apache.http.params.BasicHttpParams r5 = new org.apache.http.params.BasicHttpParams     // Catch:{ Throwable -> 0x008d }
            r5.<init>()     // Catch:{ Throwable -> 0x008d }
            r0 = 0
            ...
            org.apache.http.impl.client.DefaultHttpClient r0 = new org.apache.http.impl.client.DefaultHttpClient     // Catch:{ Throwable -> 0x008d }
            r0.<init>(r5)     // Catch:{ Throwable -> 0x008d }
            r4.f9328a = r0     // Catch:{ Throwable -> 0x008d }
            org.apache.http.impl.client.DefaultHttpClient r5 = r4.f9328a     // Catch:{ Throwable -> 0x008d }
            com.tencent.wxop.stat.j r0 = new com.tencent.wxop.stat.j     // Catch:{ Throwable -> 0x008d }
    ...
    private void a(JSONObject jSONObject) {
        try {
            String optString = jSONObject.optString(Constants.MID);
            if (h.b(optString)) {
                if (StatConfig.b()) {
                    StatLogger statLogger = d;
                    statLogger.b((Object) "update mid:" + optString);
                }
                g.a(f).a(optString);
            }
            ...
            if (!jSONObject.isNull("ncts")) {
                ...
                if (StatConfig.b()) {
                    ...
                    statLogger2.b((Object) "server time:" + i + ", diff time:" + currentTimeMillis);
                }
                k.z(f);
    ...
    public void a(com.tencent.wxop.stat.a.e eVar, h hVar) {
    ...
    public void a(java.util.List<?> r10, com.tencent.wxop.stat.h r11) {
        ...
        L_0x0045:
            ...
            java.lang.String r5 = com.tencent.wxop.stat.StatConfig.q()     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
            ...
            boolean r5 = com.tencent.wxop.stat.StatConfig.b()     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
        ...
        L_0x00a0:
            ...
            org.apache.http.impl.client.DefaultHttpClient r6 = r9.f9328a     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
            ...
            goto L_0x0117
        L_0x00d5:
            boolean r6 = com.tencent.wxop.stat.StatConfig.b()     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
            ...
            r6.j(r7)     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
        L_0x00f2:
            ...
            java.lang.String r7 = com.tencent.wxop.stat.StatConfig.l     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
        ...
        L_0x0117:
            ...
            int r8 = com.tencent.wxop.stat.StatConfig.p     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
        ...
        L_0x0153:
            ...
            boolean r0 = com.tencent.wxop.stat.StatConfig.b()     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
            if (r0 == 0) goto L_0x0196
            ...
            r0.j(r1)     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
        L_0x0196:
            ...
            org.apache.http.impl.client.DefaultHttpClient r10 = r9.f9328a     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
            ...
            java.lang.String r7 = r7.toString()     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
            r5.b((java.lang.Object) r7)     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
        L_0x01d9:
            r7 = 0
            ...
            r10.h(r1)     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
        ...
        L_0x01ef:
            ...
            byte[] r10 = com.tencent.wxop.stat.common.k.a((byte[]) r0)     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
        ...
        L_0x0229:
            ...
            byte[] r0 = com.tencent.wxop.stat.common.k.a((byte[]) r10)     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
            goto L_0x025f
        L_0x023e:
            java.lang.String r4 = r10.getValue()     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
            ...
            byte[] r0 = com.tencent.wxop.stat.common.k.a((byte[]) r0)     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
            goto L_0x025f
        L_0x024f:
        ...
        L_0x025f:
            ...
            boolean r4 = com.tencent.wxop.stat.StatConfig.b()     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
            ...
            r4.b((java.lang.Object) r5)     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
        L_0x027f:
        ...
        L_0x0299:
            ...
            r10.g(r0)     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
        L_0x02a0:
            r11.b()     // Catch:{ Throwable -> 0x02d7, all -> 0x02d5 }
            goto L_0x02c9
        L_0x02a4:
