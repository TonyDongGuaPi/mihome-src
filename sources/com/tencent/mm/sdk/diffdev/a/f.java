        ...
        public static a e(byte[] bArr) {
            ...
            if (bArr == null || bArr.length == 0) {
                ...
                try {
                    ...
                    Log.d("MicroMsg.SDK.NoopingResult", String.format("nooping uuidStatusCode = %d", new Object[]{Integer.valueOf(aVar.ay)}));
                    int i = aVar.ay;
                    if (i == 408) {
    ...
    public final /* synthetic */ Object doInBackground(Object[] objArr) {
        ...
        if (this.aq == null || this.aq.length() == 0) {
            ...
            while (!isCancelled()) {
                ...
                a e = a.e(b);
                Log.d("MicroMsg.SDK.NoopingTask", String.format("nooping, url = %s, errCode = %s, uuidStatusCode = %d, time consumed = %d(ms)", new Object[]{sb2, e.ap.toString(), Integer.valueOf(e.ay), Long.valueOf(currentTimeMillis2 - currentTimeMillis)}));
                if (e.ap == OAuthErrCode.WechatAuth_Err_OK) {
                    ...
                    Log.e("MicroMsg.SDK.NoopingTask", String.format("nooping fail, errCode = %s, uuidStatusCode = %d", new Object[]{e.ap.toString(), Integer.valueOf(e.ay)}));
                    return e;
                }
            }
