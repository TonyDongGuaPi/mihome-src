    ...
    public final /* synthetic */ Object doInBackground(Object[] objArr) {
        ...
        if (this.o == null || this.o.length() == 0) {
            ...
            while (!isCancelled()) {
                ...
                a b = a.b(a2);
                Log.d("MicroMsg.SDK.NoopingTask", String.format("nooping, url = %s, errCode = %s, uuidStatusCode = %d, time consumed = %d(ms)", new Object[]{sb2, b.n.toString(), Integer.valueOf(b.w), Long.valueOf(currentTimeMillis2 - currentTimeMillis)}));
