...
public class H5JavaScriptInterface {
    ...
    private static HashSet<Integer> f9020a = new HashSet<>();
    ...
    public static H5JavaScriptInterface getInstance(CrashReport.WebViewInterface webViewInterface) {
        String str = null;
        if (webViewInterface == null || f9020a.contains(Integer.valueOf(webViewInterface.hashCode()))) {
            return null;
        }
        H5JavaScriptInterface h5JavaScriptInterface = new H5JavaScriptInterface();
        f9020a.add(Integer.valueOf(webViewInterface.hashCode()));
    ...
    private static a a(String str) {
        ...
        try {
            ...
            a aVar = new a();
            aVar.f9021a = jSONObject.getString("projectRoot");
            if (aVar.f9021a == null) {
                return null;
            }
            ...
            if (aVar.f != null) {
                if (!aVar.f.equals("null")) {
                    ...
                    aVar.j = jSONObject.getLong(StackTraceHelper.LINE_NUMBER_KEY);
                    if (aVar.j < 0) {
                        return null;
                    }
                    ...
                    x.a("[projectRoot]: " + aVar.f9021a, new Object[0]);
    ...
    public void reportJSException(String str) {
        ...
        if (this.b == null || !this.b.equals(b2)) {
            ...
            if (a2.f9021a != null) {
                linkedHashMap2.put("[JS] projectRoot", a2.f9021a);
            }
            if (a2.b != null) {
