...
public final class a {
    ...
    static /* synthetic */ void a(a aVar, UserInfoBean userInfoBean, boolean z) {
        ...
        if (z || userInfoBean.b == 1 || (a2 = aVar.a(com.tencent.bugly.crashreport.common.info.a.a(aVar.f8985a).d)) == null || a2.size() < 20) {
            long a3 = p.a().a("t_ui", a(userInfoBean), (o) null, true);
            if (a3 >= 0) {
                x.c("[Database] insert %s success with ID: %d", "t_ui", Long.valueOf(a3));
                userInfoBean.f8984a = a3;
                return;
            }
            return;
        }
    ...
    public final void a(int i, boolean z, long j) {
        ...
        if (a2 == null || a2.c().h || i == 1 || i == 3) {
            ...
            com.tencent.bugly.crashreport.common.info.a a3 = com.tencent.bugly.crashreport.common.info.a.a(this.f8985a);
            ...
            userInfoBean.p = a3.F();
            userInfoBean.q = a3.G();
            w.a().a(new C0067a(userInfoBean, z), 0);
            return;
        }
    ...
    class C0067a implements Runnable {
        ...
        public C0067a(UserInfoBean userInfoBean, boolean z) {
            this.b = userInfoBean;
            this.f8988a = z;
        }
    ...
    public synchronized void c() {
        ...
        L_0x0017:
            ...
            return
        L_0x0027:
            android.content.Context r1 = r14.f8985a     // Catch:{ all -> 0x018b }
        ...
        L_0x0126:
            ...
            return
        L_0x0135:
            boolean r5 = r0.f9056a     // Catch:{ all -> 0x018b }
        ...
        L_0x013e:
            android.content.Context r6 = r14.f8985a     // Catch:{ all -> 0x018b }
        ...
        L_0x014f:
            ...
            boolean r2 = r0.f9056a     // Catch:{ all -> 0x018b }
        ...
        L_0x0165:
            r10 = r1
            boolean r0 = r0.f9056a     // Catch:{ all -> 0x018b }
            if (r0 == 0) goto L_0x016d
            java.lang.String r0 = com.tencent.bugly.crashreport.common.strategy.StrategyBean.b     // Catch:{ all -> 0x018b }
            goto L_0x016f
        L_0x016d:
            java.lang.String r0 = com.tencent.bugly.crashreport.common.strategy.StrategyBean.f8997a     // Catch:{ all -> 0x018b }
        L_0x016f:
            r11 = r0
    ...
    private static ContentValues a(UserInfoBean userInfoBean) {
        ...
        try {
            ...
            if (userInfoBean.f8984a > 0) {
                contentValues.put("_id", Long.valueOf(userInfoBean.f8984a));
            }
