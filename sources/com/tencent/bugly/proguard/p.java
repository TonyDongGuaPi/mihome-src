...
public final class p {
    ...
    public final synchronized boolean a(com.tencent.bugly.proguard.r r8) {
        ...
        L_0x0006:
            ...
            r8.f9054a = r1     // Catch:{ Throwable -> 0x0038 }
            monitor-exit(r7)
            return r4
        L_0x0032:
            monitor-exit(r7)
    ...
    public final synchronized void a(java.util.List<com.tencent.bugly.proguard.r> r5) {
        ...
        L_0x001b:
            ...
            java.lang.String r3 = " = "
            r1.append(r3)     // Catch:{ all -> 0x0077 }
            long r2 = r2.f9054a     // Catch:{ all -> 0x0077 }
    ...
    private static ContentValues c(r rVar) {
        ...
        try {
            ...
            if (rVar.f9054a > 0) {
                contentValues.put("_id", Long.valueOf(rVar.f9054a));
            }
    ...
    private static r a(Cursor cursor) {
        ...
        try {
            r rVar = new r();
            rVar.f9054a = cursor.getLong(cursor.getColumnIndex("_id"));
        ...
        public final void run() {
            switch (this.f9052a) {
                ...
                case 2:
                    ...
                    return;
                case 3:
                    Cursor unused3 = p.this.a(this.e, this.c, this.f, this.g, this.h, this.i, this.j, this.k, this.l, this.b);
                    return;
                case 4:
                    boolean unused4 = p.this.a(this.o, this.p, this.q, this.b);
                    return;
                case 5:
                    Map unused5 = p.this.a(this.o, this.b);
                    return;
                case 6:
                    boolean unused6 = p.this.a(this.o, this.p, this.b);
                    return;
                default:
                    return;
            }
