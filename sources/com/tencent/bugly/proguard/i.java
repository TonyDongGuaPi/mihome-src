...
public final class i {
    ...
    private ByteBuffer f9044a;
    private String b = Encoding.GBK;
    ...
    public i(byte[] bArr) {
        this.f9044a = ByteBuffer.wrap(bArr);
    }

    public i(byte[] bArr, int i) {
        this.f9044a = ByteBuffer.wrap(bArr);
        this.f9044a.position(4);
    }
    ...
    private boolean a(int i) {
        try {
            a aVar = new a();
            while (true) {
                int a2 = a(aVar, this.f9044a.duplicate());
                if (i <= aVar.b) {
                    break;
                } else if (aVar.f9045a == 11) {
                    break;
                } else {
                    this.f9044a.position(this.f9044a.position() + a2);
                    a(aVar.f9045a);
                }
            }
            if (i == aVar.b) {
    ...
    private void a(byte b2) {
        ...
        switch (b2) {
            case 0:
                this.f9044a.position(this.f9044a.position() + 1);
                return;
            case 1:
                this.f9044a.position(this.f9044a.position() + 2);
                return;
            case 2:
                this.f9044a.position(this.f9044a.position() + 4);
                return;
            case 3:
                this.f9044a.position(this.f9044a.position() + 8);
                return;
            case 4:
                this.f9044a.position(this.f9044a.position() + 4);
                return;
            case 5:
                ...
                return;
            case 6:
                int i2 = this.f9044a.get();
                if (i2 < 0) {
                    i2 += 256;
                }
                this.f9044a.position(this.f9044a.position() + i2);
                return;
            case 7:
                this.f9044a.position(this.f9044a.position() + this.f9044a.getInt());
                return;
            case 8:
                int a2 = a(0, 0, true);
                while (i < (a2 << 1)) {
            ...
            case 13:
                ...
                a(aVar3, this.f9044a);
                if (aVar3.f9045a == 0) {
                    this.f9044a.position(this.f9044a.position() + a(0, 0, true));
                    return;
                }
                throw new g("skipField with invalid type, type value: " + b2 + ", " + aVar3.f9045a);
            default:
    ...
    public final short a(short s, int i, boolean z) {
        if (a(i)) {
            ...
            switch (b2) {
                case 0:
                    return (short) this.f9044a.get();
                case 1:
                    return this.f9044a.getShort();
                default:
                    throw new g("type mismatch.");
            }
        } else if (!z) {
    ...
    public final long a(long j, int i, boolean z) {
        if (a(i)) {
            ...
            switch (b2) {
                case 0:
                    return (long) this.f9044a.get();
                case 1:
                    return (long) this.f9044a.getShort();
                case 2:
                    return (long) this.f9044a.getInt();
                case 3:
                    return this.f9044a.getLong();
                default:
                    throw new g("type mismatch.");
            }
        } else if (!z) {
    ...
    private double a(double d, int i, boolean z) {
        if (a(i)) {
            ...
            switch (b2) {
                case 4:
                    return (double) this.f9044a.getFloat();
                case 5:
                    return this.f9044a.getDouble();
                default:
                    throw new g("type mismatch.");
            }
        } else if (!z) {
    ...
    public final String b(int i, boolean z) {
        if (a(i)) {
            ...
            switch (aVar.f9045a) {
                ...
                case 7:
                    int i3 = this.f9044a.getInt();
                    if (i3 > 104857600 || i3 < 0) {
                        throw new g("String too long: " + i3);
                    }
                    byte[] bArr2 = new byte[i3];
                    this.f9044a.get(bArr2);
                    try {
        ...
        if (a(i)) {
            ...
            if (b2 == 9) {
                ...
                if (aVar2.f9045a == 0) {
                    ...
                    throw new g("invalid size, tag: " + i + ", type: " + aVar.f9045a + ", " + aVar2.f9045a + ", size: " + a3);
                }
                throw new g("type mismatch, tag: " + i + ", type: " + aVar.f9045a + ", " + aVar2.f9045a);
            } else {
                throw new g("type mismatch.");
            }
        } else if (!z) {
