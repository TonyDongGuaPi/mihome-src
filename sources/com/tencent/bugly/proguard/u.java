...
public final class u {
    ...
    public final void a(int i2, am amVar, String str, String str2, t tVar, long j2, boolean z) {
        try {
            a(new v(this.d, i2, amVar.g, a.a((Object) amVar), str, str2, tVar, this.f9056a, z), true, true, j2);
        } catch (Throwable th) {
            if (!x.a(th)) {
                th.printStackTrace();
            }
    ...
    public final void a(int i2, int i3, byte[] bArr, String str, String str2, t tVar, int i4, int i5, boolean z, Map<String, String> map) {
        try {
            a(new v(this.d, i2, i3, bArr, str, str2, tVar, this.f9056a, i4, i5, false, map), z, false, 0);
        } catch (Throwable th) {
            if (!x.a(th)) {
                th.printStackTrace();
            }
    ...
    public final void a(int i2, am amVar, String str, String str2, t tVar, boolean z) {
        a(i2, amVar.g, a.a((Object) amVar), str, str2, tVar, 0, 0, z, (Map<String, String>) null);
    }
    ...
    /*  JADX ERROR: IndexOutOfBoundsException in pass: RegionMakerVisitor
        ...
        */
    public final void a(int r8, com.tencent.bugly.proguard.an r9) {
        /*
            r7 = this;
            boolean r0 = r7.f9056a
    ...
    class a implements Runnable {
        ...
        public final void run() {
            if (!z.a(this.f9059a, "security_info", 30000)) {
