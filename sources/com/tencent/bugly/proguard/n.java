...
public final class n {
    ...
    public static final long f9048a = System.currentTimeMillis();
    private static n b;
    private Context c;
    ...
    public final synchronized boolean a(final int i) {
        ...
        try {
            ...
            boolean z2 = sharedPreferences.getBoolean(i + JSMethod.NOT_SET + this.d, true);
            try {
                w.a().a(new Runnable() {
                    public final void run() {
                        boolean b2 = n.this.b(i);
                        SharedPreferences.Editor edit = n.this.f.edit();
                        edit.putBoolean(i + JSMethod.NOT_SET + n.this.d, !b2).commit();
                    }
                });
                return z2;
            } catch (Exception unused) {
