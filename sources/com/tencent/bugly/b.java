    ...
    public static synchronized void a(Context context, BuglyStrategy buglyStrategy) {
        synchronized (b.class) {
            if (e) {
                ...
                Log.w(x.f9062a, "[init] context of init() is null, check it.");
            } else {
                a a2 = a.a(context);
                if (a(a2)) {
                    f8980a = false;
                ...
                String f = a2.f();
                if (f == null) {
                    Log.e(x.f9062a, "[init] meta data of BUGLY_APPID in AndroidManifest.xml should be set.");
                } else {
    ...
    public static synchronized void a(Context context, String str, boolean z, BuglyStrategy buglyStrategy) {
        ...
        synchronized (b.class) {
            if (e) {
                ...
                Log.w(x.f9062a, "[init] context is null, check it.");
            } else if (str2 == null) {
                Log.e(x.f9062a, "init arg 'crashReportAppID' should not be null!");
            } else {
                e = true;
                if (z2) {
                    c = true;
                ...
                if (buglyStrategy2 != null) {
                    ...
                    y.f9063a = buglyStrategy.isBuglyLogUpload();
                }
