...
public class TbsReaderView extends FrameLayout {
    ...
    public boolean a() {
        try {
            ...
            if (this.c != null) {
                return this.b.initTbsReader(this.c, this.f9101a);
            }
            return false;
    ...
    public boolean downloadPlugin(String str) {
        if (this.c != null) {
            return this.b.checkPlugin(this.c, this.f9101a, str, true);
        }
    ...
    public void openFile(Bundle bundle) {
        ...
        bundle.putBoolean("browser6.0", d.c(this.f9101a) | (!d.b(this.f9101a)));
        bundle.putBoolean("browser6.1", d.a(this.f9101a, 6101625, 610000) | (!d.b(this.f9101a)));
        if (!this.b.openFile(this.c, this.f9101a, bundle, this)) {
    ...
    public boolean preOpen(String str, boolean z) {
        boolean z2 = false;
        if (!isSupportExt(this.f9101a, str)) {
            Log.e(TAG, "not supported by:" + str);
            return false;
        }
        boolean a2 = a(this.f9101a);
        if (!a2) {
            return a2;
        }
        boolean a3 = a();
        ...
        if (Apn.getApnType(this.f9101a) == 3) {
            z2 = true;
        }
        return this.b.checkPlugin(this.c, this.f9101a, str, z2);
    }
