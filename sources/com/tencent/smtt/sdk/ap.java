    ...
    public void handleMessage(Message message) {
        ...
        switch (message.what) {
            case 1:
                ...
                this.f9143a.b((Context) objArr[0], (String) objArr[1], ((Integer) objArr[2]).intValue());
                break;
            case 2:
                TbsLog.i("TbsInstaller", "TbsInstaller--handleMessage--MSG_COPY_TBS_CORE");
                Object[] objArr2 = (Object[]) message.obj;
                this.f9143a.a((Context) objArr2[0], (Context) objArr2[1], ((Integer) objArr2[2]).intValue());
                break;
            case 3:
                TbsLog.i("TbsInstaller", "TbsInstaller--handleMessage--MSG_INSTALL_TBS_CORE_EX");
                Object[] objArr3 = (Object[]) message.obj;
                this.f9143a.b((Context) objArr3[0], (Bundle) objArr3[1]);
                break;
        }
