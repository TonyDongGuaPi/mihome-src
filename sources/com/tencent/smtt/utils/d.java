...
public class d {
    ...
    private d(Context context) {
        this.f9203a = context.getDir("debugtbs", 0).getAbsolutePath() + File.separator + "plugin";
    }
    ...
    public void a(String str, WebView webView, Context context) {
        ...
        String str2 = this.f9203a + File.separator + "DebugPlugin.tbs";
        j.b(new File(str2));
    ...
    public void a(String str, WebView webView, Context context, Looper looper) {
        ...
        String str2 = this.f9203a + File.separator + "DebugPlugin.apk";
        File file = new File(this.f9203a + File.separator + "DebugPlugin.tbs");
        ...
        try {
            ...
            String str3 = this.f9203a + File.separator + "opt";
