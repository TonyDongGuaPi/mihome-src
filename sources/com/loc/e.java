...
public final class e {
    ...
    public static synchronized java.lang.String a(android.content.Context r6, java.lang.String r7) {
        /*
            java.lang.Class<com.loc.e> r0 = com.loc.e.class
            monitor-enter(r0)
            java.lang.String r6 = a((android.content.Context) r6)     // Catch:{ all -> 0x00c8 }
            boolean r1 = android.text.TextUtils.isEmpty(r6)     // Catch:{ all -> 0x00c8 }
        ...
        L_0x0011:
            ...
            java.lang.String r6 = java.io.File.separator     // Catch:{ all -> 0x00c8 }
            r1.append(r6)     // Catch:{ all -> 0x00c8 }
            java.lang.String r6 = "backups"
            r1.append(r6)     // Catch:{ all -> 0x00c8 }
            java.lang.String r6 = r1.toString()     // Catch:{ all -> 0x00c8 }
            java.io.File r1 = new java.io.File     // Catch:{ all -> 0x00c8 }
            java.lang.String r2 = ".adiu"
            r1.<init>(r6, r2)     // Catch:{ all -> 0x00c8 }
            boolean r6 = r1.exists()     // Catch:{ all -> 0x00c8 }
            if (r6 == 0) goto L_0x00c4
            boolean r6 = r1.canRead()     // Catch:{ all -> 0x00c8 }
            if (r6 != 0) goto L_0x003c
            goto L_0x00c4
        L_0x003c:
            long r2 = r1.length()     // Catch:{ all -> 0x00c8 }
            r4 = 0
            int r6 = (r2 > r4 ? 1 : (r2 == r4 ? 0 : -1))
            if (r6 != 0) goto L_0x004d
            r1.delete()     // Catch:{ all -> 0x00c8 }
            java.lang.String r6 = ""
            monitor-exit(r0)
            return r6
        L_0x004d:
            r6 = 0
            java.io.RandomAccessFile r2 = new java.io.RandomAccessFile     // Catch:{ Throwable -> 0x00bb, all -> 0x00b0 }
            java.lang.String r3 = "r"
            r2.<init>(r1, r3)     // Catch:{ Throwable -> 0x00bb, all -> 0x00b0 }
            r1 = 1024(0x400, float:1.435E-42)
            byte[] r1 = new byte[r1]     // Catch:{ Throwable -> 0x00bc, all -> 0x00ad }
            java.io.ByteArrayOutputStream r3 = new java.io.ByteArrayOutputStream     // Catch:{ Throwable -> 0x00bc, all -> 0x00ad }
            r3.<init>()     // Catch:{ Throwable -> 0x00bc, all -> 0x00ad }
        L_0x005e:
            int r6 = r2.read(r1)     // Catch:{ Throwable -> 0x00ab, all -> 0x00a9 }
            r4 = -1
            r5 = 0
            if (r6 == r4) goto L_0x006a
            r3.write(r1, r5, r6)     // Catch:{ Throwable -> 0x00ab, all -> 0x00a9 }
            goto L_0x005e
        L_0x006a:
            java.lang.String r6 = new java.lang.String     // Catch:{ Throwable -> 0x00ab, all -> 0x00a9 }
            byte[] r1 = r3.toByteArray()     // Catch:{ Throwable -> 0x00ab, all -> 0x00a9 }
            java.lang.String r4 = "UTF-8"
            r6.<init>(r1, r4)     // Catch:{ Throwable -> 0x00ab, all -> 0x00a9 }
            boolean r1 = android.text.TextUtils.isEmpty(r6)     // Catch:{ Throwable -> 0x00ab, all -> 0x00a9 }
            if (r1 != 0) goto L_0x00a2
            java.lang.String r1 = "#"
            boolean r1 = r6.contains(r1)     // Catch:{ Throwable -> 0x00ab, all -> 0x00a9 }
            if (r1 == 0) goto L_0x00a2
            java.lang.String r1 = "#"
            java.lang.String[] r6 = r6.split(r1)     // Catch:{ Throwable -> 0x00ab, all -> 0x00a9 }
            if (r6 == 0) goto L_0x00a2
            int r1 = r6.length     // Catch:{ Throwable -> 0x00ab, all -> 0x00a9 }
            r4 = 2
            if (r1 != r4) goto L_0x00a2
            r1 = r6[r5]     // Catch:{ Throwable -> 0x00ab, all -> 0x00a9 }
            boolean r7 = android.text.TextUtils.equals(r7, r1)     // Catch:{ Throwable -> 0x00ab, all -> 0x00a9 }
            if (r7 == 0) goto L_0x00a2
            r7 = 1
            r6 = r6[r7]     // Catch:{ Throwable -> 0x00ab, all -> 0x00a9 }
            a((java.io.Closeable) r3)     // Catch:{ all -> 0x00c8 }
            a((java.io.Closeable) r2)     // Catch:{ all -> 0x00c8 }
            monitor-exit(r0)
            return r6
        L_0x00a2:
            a((java.io.Closeable) r3)     // Catch:{ all -> 0x00c8 }
        ...
        L_0x00bb:
            r2 = r6
        L_0x00bc:
            a((java.io.Closeable) r6)     // Catch:{ all -> 0x00c8 }
            goto L_0x00a5
        L_0x00c0:
            java.lang.String r6 = ""
            monitor-exit(r0)
    ...
    public static synchronized void a(android.content.Context r4, java.lang.String r5, java.lang.String r6) {
        /*
            java.lang.Class<com.loc.e> r0 = com.loc.e.class
            monitor-enter(r0)
            java.lang.String r4 = a((android.content.Context) r4)     // Catch:{ all -> 0x00b7 }
        ...
        L_0x0086:
            a((java.io.Closeable) r6)     // Catch:{ all -> 0x00b7 }
            monitor-exit(r0)
            return
        L_0x008b:
            r5 = move-exception
