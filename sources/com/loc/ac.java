...
public class ac {
    ...
    public final String a() {
        if (TextUtils.isEmpty(this.j) && !TextUtils.isEmpty(this.f6473a)) {
            this.j = ad.c(this.f6473a);
        }
        return this.j;
    }
    ...
    public int hashCode() {
        am amVar = new am();
        amVar.a((Object) this.j).a((Object) this.g).a((Object) this.h).a((Object[]) this.l);
        return amVar.a();
    }
}
