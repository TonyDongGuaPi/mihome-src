...
public class AMapLocation extends Location implements Parcelable, Cloneable {
    ...
    public static final Parcelable.Creator<AMapLocation> CREATOR = new Parcelable.Creator<AMapLocation>() {
        public final /* synthetic */ Object createFromParcel(Parcel parcel) {
            ...
            aMapLocation.f1242a = parcel.readString();
    ...
    public AMapLocation clone() {
        ...
        try {
            ...
            aMapLocation.setBuildingId(this.f1242a);
        ...
        try {
            ...
            switch (i2) {
                case 1:
                    ...
                    jSONObject.put("poiid", this.f1242a);
                    jSONObject.put(Tags.Kuwan.COMMENT_FLOOR, this.b);
            ...
            jSONObject.put(Tags.Nearby.LON, getLongitude());
            jSONObject.put(Tags.Nearby.LAT, getLatitude());
    ...
    public String toString() {
        ...
        try {
            ...
            stringBuffer.append("poiid=" + this.f1242a + "#");
