...
public class am extends k<RegeocodeQuery, RegeocodeAddress> {
    ...
    public String g() {
        ...
        stringBuffer.append(((RegeocodeQuery) this.f4426a).getPoint().getLongitude());
        stringBuffer.append(",");
        stringBuffer.append(((RegeocodeQuery) this.f4426a).getPoint().getLatitude());
        if (!TextUtils.isEmpty(((RegeocodeQuery) this.f4426a).getPoiType())) {
            stringBuffer.append("&poitype=");
            stringBuffer.append(((RegeocodeQuery) this.f4426a).getPoiType());
        }
        stringBuffer.append("&radius=");
        stringBuffer.append((int) ((RegeocodeQuery) this.f4426a).getRadius());
        stringBuffer.append("&coordsys=");
        stringBuffer.append(((RegeocodeQuery) this.f4426a).getLatLonType());
