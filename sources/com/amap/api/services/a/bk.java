...
public class bk implements IShareSearch {
            ...
            as.a().a(new Runnable() {
                public void run() {
                    if (bk.this.g != null) {
                        Message obtainMessage = ac.a().obtainMessage();
                        obtainMessage.arg1 = 11;
                        obtainMessage.what = MibiCodeConstants.v;
                        obtainMessage.obj = bk.this.g;
                        try {
        ...
        if (poiItem != null) {
            try {
                if (poiItem.getLatLonPoint() != null) {
                    ...
                    return (String) new aq(this.f4330a, String.format(e, new Object[]{poiItem.getPoiId(), Double.valueOf(latLonPoint.getLatitude()), Double.valueOf(latLonPoint.getLongitude()), poiItem.getTitle(), poiItem.getSnippet()})).c();
                }
        ...
        if (shareNaviQuery != null) {
            try {
                ...
                if (fromAndTo.getTo() != null) {
                    ...
                    return (String) new aq(this.f4330a, str).c();
                }
                throw new AMapException(AMapException.AMAP_CLIENT_INVALID_PARAMETER);
            } catch (AMapException e2) {
    ...
    public String searchLocationShareUrl(LatLonSharePoint latLonSharePoint) throws AMapException {
        if (latLonSharePoint != null) {
            try {
                return (String) new aq(this.f4330a, String.format(c, new Object[]{Double.valueOf(latLonSharePoint.getLatitude()), Double.valueOf(latLonSharePoint.getLongitude()), latLonSharePoint.getSharePointName()})).c();
            } catch (AMapException e2) {
    ...
    public String searchBusRouteShareUrl(ShareSearch.ShareBusRouteQuery shareBusRouteQuery) throws AMapException {
        if (shareBusRouteQuery != null) {
            try {
                ...
                return (String) new aq(this.f4330a, String.format(b, new Object[]{Double.valueOf(from.getLatitude()), Double.valueOf(from.getLongitude()), fromName, Double.valueOf(to.getLatitude()), Double.valueOf(to.getLongitude()), toName, Integer.valueOf(busMode), 1, 0, f, f, f})).c();
            } catch (AMapException e2) {
    ...
    public String searchDrivingRouteShareUrl(ShareSearch.ShareDrivingRouteQuery shareDrivingRouteQuery) throws AMapException {
        if (shareDrivingRouteQuery != null) {
            try {
                ...
                String fromName = shareFromAndTo.getFromName();
                String toName = shareFromAndTo.getToName();
                return (String) new aq(this.f4330a, String.format(b, new Object[]{Double.valueOf(from.getLatitude()), Double.valueOf(from.getLongitude()), fromName, Double.valueOf(to.getLatitude()), Double.valueOf(to.getLongitude()), toName, Integer.valueOf(drivingMode), 0, 0, f, f, f})).c();
            } catch (AMapException e2) {
    ...
    public String searchWalkRouteShareUrl(ShareSearch.ShareWalkRouteQuery shareWalkRouteQuery) throws AMapException {
        if (shareWalkRouteQuery != null) {
            try {
                ...
                String fromName = shareFromAndTo.getFromName();
                String toName = shareFromAndTo.getToName();
                return (String) new aq(this.f4330a, String.format(b, new Object[]{Double.valueOf(from.getLatitude()), Double.valueOf(from.getLongitude()), fromName, Double.valueOf(to.getLatitude()), Double.valueOf(to.getLongitude()), toName, Integer.valueOf(walkMode), 2, 0, f, f, f})).c();
            } catch (AMapException e2) {
