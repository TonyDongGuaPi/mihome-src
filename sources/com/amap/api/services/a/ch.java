...
public class ch {
    ...
    public ch a(boolean z) {
        this.b = (this.b * this.f4367a) + (z ^ true ? 1 : 0);
        return this;
    }
    ...
    public ch a(float f) {
        this.b = (this.b * this.f4367a) + Float.floatToIntBits(f);
        return this;
    }
    ...
    public ch a(long j) {
        this.b = (this.b * this.f4367a) + ((int) (j ^ (j >> 32)));
        return this;
    }
    ...
    public ch a(Object obj) {
        if (obj == null) {
            ...
            this.b = (this.b * this.f4367a) + obj.hashCode();
