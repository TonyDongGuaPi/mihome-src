...
public class az implements IBusLineSearch {
    ...
    public BusLineResult searchBusLine() throws AMapException {
        try {
            ...
            if (this.e == 0) {
                BusLineResult busLineResult = (BusLineResult) new m(this.f4296a, this.c.clone()).c();
                a(busLineResult);
            ...
            BusLineResult busLineResult2 = (BusLineResult) new m(this.f4296a, this.c).c();
            ...
            as.a().a(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        aVar.b = az.this.b;
                        aVar.f4277a = az.this.searchBusLine();
