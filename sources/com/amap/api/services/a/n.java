...
public class n extends k<CircleTrafficQuery, TrafficStatusResult> {
    ...
    public String g() {
        ...
        if (((CircleTrafficQuery) this.f4426a).getCenterPoint() != null) {
            stringBuffer.append("&location=");
            stringBuffer.append(s.a(((CircleTrafficQuery) this.f4426a).getCenterPoint()));
        }
        stringBuffer.append("&radius=");
        stringBuffer.append(((CircleTrafficQuery) this.f4426a).getRadius());
        stringBuffer.append("&level=");
        stringBuffer.append(((CircleTrafficQuery) this.f4426a).getLevel());
