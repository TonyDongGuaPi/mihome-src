...
public class an extends k<RouteSearch.RideRouteQuery, RideRouteResult> {
    ...
    public String g() {
        ...
        stringBuffer.append(s.a(((RouteSearch.RideRouteQuery) this.f4426a).getFromAndTo().getFrom()));
        stringBuffer.append("&destination=");
        stringBuffer.append(s.a(((RouteSearch.RideRouteQuery) this.f4426a).getFromAndTo().getTo()));
