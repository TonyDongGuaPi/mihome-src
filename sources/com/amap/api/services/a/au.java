...
public class au extends k<RouteSearch.WalkRouteQuery, WalkRouteResult> {
    ...
    public String g() {
        ...
        stringBuffer.append(s.a(((RouteSearch.WalkRouteQuery) this.f4426a).getFromAndTo().getFrom()));
        stringBuffer.append("&destination=");
        stringBuffer.append(s.a(((RouteSearch.WalkRouteQuery) this.f4426a).getFromAndTo().getTo()));
