...
public class r {
    ...
    public static final String[] f4427a = {"com.amap.api.services", "com.amap.api.search.admic"};
    ...
    public static by a(boolean z) {
        try {
            return new by.a("sea", "6.9.3", "AMAP SDK Android Search 6.9.3").a(f4427a).a(z).a("6.9.3").a();
        } catch (bo e) {
