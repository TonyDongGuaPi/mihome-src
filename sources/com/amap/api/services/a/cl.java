...
public class cl extends ci implements Thread.UncaughtExceptionHandler {
    ...
    private static final ThreadFactory h = new ThreadFactory() {
        ...
        private final AtomicInteger f4373a = new AtomicInteger(1);

        public Thread newThread(Runnable runnable) {
            return new Thread(runnable, "pama#" + this.f4373a.getAndIncrement());
        }
    };
    ...
    public static synchronized cl a(Context context, by byVar) throws bo {
        synchronized (cl.class) {
            ...
            } else if (byVar.a() == null || "".equals(byVar.a())) {
                throw new bo("sdk name is invalid");
            } else {
                try {
                    new cn().a(context);
                    if (!f.add(Integer.valueOf(byVar.hashCode()))) {
                        cl clVar = (cl) ci.f4368a;
                        return clVar;
                    }
                    if (ci.f4368a == null) {
                        ci.f4368a = new cl(context, byVar);
                    } else {
                        ci.f4368a.c = false;
                    }
                    ci.f4368a.a(context, byVar, ci.f4368a.c);
                    cl clVar2 = (cl) ci.f4368a;
                    return clVar2;
                } catch (Throwable th) {
                    th.printStackTrace();
                }
    ...
    public static void a(by byVar, String str, String str2, String str3, String str4) {
        try {
            if (ci.f4368a != null) {
                ci.f4368a.a(byVar, "path:" + str + ",type:" + str2 + ",gsid:" + str3 + ",code:" + str4, "networkError");
            }
        } catch (Throwable unused) {
        }
    }
