...
public abstract class o<T, V> extends k<T, V> {
    ...
    public Map<String, String> e() {
        ...
        hashMap.put("platinfo", String.format("platform=Android&sdkversion=%s&product=%s", new Object[]{"6.9.3", "cloud"}));
    ...
    public void a(CloudItem cloudItem, JSONObject jSONObject) {
        ...
        if (keys != null) {
            while (keys.hasNext()) {
                ...
                if (next != null && !next.toString().startsWith(JSMethod.NOT_SET)) {
