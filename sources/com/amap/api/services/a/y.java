...
public class y extends k<InputtipsQuery, ArrayList<Tip>> {
    ...
    public String g() {
        ...
        String c = c(((InputtipsQuery) this.f4426a).getKeyword());
        if (!TextUtils.isEmpty(c)) {
            stringBuffer.append("&keywords=");
            stringBuffer.append(c);
        }
        String city = ((InputtipsQuery) this.f4426a).getCity();
        if (!z.i(city)) {
            String c2 = c(city);
            stringBuffer.append("&city=");
            stringBuffer.append(c2);
        }
        String type = ((InputtipsQuery) this.f4426a).getType();
        if (!z.i(type)) {
            String c3 = c(type);
            stringBuffer.append("&type=");
            stringBuffer.append(c3);
        }
        if (((InputtipsQuery) this.f4426a).getCityLimit()) {
            stringBuffer.append("&citylimit=true");
        } else {
            stringBuffer.append("&citylimit=false");
        }
        LatLonPoint location = ((InputtipsQuery) this.f4426a).getLocation();
        if (location != null) {
