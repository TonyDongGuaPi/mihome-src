...
public class t extends k<DistanceSearch.DistanceQuery, DistanceResult> {
    ...
    public String g() {
        ...
        List<LatLonPoint> origins = ((DistanceSearch.DistanceQuery) this.f4426a).getOrigins();
        ...
        LatLonPoint destination = ((DistanceSearch.DistanceQuery) this.f4426a).getDestination();
        if (destination != null) {
        ...
        stringBuffer.append(((DistanceSearch.DistanceQuery) this.f4426a).getType());
