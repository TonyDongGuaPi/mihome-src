...
public class AMapException extends Exception {
    ...
    private void a(String str) {
        if ("用户签名未通过".equals(str)) {
            ...
            this.d = 1203;
        } else if (AMAP_CLIENT_ERROR_PROTOCOL.equals(str)) {
            this.d = CODE_AMAP_CLIENT_ERROR_PROTOCOL;
        } else if (AMAP_CLIENT_SOCKET_TIMEOUT_EXCEPTION.equals(str)) {
            this.d = CODE_AMAP_CLIENT_SOCKET_TIMEOUT_EXCEPTION;
        } else if (AMAP_CLIENT_URL_EXCEPTION.equals(str)) {
            this.d = CODE_AMAP_CLIENT_URL_EXCEPTION;
        } else if (AMAP_CLIENT_UNKNOWHOST_EXCEPTION.equals(str)) {
            this.d = CODE_AMAP_CLIENT_UNKNOWHOST_EXCEPTION;
        } else if (AMAP_CLIENT_INVALID_PARAMETER.equals(str)) {
        ...
        } else if (AMAP_CLIENT_IO_EXCEPTION.equals(str)) {
            this.d = CODE_AMAP_CLIENT_IO_EXCEPTION;
        } else if (AMAP_CLIENT_NULLPOINT_EXCEPTION.equals(str)) {
