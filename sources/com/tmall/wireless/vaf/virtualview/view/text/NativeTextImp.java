...
public class NativeTextImp extends TextView implements IView {
    ...
    public void onDraw(Canvas canvas) {
        if (this.mBackgroundColor != 0) {
            VirtualViewUtils.b(canvas, this.mBackgroundColor, canvas.getWidth(), canvas.getHeight(), this.mBorderWidth, this.mBorderTopLeftRadius, this.mBorderTopRightRadius, this.mBorderBottomLeftRadius, this.mBorderBottomRightRadius);
        }
        super.onDraw(canvas);
