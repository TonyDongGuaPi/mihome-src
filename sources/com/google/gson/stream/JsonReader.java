...
public class JsonReader implements Closeable {
    ...
    public String nextName() throws IOException {
        ...
        if (i == 14) {
            ...
            str = nextQuotedValue(Operators.SINGLE_QUOTE);
        } else if (i == 13) {
            str = nextQuotedValue('\"');
        } else {
    ...
    public double nextDouble() throws IOException {
        ...
        if (i == 16) {
            ...
            this.peekedString = nextQuotedValue(i == 8 ? Operators.SINGLE_QUOTE : '\"');
        } else if (i == 10) {
    ...
    public void skipValue() throws IOException {
        ...
        do {
            ...
            if (i2 == 3) {
                ...
                skipQuotedValue(Operators.SINGLE_QUOTE);
            } else if (i2 == 9 || i2 == 13) {
                skipQuotedValue('\"');
            } else if (i2 == 16) {
                this.pos += this.peekedNumberLength;
    ...
    private boolean fillBuffer(int i) throws IOException {
        ...
        this.pos = 0;
        do {
            int read = this.f1258in.read(cArr, this.limit, cArr.length - this.limit);
            if (read == -1) {
                return false;
            }
            this.limit += read;
