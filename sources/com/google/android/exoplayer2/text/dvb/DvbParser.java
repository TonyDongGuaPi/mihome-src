...
final class DvbParser {
    ...
    private static final byte[] defaultMap2To8 = {0, 119, Constants.TagName.ACTIVITY_DEFINITION, -1};
    private static final byte[] defaultMap4To8 = {0, 17, 34, 51, Constants.TagName.TERMINAL_OS_VERSION, Constants.TagName.TERMINAL_BACK_CHILDREN_ID, 102, 119, Constants.TagName.ACTIVITY_DEFINITION, Constants.TagName.PRODUCT_CODE, -86, Constants.TagName.APP_MANAGE_OPEATE_TYPE, -52, -35, -18, -1};
    ...
    public DvbParser(int i, int i2) {
        ...
        this.defaultDisplayDefinition = new DisplayDefinition(719, IptcDirectory.S, 0, 719, 0, IptcDirectory.S);
