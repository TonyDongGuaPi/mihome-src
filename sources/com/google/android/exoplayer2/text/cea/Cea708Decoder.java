...
public final class Cea708Decoder extends CeaDecoder {
        ...
        while (this.ccData.bytesLeft() >= 3) {
            ...
            if ((i == 2 || i == 3) && z2) {
                if (i == 3) {
                    ...
                    int i2 = (readUnsignedByte2 & Constants.TagName.STATION_ENAME) >> 6;
                    byte b = readUnsignedByte2 & Constants.TagName.CARD_APP_ACTIVATION_STATUS;
                    if (b == 0) {
                        b = 64;
                    }
    ...
    private void handleG2Character(int i) {
        if (i == 37) {
            this.currentCueBuilder.append(Typography.E);
        } else if (i == 42) {
            ...
            switch (i) {
                case 32:
                    ...
                    return;
                case 33:
                    this.currentCueBuilder.append(Typography.f);
                    return;
                default:
                    switch (i) {
                        case 48:
                            ...
                            return;
                        case 49:
                            this.currentCueBuilder.append(Typography.v);
                            return;
                        case 50:
                            this.currentCueBuilder.append(Typography.w);
                            return;
                        case 51:
                            this.currentCueBuilder.append(Typography.y);
                            return;
                        case 52:
                            this.currentCueBuilder.append(Typography.z);
                            return;
                        case 53:
                            this.currentCueBuilder.append(Typography.D);
                            return;
                        default:
                            switch (i) {
                                case 57:
                                    this.currentCueBuilder.append(Typography.I);
                                    return;
                                case 58:
