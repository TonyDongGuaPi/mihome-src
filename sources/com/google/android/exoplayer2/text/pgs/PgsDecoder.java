...
public final class PgsDecoder extends SimpleSubtitleDecoder {
    ...
    private static final class CueBuilder {
        ...
        public void parsePaletteSection(ParsableByteArray parsableByteArray, int i) {
            if (i % 5 == 2) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    ...
                    iArr[i4] = Util.constrainValue((int) (d + (d3 * 1.772d)), 0, 255) | constrainValue | (readUnsignedByte5 << 24) | (Util.constrainValue((int) ((1.402d * d2) + d), 0, 255) << 16);
                }
                this.colorsSet = true;
            }
        }
        ...
        public Cue build() {
            ...
            return new Cue(Bitmap.createBitmap(iArr, this.bitmapWidth, this.bitmapHeight, Bitmap.Config.ARGB_8888), ((float) this.bitmapX) / ((float) this.planeWidth), 0, ((float) this.bitmapY) / ((float) this.planeHeight), 0, ((float) this.bitmapWidth) / ((float) this.planeWidth), ((float) this.bitmapHeight) / ((float) this.planeHeight));
        }
