...
final class DefaultOggSeeker implements OggSeeker {
    ...
    private class OggSeekMap implements SeekMap {
        ...
        public SeekMap.SeekPoints getSeekPoints(long j) {
            ...
            return new SeekMap.SeekPoints(new SeekPoint(j, DefaultOggSeeker.this.getEstimatedPosition(DefaultOggSeeker.this.startPosition, DefaultOggSeeker.this.streamReader.convertTimeToGranule(j), 30000)));
        }
