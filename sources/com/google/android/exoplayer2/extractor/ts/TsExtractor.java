        ...
        public void consume(ParsableByteArray parsableByteArray) {
            ...
            if (parsableByteArray.readUnsignedByte() == 2) {
                ...
                if (TsExtractor.this.mode == 2 && TsExtractor.this.id3Reader == null) {
                    TsPayloadReader unused2 = TsExtractor.this.id3Reader = TsExtractor.this.payloadReaderFactory.createPayloadReader(21, new TsPayloadReader.EsInfo(21, (String) null, (List<TsPayloadReader.DvbSubtitleInfo>) null, Util.EMPTY_BYTE_ARRAY));
                ...
                if (TsExtractor.this.mode != 2) {
                    ...
                    int unused3 = tsExtractor.remainingPmts = i;
