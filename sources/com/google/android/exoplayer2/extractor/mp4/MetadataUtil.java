...
final class MetadataUtil {
    ...
    private static final int TYPE_GENRE = Util.getIntegerCodeForString(GenreBox.f3971a);
    ...
    private static final int TYPE_RATING = Util.getIntegerCodeForString(RatingBox.f3975a);
            ...
            for (int i2 = 0; i2 < metadata2.length(); i2++) {
                ...
                if (entry instanceof MdtaMetadataEntry) {
                    ...
                    if (MDTA_KEY_ANDROID_CAPTURE_FPS.equals(mdtaMetadataEntry.key) && mdtaMetadataEntry.typeIndicator == 23) {
                        try {
                            Format copyWithFrameRate = format2.copyWithFrameRate(ByteBuffer.wrap(mdtaMetadataEntry.value).asFloatBuffer().get());
                            try {
