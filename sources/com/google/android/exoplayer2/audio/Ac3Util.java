...
public final class Ac3Util {
    ...
    private static final int[] BITRATE_BY_HALF_FRMSIZECOD = {32, 40, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, CommonUtils.x, BitmapCounterProvider.MAX_BITMAP_COUNT, 448, 512, 576, 640};
    private static final int[] BLOCKS_PER_SYNCFRAME_BY_NUMBLKSCOD = {1, 2, 3, 6};
    private static final int[] CHANNEL_COUNT_BY_ACMOD = {2, 1, 2, 3, 3, 4, 4, 5};
    private static final int[] SAMPLE_RATE_BY_FSCOD = {MIOTAudioModule.SAMPLING_RATE, 44100, AsrRequest.d};
    private static final int[] SAMPLE_RATE_BY_FSCOD2 = {24000, 22050, RecordDevice.PCM_FREQUENCE_16K};
    private static final int[] SYNCFRAME_SIZE_WORDS_BY_HALF_FRMSIZECOD_44_1 = {69, 87, 104, 121, 139, 174, 208, 243, 278, 348, 417, 487, IptcDirectory.M, IptcDirectory.av, KeyType.WIND_VERTICAL, 975, 1114, 1253, 1393};
    ...
    public static Format parseEAc3AnnexFFormat(ParsableByteArray parsableByteArray, String str, String str2, DrmInitData drmInitData) {
        ...
        return Format.createAudioSampleFormat(str, str3, (String) null, -1, -1, i3, i, (List<byte[]>) null, drmInitData, 0, str2);
    }
    ...
    public static SyncFrameInfo parseAc3SyncframeInfo(ParsableBitArray parsableBitArray) {
        ...
        if (z) {
            ...
            int i14 = SAMPLE_RATE_BY_FSCOD[readBits6];
            boolean readBit2 = parsableBitArray.readBit();
            str = MimeTypes.AUDIO_AC3;
            i2 = ac3SyncframeSize;
            i3 = i14;
            i4 = CHANNEL_COUNT_BY_ACMOD[readBits7] + (readBit2 ? 1 : 0);
            i5 = -1;
            i = 1536;
        }
    ...
    public static int parseAc3SyncframeSize(byte[] bArr) {
        ...
        if (!(((bArr[5] & 255) >> 3) == 16)) {
            return getAc3SyncframeSize((bArr[4] & Constants.TagName.STATION_ENAME) >> 6, bArr[4] & Constants.TagName.CARD_APP_ACTIVATION_STATUS);
        }
    ...
    public static int parseEAc3SyncframeAudioSampleCount(ByteBuffer byteBuffer) {
        int i = 6;
        if (((byteBuffer.get(byteBuffer.position() + 4) & Constants.TagName.STATION_ENAME) >> 6) != 3) {
    ...
    public static int parseTrueHdSyncframeAudioSampleCount(byte[] bArr) {
        boolean z = false;
        if (bArr[4] != -8 || bArr[5] != 114 || bArr[6] != 111 || (bArr[7] & FileDownloadStatus.j) != 186) {
            return 0;
        }
        if ((bArr[7] & 255) == 187) {
            z = true;
