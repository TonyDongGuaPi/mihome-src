            ...
            if (this.listener != null) {
                this.handler.post(new Runnable(decoderCounters) {
                    ...
                    public final void run() {
                        AudioRendererEventListener.EventDispatcher.this.listener.onAudioEnabled(this.f$1);
                    }
                });
            }
        }
        ...
        public void decoderInitialized(String str, long j, long j2) {
            if (this.listener != null) {
                this.handler.post(new Runnable(str, j, j2) {
                    ...
                    public final void run() {
                        AudioRendererEventListener.EventDispatcher.this.listener.onAudioDecoderInitialized(this.f$1, this.f$2, this.f$3);
                    }
                });
            }
        }
        ...
        public void inputFormatChanged(Format format) {
            if (this.listener != null) {
                this.handler.post(new Runnable(format) {
                    ...
                    public final void run() {
                        AudioRendererEventListener.EventDispatcher.this.listener.onAudioInputFormatChanged(this.f$1);
                    }
                });
            }
        }
        ...
        public void audioTrackUnderrun(int i, long j, long j2) {
            if (this.listener != null) {
                this.handler.post(new Runnable(i, j, j2) {
                    ...
                    public final void run() {
                        AudioRendererEventListener.EventDispatcher.this.listener.onAudioSinkUnderrun(this.f$1, this.f$2, this.f$3);
                    }
                });
            }
        }
        ...
        public void disabled(DecoderCounters decoderCounters) {
            if (this.listener != null) {
                this.handler.post(new Runnable(decoderCounters) {
                    ...
                    public final void run() {
                        AudioRendererEventListener.EventDispatcher.lambda$disabled$4(AudioRendererEventListener.EventDispatcher.this, this.f$1);
                    }
                });
            }
        }
        ...
        public void audioSessionId(int i) {
            if (this.listener != null) {
                this.handler.post(new Runnable(i) {
                    ...
                    public final void run() {
                        AudioRendererEventListener.EventDispatcher.this.listener.onAudioSessionId(this.f$1);
                    }
                });
            }
        }
