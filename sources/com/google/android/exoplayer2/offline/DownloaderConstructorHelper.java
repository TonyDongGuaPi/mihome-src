...
public final class DownloaderConstructorHelper {
    ...
    public CacheDataSource buildCacheDataSource(boolean z) {
        ...
        DataSink createDataSink = this.cacheWriteDataSinkFactory != null ? this.cacheWriteDataSinkFactory.createDataSink() : new CacheDataSink(this.cache, 2097152);
        DataSource createDataSource2 = this.upstreamDataSourceFactory.createDataSource();
        return new CacheDataSource(this.cache, this.priorityTaskManager == null ? createDataSource2 : new PriorityDataSource(createDataSource2, this.priorityTaskManager, -1000), createDataSource, createDataSink, 1, (CacheDataSource.EventListener) null);
    }
}
