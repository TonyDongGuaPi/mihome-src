...
final class SampleMetadataQueue {
    ...
    public synchronized void commitSample(long r6, int r8, long r9, int r11, com.google.android.exoplayer2.extractor.TrackOutput.CryptoData r12) {
        /*
            r5 = this;
            monitor-enter(r5)
            boolean r0 = r5.upstreamKeyframeRequired     // Catch:{ all -> 0x00dd }
            r1 = 0
            ...
            return
        L_0x000c:
            r5.upstreamKeyframeRequired = r1     // Catch:{ all -> 0x00dd }
        L_0x000e:
            boolean r0 = r5.upstreamFormatRequired     // Catch:{ all -> 0x00dd }
            r2 = 1
            r0 = r0 ^ r2
            com.google.android.exoplayer2.util.Assertions.checkState(r0)     // Catch:{ all -> 0x00dd }
        ...
        L_0x001c:
            r0 = 0
        L_0x001d:
            r5.isLastSampleQueued = r0     // Catch:{ all -> 0x00dd }
            long r3 = r5.largestQueuedTimestampUs     // Catch:{ all -> 0x00dd }
            long r3 = java.lang.Math.max(r3, r6)     // Catch:{ all -> 0x00dd }
            r5.largestQueuedTimestampUs = r3     // Catch:{ all -> 0x00dd }
            int r0 = r5.length     // Catch:{ all -> 0x00dd }
            int r0 = r5.getRelativeIndex(r0)     // Catch:{ all -> 0x00dd }
            long[] r3 = r5.timesUs     // Catch:{ all -> 0x00dd }
            r3[r0] = r6     // Catch:{ all -> 0x00dd }
            long[] r6 = r5.offsets     // Catch:{ all -> 0x00dd }
            r6[r0] = r9     // Catch:{ all -> 0x00dd }
            int[] r6 = r5.sizes     // Catch:{ all -> 0x00dd }
            r6[r0] = r11     // Catch:{ all -> 0x00dd }
            int[] r6 = r5.flags     // Catch:{ all -> 0x00dd }
            r6[r0] = r8     // Catch:{ all -> 0x00dd }
            com.google.android.exoplayer2.extractor.TrackOutput$CryptoData[] r6 = r5.cryptoDatas     // Catch:{ all -> 0x00dd }
            r6[r0] = r12     // Catch:{ all -> 0x00dd }
            com.google.android.exoplayer2.Format[] r6 = r5.formats     // Catch:{ all -> 0x00dd }
            com.google.android.exoplayer2.Format r7 = r5.upstreamFormat     // Catch:{ all -> 0x00dd }
            r6[r0] = r7     // Catch:{ all -> 0x00dd }
            int[] r6 = r5.sourceIds     // Catch:{ all -> 0x00dd }
            int r7 = r5.upstreamSourceId     // Catch:{ all -> 0x00dd }
            r6[r0] = r7     // Catch:{ all -> 0x00dd }
            int r6 = r5.length     // Catch:{ all -> 0x00dd }
            int r6 = r6 + r2
            r5.length = r6     // Catch:{ all -> 0x00dd }
            int r6 = r5.length     // Catch:{ all -> 0x00dd }
            int r7 = r5.capacity     // Catch:{ all -> 0x00dd }
            if (r6 != r7) goto L_0x00db
            int r6 = r5.capacity     // Catch:{ all -> 0x00dd }
            int r6 = r6 + 1000
            int[] r7 = new int[r6]     // Catch:{ all -> 0x00dd }
            long[] r8 = new long[r6]     // Catch:{ all -> 0x00dd }
            long[] r9 = new long[r6]     // Catch:{ all -> 0x00dd }
            int[] r10 = new int[r6]     // Catch:{ all -> 0x00dd }
            int[] r11 = new int[r6]     // Catch:{ all -> 0x00dd }
            com.google.android.exoplayer2.extractor.TrackOutput$CryptoData[] r12 = new com.google.android.exoplayer2.extractor.TrackOutput.CryptoData[r6]     // Catch:{ all -> 0x00dd }
            com.google.android.exoplayer2.Format[] r0 = new com.google.android.exoplayer2.Format[r6]     // Catch:{ all -> 0x00dd }
            int r2 = r5.capacity     // Catch:{ all -> 0x00dd }
            int r3 = r5.relativeFirstIndex     // Catch:{ all -> 0x00dd }
            int r2 = r2 - r3
            long[] r3 = r5.offsets     // Catch:{ all -> 0x00dd }
            int r4 = r5.relativeFirstIndex     // Catch:{ all -> 0x00dd }
            java.lang.System.arraycopy(r3, r4, r8, r1, r2)     // Catch:{ all -> 0x00dd }
            long[] r3 = r5.timesUs     // Catch:{ all -> 0x00dd }
            int r4 = r5.relativeFirstIndex     // Catch:{ all -> 0x00dd }
            java.lang.System.arraycopy(r3, r4, r9, r1, r2)     // Catch:{ all -> 0x00dd }
            int[] r3 = r5.flags     // Catch:{ all -> 0x00dd }
            int r4 = r5.relativeFirstIndex     // Catch:{ all -> 0x00dd }
            java.lang.System.arraycopy(r3, r4, r10, r1, r2)     // Catch:{ all -> 0x00dd }
            int[] r3 = r5.sizes     // Catch:{ all -> 0x00dd }
            int r4 = r5.relativeFirstIndex     // Catch:{ all -> 0x00dd }
            java.lang.System.arraycopy(r3, r4, r11, r1, r2)     // Catch:{ all -> 0x00dd }
            com.google.android.exoplayer2.extractor.TrackOutput$CryptoData[] r3 = r5.cryptoDatas     // Catch:{ all -> 0x00dd }
            int r4 = r5.relativeFirstIndex     // Catch:{ all -> 0x00dd }
            java.lang.System.arraycopy(r3, r4, r12, r1, r2)     // Catch:{ all -> 0x00dd }
            com.google.android.exoplayer2.Format[] r3 = r5.formats     // Catch:{ all -> 0x00dd }
            int r4 = r5.relativeFirstIndex     // Catch:{ all -> 0x00dd }
            java.lang.System.arraycopy(r3, r4, r0, r1, r2)     // Catch:{ all -> 0x00dd }
            int[] r3 = r5.sourceIds     // Catch:{ all -> 0x00dd }
            int r4 = r5.relativeFirstIndex     // Catch:{ all -> 0x00dd }
            java.lang.System.arraycopy(r3, r4, r7, r1, r2)     // Catch:{ all -> 0x00dd }
            int r3 = r5.relativeFirstIndex     // Catch:{ all -> 0x00dd }
            long[] r4 = r5.offsets     // Catch:{ all -> 0x00dd }
            java.lang.System.arraycopy(r4, r1, r8, r2, r3)     // Catch:{ all -> 0x00dd }
            long[] r4 = r5.timesUs     // Catch:{ all -> 0x00dd }
            java.lang.System.arraycopy(r4, r1, r9, r2, r3)     // Catch:{ all -> 0x00dd }
            int[] r4 = r5.flags     // Catch:{ all -> 0x00dd }
            java.lang.System.arraycopy(r4, r1, r10, r2, r3)     // Catch:{ all -> 0x00dd }
            int[] r4 = r5.sizes     // Catch:{ all -> 0x00dd }
            java.lang.System.arraycopy(r4, r1, r11, r2, r3)     // Catch:{ all -> 0x00dd }
            com.google.android.exoplayer2.extractor.TrackOutput$CryptoData[] r4 = r5.cryptoDatas     // Catch:{ all -> 0x00dd }
            java.lang.System.arraycopy(r4, r1, r12, r2, r3)     // Catch:{ all -> 0x00dd }
            com.google.android.exoplayer2.Format[] r4 = r5.formats     // Catch:{ all -> 0x00dd }
            java.lang.System.arraycopy(r4, r1, r0, r2, r3)     // Catch:{ all -> 0x00dd }
            int[] r4 = r5.sourceIds     // Catch:{ all -> 0x00dd }
            java.lang.System.arraycopy(r4, r1, r7, r2, r3)     // Catch:{ all -> 0x00dd }
            r5.offsets = r8     // Catch:{ all -> 0x00dd }
            r5.timesUs = r9     // Catch:{ all -> 0x00dd }
            r5.flags = r10     // Catch:{ all -> 0x00dd }
            r5.sizes = r11     // Catch:{ all -> 0x00dd }
            r5.cryptoDatas = r12     // Catch:{ all -> 0x00dd }
            r5.formats = r0     // Catch:{ all -> 0x00dd }
            r5.sourceIds = r7     // Catch:{ all -> 0x00dd }
            r5.relativeFirstIndex = r1     // Catch:{ all -> 0x00dd }
            int r7 = r5.capacity     // Catch:{ all -> 0x00dd }
            r5.length = r7     // Catch:{ all -> 0x00dd }
            r5.capacity = r6     // Catch:{ all -> 0x00dd }
        L_0x00db:
            monitor-exit(r5)
            return
        L_0x00dd:
