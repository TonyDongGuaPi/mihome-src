...
public class DashManifestParser extends DefaultHandler implements ParsingLoadable.Parser<DashManifest> {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:66:0x0184 A[LOOP:0: B:20:0x006e->B:66:0x0184, LOOP_END] */
    /* JADX WARNING: Removed duplicated region for block: B:67:0x0142 A[SYNTHETIC] */
    ...
    public RangedUri parseInitialization(XmlPullParser xmlPullParser) {
        return parseRangedUrl(xmlPullParser, "sourceURL", Common.v);
    }
    ...
    public ProgramInformation parseProgramInformation(XmlPullParser xmlPullParser) throws IOException, XmlPullParserException {
        ...
        String parseString2 = parseString(xmlPullParser, TSMAuthContants.PARAM_LANGUAGE, (String) null);
        String str2 = null;
        String str3 = null;
        while (true) {
            xmlPullParser.next();
    ...
    private static String getSampleMimeType(String str, String str2) {
        ...
        if (!MimeTypes.APPLICATION_MP4.equals(str)) {
            ...
            if (str2.startsWith(XMLSubtitleSampleEntry.f3931a)) {
                return MimeTypes.APPLICATION_TTML;
            }
            if (str2.startsWith(WebVTTSampleEntry.f3929a)) {
