...
public class DebugTextViewHelper implements Player.EventListener, Runnable {
    ...
    public String getVideoString() {
        ...
        return "\n" + videoFormat.sampleMimeType + "(id:" + videoFormat.id + " r:" + videoFormat.width + "x" + videoFormat.height + getPixelAspectRatioString(videoFormat.pixelWidthHeightRatio) + getDecoderCountersBufferCountString(videoDecoderCounters) + Operators.BRACKET_END_STR;
    }
    ...
    public String getAudioString() {
        ...
        return "\n" + audioFormat.sampleMimeType + "(id:" + audioFormat.id + " hz:" + audioFormat.sampleRate + " ch:" + audioFormat.channelCount + getDecoderCountersBufferCountString(audioDecoderCounters) + Operators.BRACKET_END_STR;
    }
