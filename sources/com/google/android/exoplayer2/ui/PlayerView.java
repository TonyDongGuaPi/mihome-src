...
public class PlayerView extends FrameLayout implements AdsLoader.AdViewProvider {
    ...
    public View[] getAdOverlayViews() {
        ...
        if (this.overlayFrameLayout != null) {
            arrayList.add(this.overlayFrameLayout);
        }
        if (this.controller != null) {
    ...
    private final class ComponentListener implements View.OnLayoutChangeListener, Player.EventListener, TextOutput, SingleTapListener, SphericalSurfaceView.SurfaceListener, VideoListener {
