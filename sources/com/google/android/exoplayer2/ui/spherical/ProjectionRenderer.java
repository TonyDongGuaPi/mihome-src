...
final class ProjectionRenderer {
    ...
    public void draw(int i, float[] fArr, int i2) {
        ...
        if (meshData != null) {
            ...
            GLES20.glBindTexture(GlslFilter.e, i);
            GLES20.glUniform1i(this.textureHandle, 0);
            GlUtil.checkGlError();
            GLES20.glVertexAttribPointer(this.positionHandle, 3, FujifilmMakernoteDirectory.M, false, 12, meshData.vertexBuffer);
            GlUtil.checkGlError();
            GLES20.glVertexAttribPointer(this.texCoordsHandle, 2, FujifilmMakernoteDirectory.M, false, 8, meshData.textureBuffer);
            GlUtil.checkGlError();
