...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    private static Map<String, int[]> createInitialBitrateCountryGroupAssignment() {
        ...
        hashMap.put(AlarmCloudManager.AI, new int[]{1, 0, 0, 2});
        ...
        hashMap.put(ServerCompact.f, new int[]{0, 0, 1, 1});
        ...
        hashMap.put(ServerCompact.e, new int[]{1, 0, 2, 1});
        hashMap.put("GA", new int[]{3, 3, 2, 1});
        hashMap.put(ServerCompact.i, new int[]{0, 1, 3, 2});
        ...
        hashMap.put(ServerCompact.b, new int[]{0, 2, 3, 4});
        ...
        hashMap.put(HTTP.MX, new int[]{2, 4, 3, 1});
        ...
        hashMap.put(Constants.ae, new int[]{0, 0, 1, 0});
        ...
        hashMap.put(ServerCompact.d, new int[]{0, 1, 1, 1});
        ...
        hashMap.put(HTTP.ST, new int[]{3, 2, 2, 2});
        ...
        hashMap.put(ServerCompact.f1531a, new int[]{0, 0, 0, 1});
