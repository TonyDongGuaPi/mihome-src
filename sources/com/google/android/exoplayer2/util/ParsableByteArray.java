...
public final class ParsableByteArray {
    ...
    public int readUnsignedInt24() {
        ...
        int i2 = this.position;
        this.position = i2 + 1;
        byte b = ((bArr[i] & 255) << 16) | ((bArr2[i2] & 255) << 8);
        byte[] bArr3 = this.data;
        int i3 = this.position;
        this.position = i3 + 1;
        return b | (bArr3[i3] & 255);
    }
    ...
    public int readInt24() {
        ...
        int i2 = this.position;
        this.position = i2 + 1;
        byte b = (((bArr[i] & 255) << 24) >> 8) | ((bArr2[i2] & 255) << 8);
        byte[] bArr3 = this.data;
        int i3 = this.position;
        this.position = i3 + 1;
        return b | (bArr3[i3] & 255);
    ...
    public long readUtf8EncodedLong() {
        ...
        if (i2 != 0) {
            while (i < i2) {
                ...
                if ((b & Constants.TagName.STATION_ENAME) == 128) {
                    j = (j << 6) | ((long) (b & Constants.TagName.CARD_APP_ACTIVATION_STATUS));
                    i++;
                } else {
