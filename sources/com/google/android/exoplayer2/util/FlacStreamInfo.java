...
public final class FlacStreamInfo {
    ...
    public FlacStreamInfo(byte[] bArr, int i) {
        ...
        this.totalSamples = ((((long) parsableBitArray.readBits(4)) & 15) << 32) | (((long) parsableBitArray.readBits(32)) & MessageHead.SERIAL_MAK);
    }
    ...
    public long getApproxBytesPerFrame() {
        ...
        return (((((this.minBlockSize != this.maxBlockSize || this.minBlockSize <= 0) ? 4096 : (long) this.minBlockSize) * ((long) this.channels)) * ((long) this.bitsPerSample)) / 8) + 64;
    }
}
