...
public final class MediaCodecInfo {
    ...
    public boolean isSeamlessAdaptationSupported(Format format, Format format2, boolean z) {
        if (this.isVideo) {
            ...
            return true;
        } else if (!"audio/mp4a-latm".equals(this.mimeType) || !format.sampleMimeType.equals(format2.sampleMimeType) || format.channelCount != format2.channelCount || format.sampleRate != format2.sampleRate) {
            return false;
        } else {
            Pair<Integer, Integer> codecProfileAndLevel = MediaCodecUtil.getCodecProfileAndLevel(format.codecs);
    ...
    private static int adjustMaxInputChannelCount(String str, String str2, int i) {
        ...
        Log.w(TAG, "AssumedMaxChannelAdjustment: " + str + ", [" + i + " to " + i2 + Operators.ARRAY_END_STR);
        return i2;
    }
