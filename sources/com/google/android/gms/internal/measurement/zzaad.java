...
final class zzaad implements zzaaw {
    ...
    private static zzaak zzts() {
        try {
            return (zzaak) Class.forName("com.google.protobuf.DescriptorMessageInfoFactory").getDeclaredMethod("getInstance", new Class[0]).invoke((Object) null, new Object[0]);
    ...
    public final <T> zzaav<T> zzg(Class<T> cls) {
        ...
        if (zzzq.class.isAssignableFrom(cls)) {
            ...
            return zzaao.zza(cls, zze, zzaas.zzub(), zzzz.zztr(), zzaax.zzug(), (zzzj<?>) null, zzaai.zztu());
        } else if (zza(zze)) {
            return zzaao.zza(cls, zze, zzaas.zzua(), zzzz.zztq(), zzaax.zzue(), zzzl.zzth(), zzaai.zztt());
        } else {
            return zzaao.zza(cls, zze, zzaas.zzua(), zzzz.zztq(), zzaax.zzuf(), (zzzj<?>) null, zzaai.zztt());
        }
    }
}
