...
public class zzgl extends zzjr implements zzhi {
    ...
    public final boolean zzjv() {
        ...
        if (this.zzamw == null || this.zzamx == 0 || (this.zzamw != null && !this.zzamw.booleanValue() && Math.abs(zzbt().elapsedRealtime() - this.zzamx) > 1000)) {
            ...
            boolean z = false;
            if (zzgb().zzx(Permission.y) && zzgb().zzx("android.permission.ACCESS_NETWORK_STATE") && (Wrappers.packageManager(getContext()).isCallerInstantApp() || (zzgb.zza(getContext()) && zzjc.zza(getContext(), false)))) {
                z = true;
            }
