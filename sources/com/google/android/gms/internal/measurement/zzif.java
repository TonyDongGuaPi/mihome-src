...
public final class zzif extends zzhh {
    ...
    private final void zza(Activity activity, zzie zzie, boolean z) {
        ...
        this.zzaom = zzie;
        zzgd().zzc((Runnable) new zzig(this, z, zzie2, zzie));
    }

    /* access modifiers changed from: private */
    @WorkerThread
    public final void zza(@NonNull zzie zzie) {
    ...
    private final zzie zze(@NonNull Activity activity) {
        ...
        zzie zzie2 = new zzie((String) null, zzca(activity.getClass().getCanonicalName()), zzgb().zzlb());
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        this.zzaoo = zzbt().elapsedRealtime();
        this.zzaom = null;
        zzgd().zzc((Runnable) new zzih(this, zze));
    }
    ...
    public final void onActivityResumed(Activity activity) {
        ...
        zzdu zzft = zzft();
        zzft.zzgd().zzc((Runnable) new zzdx(zzft, zzft.zzbt().elapsedRealtime()));
    }
