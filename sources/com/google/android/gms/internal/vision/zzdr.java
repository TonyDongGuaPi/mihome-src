...
public final class zzdr extends zzjn<zzdr> {
    ...
    public final void zza(zzjl zzjl) throws IOException {
        ...
        if (this.zzpr != null) {
            zzjl.zza(3, (zzjt) this.zzpr);
        }
        if (this.zzon != null) {
            zzjl.zza(6, this.zzon);
        }
        if (this.zzps != null) {
            zzjl.zza(16, (zzjt) this.zzps);
        }
        if (this.zzpt != null) {
            zzjl.zza(17, (zzjt) this.zzpt);
        }
        super.zza(zzjl);
    }
    ...
    public final int zzt() {
        ...
        if (this.zzpr != null) {
            zzt += zzjl.zzb(3, (zzjt) this.zzpr);
        }
        if (this.zzon != null) {
            zzt += zzjl.zzb(6, this.zzon);
        }
        if (this.zzps != null) {
            zzt += zzjl.zzb(16, (zzjt) this.zzps);
        }
        return this.zzpt != null ? zzt + zzjl.zzb(17, (zzjt) this.zzpt) : zzt;
    }
