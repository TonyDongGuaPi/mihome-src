            ...
            if (byteBuffer.hasArray()) {
                    ...
                    if (i3 == length) {
                        ...
                        while (i3 < length) {
                            ...
                            if (charAt2 < 128 && i < i4) {
                                ...
                                i = i6 + 1;
                                array[i6] = (byte) ((charAt2 & Operators.CONDITION_IF) | 128);
                                i3++;
                                ...
                                i2 = i8 + 1;
                                array[i8] = (byte) ((charAt2 & Operators.CONDITION_IF) | 128);
                            } else if (i <= i4 - 4) {
                                int i9 = i3 + 1;
                ...
                while (i3 < length2) {
                    ...
                    if (charAt4 < 128) {
                        ...
                        byteBuffer.put((byte) ((charAt4 & Operators.CONDITION_IF) | 128));
