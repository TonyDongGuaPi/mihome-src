...
final class zzjb extends zziy {
    ...
    public final int zzb(int r18, byte[] r19, int r20, int r21) {
        ...
        L_0x001e:
            ...
            long r13 = r11 + r9
            byte r3 = com.google.android.gms.internal.vision.zziu.zza((byte[]) r0, (long) r11)
        ...
        L_0x0032:
            ...
            long r2 = r7 + r9
            byte r7 = com.google.android.gms.internal.vision.zziu.zza((byte[]) r0, (long) r7)
        ...
        L_0x0087:
            r2 = 0
            long r7 = r13 + r9
            byte r2 = com.google.android.gms.internal.vision.zziu.zza((byte[]) r0, (long) r13)
        ...
        L_0x0098:
            int r1 = r1 + -3
            long r13 = r7 + r9
            byte r3 = com.google.android.gms.internal.vision.zziu.zza((byte[]) r0, (long) r7)
            ...
            long r2 = r13 + r9
            byte r7 = com.google.android.gms.internal.vision.zziu.zza((byte[]) r0, (long) r13)
            if (r7 > r11) goto L_0x00bb
            long r7 = r2 + r9
            byte r2 = com.google.android.gms.internal.vision.zziu.zza((byte[]) r0, (long) r2)
            if (r2 <= r11) goto L_0x0031
        L_0x00bb:
            return r12
        L_0x00bc:
        ...
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (r13 < i3) {
                ...
                if (zzix.zzd(zza2)) {
                    ...
                    int i11 = i6 + 1;
                    byte zza4 = zziu.zza(bArr, (long) i6);
                    int i12 = i11 + 1;
                    zzix.zza(zza2, zza4, zziu.zza(bArr, (long) i11), zziu.zza(bArr, (long) i12), cArr, i5);
                    r13 = i12 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzgf.zzfp();
    ...
    public final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i6 < length) {
            ...
            if (charAt3 < 128 && j < j4) {
                j2 = j + 1;
                zziu.zza(bArr2, j, (byte) charAt3);
            } else if (charAt3 < 2048 && j <= j4 - 2) {
                long j5 = j + 1;
                zziu.zza(bArr2, j, (byte) ((charAt3 >>> 6) | 960));
                j = j5 + 1;
                zziu.zza(bArr2, j5, (byte) ((charAt3 & Operators.CONDITION_IF) | 128));
                i6++;
            } else if ((charAt3 < 55296 || 57343 < charAt3) && j <= j4 - 3) {
                long j6 = j + 1;
                zziu.zza(bArr2, j, (byte) ((charAt3 >>> 12) | 480));
                long j7 = j6 + 1;
                zziu.zza(bArr2, j6, (byte) (((charAt3 >>> 6) & 63) | 128));
                j2 = j7 + 1;
                zziu.zza(bArr2, j7, (byte) ((charAt3 & Operators.CONDITION_IF) | 128));
            } else if (j <= j4 - 4) {
                int i7 = i6 + 1;
                if (i7 != length) {
                    ...
                    if (Character.isSurrogatePair(charAt3, charAt4)) {
                        ...
                        long j8 = j + 1;
                        zziu.zza(bArr2, j, (byte) ((codePoint >>> 18) | PsExtractor.VIDEO_STREAM_MASK));
                        long j9 = j8 + 1;
                        zziu.zza(bArr2, j8, (byte) (((codePoint >>> 12) & 63) | 128));
                        long j10 = j9 + 1;
                        zziu.zza(bArr2, j9, (byte) (((codePoint >>> 6) & 63) | 128));
                        j = j10 + 1;
                        zziu.zza(bArr2, j10, (byte) ((codePoint & 63) | 128));
                        i6 = i7;
                        i6++;
                    }
                } else {
    ...
    public final void zzb(java.lang.CharSequence r21, java.nio.ByteBuffer r22) {
        /*
            ...
            r0 = r21
            r1 = r22
            long r2 = com.google.android.gms.internal.vision.zziu.zzb(r22)
            int r4 = r22.position()
            long r4 = (long) r4
            long r4 = r4 + r2
            int r6 = r22.limit()
        ...
        L_0x0020:
            ...
            long r11 = r11 + r4
            byte r10 = (byte) r13
            com.google.android.gms.internal.vision.zziu.zza((long) r4, (byte) r10)
            int r9 = r9 + 1
            r4 = r11
            goto L_0x0020
        L_0x0035:
        ...
        L_0x003d:
            ...
            long r14 = r4 + r11
            byte r13 = (byte) r13
            com.google.android.gms.internal.vision.zziu.zza((long) r4, (byte) r13)
        L_0x004f:
            r4 = r11
        L_0x0050:
        ...
        L_0x0054:
            ...
            r10 = r10 | r13
            byte r10 = (byte) r10
            com.google.android.gms.internal.vision.zziu.zza((long) r14, (byte) r10)
            r14 = r4
            goto L_0x004f
        L_0x0077:
        ...
        L_0x00b0:
            ...
            byte r15 = (byte) r15
            com.google.android.gms.internal.vision.zziu.zza((long) r4, (byte) r15)
            long r4 = r13 + r11
            int r15 = r9 >>> 12
            r15 = r15 & 63
            r11 = 128(0x80, float:1.794E-43)
            ...
            byte r12 = (byte) r12
            com.google.android.gms.internal.vision.zziu.zza((long) r13, (byte) r12)
            r12 = 1
            long r14 = r4 + r12
            int r16 = r9 >>> 6
            r12 = r16 & 63
            r12 = r12 | r11
            byte r12 = (byte) r12
            com.google.android.gms.internal.vision.zziu.zza((long) r4, (byte) r12)
            r4 = 1
            long r12 = r14 + r4
            r9 = r9 & 63
            r9 = r9 | r11
            byte r9 = (byte) r9
            com.google.android.gms.internal.vision.zziu.zza((long) r14, (byte) r9)
            r9 = r10
            r14 = r12
        L_0x00fe:
            int r9 = r9 + 1
        ...
        L_0x0106:
            r9 = r10
        L_0x0107:
            com.google.android.gms.internal.vision.zzja r0 = new com.google.android.gms.internal.vision.zzja
            int r9 = r9 + -1
            r0.<init>(r9, r8)
            throw r0
        L_0x010f:
