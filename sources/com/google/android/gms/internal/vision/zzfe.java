...
public abstract class zzfe extends zzen {
    ...
    static final class zze extends zzfe {
        ...
        public final void zzc(byte b) throws IOException {
            ...
            throw new zzc(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(this.zztb), Long.valueOf(this.zzsz), 1}));
        }
        ...
        public final void zze(long j) throws IOException {
            ...
            while (this.zztb < this.zzsz) {
                ...
                long j5 = this.zztb;
                this.zztb = j5 + 1;
                zziu.zza(j5, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            throw new zzc(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(this.zztb), Long.valueOf(this.zzsz), 1}));
        }
