...
public final class zzr extends AbstractSafeParcelable {
    ...
    public final String toString() {
        return "PlayLoggerContext[" + "package=" + this.packageName + ',' + "packageVersionCode=" + this.zzi + ',' + "logSource=" + this.zzk + ',' + "logSourceName=" + this.zzj + ',' + "uploadAccount=" + this.zzl + ',' + "loggingId=" + this.zzm + ',' + "logAndroidId=" + this.zzay + ',' + "isAnonymous=" + this.zzn + ',' + "qosTier=" + this.zzaz + Operators.ARRAY_END_STR;
    }
