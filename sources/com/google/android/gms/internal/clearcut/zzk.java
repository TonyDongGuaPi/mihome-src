    ...
    public static long zza(byte[] bArr) {
        ...
        if (length <= 32) {
            if (length > 16) {
                ...
                return zza(((((long) zza(bArr2, 0)) & MessageHead.SERIAL_MAK) << 3) + ((long) length), ((long) zza(bArr2, (length + 0) - 4)) & MessageHead.SERIAL_MAK, ((long) (length << 1)) - 7286425919675154353L);
            } else if (length <= 0) {
            ...
            return zza(Long.rotateRight(zzb9 + zzb10, 43) + Long.rotateRight(zzb11, 30) + ((zza + zzb(bArr2, i3 - 24)) * j5), zzb9 + Long.rotateRight(zzb10 + zzb6, 18) + zzb11, j6);
        } else {
            ...
            while (true) {
                ...
                long rotateRight3 = (Long.rotateRight(j7 + jArr[1] + zzb(bArr2, i8 + 48), 42) * j) + jArr[0] + zzb(bArr2, i8 + 40);
                long rotateRight4 = Long.rotateRight(j8 + jArr2[0], 33) * j;
                int i9 = i6;
                int i10 = i5;
                ...
                if (i11 == i10) {
                    ...
                    long j10 = j9;
                    return zza(zza(jArr[0], jArr2[0], j10) + ((rotateRight6 ^ (rotateRight6 >>> 47)) * -4348849565147123417L) + rotateRight5, zza(jArr[1], jArr2[1], j10) + rotateRight7, j10);
                }
                i8 = i11;
                i6 = i9;
                i5 = i10;
