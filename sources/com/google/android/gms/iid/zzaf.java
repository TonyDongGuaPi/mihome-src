...
public final class zzaf {
    ...
    private final android.os.Bundle zzk(android.os.Bundle r9) throws java.io.IOException {
        /*
            ...
            monitor-enter(r2)
            java.util.Map<java.lang.String, java.lang.Object> r3 = r8.zzcu     // Catch:{ all -> 0x01da }
            r3.put(r1, r0)     // Catch:{ all -> 0x01da }
        ...
        L_0x00e0:
            ...
            r3.obj = r2
            android.os.Messenger r5 = r8.zzcv     // Catch:{ RemoteException -> 0x00f8 }
            r5.send(r3)     // Catch:{ RemoteException -> 0x00f8 }
            goto L_0x017f
        L_0x00f8:
            java.lang.String r3 = "InstanceID"
            boolean r3 = android.util.Log.isLoggable(r3, r4)
        ...
        L_0x0107:
            ...
            monitor-enter(r8)
            android.content.BroadcastReceiver r9 = zzct     // Catch:{ all -> 0x0140 }
            if (r9 != 0) goto L_0x013e
            com.google.android.gms.iid.zzah r9 = new com.google.android.gms.iid.zzah     // Catch:{ all -> 0x0140 }
            r9.<init>(r8)     // Catch:{ all -> 0x0140 }
            zzct = r9     // Catch:{ all -> 0x0140 }
            java.lang.String r9 = "InstanceID"
            boolean r9 = android.util.Log.isLoggable(r9, r4)     // Catch:{ all -> 0x0140 }
            if (r9 == 0) goto L_0x0124
            java.lang.String r9 = "InstanceID"
            java.lang.String r3 = "Registered GSF callback receiver"
            android.util.Log.d(r9, r3)     // Catch:{ all -> 0x0140 }
        L_0x0124:
            android.content.IntentFilter r9 = new android.content.IntentFilter     // Catch:{ all -> 0x0140 }
            java.lang.String r3 = "com.google.android.c2dm.intent.REGISTRATION"
            r9.<init>(r3)     // Catch:{ all -> 0x0140 }
            android.content.Context r3 = r8.zzk     // Catch:{ all -> 0x0140 }
            java.lang.String r3 = r3.getPackageName()     // Catch:{ all -> 0x0140 }
            r9.addCategory(r3)     // Catch:{ all -> 0x0140 }
            android.content.Context r3 = r8.zzk     // Catch:{ all -> 0x0140 }
            android.content.BroadcastReceiver r4 = zzct     // Catch:{ all -> 0x0140 }
            java.lang.String r5 = "com.google.android.c2dm.permission.SEND"
            r6 = 0
            r3.registerReceiver(r4, r9, r5, r6)     // Catch:{ all -> 0x0140 }
        L_0x013e:
        ...
        L_0x0143:
            ...
            r9.obj = r2
            com.google.android.gms.iid.MessengerCompat r3 = r8.zzcw     // Catch:{ RemoteException -> 0x0161 }
        ...
        L_0x017f:
            ...
            monitor-enter(r9)
            java.util.Map<java.lang.String, java.lang.Object> r0 = r8.zzcu     // Catch:{ all -> 0x01cf }
            java.lang.Object r0 = r0.remove(r1)     // Catch:{ all -> 0x01cf }
            boolean r1 = r0 instanceof android.os.Bundle     // Catch:{ all -> 0x01cf }
            if (r1 == 0) goto L_0x0197
            android.os.Bundle r0 = (android.os.Bundle) r0     // Catch:{ all -> 0x01cf }
            monitor-exit(r9)     // Catch:{ all -> 0x01cf }
            return r0
        L_0x0197:
            boolean r1 = r0 instanceof java.lang.String     // Catch:{ all -> 0x01cf }
            if (r1 == 0) goto L_0x01a3
            java.io.IOException r1 = new java.io.IOException     // Catch:{ all -> 0x01cf }
            java.lang.String r0 = (java.lang.String) r0     // Catch:{ all -> 0x01cf }
            r1.<init>(r0)     // Catch:{ all -> 0x01cf }
            throw r1     // Catch:{ all -> 0x01cf }
        L_0x01a3:
            java.lang.String r1 = "InstanceID"
            java.lang.String r0 = java.lang.String.valueOf(r0)     // Catch:{ all -> 0x01cf }
            java.lang.String r2 = java.lang.String.valueOf(r0)     // Catch:{ all -> 0x01cf }
            int r2 = r2.length()     // Catch:{ all -> 0x01cf }
            int r2 = r2 + 12
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ all -> 0x01cf }
            r3.<init>(r2)     // Catch:{ all -> 0x01cf }
            java.lang.String r2 = "No response "
            r3.append(r2)     // Catch:{ all -> 0x01cf }
            r3.append(r0)     // Catch:{ all -> 0x01cf }
            java.lang.String r0 = r3.toString()     // Catch:{ all -> 0x01cf }
            android.util.Log.w(r1, r0)     // Catch:{ all -> 0x01cf }
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x01cf }
            ...
            if ("com.google.android.c2dm.intent.REGISTRATION".equals(action) || "com.google.android.gms.iid.InstanceID".equals(action)) {
                ...
                if (stringExtra == null) {
                    ...
                    if (stringExtra2.startsWith("|")) {
                        String[] split = stringExtra2.split(PaymentOptionsDecoder.pipeSeparator);
