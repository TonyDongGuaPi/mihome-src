...
public final class zzc extends AbstractSafeParcelable {
    ...
    public final String toString() {
        return "CollectForDebugParcelable[skipPersistentStorage: " + this.zzad + ",collectForDebugStartTimeMillis: " + this.zzae + ",collectForDebugExpiryTimeMillis: " + this.zzaf + Operators.ARRAY_END_STR;
    }
