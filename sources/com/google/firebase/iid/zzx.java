...
final /* synthetic */ class zzx implements Runnable {
    ...
    public final void run() {
        /*
            r8 = this;
            com.google.firebase.iid.zzu r0 = r8.zzbo
        L_0x0002:
            monitor-enter(r0)
            ...
            return
        L_0x000a:
            java.util.Queue<com.google.firebase.iid.zzab<?>> r1 = r0.zzbl     // Catch:{ all -> 0x00ae }
            boolean r1 = r1.isEmpty()     // Catch:{ all -> 0x00ae }
            if (r1 == 0) goto L_0x0017
            r0.zzu()     // Catch:{ all -> 0x00ae }
            monitor-exit(r0)     // Catch:{ all -> 0x00ae }
            return
        L_0x0017:
            java.util.Queue<com.google.firebase.iid.zzab<?>> r1 = r0.zzbl     // Catch:{ all -> 0x00ae }
            java.lang.Object r1 = r1.poll()     // Catch:{ all -> 0x00ae }
            com.google.firebase.iid.zzab r1 = (com.google.firebase.iid.zzab) r1     // Catch:{ all -> 0x00ae }
            android.util.SparseArray<com.google.firebase.iid.zzab<?>> r3 = r0.zzbm     // Catch:{ all -> 0x00ae }
            int r4 = r1.zzbr     // Catch:{ all -> 0x00ae }
            r3.put(r4, r1)     // Catch:{ all -> 0x00ae }
            com.google.firebase.iid.zzs r3 = r0.zzbn     // Catch:{ all -> 0x00ae }
            java.util.concurrent.ScheduledExecutorService r3 = r3.zzbg     // Catch:{ all -> 0x00ae }
            com.google.firebase.iid.zzy r4 = new com.google.firebase.iid.zzy     // Catch:{ all -> 0x00ae }
        ...
        L_0x0066:
            com.google.firebase.iid.zzs r3 = r0.zzbn
            android.content.Context r3 = r3.zzz
            android.os.Messenger r4 = r0.zzbj
            ...
            android.os.Bundle r1 = r1.zzbt
            r4.putBundle(r3, r1)
            r5.setData(r4)
            com.google.firebase.iid.zzz r1 = r0.zzbk     // Catch:{ RemoteException -> 0x00a4 }
