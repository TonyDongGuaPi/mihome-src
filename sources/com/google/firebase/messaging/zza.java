...
final class zza {
    ...
    private final String zzd(Bundle bundle, String str) {
        ...
        int identifier = resources.getIdentifier(zzb, EventData.b, this.zzz.getPackageName());
        if (identifier == 0) {
            String valueOf = String.valueOf(str);
            String valueOf2 = String.valueOf("_loc_key");
    ...
    private final String zzn(String str) {
        ...
        try {
            ...
            Object newInstance = cls.getConstructor(new Class[]{String.class, CharSequence.class, Integer.TYPE}).newInstance(new Object[]{"fcm_fallback_notification_channel", this.zzz.getString(R.string.fcm_fallback_notification_channel_label), 3});
    ...
    public final boolean zzh(android.os.Bundle r14) {
        ...
        L_0x020b:
            android.content.Context r10 = r13.zzz
            java.util.concurrent.atomic.AtomicInteger r11 = r13.zzdd
        ...
        L_0x0217:
            ...
            r8.putExtra(r10, r9)
            android.content.Context r9 = r13.zzz
            java.util.concurrent.atomic.AtomicInteger r10 = r13.zzdd
            int r10 = r10.incrementAndGet()
            android.app.PendingIntent r8 = com.google.firebase.iid.zzan.zza(r9, r10, r8, r3)
            android.content.Intent r9 = new android.content.Intent
            ...
            java.util.concurrent.atomic.AtomicInteger r11 = r13.zzdd
            int r11 = r11.incrementAndGet()
            android.app.PendingIntent r3 = com.google.firebase.iid.zzan.zza(r10, r11, r9, r3)
            r10 = r3
            r9 = r8
            goto L_0x0252
        L_0x0251:
