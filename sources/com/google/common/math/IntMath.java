...
public final class IntMath {
    ...
    private static final int[] factorials = {1, 1, 2, 6, 24, 120, 720, TbsReaderView.ReaderCallback.READER_PLUGIN_COMMAND_TEXT_FIND_PREV, 40320, 362880, 3628800, 39916800, 479001600};
    @VisibleForTesting
    ...
    public static int pow(int i, int i2) {
        MathPreconditions.checkNonNegative(Constants.XMLNode.KEY_EXPONENT, i2);
        switch (i) {
            case -2:
                if (i2 < 32) {
