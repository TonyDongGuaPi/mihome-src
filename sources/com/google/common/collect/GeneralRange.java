...
final class GeneralRange<T> implements Serializable {
    ...
    public GeneralRange<T> intersect(GeneralRange<T> generalRange) {
        ...
        boolean z4 = z3;
        T t2 = upperEndpoint2;
        if (!z2 || !z4 || ((compare3 = this.comparator.compare(lowerEndpoint2, t2)) <= 0 && !(compare3 == 0 && lowerBoundType2 == BoundType.OPEN && upperBoundType2 == BoundType.OPEN))) {
    ...
    public String toString() {
        ...
        sb.append(":");
        sb.append(this.lowerBoundType == BoundType.CLOSED ? Operators.ARRAY_START : Operators.BRACKET_START);
        sb.append(this.hasLowerBound ? this.lowerEndpoint : "-∞");
        sb.append(',');
        sb.append(this.hasUpperBound ? this.upperEndpoint : "∞");
        sb.append(this.upperBoundType == BoundType.CLOSED ? Operators.ARRAY_END : Operators.BRACKET_END);
        return sb.toString();
    }
