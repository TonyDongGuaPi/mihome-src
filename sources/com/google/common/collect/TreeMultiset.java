...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    public AvlNode<E> firstNode() {
        ...
        if (this.range.hasLowerBound()) {
            ...
            AvlNode<E> access$800 = this.rootReference.get().ceiling(comparator(), lowerEndpoint);
            if (access$800 == null) {
                return null;
            }
    ...
    public AvlNode<E> lastNode() {
        ...
        if (this.range.hasUpperBound()) {
            ...
            AvlNode<E> access$1000 = this.rootReference.get().floor(comparator(), upperEndpoint);
            if (access$1000 == null) {
                return null;
            }
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        Serialization.getFieldSetter(TreeMultiset.class, Common.v).set(this, (Object) GeneralRange.all(comparator));
