...
public final class Predicates {
    ...
    private static class ContainsPatternPredicate implements Predicate<CharSequence>, Serializable {
        ...
        public String toString() {
            String valueOf = String.valueOf(String.valueOf(Objects.toStringHelper((Object) this.pattern).add(PatternFormatter.PATTERN_PROPERTY, (Object) this.pattern.pattern()).add("pattern.flags", this.pattern.flags()).toString()));
