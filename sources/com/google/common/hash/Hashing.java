...
public final class Hashing {
    ...
    private static class Sha1Holder {
        static final HashFunction SHA_1 = new MessageDigestHashFunction(DigestUtils.b, "Hashing.sha1()");
    ...
    public static HashCode combineOrdered(Iterable<HashCode> iterable) {
        ...
        for (HashCode asBytes : iterable) {
            ...
            for (int i = 0; i < asBytes2.length; i++) {
                bArr[i] = (byte) ((bArr[i] * Constants.TagName.ORDER_RANGE_TYPE) ^ asBytes2[i]);
            }
        }
