...
public final class AddressBookAUResultParser extends ResultParser {
    public AddressBookParsedResult parse(Result result) {
        ...
        String matchSinglePrefixedField = matchSinglePrefixedField("NAME1:", massagedText, CharUtils.b, true);
        String matchSinglePrefixedField2 = matchSinglePrefixedField("NAME2:", massagedText, CharUtils.b, true);
        ...
        String matchSinglePrefixedField3 = matchSinglePrefixedField("MEMORY:", massagedText, CharUtils.b, false);
        String matchSinglePrefixedField4 = matchSinglePrefixedField("ADD:", massagedText, CharUtils.b, true);
    ...
    private static String[] matchMultipleValuePrefix(String str, int i, String str2, boolean z) {
        ...
        for (int i2 = 1; i2 <= i; i2++) {
            String matchSinglePrefixedField = matchSinglePrefixedField(str + i2 + Operators.CONDITION_IF_MIDDLE, str2, CharUtils.b, z);
