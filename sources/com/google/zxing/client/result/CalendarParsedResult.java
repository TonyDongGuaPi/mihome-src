...
public final class CalendarParsedResult extends ParsedResult {
    ...
    private static final long[] RFC2445_DURATION_FIELD_UNITS = {DateUtils.d, 86400000, 3600000, 60000, 1000};
    ...
    private static long parseDate(String str) throws ParseException {
        if (!DATE_TIME.matcher(str).matches()) {
            ...
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat(StringUtils.SOURCE_DATE_FORMAT, Locale.ENGLISH);
