...
public final class ITFReader extends OneDReader {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:7:?, code lost:
        r3 = findGuardPattern(r7, r0, END_PATTERN_REVERSED[1]);
     */
    ...
    private int[] decodeEnd(com.google.zxing.common.BitArray r7) throws com.google.zxing.NotFoundException {
        /*
            ...
            int[] r3 = findGuardPattern(r7, r0, r3)     // Catch:{ NotFoundException -> 0x0012 }
            goto L_0x001a
        L_0x0012:
            int[][] r3 = END_PATTERN_REVERSED     // Catch:{ all -> 0x0035 }
            r3 = r3[r1]     // Catch:{ all -> 0x0035 }
            int[] r3 = findGuardPattern(r7, r0, r3)     // Catch:{ all -> 0x0035 }
        L_0x001a:
            r0 = r3[r2]     // Catch:{ all -> 0x0035 }
            r6.validateQuietZone(r7, r0)     // Catch:{ all -> 0x0035 }
            r0 = r3[r2]     // Catch:{ all -> 0x0035 }
