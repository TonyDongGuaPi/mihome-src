...
public final class CodaBarWriter extends OneDimensionalCodeWriter {
    private static final char[] ALT_START_END_CHARS = {PatternFormatter.THROWABLE_CONVERSION_CHAR, 'N', '*', 'E'};
    private static final char[] CHARS_WHICH_ARE_TEN_LENGTH_EACH_AFTER_DECODED = {IOUtils.f15883a, Operators.CONDITION_IF_MIDDLE, '+', '.'};
