...
public final class Detector {
    ...
    private ResultPoint[] getBullsEyeCorners(Point point) throws NotFoundException {
        ...
        if (this.nbCenterLayers == 5 || this.nbCenterLayers == 7) {
            ...
            return expandSquare(new ResultPoint[]{new ResultPoint(((float) point2.getX()) + 0.5f, ((float) point2.getY()) - 0.5f), new ResultPoint(((float) point3.getX()) + 0.5f, ((float) point3.getY()) + 0.5f), new ResultPoint(((float) point4.getX()) - 0.5f, ((float) point4.getY()) + 0.5f), new ResultPoint(((float) point5.getX()) - 0.5f, ((float) point5.getY()) - 0.5f)}, (this.nbCenterLayers * 2) - 3, this.nbCenterLayers * 2);
        }
        throw NotFoundException.getNotFoundInstance();
    }
    ...
    private BitMatrix sampleGrid(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4) throws NotFoundException {
        ...
        float f3 = f2;
        float f4 = f + ((float) this.nbCenterLayers);
        return instance.sampleGrid(bitMatrix, i2, i, f3, f2, f4, f2, f4, f4, f2, f4, resultPoint.getX(), resultPoint.getY(), resultPoint2.getX(), resultPoint2.getY(), resultPoint3.getX(), resultPoint3.getY(), resultPoint4.getX(), resultPoint4.getY());
    }
    ...
    static final class Point {
        ...
        public String toString() {
            return "<" + this.x + ' ' + this.y + Typography.e;
        }
    }
}
