...
public final class GenericGF {
    public static final GenericGF AZTEC_DATA_10 = new GenericGF(PhotoshopDirectory.F, 1024, 1);
    ...
    public String toString() {
        return "GF(0x" + Integer.toHexString(this.primitive) + ',' + this.size + Operators.BRACKET_END;
    }
}
