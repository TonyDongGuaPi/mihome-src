...
public class BlurTool {
    ...
    private static ExecutorService f2517a = Executors.newCachedThreadPool(new ThreadFactory() {
        public Thread newThread(Runnable runnable) {
            return new Thread(runnable, "wx_blur_thread");
        }
    });
    private static final String b = "BlurTool";
    ...
    public static Bitmap a(@NonNull Bitmap bitmap, int i) {
        ...
        Double.isNaN(d2);
        boolean z = true;
        Bitmap createScaledBitmap = Bitmap.createScaledBitmap(bitmap2, (int) (a2 * d), (int) (a2 * d2), true);
        int i3 = min;
        ...
        while (i4 < i2) {
            ...
            try {
                ...
                if (a3 != a2) {
                    ...
                    Double.isNaN(d2);
                    try {
                        bitmap3 = Bitmap.createScaledBitmap(bitmap2, i5, (int) (a3 * d2), z);
                        a2 = a3;
                    } catch (Exception e) {
                        e = e;
                        a2 = a3;
                        WXLogUtils.e(b, "thrown exception when blurred image(times = " + i4 + ")," + e.getMessage());
                        i3 = Math.max(0, i3 + -1);
                        i4++;
                        i2 = 3;
                        z = true;
        ...
        WXLogUtils.d(b, "elapsed time on blurring image(radius:" + i3 + ",sampling: " + a2 + "): " + (System.currentTimeMillis() - currentTimeMillis) + d.H);
        return bitmap2;
    }

    public static void a(@NonNull final Bitmap bitmap, final int i, @Nullable final OnBlurCompleteListener onBlurCompleteListener) {
        f2517a.execute(new Runnable() {
            public void run() {
                if (onBlurCompleteListener != null) {
                    onBlurCompleteListener.a(BlurTool.a(bitmap, i));
                }
            }
        });
    }
