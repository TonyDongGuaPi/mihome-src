...
public class PaymentOptions extends Activity {
    ...
    public void a(boolean z) {
        ...
        if (this.f8358a.size() != 1) {
            ...
            if (this.f8358a.contains(PaymentInstrumentType.SAVED_CARD) && b.b((Context) this).h() != null && b.b((Context) this).h().length > 0) {
                ...
                button.setOnClickListener(new C0094r(this));
            }
            if (this.f8358a.contains(PaymentInstrumentType.CREDIT_CARD)) {
            ...
            if (this.f8358a.contains(PaymentInstrumentType.DEBIT_CARD)) {
            ...
            if (this.f8358a.contains(PaymentInstrumentType.NETBANKING)) {
            ...
            if (this.f8358a.contains(PaymentInstrumentType.MK_WALLET)) {
            ...
            arrayList.clear();
        } else if (this.f8358a.contains(PaymentInstrumentType.MK_WALLET) && z) {
            payByMkWallet((View) null);
        } else if (this.f8358a.contains(PaymentInstrumentType.CREDIT_CARD) && z) {
            payByCC((View) null);
        } else if (this.f8358a.contains(PaymentInstrumentType.DEBIT_CARD) && z) {
            payByDC((View) null);
        } else if (this.f8358a.contains(PaymentInstrumentType.NETBANKING) && z) {
            payByNetbanking((View) null);
        }
    }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i == 1) {
            if (i2 == -1) {
                ...
                a((Intent) null, SDKErrorCodes.USER_CANCELLED_TRANSACTION.getErrorCode(), SDKErrorCodes.USER_CANCELLED_TRANSACTION.getErrorDescription());
            }
        }
        if (i == 2 && i2 == 1) {
    ...
    public void onBackPressed() {
        ...
        builder.setCancelable(false).setIcon(17301543).setTitle(Constants.QUIT_PAYMENT_FLOW_TITLE).setMessage(Constants.QUIT_PAYMENT_FLOW_DESC).setPositiveButton(IntentIntegrator.d, new x(this)).setNegativeButton(IntentIntegrator.e, new w(this));
        builder.create().show();
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.b = b.b((Context) this).d();
        this.f8358a = b.b((Context) this).b();
        if (bundle == null) {
            a(true);
        }
    }
