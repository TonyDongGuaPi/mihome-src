...
class c extends AsyncTask {
    ...
    public String doInBackground(Void... voidArr) {
        return Network.getResponseOfFormPostRequest(this.f8361a, this.b, this.c, 50000, this.d, false);
    }
    ...
    public void onPostExecute(String str) {
        ...
        if (!Network.validateNetworkResponse(this.f.f8355a, str, false)) {
            ...
            this.e.loadDataWithBaseURL(this.f8361a, str, NanoHTTPD.c, "UTF-8", (String) null);
        }
    }
}
