...
public class b implements Serializable {
    ...
    public TransactionConfiguration f8380a;
    ...
    public void a(TransactionConfiguration transactionConfiguration) {
        this.f8380a = transactionConfiguration;
    }
    ...
    public String k() {
        return (Constants.getServerUrl(this.f8380a.getMode()) + "mobilePaymentResponse.do") + "?userId=" + this.e.getUser().getEmail() + "&param1=" + this.f8380a.getMbkId() + "&param2=" + e() + "&param3=" + this.e.getAmount() + "&version=4";
    }
}
