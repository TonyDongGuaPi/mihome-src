...
public class o extends aj implements View.OnClickListener {
    ...
    SavedCardResponse.CardDetails[] f8405a;
    ...
    class a extends AsyncTask {
        ...
        /* renamed from: a  reason: collision with root package name */
        SavedCardResponse.CardDetails f8406a;

        public a(SavedCardResponse.CardDetails cardDetails) {
            this.f8406a = cardDetails;
        }
        ...
        public String doInBackground(Void... voidArr) {
            ...
            return Network.getResponseFromQuery(o.this.k, "https://api.zaakpay.com/removeCard?mode=0&merchantIdentifier=" + zaakpayMerchantIdForAmount + "&buyerEmail=" + o.this.l.getUser().getEmail() + "&cardId=" + this.f8406a.cardId);
        }
        ...
        public void onPreExecute() {
            ProgressDialog unused = o.this.u = ProgressDialog.show(o.this.k, (CharSequence) null, "Processing your request...", true);
        }
    }
    ...
    private void a(View view) {
        View inflate = LayoutInflater.from(this.k).inflate(R.layout.mk_layout_cvv, (ViewGroup) null, false);
    ...
    private void b(View view) {
        this.f8405a = this.r ? com.mobikwik.sdk.ui.data.b.b((Context) this.k).g() : com.mobikwik.sdk.ui.data.b.b((Context) this.k).h();
        int applyDimension = (int) TypedValue.applyDimension(1, 5.0f, getResources().getDisplayMetrics());
        LinearLayout linearLayout = (LinearLayout) view.findViewById(R.id.layout_saved_cards);
        linearLayout.removeAllViews();
        this.i = null;
        if (this.f8405a == null || this.f8405a.length == 0) {
        ...
        int i2 = 0;
        while (i2 < this.f8405a.length) {
            if (i2 == 0) {
                a(linearLayout);
            }
            SavedCardResponse.CardDetails cardDetails = this.f8405a[i2];
        ...
        if (this.f8405a.length == 1 && textView2 != null) {
    ...
    private void b(ViewGroup viewGroup) {
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            ...
            if (childAt instanceof ViewGroup) {
                ...
                SavedCardResponse.CardDetails cardDetails2 = (SavedCardResponse.CardDetails) textView2.getTag();
                ViewGroup viewGroup2 = (ViewGroup) textView2.getParent();
                if (cardDetails2 == this.i) {
                    ...
                    viewGroup2.setBackgroundDrawable((Drawable) null);
                } else {
    ...
    public void a(SavedCardResponse.CardDetails cardDetails) {
        ...
        if (Network.isConnected(this.k)) {
            com.mobikwik.sdk.ui.data.b b2 = com.mobikwik.sdk.ui.data.b.b((Context) this.k);
            if (this.r) {
                this.u = ProgressDialog.show(this.k, (CharSequence) null, "Processing your request...", true);
    ...
    public void a(SavedCardResponse.CardDetails cardDetails, String str) {
        ...
        if (cardDetails != null) {
            SavedCardResponse.CardDetails[] g = this.r ? com.mobikwik.sdk.ui.data.b.b((Context) this.k).g() : com.mobikwik.sdk.ui.data.b.b((Context) this.k).h();
            if (g != null) {
            ...
            this.f8405a = cardDetailsArr;
            if (this.r) {
                com.mobikwik.sdk.ui.data.b.b((Context) this.k).a(cardDetailsArr);
            } else {
                com.mobikwik.sdk.ui.data.b.b((Context) this.k).b(cardDetailsArr);
            }
            this.i = null;
            b(getView());
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.button_savedcard_pay) {
            ...
            if (this.i == null || this.f8405a.length != 1) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        com.mobikwik.sdk.ui.data.b.b((Context) getActivity());
        this.s = WalletAPIs.getInstance("1".equals(com.mobikwik.sdk.ui.data.b.b((Context) getActivity()).f().getMode()), getActivity());
        View inflate = layoutInflater.inflate(R.layout.mk_fragment_saved_cards, viewGroup, false);
