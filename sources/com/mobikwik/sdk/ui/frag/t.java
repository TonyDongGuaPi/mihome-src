...
public class t extends Fragment {
    ...
    public void a(View view) {
        ...
        if (b.b((Context) this.b).g() == null || b.b((Context) this.b).g().length <= 0) {
            button = null;
        } else {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.f8411a = b.b((Context) this.b).d();
        a(inflate);
        l.a((TextView) inflate.findViewById(R.id.amount), this.f8411a.getAmount(), b.b((Context) this.b).e());
        return inflate;
    }
}
