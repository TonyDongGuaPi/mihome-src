...
public class APICallTask extends AsyncTask {
    ...
    public String doInBackground(Void... voidArr) {
        return this.data == null ? Network.getResponseOfPostRequest(this.url, this.jsondata, "application/json", (String) null) : Network.getResponseOfPostRequest(this.url, this.data);
    }
