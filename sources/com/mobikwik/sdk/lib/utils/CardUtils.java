...
public class CardUtils {
    ...
    public static String detectType(String str) {
        ...
        return parseInt == 4 ? "visa" : (parseInt2 < 51 || parseInt2 > 55) ? (parseInt2 == 34 || parseInt2 == 37 || parseInt3 == 3528 || parseInt3 == 3589) ? "amex" : (i < 300000 || i > 305999) ? (i < 309500 || i > 309599) ? (i < 360000 || i > 369999) ? (i < 380000 || i > 389999) ? (i < 601100 || i > 601109) ? (i < 601120 || i > 601149) ? (i < 601174 || i > 601174) ? (i < 601177 || i > 601179) ? (i < 601186 || i > 601199) ? (i < 644000 || i > 659999) ? (i < 508500 || i > 508999) ? (i < 606985 || i > 607384) ? (i < 607385 || i > 607484) ? (i < 607485 || i > 607984) ? (i < 608001 || i > 608100) ? (i < 608101 || i > 608200) ? (i < 608201 || i > 608300) ? (i < 608301 || i > 608350) ? (i < 608351 || i > 608500) ? (i < 652150 || i > 652849) ? (i < 652850 || i > 653049) ? (i < 653050 || i > 653149) ? (str.matches(REGEX_FOR_MAESTRO) || str.length() > 16) ? "maestro" : "Unsupported Card" : Constants.CARD_TYPE_RUPAY : Constants.CARD_TYPE_RUPAY : Constants.CARD_TYPE_RUPAY : Constants.CARD_TYPE_RUPAY : Constants.CARD_TYPE_RUPAY : Constants.CARD_TYPE_RUPAY : Constants.CARD_TYPE_RUPAY : Constants.CARD_TYPE_RUPAY : Constants.CARD_TYPE_RUPAY : Constants.CARD_TYPE_RUPAY : Constants.CARD_TYPE_RUPAY : Constants.CARD_TYPE_RUPAY : "discover" : "discover" : "discover" : "discover" : "discover" : "discover" : "diners" : "diners" : "diners" : "diners" : "mastercard";
    }
