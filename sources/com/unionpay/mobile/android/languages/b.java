...
public final class b extends c {
    public b() {
        this.b = "© 2019 UnionPay All Rights Reserved";
        this.c = "Loading...";
        ...
        this.W = "Confirm";
        this.X = WXModalUIModule.CANCEL;
        this.Y = "Info";
        this.ae = "New Version";
        this.af = "Update Now";
        this.ag = WXModalUIModule.CANCEL;
        this.ah = "Exit";
        this.ai = "Mini IC";
        this.aj = "SIM";
        this.ak = "SD";
