...
public final class b implements X509TrustManager {
    ...
    private X509TrustManager f9536a = null;
    ...
    public b(Context context) {
        ...
        if (trustManagers.length != 0) {
            this.f9536a = (X509TrustManager) trustManagers[0];
            if (Build.VERSION.SDK_INT > 23) {
                this.b = new X509TrustManagerExtensions(this.f9536a);
                return;
            }
            return;
        }
    ...
    public final void checkClientTrusted(X509Certificate[] x509CertificateArr, String str) {
        this.f9536a.checkClientTrusted(x509CertificateArr, str);
    }

    public final void checkServerTrusted(X509Certificate[] x509CertificateArr, String str) {
        boolean z;
        if (Build.VERSION.SDK_INT <= 23 || this.b == null) {
            this.f9536a.checkServerTrusted(x509CertificateArr, str);
        } else {
        ...
        try {
            ...
            String a2 = com.unionpay.utils.b.a(this.c);
    ...
    public final X509Certificate[] getAcceptedIssuers() {
        return this.f9536a.getAcceptedIssuers();
    }
}
