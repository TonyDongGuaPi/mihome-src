...
public interface ITsmConnectionCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITsmConnectionCallback {
        ...
        public static ITsmConnectionCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ITsmConnectionCallback)) ? new Proxy(iBinder) : (ITsmConnectionCallback) queryLocalInterface;
        }
