...
public class BitmapEncoder implements ResourceEncoder<Bitmap> {
    ...
    public static final Option<Integer> f4993a = Option.a("com.bumptech.glide.load.resource.bitmap.BitmapEncoder.CompressionQuality", 90);
    ...
    public boolean a(@android.support.annotation.NonNull com.bumptech.glide.load.engine.Resource<android.graphics.Bitmap> r8, @android.support.annotation.NonNull java.io.File r9, @android.support.annotation.NonNull com.bumptech.glide.load.Options r10) {
        /*
            r7 = this;
            ...
            com.bumptech.glide.util.pool.GlideTrace.a(r1, r2, r3, r0)
            long r1 = com.bumptech.glide.util.LogTime.a()     // Catch:{ all -> 0x00c6 }
            com.bumptech.glide.load.Option<java.lang.Integer> r3 = f4993a     // Catch:{ all -> 0x00c6 }
            java.lang.Object r3 = r10.a(r3)     // Catch:{ all -> 0x00c6 }
            ...
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r9 = r7.d     // Catch:{ IOException -> 0x0052, all -> 0x004f }
            ...
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r5 = r7.d     // Catch:{ IOException -> 0x0052, all -> 0x004f }
        ...
        L_0x006b:
            ...
            r3.append(r0)     // Catch:{ all -> 0x00c6 }
            int r0 = com.bumptech.glide.util.Util.b((android.graphics.Bitmap) r8)     // Catch:{ all -> 0x00c6 }
            r3.append(r0)     // Catch:{ all -> 0x00c6 }
            java.lang.String r0 = " in "
            r3.append(r0)     // Catch:{ all -> 0x00c6 }
            double r0 = com.bumptech.glide.util.LogTime.a(r1)     // Catch:{ all -> 0x00c6 }
            r3.append(r0)     // Catch:{ all -> 0x00c6 }
            java.lang.String r0 = ", options format: "
            r3.append(r0)     // Catch:{ all -> 0x00c6 }
            com.bumptech.glide.load.Option<android.graphics.Bitmap$CompressFormat> r0 = b     // Catch:{ all -> 0x00c6 }
            java.lang.Object r10 = r10.a(r0)     // Catch:{ all -> 0x00c6 }
