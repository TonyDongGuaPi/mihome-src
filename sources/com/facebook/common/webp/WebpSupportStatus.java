...
public class WebpSupportStatus {
    ...
    private static final byte[] WEBP_NAME_BYTES = asciiBytes(WebpDirectory.o);
    private static final byte[] WEBP_RIFF_BYTES = asciiBytes("RIFF");
    private static final byte[] WEBP_VP8L_BYTES = asciiBytes(WebpDirectory.j);
    private static final byte[] WEBP_VP8X_BYTES = asciiBytes(WebpDirectory.i);
    private static final byte[] WEBP_VP8_BYTES = asciiBytes(WebpDirectory.k);
