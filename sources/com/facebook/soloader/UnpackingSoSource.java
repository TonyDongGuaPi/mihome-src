...
public abstract class UnpackingSoSource extends DirectorySoSource {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:65:?, code lost:
        r6.close();
     */
    /* JADX WARNING: Removed duplicated region for block: B:53:0x00bb A[ExcHandler: all (th java.lang.Throwable)] */
    ...
    private boolean refreshLocked(com.facebook.soloader.FileLocker r12, int r13, byte[] r14) throws java.io.IOException {
        ...
        L_0x0047:
            ...
            r0.<init>(r4, r6)
            long r8 = r0.length()     // Catch:{ Throwable -> 0x010c }
            int r6 = (int) r8     // Catch:{ Throwable -> 0x010c }
            byte[] r6 = new byte[r6]     // Catch:{ Throwable -> 0x010c }
            int r8 = r0.read(r6)     // Catch:{ Throwable -> 0x010c }
            int r9 = r6.length     // Catch:{ Throwable -> 0x010c }
            if (r8 == r9) goto L_0x0071
            java.lang.String r3 = "fb-UnpackingSoSource"
            java.lang.String r8 = "short read of so store deps file: marking unclean"
            android.util.Log.v(r3, r8)     // Catch:{ Throwable -> 0x010c }
            r3 = 0
        L_0x0071:
            boolean r6 = java.util.Arrays.equals(r6, r14)     // Catch:{ Throwable -> 0x010c }
            if (r6 != 0) goto L_0x007f
            java.lang.String r3 = "fb-UnpackingSoSource"
            java.lang.String r6 = "deps mismatch on deps store: regenerating"
            android.util.Log.v(r3, r6)     // Catch:{ Throwable -> 0x010c }
            r3 = 0
        L_0x007f:
            if (r3 != 0) goto L_0x00d0
            java.lang.String r6 = "fb-UnpackingSoSource"
            java.lang.String r8 = "so store dirty: regenerating"
            android.util.Log.v(r6, r8)     // Catch:{ Throwable -> 0x010c }
            writeState(r5, r2)     // Catch:{ Throwable -> 0x010c }
            com.facebook.soloader.UnpackingSoSource$Unpacker r6 = r11.makeUnpacker()     // Catch:{ Throwable -> 0x010c }
            com.facebook.soloader.UnpackingSoSource$DsoManifest r8 = r6.getDsoManifest()     // Catch:{ Throwable -> 0x00be, all -> 0x00bb }
            com.facebook.soloader.UnpackingSoSource$InputDsoIterator r9 = r6.openDsoIterator()     // Catch:{ Throwable -> 0x00be, all -> 0x00bb }
            r11.regenerate(r3, r8, r9)     // Catch:{ Throwable -> 0x00a9, all -> 0x00a6 }
            if (r9 == 0) goto L_0x00a0
            r9.close()     // Catch:{ Throwable -> 0x00be, all -> 0x00bb }
        L_0x00a0:
            if (r6 == 0) goto L_0x00d1
            r6.close()     // Catch:{ Throwable -> 0x010c }
            goto L_0x00d1
        L_0x00a6:
            r12 = move-exception
            r13 = r1
        ...
        L_0x00af:
            ...
            r9.close()     // Catch:{ Throwable -> 0x00ba, all -> 0x00bb }
            goto L_0x00ba
        L_0x00b7:
            r9.close()     // Catch:{ Throwable -> 0x00be, all -> 0x00bb }
        L_0x00ba:
            throw r12     // Catch:{ Throwable -> 0x00be, all -> 0x00bb }
        L_0x00bb:
            r12 = move-exception
            r13 = r1
            goto L_0x00c4
        ...
        L_0x00c4:
            ...
            r6.close()     // Catch:{ Throwable -> 0x00cf }
            goto L_0x00cf
        L_0x00cc:
            r6.close()     // Catch:{ Throwable -> 0x010c }
        L_0x00cf:
            throw r12     // Catch:{ Throwable -> 0x010c }
        L_0x00d0:
            r8 = r1
        L_0x00d1:
            r0.close()
        ...
        L_0x010f:
            ...
            r0.close()     // Catch:{ Throwable -> 0x0118 }
            goto L_0x0118
        L_0x0115:
            r0.close()
        L_0x0118:
