...
public class WifiScannerImpl implements WifiScanner {
    ...
    private java.util.List<com.facebook.places.internal.WifiScanResult> getActiveScanResults() throws com.facebook.places.internal.ScannerException {
        /*
            r5 = this;
            r0 = 0
            android.content.Context r1 = r5.context     // Catch:{ Exception -> 0x0032, all -> 0x002d }
            boolean r1 = com.facebook.internal.Validate.hasChangeWifiStatePermission(r1)     // Catch:{ Exception -> 0x0032, all -> 0x002d }
            if (r1 == 0) goto L_0x0032
            r5.registerBroadcastReceiver()     // Catch:{ Exception -> 0x0032, all -> 0x002d }
            android.net.wifi.WifiManager r1 = r5.wifiManager     // Catch:{ Exception -> 0x0032, all -> 0x002d }
            boolean r1 = r1.startScan()     // Catch:{ Exception -> 0x0032, all -> 0x002d }
            if (r1 == 0) goto L_0x0032
        ...
        L_0x0027:
            java.util.List r1 = r5.getCachedScanResults()     // Catch:{ Exception -> 0x0032, all -> 0x002d }
            r0 = r1
            goto L_0x0032
        L_0x002d:
            r0 = move-exception
