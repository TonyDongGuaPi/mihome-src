...
public final class FetchedAppSettingsManager {
    ...
    public static FetchedAppSettings parseAppSettingsFromJSON(String str, JSONObject jSONObject) {
        ...
        FetchedAppSettings fetchedAppSettings3 = new FetchedAppSettings(jSONObject2.optBoolean(APP_SETTING_SUPPORTS_IMPLICIT_SDK_LOGGING, false), jSONObject2.optString(APP_SETTING_NUX_CONTENT, ""), jSONObject2.optBoolean(APP_SETTING_NUX_ENABLED, false), jSONObject2.optInt(APP_SETTING_APP_EVENTS_SESSION_TIMEOUT, Constants.getDefaultAppEventsSessionTimeoutInSeconds()), SmartLoginOption.parseOptions(jSONObject2.optLong(APP_SETTING_SMART_LOGIN_OPTIONS)), parseDialogConfigurations(jSONObject2.optJSONObject(APP_SETTING_DIALOG_CONFIGS)), z, facebookRequestErrorClassification, jSONObject2.optString(SMART_LOGIN_BOOKMARK_ICON_URL), jSONObject2.optString(SMART_LOGIN_MENU_ICON_URL), z2, z3, optJSONArray2, jSONObject2.optString(SDK_UPDATE_MESSAGE), z4, jSONObject2.optString(APP_SETTING_APP_EVENTS_AAM_RULE), jSONObject2.optString(SUGGESTED_EVENTS_SETTING), jSONObject2.optString(APP_SETTING_RESTRICTIVE_EVENT_FILTER_FIELD));
