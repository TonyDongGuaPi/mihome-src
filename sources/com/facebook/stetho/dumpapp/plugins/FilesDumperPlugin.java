...
public class FilesDumperPlugin implements DumperPlugin {
    ...
    public void dump(DumperContext dumperContext) throws DumpException {
        ...
        } else if (Constants.TitleMenu.MENU_DOWNLOAD.equals(nextOptionalArg)) {
    ...
    private void doDownload(PrintStream printStream, Iterator<String> it) throws DumpUsageException {
        ...
        try {
            fileOutputStream = "-".equals(nextArg) ? printStream : new FileOutputStream(resolvePossibleSdcardPath(nextArg));
