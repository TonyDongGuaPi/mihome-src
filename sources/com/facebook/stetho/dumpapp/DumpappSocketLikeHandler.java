...
public class DumpappSocketLikeHandler implements SocketLikeHandler {
    public static final byte[] PROTOCOL_MAGIC = {Constants.TagName.TERMINAL_OS_VERSION, Constants.TagName.TERMINAL_BACK_CHILDREN_ID, 77, Constants.TagName.ORDER_BRIEF_INFO_LIST};
