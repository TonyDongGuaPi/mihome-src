...
public final class AccessibilityNodeInfoWrapper {
    ...
    public static String getActions(View view) {
        ...
        try {
            ...
            for (AccessibilityNodeInfoCompat.AccessibilityActionCompat next : createNodeInfoFromView.getActionList()) {
                if (sb.length() > 0) {
                    sb.append(", ");
                }
                switch (next.getId()) {
                    case 1:
                        sb.append(Constants.Event.FOCUS);
                        break;
                    case 2:
                    ...
                    case 8192:
                        ...
                        break;
                    case 16384:
                        sb.append(ShareRecordConstant.j);
                        break;
                    case 32768:
                        sb.append("paste");
                        break;
