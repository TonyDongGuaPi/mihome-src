...
public final class ShareApi {
    ...
    private void addCommonParameters(Bundle bundle, ShareContent shareContent2) {
        ...
        if (!Utility.isNullOrEmpty(peopleIds)) {
            bundle.putString(CommandMessage.TYPE_TAGS, TextUtils.join(", ", peopleIds));
        }
    ...
    public static void handleImagesOnAction(android.os.Bundle r9) {
        /*
            java.lang.String r0 = "image"
            java.lang.String r0 = r9.getString(r0)
            if (r0 == 0) goto L_0x004d
            r1 = 0
            org.json.JSONArray r2 = new org.json.JSONArray     // Catch:{ JSONException -> 0x0040 }
            r2.<init>(r0)     // Catch:{ JSONException -> 0x0040 }
            r3 = 0
        L_0x000f:
            int r4 = r2.length()     // Catch:{ JSONException -> 0x0040 }
            if (r3 >= r4) goto L_0x003a
            org.json.JSONObject r4 = r2.optJSONObject(r3)     // Catch:{ JSONException -> 0x0040 }
            if (r4 == 0) goto L_0x001f
            putImageInBundleWithArrayFormat(r9, r3, r4)     // Catch:{ JSONException -> 0x0040 }
            goto L_0x0037
        L_0x001f:
            java.lang.String r4 = r2.getString(r3)     // Catch:{ JSONException -> 0x0040 }
            java.util.Locale r5 = java.util.Locale.ROOT     // Catch:{ JSONException -> 0x0040 }
            java.lang.String r6 = "image[%d][url]"
            r7 = 1
            java.lang.Object[] r7 = new java.lang.Object[r7]     // Catch:{ JSONException -> 0x0040 }
            java.lang.Integer r8 = java.lang.Integer.valueOf(r3)     // Catch:{ JSONException -> 0x0040 }
            r7[r1] = r8     // Catch:{ JSONException -> 0x0040 }
            java.lang.String r5 = java.lang.String.format(r5, r6, r7)     // Catch:{ JSONException -> 0x0040 }
    ...
    private Bundle getSharePhotoCommonParameters(SharePhoto sharePhoto, SharePhotoContent sharePhotoContent) throws JSONException {
        ...
        if (!parameters.containsKey(CommandMessage.TYPE_TAGS) && !Utility.isNullOrEmpty(sharePhotoContent.getPeopleIds())) {
            ...
            if (!Utility.isNullOrEmpty(peopleIds)) {
                ...
                parameters.putString(CommandMessage.TYPE_TAGS, jSONArray.toString());
            }
        }
    ...
    public void stageOpenGraphObject(final ShareOpenGraphObject shareOpenGraphObject, final CollectionMapper.OnMapValueCompleteListener onMapValueCompleteListener) {
        ...
        stageCollectionValues(r0, new CollectionMapper.OnMapperCompleteListener() {
            public void onComplete() {
                ...
                Bundle bundle = new Bundle();
                bundle.putString(EventData.e, jSONObject);
                try {
                    AccessToken currentAccessToken = AccessToken.getCurrentAccessToken();
