...
public class MessengerShareContentUtility {
    ...
    private static String getImageRatioString(ShareMessengerGenericTemplateContent.ImageAspectRatio imageAspectRatio) {
        return (imageAspectRatio != null && AnonymousClass1.$SwitchMap$com$facebook$share$model$ShareMessengerGenericTemplateContent$ImageAspectRatio[imageAspectRatio.ordinal()] == 1) ? IMAGE_RATIO_SQUARE : "horizontal";
    }
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ...
                r0 = 1
                int[] r1 = $SwitchMap$com$facebook$share$model$ShareMessengerMediaTemplateContent$MediaType     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                ...
                int r1 = r1.length
                int[] r1 = new int[r1]
                $SwitchMap$com$facebook$share$model$ShareMessengerGenericTemplateContent$ImageAspectRatio = r1
                int[] r1 = $SwitchMap$com$facebook$share$model$ShareMessengerGenericTemplateContent$ImageAspectRatio     // Catch:{ NoSuchFieldError -> 0x0027 }
            ...
            L_0x0027:
                ...
                int r1 = r1.length
                int[] r1 = new int[r1]
                $SwitchMap$com$facebook$share$model$ShareMessengerURLActionButton$WebviewHeightRatio = r1
                int[] r1 = $SwitchMap$com$facebook$share$model$ShareMessengerURLActionButton$WebviewHeightRatio     // Catch:{ NoSuchFieldError -> 0x003a }
            ...
            L_0x003a:
                int[] r0 = $SwitchMap$com$facebook$share$model$ShareMessengerURLActionButton$WebviewHeightRatio     // Catch:{ NoSuchFieldError -> 0x0045 }
