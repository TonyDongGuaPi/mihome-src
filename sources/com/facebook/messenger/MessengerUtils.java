...
public class MessengerUtils {
    ...
    public static MessengerThreadParams getMessengerThreadParamsForIntent(Intent intent) {
        ...
        Bundle b = AppLinks.b(intent);
        String string = b.getString(EXTRA_THREAD_TOKEN_KEY);
        String string2 = b.getString(EXTRA_METADATA);
        String string3 = b.getString(EXTRA_PARTICIPANTS);
        boolean z = b.getBoolean(EXTRA_IS_REPLY);
        boolean z2 = b.getBoolean(EXTRA_IS_COMPOSE);
