...
final class FeatureExtractor {
    ...
    private static float[] parseFeatures(JSONObject jSONObject) {
        ...
        if (matchIndicators(new String[]{Operators.DOLLAR_STR, "amount", "price", "total"}, strArr)) {
        ...
        if (matchIndicators(new String[]{"complete", "confirm", AbstractEditComponent.ReturnTypes.DONE, "submit"}, new String[]{lowerCase})) {
