...
public class WebpUtil {
    ...
    public static Pair<Integer, Integer> getSize(InputStream inputStream) {
        ...
        try {
            ...
            getInt(inputStream);
            inputStream.read(bArr);
            if (!compare(bArr, WebpDirectory.o)) {
                if (inputStream != null) {
                    try {
                        inputStream.close();
    ...
    private static Pair<Integer, Integer> getVP8LDimension(InputStream inputStream) throws IOException {
        ...
        return new Pair<>(Integer.valueOf(((((byte) inputStream.read()) & 255) | ((read & Constants.TagName.CARD_APP_ACTIVATION_STATUS) << 8)) + 1), Integer.valueOf(((((((byte) inputStream.read()) & 255) & 15) << 10) | ((((byte) inputStream.read()) & 255) << 2) | ((read & Constants.TagName.STATION_ENAME) >> 6)) + 1));
    }
