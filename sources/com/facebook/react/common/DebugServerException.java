...
public class DebugServerException extends RuntimeException {
    ...
    public static DebugServerException parse(String str, String str2) {
        ...
        try {
            ...
            return new DebugServerException(jSONObject.getString("message"), shortenFileName(jSONObject.getString("filename")), jSONObject.getInt(StackTraceHelper.LINE_NUMBER_KEY), jSONObject.getInt("column"));
