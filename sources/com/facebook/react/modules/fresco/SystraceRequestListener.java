...
public class SystraceRequestListener extends BaseRequestListener {
    ...
    public void onProducerStart(String str, String str2) {
        if (Systrace.isTracing(0)) {
            Pair create = Pair.create(Integer.valueOf(this.mCurrentID), "FRESCO_PRODUCER_" + str2.replace(Operators.CONDITION_IF_MIDDLE, '_'));
    ...
    public void onProducerEvent(String str, String str2, String str3) {
        if (Systrace.isTracing(0)) {
            Systrace.traceInstant(0, "FRESCO_PRODUCER_EVENT_" + str.replace(Operators.CONDITION_IF_MIDDLE, '_') + JSMethod.NOT_SET + str2.replace(Operators.CONDITION_IF_MIDDLE, '_') + JSMethod.NOT_SET + str3.replace(Operators.CONDITION_IF_MIDDLE, '_'), Systrace.EventScope.THREAD);
        }
    }

    public void onRequestStart(ImageRequest imageRequest, Object obj, String str, boolean z) {
        if (Systrace.isTracing(0)) {
            Pair create = Pair.create(Integer.valueOf(this.mCurrentID), "FRESCO_REQUEST_" + imageRequest.getSourceUri().toString().replace(Operators.CONDITION_IF_MIDDLE, '_'));
            Systrace.beginAsyncSection(0, (String) create.second, this.mCurrentID);
