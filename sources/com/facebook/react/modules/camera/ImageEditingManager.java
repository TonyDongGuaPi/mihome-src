...
public class ImageEditingManager extends ReactContextBaseJavaModule {
    ...
    public void cropImage(String str, ReadableMap readableMap, Callback callback, Callback callback2) {
        ...
        if (map == null || readableMap3 == null || !map.hasKey("x") || !map.hasKey(Constants.Name.Y) || !readableMap3.hasKey("width") || !readableMap3.hasKey("height")) {
            throw new JSApplicationIllegalArgumentException("Please specify offset and size");
        } else if (str == null || str.isEmpty()) {
            throw new JSApplicationIllegalArgumentException("Please specify a URI");
        } else {
            CropTask cropTask = new CropTask(getReactApplicationContext(), str, (int) map.getDouble("x"), (int) map.getDouble(Constants.Name.Y), (int) readableMap3.getDouble("width"), (int) readableMap3.getDouble("height"), callback, callback2);
        ...
        private Bitmap cropAndResize(int i, int i2, BitmapFactory.Options options) throws IOException {
            ...
            try {
                ...
                if (((float) this.mWidth) / ((float) this.mHeight) > f8) {
                    ...
                    f2 = ((float) this.mX) + ((((float) this.mWidth) - f5) / 2.0f);
                    f = (float) this.mY;
                    ...
                    f2 = (float) this.mX;
                    f = ((float) this.mY) + ((((float) this.mHeight) - f9) / 2.0f);
                    float f10 = f9;
                ...
                try {
                    ...
                    if (decodeStream != null) {
                        ...
                        return Bitmap.createBitmap(decodeStream, (int) Math.floor((double) (f2 / ((float) options2.inSampleSize))), (int) Math.floor((double) (f / ((float) options2.inSampleSize))), (int) Math.floor((double) (f5 / ((float) options2.inSampleSize))), (int) Math.floor((double) (f4 / ((float) options2.inSampleSize))), matrix, true);
                    }
    ...
    private static File getFileFromUri(Context context, Uri uri) {
        ...
        if (!uri.getScheme().equals("content") || (query = context.getContentResolver().query(uri, new String[]{Downloads._DATA}, (String) null, (String[]) null, (String) null)) == null) {
            return null;
        }
        try {
