            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                ...
                try {
                    ...
                    try {
                        ...
                        if (error == null) {
                            error = AsyncStorageErrorUtil.getError((String) null, e6.getMessage());
                        }
                    }
                    writableMap = error;
                } catch (Throwable th) {
            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                ...
                try {
                    ...
                    try {
                        ...
                        FLog.w(ReactConstants.TAG, e3.getMessage(), (Throwable) e3);
                        if (error == null) {
                            error = AsyncStorageErrorUtil.getError((String) null, e3.getMessage());
                        }
                    }
                    writableMap = error;
                } catch (Throwable th) {
            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                ...
                try {
                    ...
                    try {
                        ...
                        FLog.w(ReactConstants.TAG, e7.getMessage(), (Throwable) e7);
                        if (error == null) {
                            error = AsyncStorageErrorUtil.getError((String) null, e7.getMessage());
                        }
                    }
                    writableMap = error;
                } catch (Throwable th) {
