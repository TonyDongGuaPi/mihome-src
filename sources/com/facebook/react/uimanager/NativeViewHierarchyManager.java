...
public class NativeViewHierarchyManager {
            ...
            for (int i7 = 0; i7 < viewAtIndexArr.length; i7 += 16) {
                ...
                while (true) {
                    ...
                    if (i9 >= viewAtIndexArr.length || i8 >= 16) {
                        ...
                        sb.append(Operators.ARRAY_START_STR + viewAtIndexArr[i9].mIndex + "," + viewAtIndexArr[i9].mTag + "],");
                        i8++;
                    }
                }
                sb.append("\n");
    ...
    public synchronized void manageChildren(int r17, @android.support.annotation.Nullable int[] r18, @android.support.annotation.Nullable com.facebook.react.uimanager.ViewAtIndex[] r19, @android.support.annotation.Nullable int[] r20, @android.support.annotation.Nullable int[] r21) {
        /*
            r16 = this;
            r8 = r16
            r0 = r17
    ...
    private void cacheDroppedTag(int i) {
        this.mDroppedViewArray[this.mDroppedViewIndex] = i;
