...
public class UIViewOperationQueue {
    ...
    private final class ManageChildrenOperation extends ViewOperation {
        ...
        public ManageChildrenOperation(int i, int[] iArr, @Nullable ViewAtIndex[] viewAtIndexArr, @Nullable int[] iArr2, @Nullable int[] iArr3) {
            super(i);
    ...
    private class DispatchUIFrameCallback extends GuardedFrameCallback {
        ...
        private void dispatchPendingNonBatchedOperations(long r9) {
            ...
            L_0x0014:
                ...
                monitor-enter(r0)
                com.facebook.react.uimanager.UIViewOperationQueue r1 = com.facebook.react.uimanager.UIViewOperationQueue.this     // Catch:{ all -> 0x0058 }
                java.util.ArrayDeque r1 = r1.mNonBatchedOperations     // Catch:{ all -> 0x0058 }
                boolean r1 = r1.isEmpty()     // Catch:{ all -> 0x0058 }
            ...
            L_0x0029:
                com.facebook.react.uimanager.UIViewOperationQueue r1 = com.facebook.react.uimanager.UIViewOperationQueue.this     // Catch:{ all -> 0x0058 }
                java.util.ArrayDeque r1 = r1.mNonBatchedOperations     // Catch:{ all -> 0x0058 }
                java.lang.Object r1 = r1.pollFirst()     // Catch:{ all -> 0x0058 }
                com.facebook.react.uimanager.UIViewOperationQueue$UIOperation r1 = (com.facebook.react.uimanager.UIViewOperationQueue.UIOperation) r1     // Catch:{ all -> 0x0058 }
                monitor-exit(r0)     // Catch:{ all -> 0x0058 }
                long r2 = android.os.SystemClock.uptimeMillis()     // Catch:{ Exception -> 0x0050 }
                r1.execute()     // Catch:{ Exception -> 0x0050 }
                com.facebook.react.uimanager.UIViewOperationQueue r0 = com.facebook.react.uimanager.UIViewOperationQueue.this     // Catch:{ Exception -> 0x0050 }
                com.facebook.react.uimanager.UIViewOperationQueue r1 = com.facebook.react.uimanager.UIViewOperationQueue.this     // Catch:{ Exception -> 0x0050 }
                long r4 = r1.mNonBatchedExecutionTotalTime     // Catch:{ Exception -> 0x0050 }
                long r6 = android.os.SystemClock.uptimeMillis()     // Catch:{ Exception -> 0x0050 }
                r1 = 0
                long r6 = r6 - r2
                long r4 = r4 + r6
                long unused = r0.mNonBatchedExecutionTotalTime = r4     // Catch:{ Exception -> 0x0050 }
                goto L_0x0000
            L_0x0050:
                r9 = move-exception
