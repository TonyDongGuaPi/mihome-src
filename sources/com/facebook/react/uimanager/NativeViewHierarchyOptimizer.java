...
public class NativeViewHierarchyOptimizer {
    ...
    private void removeNodeFromParent(ReactShadowNode reactShadowNode, boolean z) {
        ...
        if (nativeParent != null) {
            ...
            this.mUIViewOperationQueue.enqueueManageChildren(nativeParent.getReactTag(), new int[]{indexOfNativeChild}, (ViewAtIndex[]) null, z ? new int[]{reactShadowNode.getReactTag()} : null, z ? new int[]{indexOfNativeChild} : null);
        }
    }
    ...
    private void addNativeChild(ReactShadowNode reactShadowNode, ReactShadowNode reactShadowNode2, int i) {
        ...
        this.mUIViewOperationQueue.enqueueManageChildren(reactShadowNode.getReactTag(), (int[]) null, new ViewAtIndex[]{new ViewAtIndex(reactShadowNode2.getReactTag(), i)}, (int[]) null, (int[]) null);
