...
public class UIImplementation {
    ...
    public ReactShadowNode createRootShadowNode() {
        ...
        reactShadowNodeImpl.setViewClassName(Consts.d);
    ...
    public void updateViewHierarchy() {
        ...
        L_0x0008:
            ...
            com.facebook.react.uimanager.ReactShadowNode r3 = r4.getNode(r3)     // Catch:{ all -> 0x007b }
            java.lang.Integer r4 = r3.getWidthMeasureSpec()     // Catch:{ all -> 0x007b }
            if (r4 == 0) goto L_0x0074
            java.lang.Integer r4 = r3.getHeightMeasureSpec()     // Catch:{ all -> 0x007b }
            if (r4 == 0) goto L_0x0074
            java.lang.String r4 = "UIImplementation.notifyOnBeforeLayoutRecursive"
            com.facebook.systrace.SystraceMessage$Builder r4 = com.facebook.systrace.SystraceMessage.beginSection(r1, r4)     // Catch:{ all -> 0x007b }
            java.lang.String r5 = "rootTag"
            int r6 = r3.getReactTag()     // Catch:{ all -> 0x007b }
            com.facebook.systrace.SystraceMessage$Builder r4 = r4.arg((java.lang.String) r5, (int) r6)     // Catch:{ all -> 0x007b }
            r4.flush()     // Catch:{ all -> 0x007b }
            r7.notifyOnBeforeLayoutRecursive(r3)     // Catch:{ all -> 0x006f }
            com.facebook.systrace.Systrace.endSection(r1)     // Catch:{ all -> 0x007b }
            r7.calculateRootLayout(r3)     // Catch:{ all -> 0x007b }
            ...
            r4.flush()     // Catch:{ all -> 0x007b }
            r4 = 0
            r7.applyUpdatesRecursive(r3, r4, r4)     // Catch:{ all -> 0x006a }
            com.facebook.systrace.Systrace.endSection(r1)     // Catch:{ all -> 0x007b }
            com.facebook.react.uimanager.UIImplementation$LayoutUpdateListener r4 = r7.mLayoutUpdateListener     // Catch:{ all -> 0x007b }
            if (r4 == 0) goto L_0x0074
            com.facebook.react.uimanager.UIViewOperationQueue r4 = r7.mOperationsQueue     // Catch:{ all -> 0x007b }
            com.facebook.react.uimanager.UIImplementation$LayoutUpdateListener r5 = r7.mLayoutUpdateListener     // Catch:{ all -> 0x007b }
            r4.enqueueLayoutUpdateFinished(r3, r5)     // Catch:{ all -> 0x007b }
            goto L_0x0074
        L_0x006a:
            r0 = move-exception
            com.facebook.systrace.Systrace.endSection(r1)     // Catch:{ all -> 0x007b }
