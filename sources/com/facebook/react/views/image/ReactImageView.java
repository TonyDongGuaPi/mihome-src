...
public class ReactImageView extends GenericDraweeView {
    ...
    public void cornerRadii(float[] fArr) {
        ...
        fArr[0] = (this.mBorderCornerRadii == null || YogaConstants.isUndefined(this.mBorderCornerRadii[0])) ? f : this.mBorderCornerRadii[0];
        fArr[1] = (this.mBorderCornerRadii == null || YogaConstants.isUndefined(this.mBorderCornerRadii[1])) ? f : this.mBorderCornerRadii[1];
        fArr[2] = (this.mBorderCornerRadii == null || YogaConstants.isUndefined(this.mBorderCornerRadii[2])) ? f : this.mBorderCornerRadii[2];
                ...
                if (this.mImageSource != null) {
                    ...
                    if (!isTiled() || (getWidth() > 0 && getHeight() > 0)) {
                        ...
                        if (this.mDefaultImageDrawable != null) {
                            genericDraweeHierarchy.setPlaceholderImage(this.mDefaultImageDrawable, this.mScaleType);
                        }
