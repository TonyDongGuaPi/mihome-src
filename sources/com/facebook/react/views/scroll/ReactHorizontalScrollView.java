...
public class ReactHorizontalScrollView extends HorizontalScrollView implements ReactClippingViewGroup {
    ...
    public void flingAndSnap(int r28) {
        ...
        L_0x002f:
            int r4 = r27.getWidth()
            int r5 = android.support.v4.view.ViewCompat.getPaddingStart(r27)
            int r4 = r4 - r5
            int r5 = android.support.v4.view.ViewCompat.getPaddingEnd(r27)
            int r4 = r4 - r5
            java.util.Locale r5 = java.util.Locale.getDefault()
            int r5 = android.support.v4.text.TextUtilsCompat.getLayoutDirectionFromLocale(r5)
            r6 = 1
        ...
        L_0x0055:
            ...
            java.util.List<java.lang.Integer> r10 = r0.mSnapOffsets
            int r10 = r10.size()
            int r10 = r10 - r6
