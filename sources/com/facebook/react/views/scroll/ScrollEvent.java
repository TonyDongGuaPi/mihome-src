...
public class ScrollEvent extends Event<ScrollEvent> {
    ...
    private WritableMap serializeEventData() {
        ...
        createMap2.putDouble(Constants.Name.Y, (double) PixelUtil.toDIPFromPixel((float) this.mScrollY));
        ...
        createMap5.putDouble(Constants.Name.Y, this.mYVelocity);
        WritableMap createMap6 = Arguments.createMap();
        createMap6.putMap("contentInset", createMap);
        createMap6.putMap(Constants.Name.CONTENT_OFFSET, createMap2);
        createMap6.putMap(Constants.Name.CONTENT_SIZE, createMap3);
