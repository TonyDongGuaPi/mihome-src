...
public class FrescoBasedReactTextInlineImageShadowNode extends ReactTextInlineImageShadowNode {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0022, code lost:
        if (r1.getScheme() == null) goto L_0x0026;
     */
    ...
    public void setSource(@android.support.annotation.Nullable com.facebook.react.bridge.ReadableArray r4) {
        /*
            r3 = this;
            r0 = 0
    ...
    private static Uri getResourceDrawableUri(Context context, @Nullable String str) {
        ...
        return new Uri.Builder().scheme("res").path(String.valueOf(context.getResources().getIdentifier(str.toLowerCase(Locale.getDefault()).replace("-", JSMethod.NOT_SET), "drawable", context.getPackageName()))).build();
    }
