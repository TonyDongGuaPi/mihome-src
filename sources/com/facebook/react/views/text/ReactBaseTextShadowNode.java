...
public abstract class ReactBaseTextShadowNode extends LayoutShadowNode {
    ...
    private static class SetSpanOperation {
        ...
        public void execute(SpannableStringBuilder spannableStringBuilder, int i) {
            spannableStringBuilder.setSpan(this.what, this.start, this.end, ((i << 16) & 16711680) | ((this.start == 0 ? 18 : 34) & Color.j));
        }
    }
    ...
    private static void buildSpannedFromShadowNode(ReactBaseTextShadowNode reactBaseTextShadowNode, SpannableStringBuilder spannableStringBuilder, List<SetSpanOperation> list, TextAttributes textAttributes, boolean z, Map<Integer, ReactShadowNode> map, int i) {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt instanceof ReactRawTextShadowNode) {
                ...
                list2.add(new SetSpanOperation(spannableStringBuilder.length() - "0".length(), spannableStringBuilder.length(), ((ReactTextInlineImageShadowNode) childAt).buildInlineImageSpan()));
            } else if (z) {
                ...
                if (styleWidth.unit == YogaUnit.POINT && styleHeight.unit == YogaUnit.POINT) {
                    ...
                    spannableStringBuilder2.append("0");
                    list2.add(new SetSpanOperation(spannableStringBuilder.length() - "0".length(), spannableStringBuilder.length(), new TextInlineViewPlaceholderSpan(reactTag, (int) f, (int) f2)));
        ...
        if (length >= i2) {
            ...
            if (!((reactBaseTextShadowNode2.mTextShadowOffsetDx == 0.0f && reactBaseTextShadowNode2.mTextShadowOffsetDy == 0.0f && reactBaseTextShadowNode2.mTextShadowRadius == 0.0f) || android.graphics.Color.alpha(reactBaseTextShadowNode2.mTextShadowColor) == 0)) {
