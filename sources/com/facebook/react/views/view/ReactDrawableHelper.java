...
public class ReactDrawableHelper {
    ...
    public static Drawable createDrawableFromJSDescription(ReactViewGroup reactViewGroup, ReadableMap readableMap) {
        ...
        if ("ThemeAttrAndroid".equals(string)) {
            ...
            int identifier = context.getResources().getIdentifier(string2, RichTextNode.ATTR, "android");
            if (identifier == 0) {
            ...
            return new RippleDrawable(new ColorStateList(new int[][]{new int[0]}, new int[]{i}), (Drawable) null, drawable);
        } else {
