...
public class DecodeProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    public DecodeProducer(com.facebook.common.memory.ByteArrayPool r1, java.util.concurrent.Executor r2, com.facebook.imagepipeline.decoder.ImageDecoder r3, com.facebook.imagepipeline.decoder.ProgressiveJpegConfig r4, boolean r5, boolean r6, boolean r7, com.facebook.imagepipeline.producers.Producer<com.facebook.imagepipeline.image.EncodedImage> r8, com.facebook.common.internal.Supplier<java.lang.Boolean> r9) {
        /*
            ...
            r0.mExperimentalSmartResizingEnabled = r9
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.producers.DecodeProducer.<init>(com.facebook.common.memory.ByteArrayPool, java.util.concurrent.Executor, com.facebook.imagepipeline.decoder.ImageDecoder, com.facebook.imagepipeline.decoder.ProgressiveJpegConfig, boolean, boolean, boolean, com.facebook.imagepipeline.producers.Producer, com.facebook.common.internal.Supplier):void");
    }
    ...
    private abstract class ProgressiveDecoder extends DelegatingConsumer<EncodedImage, CloseableReference<CloseableImage>> {
            ...
            this.mJobScheduler = new JobScheduler(DecodeProducer.this.mExecutor, new JobScheduler.JobRunnable(DecodeProducer.this) {
                public void run(EncodedImage encodedImage, int i) {
                    if (encodedImage != null) {
                        if (DecodeProducer.this.mDownsampleEnabled || (((Boolean) DecodeProducer.this.mExperimentalSmartResizingEnabled.get()).booleanValue() && !BaseConsumer.statusHasFlag(i, 16))) {
        ...
        /* access modifiers changed from: private */
        /* JADX WARNING: Removed duplicated region for block: B:32:0x00b9 A[Catch:{ all -> 0x0156 }] */
        ...
        public void doDecode(com.facebook.imagepipeline.image.EncodedImage r19, int r20) {
            ...
            L_0x0095:
                com.facebook.imagepipeline.producers.JobScheduler r12 = r11.mJobScheduler     // Catch:{ all -> 0x0156 }
                long r12 = r12.getQueuedTime()     // Catch:{ all -> 0x0156 }
                com.facebook.imagepipeline.producers.ProducerContext r14 = r11.mProducerContext     // Catch:{ all -> 0x0156 }
                com.facebook.imagepipeline.request.ImageRequest r14 = r14.getImageRequest()     // Catch:{ all -> 0x0156 }
                android.net.Uri r14 = r14.getSourceUri()     // Catch:{ all -> 0x0156 }
                java.lang.String r14 = java.lang.String.valueOf(r14)     // Catch:{ all -> 0x0156 }
                if (r3 != 0) goto L_0x00b3
                if (r5 == 0) goto L_0x00ae
                goto L_0x00b3
            L_0x00ae:
                int r15 = r18.getIntermediateImageEndOffset(r19)     // Catch:{ all -> 0x0156 }
                goto L_0x00b7
            L_0x00b3:
                int r15 = r19.getSize()     // Catch:{ all -> 0x0156 }
            L_0x00b7:
                if (r3 != 0) goto L_0x00c2
                if (r5 == 0) goto L_0x00bc
                goto L_0x00c2
            L_0x00bc:
                com.facebook.imagepipeline.image.QualityInfo r3 = r18.getQualityInfo()     // Catch:{ all -> 0x0156 }
            L_0x00c0:
                r5 = r3
                goto L_0x00c5
            L_0x00c2:
                com.facebook.imagepipeline.image.QualityInfo r3 = com.facebook.imagepipeline.image.ImmutableQualityInfo.FULL_QUALITY     // Catch:{ all -> 0x0156 }
                goto L_0x00c0
            L_0x00c5:
                com.facebook.imagepipeline.producers.ProducerListener r3 = r11.mProducerListener     // Catch:{ all -> 0x0156 }
                com.facebook.imagepipeline.producers.ProducerContext r1 = r11.mProducerContext     // Catch:{ all -> 0x0156 }
                java.lang.String r1 = r1.getId()     // Catch:{ all -> 0x0156 }
                java.lang.String r4 = "DecodeProducer"
                r3.onProducerStart(r1, r4)     // Catch:{ all -> 0x0156 }
                com.facebook.imagepipeline.producers.DecodeProducer r3 = com.facebook.imagepipeline.producers.DecodeProducer.this     // Catch:{ DecodeException -> 0x010b }
                com.facebook.imagepipeline.decoder.ImageDecoder r3 = r3.mImageDecoder     // Catch:{ DecodeException -> 0x010b }
                com.facebook.imagepipeline.common.ImageDecodeOptions r4 = r11.mImageDecodeOptions     // Catch:{ DecodeException -> 0x010b }
                r2 = r19
                com.facebook.imagepipeline.image.CloseableImage r15 = r3.decode(r2, r15, r5, r4)     // Catch:{ DecodeException -> 0x010b }
                int r1 = r19.getSampleSize()     // Catch:{ Exception -> 0x0105 }
                r3 = 1
            ...
            L_0x00e9:
                ...
                r2 = r15
                r3 = r12
                java.util.Map r1 = r1.getExtraMap(r2, r3, r5, r6, r7, r8, r9, r10)     // Catch:{ all -> 0x0156 }
                com.facebook.imagepipeline.producers.ProducerListener r2 = r11.mProducerListener     // Catch:{ all -> 0x0156 }
                com.facebook.imagepipeline.producers.ProducerContext r3 = r11.mProducerContext     // Catch:{ all -> 0x0156 }
                java.lang.String r3 = r3.getId()     // Catch:{ all -> 0x0156 }
                java.lang.String r4 = "DecodeProducer"
                r2.onProducerFinishWithSuccess(r3, r4, r1)     // Catch:{ all -> 0x0156 }
                r11.handleResult(r15, r0)     // Catch:{ all -> 0x0156 }
            ...
            L_0x010b:
                r0 = move-exception
                com.facebook.imagepipeline.image.EncodedImage r2 = r0.getEncodedImage()     // Catch:{ Exception -> 0x0108 }
                java.lang.String r3 = "ProgressiveDecoder"
                java.lang.String r4 = "%s, {uri: %s, firstEncodedBytes: %s, length: %d}"
                r15 = 4
                java.lang.Object[] r15 = new java.lang.Object[r15]     // Catch:{ Exception -> 0x0108 }
                java.lang.String r17 = r0.getMessage()     // Catch:{ Exception -> 0x0108 }
                r16 = 0
                r15[r16] = r17     // Catch:{ Exception -> 0x0108 }
                r16 = 1
                r15[r16] = r14     // Catch:{ Exception -> 0x0108 }
                r14 = 2
                r1 = 10
                java.lang.String r1 = r2.getFirstBytesAsHexString(r1)     // Catch:{ Exception -> 0x0108 }
                r15[r14] = r1     // Catch:{ Exception -> 0x0108 }
                r1 = 3
                int r2 = r2.getSize()     // Catch:{ Exception -> 0x0108 }
                java.lang.Integer r2 = java.lang.Integer.valueOf(r2)     // Catch:{ Exception -> 0x0108 }
                r15[r1] = r2     // Catch:{ Exception -> 0x0108 }
                com.facebook.common.logging.FLog.w((java.lang.String) r3, (java.lang.String) r4, (java.lang.Object[]) r15)     // Catch:{ Exception -> 0x0108 }
            ...
            L_0x013b:
                ...
                java.lang.String r3 = r3.getId()     // Catch:{ all -> 0x0156 }
                java.lang.String r4 = "DecodeProducer"
                r2.onProducerFinishWithFailure(r3, r4, r0, r1)     // Catch:{ all -> 0x0156 }
                r11.handleError(r0)     // Catch:{ all -> 0x0156 }
                com.facebook.imagepipeline.image.EncodedImage.closeSafely(r19)
                return
            L_0x0156:
                r0 = move-exception
