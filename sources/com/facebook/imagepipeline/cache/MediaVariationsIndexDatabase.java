...
public class MediaVariationsIndexDatabase implements MediaVariationsIndex {
    ...
    public Task<MediaVariations> getCachedVariants(final String str, final MediaVariations.Builder builder) {
        try {
            return Task.a(new Callable<MediaVariations>() {
    ...
    public com.facebook.imagepipeline.request.MediaVariations getCachedVariantsSync(java.lang.String r16, com.facebook.imagepipeline.request.MediaVariations.Builder r17) {
        /*
            ...
            monitor-enter(r1)
            r2 = r15
            com.facebook.imagepipeline.cache.MediaVariationsIndexDatabase$LazyIndexDbOpenHelper r0 = r2.mDbHelper     // Catch:{ all -> 0x009f }
            android.database.sqlite.SQLiteDatabase r3 = r0.getWritableDatabase()     // Catch:{ all -> 0x009f }
            r11 = 0
            r12 = 1
            r13 = 0
            java.lang.String r6 = "media_id = ?"
            java.lang.String[] r7 = new java.lang.String[r12]     // Catch:{ SQLException -> 0x008c }
            r7[r11] = r16     // Catch:{ SQLException -> 0x008c }
            java.lang.String r4 = "media_variations_index"
            java.lang.String[] r5 = PROJECTION     // Catch:{ SQLException -> 0x008c }
            r8 = 0
            r9 = 0
            r10 = 0
            android.database.Cursor r3 = r3.query(r4, r5, r6, r7, r8, r9, r10)     // Catch:{ SQLException -> 0x008c }
            int r0 = r3.getCount()     // Catch:{ SQLException -> 0x0086, all -> 0x0084 }
            if (r0 != 0) goto L_0x002f
            com.facebook.imagepipeline.request.MediaVariations r0 = r17.build()     // Catch:{ SQLException -> 0x0086, all -> 0x0084 }
        ...
        L_0x002f:
            ...
            int r0 = r3.getColumnIndexOrThrow(r0)     // Catch:{ SQLException -> 0x0086, all -> 0x0084 }
            java.lang.String r4 = "width"
            int r4 = r3.getColumnIndexOrThrow(r4)     // Catch:{ SQLException -> 0x0086, all -> 0x0084 }
            java.lang.String r5 = "height"
            int r5 = r3.getColumnIndexOrThrow(r5)     // Catch:{ SQLException -> 0x0086, all -> 0x0084 }
            java.lang.String r6 = "cache_choice"
            int r6 = r3.getColumnIndexOrThrow(r6)     // Catch:{ SQLException -> 0x0086, all -> 0x0084 }
        L_0x0048:
            boolean r7 = r3.moveToNext()     // Catch:{ SQLException -> 0x0086, all -> 0x0084 }
            if (r7 == 0) goto L_0x0077
            java.lang.String r7 = r3.getString(r6)     // Catch:{ SQLException -> 0x0086, all -> 0x0084 }
            java.lang.String r8 = r3.getString(r0)     // Catch:{ SQLException -> 0x0086, all -> 0x0084 }
            android.net.Uri r8 = android.net.Uri.parse(r8)     // Catch:{ SQLException -> 0x0086, all -> 0x0084 }
            int r9 = r3.getInt(r4)     // Catch:{ SQLException -> 0x0086, all -> 0x0084 }
            int r10 = r3.getInt(r5)     // Catch:{ SQLException -> 0x0086, all -> 0x0084 }
            boolean r14 = android.text.TextUtils.isEmpty(r7)     // Catch:{ SQLException -> 0x0086, all -> 0x0084 }
            if (r14 == 0) goto L_0x006c
            r7 = r17
            r14 = r13
            goto L_0x0073
        L_0x006c:
            com.facebook.imagepipeline.request.ImageRequest$CacheChoice r7 = com.facebook.imagepipeline.request.ImageRequest.CacheChoice.valueOf(r7)     // Catch:{ SQLException -> 0x0086, all -> 0x0084 }
            r14 = r7
            r7 = r17
        L_0x0073:
            r7.addVariant(r8, r9, r10, r14)     // Catch:{ SQLException -> 0x0086, all -> 0x0084 }
            goto L_0x0048
        L_0x0077:
            r7 = r17
            com.facebook.imagepipeline.request.MediaVariations r0 = r17.build()     // Catch:{ SQLException -> 0x0086, all -> 0x0084 }
        ...
        L_0x008c:
            r0 = move-exception
        L_0x008d:
            java.lang.String r3 = TAG     // Catch:{ all -> 0x0089 }
            java.lang.String r4 = "Error reading for %s"
            java.lang.Object[] r5 = new java.lang.Object[r12]     // Catch:{ all -> 0x0089 }
            r5[r11] = r16     // Catch:{ all -> 0x0089 }
            com.facebook.common.logging.FLog.e((java.lang.String) r3, (java.lang.Throwable) r0, (java.lang.String) r4, (java.lang.Object[]) r5)     // Catch:{ all -> 0x0089 }
    ...
    /* JADX WARNING: Unknown top exception splitter block from list: {B:16:0x009a=Splitter:B:16:0x009a, B:21:0x009f=Splitter:B:21:0x009f} */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void saveCachedVariantSync(java.lang.String r10, com.facebook.imagepipeline.request.ImageRequest.CacheChoice r11, com.facebook.cache.common.CacheKey r12, com.facebook.imagepipeline.image.EncodedImage r13) {
        /*
            ...
            monitor-enter(r0)
            com.facebook.imagepipeline.cache.MediaVariationsIndexDatabase$LazyIndexDbOpenHelper r1 = r9.mDbHelper     // Catch:{ all -> 0x00a0 }
            android.database.sqlite.SQLiteDatabase r1 = r1.getWritableDatabase()     // Catch:{ all -> 0x00a0 }
            com.facebook.common.time.Clock r2 = r9.mClock     // Catch:{ all -> 0x00a0 }
            long r2 = r2.now()     // Catch:{ all -> 0x00a0 }
            r4 = 0
            r5 = 1
            r1.beginTransaction()     // Catch:{ Exception -> 0x008d }
            android.content.ContentValues r6 = new android.content.ContentValues     // Catch:{ Exception -> 0x008d }
            r6.<init>()     // Catch:{ Exception -> 0x008d }
            java.lang.String r7 = "media_id"
            r6.put(r7, r10)     // Catch:{ Exception -> 0x008d }
            java.lang.String r7 = "width"
            int r8 = r13.getWidth()     // Catch:{ Exception -> 0x008d }
            java.lang.Integer r8 = java.lang.Integer.valueOf(r8)     // Catch:{ Exception -> 0x008d }
            r6.put(r7, r8)     // Catch:{ Exception -> 0x008d }
            java.lang.String r7 = "height"
            int r13 = r13.getHeight()     // Catch:{ Exception -> 0x008d }
            java.lang.Integer r13 = java.lang.Integer.valueOf(r13)     // Catch:{ Exception -> 0x008d }
            r6.put(r7, r13)     // Catch:{ Exception -> 0x008d }
            java.lang.String r13 = "cache_choice"
            java.lang.String r11 = r11.name()     // Catch:{ Exception -> 0x008d }
            r6.put(r13, r11)     // Catch:{ Exception -> 0x008d }
            java.lang.String r11 = "cache_key"
            java.lang.String r13 = r12.getUriString()     // Catch:{ Exception -> 0x008d }
            r6.put(r11, r13)     // Catch:{ Exception -> 0x008d }
            java.lang.String r11 = "resource_id"
            java.lang.String r12 = com.facebook.cache.common.CacheKeyUtil.getFirstResourceId(r12)     // Catch:{ Exception -> 0x008d }
            r6.put(r11, r12)     // Catch:{ Exception -> 0x008d }
            java.lang.String r11 = "date"
            java.lang.Long r12 = java.lang.Long.valueOf(r2)     // Catch:{ Exception -> 0x008d }
            r6.put(r11, r12)     // Catch:{ Exception -> 0x008d }
            java.lang.String r11 = "media_variations_index"
            r12 = 0
            r1.replaceOrThrow(r11, r12, r6)     // Catch:{ Exception -> 0x008d }
            long r11 = r9.mLastTrimTimestamp     // Catch:{ Exception -> 0x008d }
            long r6 = MILLIS_IN_ONE_DAY     // Catch:{ Exception -> 0x008d }
            r13 = 0
            long r6 = r2 - r6
            ...
            java.lang.String[] r13 = new java.lang.String[r5]     // Catch:{ Exception -> 0x008d }
            long r6 = MILLIS_IN_FIVE_DAYS     // Catch:{ Exception -> 0x008d }
            r8 = 0
            long r6 = r2 - r6
            java.lang.String r6 = java.lang.Long.toString(r6)     // Catch:{ Exception -> 0x008d }
            r13[r4] = r6     // Catch:{ Exception -> 0x008d }
            r1.delete(r11, r12, r13)     // Catch:{ Exception -> 0x008d }
            r9.mLastTrimTimestamp = r2     // Catch:{ Exception -> 0x008d }
        L_0x0084:
            r1.setTransactionSuccessful()     // Catch:{ Exception -> 0x008d }
        L_0x0087:
            r1.endTransaction()     // Catch:{ SQLiteException -> 0x009a }
            goto L_0x009a
        L_0x008b:
            r10 = move-exception
            goto L_0x009c
        L_0x008d:
            r11 = move-exception
            java.lang.String r12 = TAG     // Catch:{ all -> 0x008b }
            java.lang.String r13 = "Error writing for %s"
            java.lang.Object[] r2 = new java.lang.Object[r5]     // Catch:{ all -> 0x008b }
            r2[r4] = r10     // Catch:{ all -> 0x008b }
            com.facebook.common.logging.FLog.e((java.lang.String) r12, (java.lang.Throwable) r11, (java.lang.String) r13, (java.lang.Object[]) r2)     // Catch:{ all -> 0x008b }
            goto L_0x0087
        L_0x009a:
            monitor-exit(r0)     // Catch:{ all -> 0x00a0 }
            return
        L_0x009c:
            r1.endTransaction()     // Catch:{ SQLiteException -> 0x009f }
        L_0x009f:
