...
abstract class LoginMethodHandler implements Parcelable {
    ...
    static AccessToken createAccessTokenFromNativeLogin(Bundle bundle, AccessTokenSource accessTokenSource, String str) {
        ...
        return new AccessToken(string, str, bundle2.getString(NativeProtocol.EXTRA_USER_ID), stringArrayList, (Collection<String>) null, (Collection<String>) null, accessTokenSource, bundleLongAsDate, new Date(), bundleLongAsDate2);
    }
