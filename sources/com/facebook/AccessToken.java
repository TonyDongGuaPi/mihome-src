...
public final class AccessToken implements Parcelable {
    ...
    public AccessToken(String str, String str2, String str3, @Nullable Collection<String> collection, @Nullable Collection<String> collection2, @Nullable Collection<String> collection3, @Nullable AccessTokenSource accessTokenSource, @Nullable Date date, @Nullable Date date2, @Nullable Date date3) {
        Validate.notNullOrEmpty(str, OAuthAccountManager.MiOAuthConstant.TOKEN);
    ...
    static AccessToken createFromJSONObject(JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObject.getInt("version") <= 1) {
            ...
            return new AccessToken(string, string2, string3, jsonArrayToStringList2, jsonArrayToStringList3, jsonArrayToStringList, valueOf, date, date2, date3);
        }
