package com.xiaomi.youpin.login.other.http.client.utils;

import com.xiaomi.youpin.login.other.http.Header;
import com.xiaomi.youpin.login.other.http.HttpEntity;
import com.xiaomi.youpin.login.other.http.NameValuePair;
import com.xiaomi.youpin.login.other.http.message.BasicNameValuePair;
import com.xiaomi.youpin.login.other.http.util.EntityUtils;
...
public class URLEncodedUtils {
    ...
    public static final String f23587a = "application/x-www-form-urlencoded";
