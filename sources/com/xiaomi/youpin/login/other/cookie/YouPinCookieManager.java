...
public class YouPinCookieManager {
    ...
    private static final String f23581a = "MiotCookieManager";
    ...
    public void a(@NonNull String str, String str2) {
        LogUtils.b(f23581a, "setCookie(): " + str + ", " + str2);
        if (b) {
    ...
    public void a(@NonNull String str, List<String> list) {
        LogUtils.b(f23581a, "setCookie(): " + str + ", " + list);
        if (b) {
            ArrayList arrayList = new ArrayList();
            arrayList.add(str);
    ...
    public void a(@NonNull String str) {
        LogUtils.b(f23581a, "removeCookie(): " + str);
        String b2 = b(str);
        if (b2 != null) {
    ...
    public String b(@NonNull String str) {
        ...
        LogUtils.b(f23581a, "getCookie(): " + str + ", " + cookie);
        return cookie;
    }

    public void b() {
        LogUtils.b(f23581a, "removeAllCookies()");
        if (b) {
        ...
        if (d2 != null) {
            d2.removeAllCookies(new ValueCallback<Boolean>() {
                ...
                public void onReceiveValue(Boolean bool) {
                    LogUtils.b(YouPinCookieManager.f23581a, "clearCookiesAsync success");
        ...
        public Void doInBackground(List<String>... listArr) {
            ...
            for (int i = 1; i < list.size(); i++) {
                ...
                if (this.f23584a != null) {
                    this.f23584a.setCookie(str, str2);
                }
            }
            if (this.b == null) {
                return null;
