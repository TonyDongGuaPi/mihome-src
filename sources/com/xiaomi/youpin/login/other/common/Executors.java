...
public class Executors {
    ...
    public static final int f23567a = Runtime.getRuntime().availableProcessors();
    private static final ThreadPoolExecutor b = new ThreadPoolExecutor(f23567a * 2, f23567a * 2, 60, TimeUnit.SECONDS, new LinkedBlockingQueue(), new PriorityThreadFactory(10, "ForBackgroundTasks"));
    private static final ThreadPoolExecutor c = new ThreadPoolExecutor(f23567a * 2, f23567a * 2, 60, TimeUnit.SECONDS, new LinkedBlockingQueue(), new PriorityThreadFactory(10, "ForLightWeightBackgroundTasks"));
