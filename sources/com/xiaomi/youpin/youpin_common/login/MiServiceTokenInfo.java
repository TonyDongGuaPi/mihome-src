...
public class MiServiceTokenInfo implements Parcelable {
    ...
    public static MiServiceTokenInfo a(String str) {
        ...
        try {
            ...
            miServiceTokenInfo.f23799a = jSONObject.optString("sid");
    ...
    public String a() {
        try {
            ...
            jSONObject.put("sid", this.f23799a);
    ...
    public String toString() {
        return "MiServiceTokenInfo{sid='" + this.f23799a + Operators.SINGLE_QUOTE + ", cUserId='" + this.b + Operators.SINGLE_QUOTE + ", serviceToken='" + this.c + Operators.SINGLE_QUOTE + ", ssecurity='" + this.d + Operators.SINGLE_QUOTE + ", timeDiff=" + this.e + ", domain='" + this.f + Operators.SINGLE_QUOTE + Operators.BLOCK_END;
    }
}
