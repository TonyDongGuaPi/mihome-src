...
public class TEA {
    ...
    public static String f23297a = "Now rise, and show your strength. Be eloquent, and deep, and tender; see, with a clear eye, into Nature, and into life:  spread your white wings of quivering thought, and soar, a god-like spirit, over the whirling world beneath you, up through long lanes of flaming stars to the gates of eternity!";
    ...
    public static void a(String[] strArr) {
        ...
        if (!new String(tea.b(tea.a(f23297a.getBytes()))).equals(f23297a)) {
    ...
    public void a(byte[] r7, int[] r8, int r9) {
        ...
        L_0x0039:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.youpin.common.util.crypto.TEA.a(byte[], int[], int):void");
    }
