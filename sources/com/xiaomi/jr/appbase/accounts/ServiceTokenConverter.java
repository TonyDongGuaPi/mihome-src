...
public class ServiceTokenConverter {
    ...
    public static ServiceTokenResult a(Bundle bundle) {
        ...
        if (bundle.containsKey("serviceToken")) {
            ...
            return new ServiceTokenResult.Builder(string).errorCode(ServiceTokenResult.ErrorCode.ERROR_NONE).cUserId(string2).serviceToken(string3).security(string6).slh(string4).ph(string5).peeked(false).build();
        }
