...
public class e {
    private static PerfClientReport a(PerfClientReport perfClientReport, String str) {
        long[] a2;
        if (perfClientReport == null || (a2 = a(str)) == null) {
            return null;
        }
        perfClientReport.b = a2[0];
        perfClientReport.c = a2[1];
        return perfClientReport;
    }

    public static String a(PerfClientReport perfClientReport) {
        return perfClientReport.e + "#" + perfClientReport.f + "#" + perfClientReport.g + "#" + perfClientReport.f10078a;
    }
    ...
    public static java.util.List<java.lang.String> a(android.content.Context r7, java.lang.String r8) {
        ...
        L_0x0018:
            ...
            com.xiaomi.push.y.c(r1)     // Catch:{ Exception -> 0x00ae, all -> 0x00ab }
        ...
        L_0x004b:
            ...
            com.xiaomi.clientreport.data.PerfClientReport r0 = d(r0)     // Catch:{ Exception -> 0x009d, all -> 0x009b }
            ...
            goto L_0x004b
        L_0x007c:
            java.lang.String r8 = r8.c()     // Catch:{ Exception -> 0x009d, all -> 0x009b }
                ...
                try {
                    ...
                    for (PerfClientReport perfClientReport : aVarArr) {
                        if (perfClientReport != null) {
                            ...
                            long j = perfClientReport.b;
                            long j2 = perfClientReport.c;
    ...
    private static PerfClientReport d(String str) {
        ...
        try {
            ...
            PerfClientReport a2 = PerfClientReport.a();
            try {
                a2.e = Integer.parseInt(c[0]);
                a2.f = c[1];
                a2.g = Integer.parseInt(c[2]);
                a2.f10078a = Integer.parseInt(c[3]);
                return a2;
