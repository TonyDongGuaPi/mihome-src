...
public class a implements IEventProcessor {
                        ...
                        if (aVar != null) {
                            ...
                            if (a2 != null && a2.length >= 1) {
                                if (a2.length <= 4096) {
                                    ...
                                    bufferedOutputStream2.write(ac.a(a2.length));
    ...
    private java.util.List<java.lang.String> b(java.lang.String r8) {
        ...
        L_0x0049:
            ...
            goto L_0x0021
        L_0x0054:
            java.lang.String r8 = r7.a((byte[]) r4)     // Catch:{ Exception -> 0x0065, all -> 0x0063 }
        ...
        L_0x0073:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.clientreport.processor.a.b(java.lang.String):java.util.List");
    }

    private String c(com.xiaomi.clientreport.data.a aVar) {
        File externalFilesDir = this.f10085a.getExternalFilesDir("event");
        String a2 = a(aVar);
    ...
    public String a(byte[] bArr) {
        ...
        if (bArr != null && bArr.length >= 1) {
            if (!com.xiaomi.clientreport.manager.a.a(this.f10085a).a().b()) {
                return bf.a(bArr);
            }
            String a3 = bl.a(this.f10085a);
    ...
    public void a() {
        /*
            r11 = this;
            android.content.Context r0 = r11.f10085a
            java.lang.String r1 = "event"
            java.lang.String r2 = "eventUploading"
            com.xiaomi.push.bl.a(r0, r1, r2)
            android.content.Context r0 = r11.f10085a
            java.lang.String r1 = "eventUploading"
            java.io.File[] r0 = com.xiaomi.push.bl.c(r0, r1)
        ...
        L_0x003d:
            ...
            com.xiaomi.push.y.c(r8)     // Catch:{ Exception -> 0x009e, all -> 0x009b }
            ...
            java.util.List r3 = r11.b((java.lang.String) r7)     // Catch:{ Exception -> 0x0090, all -> 0x008d }
    ...
    public void a(HashMap<String, ArrayList<com.xiaomi.clientreport.data.a>> hashMap) {
        this.b = hashMap;
    }

    public void a(List<String> list) {
        bl.a(this.f10085a, list);
    }
    ...
    public byte[] a(String str) {
        ...
        String a3 = bl.a(this.f10085a);
        byte[] c = bf.c(str);
        if (!TextUtils.isEmpty(a3) && c != null && c.length > 1 && (a2 = bl.a(a3)) != null) {
            try {
                if (a2.length > 1) {
                    return h.b(a2, Base64.encode(c, 2));
                }
            } catch (Exception e) {
                b.a((Throwable) e);
            }
    ...
    public void b(com.xiaomi.clientreport.data.a aVar) {
        if ((aVar instanceof EventClientReport) && this.b != null) {
            ...
            ArrayList arrayList = this.b.get(a2);
            if (arrayList == null) {
