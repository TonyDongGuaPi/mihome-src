...
public enum fj {
    ...
    GSLB_TCP_NOACCESS(ErrorCode.ERRCODE_REGISTER_NOT_FOUND_VALID_PHONE_OR_EMAIL),
    GSLB_TCP_NETUNREACH(ErrorCode.ERRCODE_REGISTER_PHONE_OR_EMAIL_EXISTS),
    ...
    public static fj a(int i) {
        switch (i) {
            ...
            default:
                switch (i) {
                    case ErrorCode.ERRCODE_REGISTER_NOT_FOUND_VALID_PHONE_OR_EMAIL:
                        return GSLB_TCP_NOACCESS;
                    case ErrorCode.ERRCODE_REGISTER_PHONE_OR_EMAIL_EXISTS:
