...
class cf implements Runnable {
    ...
    public void run() {
        /*
            r4 = this;
            r0 = 0
            com.xiaomi.push.cd$a r1 = r4.b     // Catch:{ Exception -> 0x003a, all -> 0x0035 }
            android.database.sqlite.SQLiteDatabase r1 = r1.d()     // Catch:{ Exception -> 0x003a, all -> 0x0035 }
            if (r1 == 0) goto L_0x001f
            boolean r0 = r1.isOpen()     // Catch:{ Exception -> 0x001d }
            if (r0 == 0) goto L_0x001f
            r1.beginTransaction()     // Catch:{ Exception -> 0x001d }
            com.xiaomi.push.cd$a r0 = r4.b     // Catch:{ Exception -> 0x001d }
            android.content.Context r2 = r4.f12673a     // Catch:{ Exception -> 0x001d }
        ...
        L_0x0025:
            ...
            goto L_0x0057
        L_0x0027:
            com.xiaomi.push.cd$a r0 = r4.b     // Catch:{ Exception -> 0x0025 }
            com.xiaomi.push.cb r0 = r0.c     // Catch:{ Exception -> 0x0025 }
        ...
        L_0x0047:
            ...
            goto L_0x0057
        L_0x0049:
            com.xiaomi.push.cd$a r0 = r4.b     // Catch:{ Exception -> 0x0047 }
            com.xiaomi.push.cb r0 = r0.c     // Catch:{ Exception -> 0x0047 }
            if (r0 == 0) goto L_0x005a
            com.xiaomi.push.cd$a r0 = r4.b     // Catch:{ Exception -> 0x0047 }
            com.xiaomi.push.cb r0 = r0.c     // Catch:{ Exception -> 0x0047 }
        ...
        L_0x005a:
            com.xiaomi.push.cd$a r0 = r4.b
            android.content.Context r1 = r4.f12673a
        ...
        L_0x0069:
            ...
            goto L_0x0079
        L_0x006b:
            com.xiaomi.push.cd$a r1 = r4.b     // Catch:{ Exception -> 0x0069 }
            com.xiaomi.push.cb r1 = r1.c     // Catch:{ Exception -> 0x0069 }
        ...
        L_0x007c:
            com.xiaomi.push.cd$a r1 = r4.b
            android.content.Context r2 = r4.f12673a
            r1.a((android.content.Context) r2)
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.cf.run():void");
    }
}
