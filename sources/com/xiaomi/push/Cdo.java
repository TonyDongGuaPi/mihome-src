...
public class Cdo implements LoggerInterface {
    ...
    public static String f12697a = "/MiPushLog";
    ...
    public void b() {
        /*
            r10 = this;
            r0 = 0
            java.lang.String r1 = r10.f     // Catch:{ Exception -> 0x0155, all -> 0x0151 }
            boolean r1 = android.text.TextUtils.isEmpty(r1)     // Catch:{ Exception -> 0x0155, all -> 0x0151 }
            if (r1 == 0) goto L_0x0028
            android.content.Context r1 = r10.e     // Catch:{ Exception -> 0x0155, all -> 0x0151 }
            ...
            r10.f = r1     // Catch:{ Exception -> 0x0155, all -> 0x0151 }
        L_0x0028:
            java.io.File r1 = new java.io.File     // Catch:{ Exception -> 0x0155, all -> 0x0151 }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x0155, all -> 0x0151 }
            r2.<init>()     // Catch:{ Exception -> 0x0155, all -> 0x0151 }
            java.lang.String r3 = r10.f     // Catch:{ Exception -> 0x0155, all -> 0x0151 }
            r2.append(r3)     // Catch:{ Exception -> 0x0155, all -> 0x0151 }
            java.lang.String r3 = f12697a     // Catch:{ Exception -> 0x0155, all -> 0x0151 }
            r2.append(r3)     // Catch:{ Exception -> 0x0155, all -> 0x0151 }
        ...
        L_0x004c:
            ...
            if (r2 != 0) goto L_0x005a
            java.lang.String r1 = r10.d     // Catch:{ Exception -> 0x0155, all -> 0x0151 }
        ...
        L_0x0096:
            java.util.List<android.util.Pair<java.lang.String, java.lang.Throwable>> r5 = g     // Catch:{ Exception -> 0x0146, all -> 0x0143 }
        ...
        L_0x0155:
            ...
            r3 = r2
        L_0x0158:
            java.lang.String r4 = r10.d     // Catch:{ all -> 0x0190 }
            java.lang.String r5 = ""
        ...
        L_0x01c1:
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.Cdo.b():void");
    }
    ...
    public final void a(String str, Throwable th) {
        g.add(new Pair(String.format("%1$s %2$s %3$s ", new Object[]{b.format(new Date()), this.d, str}), th));
        c.a((al.b) new dp(this));
    }
