...
public class a {
    ...
    /* renamed from: a  reason: collision with other field name */
    private final String f259a = "mipush_region";
    private final Object b = new Object();

    /* renamed from: b  reason: collision with other field name */
    private final String f260b = "mipush_country_code";
    ...
    private java.lang.String a(android.content.Context r4, java.lang.String r5, java.lang.String r6, java.lang.Object r7) {
        ...
        L_0x0025:
            ...
            com.xiaomi.push.y.c(r5)     // Catch:{ Exception -> 0x0064, all -> 0x0061 }
            ...
            java.lang.String r6 = com.xiaomi.push.y.b(r0)     // Catch:{ Exception -> 0x005a }
    ...
    private void a(android.content.Context r4, java.lang.String r5, java.lang.String r6, java.lang.String r7, java.lang.Object r8) {
        /*
            ...
            com.xiaomi.push.y.c(r1)     // Catch:{ Exception -> 0x0048, all -> 0x0045 }
    ...
    public String a() {
        if (TextUtils.isEmpty(this.e)) {
            this.e = a(this.f257a, "mipush_region", "mipush_region.lock", this.f258a);
        }
        return this.e;
    }
    ...
    public void a(String str) {
        if (!TextUtils.equals(str, this.e)) {
            this.e = str;
            a(this.f257a, this.e, "mipush_region", "mipush_region.lock", this.f258a);
        }
    }

    public String b() {
        if (TextUtils.isEmpty(this.f)) {
            this.f = a(this.f257a, "mipush_country_code", "mipush_country_code.lock", this.b);
        }
        return this.f;
    }
    ...
    public void b(String str) {
        if (!TextUtils.equals(str, this.f)) {
            this.f = str;
            a(this.f257a, this.f, "mipush_country_code", "mipush_country_code.lock", this.b);
        }
    }
}
