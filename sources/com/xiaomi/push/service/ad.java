...
public class ad {
    ...
    private static ThreadPoolExecutor f271a = new ThreadPoolExecutor(1, 1, 20, TimeUnit.SECONDS, new LinkedBlockingQueue());

    /* renamed from: a  reason: collision with other field name */
    private static final Pattern f272a = Pattern.compile("([0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3})");
    ...
    public static void a() {
        ...
        if ((f271a.getActiveCount() <= 0 || currentTimeMillis - f12870a >= 1800000) && hg.a().c() && (a2 = bb.a().a()) != null && a2.m() > 0) {
    ...
    private static boolean b(String str) {
        ...
        try {
            ...
            socket.connect(cz.b(str, 5222), 5000);
