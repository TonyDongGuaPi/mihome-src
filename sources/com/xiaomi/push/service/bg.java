...
public class bg {
    ...
    public static void a(Context context, hs hsVar) {
        if (bf.a(hsVar.e())) {
            b.a("TinyData TinyDataStorage.cacheTinyData cache data to file begin item:" + hsVar.d() + "  ts:" + System.currentTimeMillis());
            ai.a(context).a((Runnable) new bh(context, hsVar));
        }
    }

    public static byte[] a(Context context) {
        String b = p.a(context).b("mipush", "td_key", "");
        if (TextUtils.isEmpty(b)) {
            b = bf.a(20);
            p.a(context).a("mipush", "td_key", b);
        }
        return a(b);
    }
    ...
    public static void c(android.content.Context r6, com.xiaomi.push.hs r7) {
        /*
            byte[] r0 = a((android.content.Context) r6)
            r1 = 0
            byte[] r2 = com.xiaomi.push.iy.a(r7)     // Catch:{ IOException -> 0x00e1, Exception -> 0x00c9, all -> 0x00c6 }
        ...
        L_0x0103:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.service.bg.c(android.content.Context, com.xiaomi.push.hs):void");
    }
}
