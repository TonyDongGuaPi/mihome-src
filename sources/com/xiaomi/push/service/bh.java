...
final class bh implements Runnable {
    ...
    final /* synthetic */ Context f12906a;

    /* renamed from: a  reason: collision with other field name */
    final /* synthetic */ hs f327a;

    bh(Context context, hs hsVar) {
    ...
    public void run() {
        /*
            r6 = this;
            java.lang.Object r0 = com.xiaomi.push.service.bg.f12905a
            monitor-enter(r0)
            r1 = 0
            java.io.File r2 = new java.io.File     // Catch:{ Exception -> 0x004d, all -> 0x004a }
            android.content.Context r3 = r6.f12906a     // Catch:{ Exception -> 0x004d, all -> 0x004a }
            ...
            com.xiaomi.push.y.c(r2)     // Catch:{ Exception -> 0x004d, all -> 0x004a }
            ...
            android.content.Context r1 = r6.f12906a     // Catch:{ Exception -> 0x0043, all -> 0x003e }
            com.xiaomi.push.hs r4 = r6.f327a     // Catch:{ Exception -> 0x0043, all -> 0x003e }
        ...
        L_0x0036:
            r1 = move-exception
            com.xiaomi.channel.commonutils.logger.b.a((java.lang.Throwable) r1)     // Catch:{ all -> 0x0077 }
        L_0x003a:
            com.xiaomi.push.y.a((java.io.Closeable) r3)     // Catch:{ all -> 0x0077 }
            goto L_0x0063
        L_0x003e:
            r1 = move-exception
            r5 = r2
        ...
        L_0x004d:
            ...
            r3 = r1
        L_0x004f:
            com.xiaomi.channel.commonutils.logger.b.a((java.lang.Throwable) r2)     // Catch:{ all -> 0x0065 }
            if (r1 == 0) goto L_0x003a
