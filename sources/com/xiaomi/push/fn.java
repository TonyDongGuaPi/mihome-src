...
public class fn {
    ...
    fn(em.a aVar, short s, byte[] bArr) {
        this.e = 2;
        this.g = f;
        this.f12738a = null;
        this.d = aVar;
    ...
    @Deprecated
    public static fn a(gl glVar, String str) {
        int i;
        fn fnVar = new fn();
        try {
            i = Integer.parseInt(glVar.l());
        } catch (Exception e2) {
        ...
        fnVar.c(glVar.n());
        fnVar.b(glVar.o());
        fnVar.a("XMLMSG", (String) null);
        try {
            fnVar.a(glVar.c().getBytes("utf8"), str);
            if (TextUtils.isEmpty(str)) {
                fnVar.a(3);
            } else {
                fnVar.a(2);
                fnVar.a(MIMCConstant.p, (String) null);
            }
    ...
    static fn b(ByteBuffer byteBuffer) {
        try {
    ...
    public byte[] d(String str) {
        if (this.d.u() == 1) {
            return av.a(av.a(str, h()), this.g);
        }
        if (this.d.u() == 0) {
            return this.g;
        }
        b.a("unknow cipher = " + this.d.u());
        return this.g;
    }
