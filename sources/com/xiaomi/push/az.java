...
public class az {
    ...
    public static final Pattern f12638a = Pattern.compile("([^\\s;]+)(.*)");
    ...
    public static final class a extends FilterInputStream {
        ...
        public int read(byte[] bArr, int i, int i2) {
            int read;
            if (!this.f12639a && (read = super.read(bArr, i, i2)) != -1) {
                return read;
            }
            this.f12639a = true;
            return -1;
    ...
    public static class b {
        ...
        public String toString() {
            return String.format("resCode = %1$d, headers = %2$s", new Object[]{Integer.valueOf(this.f12640a), this.b.toString()});
        }
    }
    ...
    public static int a(android.content.Context r2) {
        ...
        L_0x0018:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.az.a(android.content.Context):int");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static com.xiaomi.push.ax a(android.content.Context r4, java.lang.String r5, java.lang.String r6, java.util.Map<java.lang.String, java.lang.String> r7, java.lang.String r8) {
        /*
            com.xiaomi.push.ax r0 = new com.xiaomi.push.ax
            r0.<init>()
            r1 = 0
            java.net.URL r2 = b((java.lang.String) r5)     // Catch:{ IOException -> 0x0105, Throwable -> 0x00f9, all -> 0x00f6 }
            java.net.HttpURLConnection r4 = b(r4, r2)     // Catch:{ IOException -> 0x0105, Throwable -> 0x00f9, all -> 0x00f6 }
        ...
        L_0x006c:
            ...
            r0.f12637a = r6     // Catch:{ IOException -> 0x0105, Throwable -> 0x00f9, all -> 0x00f6 }
            ...
            int r3 = r0.f12637a     // Catch:{ IOException -> 0x0105, Throwable -> 0x00f9, all -> 0x00f6 }
            r8.append(r3)     // Catch:{ IOException -> 0x0105, Throwable -> 0x00f9, all -> 0x00f6 }
        ...
        L_0x008a:
            ...
            com.xiaomi.push.az$a r8 = new com.xiaomi.push.az$a     // Catch:{ IOException -> 0x00aa, Throwable -> 0x00f9, all -> 0x00f6 }
        ...
        L_0x00aa:
            ...
            com.xiaomi.push.az$a r8 = new com.xiaomi.push.az$a     // Catch:{ IOException -> 0x0105, Throwable -> 0x00f9, all -> 0x00f6 }
        ...
        L_0x00d9:
            ...
            r0.c = r4     // Catch:{ IOException -> 0x00eb, Throwable -> 0x00e9 }
        ...
        L_0x00eb:
            ...
            goto L_0x0107
        L_0x00ed:
            java.util.Map<java.lang.String, java.lang.String> r3 = r0.b     // Catch:{ IOException -> 0x0105, Throwable -> 0x00f9, all -> 0x00f6 }
        ...
        L_0x012f:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.az.a(android.content.Context, java.lang.String, java.lang.String, java.util.Map, java.lang.String):com.xiaomi.push.ax");
    }
        ...
        if (context == null) {
            ...
            try {
                ...
                if (bVar != null && (url.getProtocol().equals("http") || url.getProtocol().equals("https"))) {
                    bVar.f12640a = b2.getResponseCode();
                    if (bVar.b == null) {
                        bVar.b = new HashMap();
                    }
                    int i = 0;
    ...
    public static String a(String str) {
        ...
        new String();
        return String.format("%s&key=%s", new Object[]{str, be.a(String.format("%sbe988a6134bc8254465424e5a70ef037", new Object[]{str}))});
    }
    ...
    public static java.lang.String a(java.lang.String r5, java.util.Map<java.lang.String, java.lang.String> r6, java.io.File r7, java.lang.String r8) {
        ...
        L_0x00cd:
            ...
            com.xiaomi.push.az$a r2 = new com.xiaomi.push.az$a     // Catch:{ IOException -> 0x0124, Throwable -> 0x0120, all -> 0x011c }
        ...
        L_0x0159:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.az.a(java.lang.String, java.util.Map, java.io.File, java.lang.String):java.lang.String");
    }
    ...
    public static boolean b(android.content.Context r3) {
        ...
        L_0x0044:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.az.b(android.content.Context):boolean");
    }
    ...
    public static boolean e(android.content.Context r2) {
        ...
        L_0x001b:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.az.e(android.content.Context):boolean");
    }
