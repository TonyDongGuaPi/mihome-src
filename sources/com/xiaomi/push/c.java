...
public final class c {
    ...
    private void d() {
        if (this.d != null) {
            this.d.write(this.f12664a, 0, this.c);
            this.c = 0;
            return;
        }
        throw new a();
    ...
    public void b(byte[] bArr, int i, int i2) {
        if (this.b - this.c >= i2) {
            System.arraycopy(bArr, i, this.f12664a, this.c, i2);
            this.c += i2;
            return;
        }
        int i3 = this.b - this.c;
        System.arraycopy(bArr, i, this.f12664a, this.c, i3);
        int i4 = i + i3;
        int i5 = i2 - i3;
        this.c = this.b;
        d();
        if (i5 <= this.b) {
            System.arraycopy(bArr, i4, this.f12664a, 0, i5);
            this.c = i5;
            return;
        }
