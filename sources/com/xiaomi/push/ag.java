...
public class ag {
    ...
    private static final String f12625a = (Environment.getExternalStorageDirectory().getPath() + "/mipush/");
    private static final String b = (f12625a + "lcfp");
    private static final String c = (f12625a + "lcfp.lock");
    ...
    private static boolean b(android.content.Context r16, java.lang.String r17, long r18) {
        /*
            ...
            r2 = r16
            boolean r0 = com.xiaomi.push.g.f(r2, r0)
        ...
        L_0x00bc:
            ...
            throw r0
        L_0x00c0:
            boolean r2 = com.xiaomi.push.y.c(r0)
