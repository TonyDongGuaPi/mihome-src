...
public abstract class v implements Runnable {
    ...
    public final void run() {
        /*
            r5 = this;
            r0 = 0
            java.io.File r1 = r5.b     // Catch:{ IOException -> 0x003c }
            if (r1 != 0) goto L_0x0014
            java.io.File r1 = new java.io.File     // Catch:{ IOException -> 0x003c }
            android.content.Context r2 = r5.f12948a     // Catch:{ IOException -> 0x003c }
            ...
            r5.b = r1     // Catch:{ IOException -> 0x003c }
        L_0x0014:
            android.content.Context r1 = r5.f12948a     // Catch:{ IOException -> 0x003c }
            java.io.File r2 = r5.b     // Catch:{ IOException -> 0x003c }
            com.xiaomi.push.u r1 = com.xiaomi.push.u.a(r1, r2)     // Catch:{ IOException -> 0x003c }
            java.lang.Runnable r0 = r5.c     // Catch:{ IOException -> 0x0035, all -> 0x0030 }
            if (r0 == 0) goto L_0x0025
            java.lang.Runnable r0 = r5.c     // Catch:{ IOException -> 0x0035, all -> 0x0030 }
            r0.run()     // Catch:{ IOException -> 0x0035, all -> 0x0030 }
        L_0x0025:
            android.content.Context r0 = r5.f12948a     // Catch:{ IOException -> 0x0035, all -> 0x0030 }
