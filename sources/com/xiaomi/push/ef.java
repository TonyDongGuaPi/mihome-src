...
public abstract class ef extends ai.a {
    protected int c;
    protected Context d;
    ...
    public static void a(Context context, hw hwVar) {
        ...
        if (!TextUtils.isEmpty(a2) && !TextUtils.isEmpty(hwVar.a())) {
            a(context, hwVar, a2);
        }
    }
    ...
    private static void a(android.content.Context r6, com.xiaomi.push.hw r7, java.lang.String r8) {
        /*
            byte[] r7 = com.xiaomi.push.iy.a(r7)
            byte[] r7 = com.xiaomi.push.dw.b(r8, r7)
            if (r7 == 0) goto L_0x00ab
            int r8 = r7.length
            if (r8 != 0) goto L_0x000f
            goto L_0x00ab
        L_0x000f:
            java.lang.Object r8 = com.xiaomi.push.dx.f12702a
            monitor-enter(r8)
            r0 = 0
            ...
            com.xiaomi.push.y.c(r1)     // Catch:{ IOException -> 0x007a, all -> 0x0076 }
        ...
        L_0x00ab:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.ef.a(android.content.Context, com.xiaomi.push.hw, java.lang.String):void");
    }

    public abstract String b();

    public abstract hq c();

    /* access modifiers changed from: protected */
    public boolean d() {
        return ag.a(this.d, String.valueOf(a()), (long) this.c);
    }
