...
public class gk extends gl {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.g == null ? gkVar.g != null : !this.g.equals(gkVar.g)) {
            return false;
        }
        if (this.e == null ? gkVar.e != null : !this.e.equals(gkVar.e)) {
            return false;
        }
        if (this.f == null ? gkVar.f != null : !this.f.equals(gkVar.f)) {
            return false;
        }
        if (this.d == null ? gkVar.d == null : this.d.equals(gkVar.d)) {
            return this.c == gkVar.c;
        }
        return false;
    }
