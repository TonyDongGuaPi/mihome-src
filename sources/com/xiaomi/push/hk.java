...
public class hk {
    ...
    public static void a(Context context, hn hnVar) {
        ai.a(context).a((Runnable) new a(context, hnVar));
    }

    private static void a(Context context, hn hnVar, File file, byte[] bArr) {
        String str;
        int a2;
                                ...
                                if (a3 != null) {
                                    if (a3.length != 0) {
                                        ...
                                        if (i >= 8 || i2 >= 10240) {
                                            ...
                                            hl.a(context, hnVar, (List<hs>) arrayList);
    ...
    public static void c(android.content.Context r7, com.xiaomi.push.hn r8) {
        /*
            boolean r0 = f12777a
        ...
        L_0x001e:
            a(r7)
            byte[] r1 = com.xiaomi.push.service.bg.a((android.content.Context) r7)
            r2 = 0
            ...
            com.xiaomi.push.y.c(r3)     // Catch:{ Exception -> 0x0083, all -> 0x007f }
        ...
        L_0x00cb:
            a(r7, r8, r0, r1)
            r8 = 0
            com.xiaomi.push.hj.a((boolean) r8)
            b(r7)
            f12777a = r8
            return
        L_0x00d8:
        ...
        L_0x00ee:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.hk.c(android.content.Context, com.xiaomi.push.hn):void");
    }
}
