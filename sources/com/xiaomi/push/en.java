...
public class en {
    ...
    public static String a(String str) {
        return Base64.encodeToString(bf.c(str), 2);
    }
        ...
        if (hashMap != null) {
            ...
            if (!TextUtils.isEmpty(str)) {
                try {
                    ...
                    hashMap2.put(Field.b, String.valueOf(jSONObject.opt("awakened_app")));
                    hashMap2.put(WXBridgeManager.MODULE, String.valueOf(jSONObject.opt("awake_type")));
                } catch (JSONException e) {
                    b.a((Throwable) e);
                }
            }
