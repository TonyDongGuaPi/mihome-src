...
final class AutoFocusManager implements Camera.AutoFocusCallback {
    ...
    private static final String f13028a = "AutoFocusManager";
    ...
    private synchronized void c() {
        if (!this.d && this.h == null) {
            ...
            try {
                ...
                Log.w(f13028a, "Could not request auto focus", e2);
            }
        }
        return;
    }
        ...
        if (this.f) {
            ...
            if (!this.d && !this.e) {
                try {
                    ...
                    Log.w(f13028a, "Unexpected exception while focusing", e2);
                    c();
                }
            }
        }
    ...
    public synchronized void b() {
        ...
        if (this.f) {
            ...
            try {
                ...
                Log.w(f13028a, "Unexpected exception while cancelling focusing", e2);
            }
        }
        return;
    }
