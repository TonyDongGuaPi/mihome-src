...
final class DecodeHintManager {
    ...
    private static final String f13002a = "DecodeHintManager";
                ...
                if (decodeHintType.getValueType().equals(Object.class)) {
                    ...
                    while (i < split.length) {
                        try {
                            ...
                            Log.w(f13002a, "Skipping array of integers hint " + decodeHintType + " due to invalid numeric value: '" + split[i] + Operators.SINGLE_QUOTE);
                            iArr = null;
                        }
                    }
                    if (iArr != null) {
                    ...
                    Log.w(f13002a, "Unsupported hint type '" + decodeHintType + "' of type " + decodeHintType.getValueType());
                }
            }
        }
        Log.i(f13002a, "Hints from the URI: " + enumMap);
        return enumMap;
    }
                ...
                if (extras.containsKey(name)) {
                    if (decodeHintType.getValueType().equals(Void.class)) {
                        ...
                        if (decodeHintType.getValueType().isInstance(obj)) {
                            ...
                            Log.w(f13002a, "Ignoring hint " + decodeHintType + " because it is not assignable from " + obj);
                        }
                    }
                }
            }
        }
        Log.i(f13002a, "Hints from the Intent: " + enumMap);
        return enumMap;
    }
}
