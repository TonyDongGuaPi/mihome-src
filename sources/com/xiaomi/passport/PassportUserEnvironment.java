...
public class PassportUserEnvironment {
    ...
    private String getAndroidId(Application application) {
        ...
        return Settings.Secure.getString(application.getContentResolver(), DeviceInfoResult.BUNDLE_KEY_ANDROID_ID);
    }
    ...
    public static String hashEnvParamString(ArrayList<String> arrayList) {
        return (arrayList == null || arrayList.size() == 0) ? "" : CloudCoder.hashAndJoin("#", (List<String>) arrayList, 6);
    }
