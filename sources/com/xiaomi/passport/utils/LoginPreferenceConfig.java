...
public class LoginPreferenceConfig {
    ...
    public static LoginPreference getPhoneLoginConfigOnLine(String str, String str2) throws AccessDeniedException, AuthenticationFailureException, IOException, InvalidResponseException, InvalidPhoneNumException {
        SimpleRequest.StringContent postAsString = SimpleRequestForAccount.postAsString(XMPassportUtil.buildUrlWithLocaleQueryParam(PassportOnlinePreference.URL_GET_LOGIN_PREFERENCE), new EasyMap().easyPut("phone", str).easyPutOpt("region", str2), (Map<String, String>) null, true);
