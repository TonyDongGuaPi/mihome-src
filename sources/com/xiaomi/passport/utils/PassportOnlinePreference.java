...
public class PassportOnlinePreference {
    ...
    public static OnlinePreference getOnlineConfig() throws AccessDeniedException, AuthenticationFailureException, IOException, InvalidResponseException {
        SimpleRequest.StringContent asString = SimpleRequestForAccount.getAsString(XMPassportUtil.buildUrlWithLocaleQueryParam(URL_GET_LOGIN_PREFERENCE), (Map<String, String>) null, (Map<String, String>) null, true);
        if (asString != null) {
