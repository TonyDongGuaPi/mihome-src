...
public interface ISecurityDeviceSignResponse extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISecurityDeviceSignResponse {
        private static final String DESCRIPTOR = "com.xiaomi.passport.ISecurityDeviceSignResponse";
        ...
        private static class Proxy implements ISecurityDeviceSignResponse {
