...
public class InNetDateHelper {
    ...
    private InNetDateHelper(Context context2, FragmentManager fragmentManager) {
        this.context = context2;
        this.fm = fragmentManager;
    }

    public static RegisterUserInfo updateRegisterStatusIfNeed(Context context2, FragmentManager fragmentManager, RegisterUserInfo registerUserInfo) {
        return new InNetDateHelper(context2, fragmentManager).updateRegisterStatusIfNeed(registerUserInfo, (QueryPhoneInfoParams) null);
    }

    public static RegisterUserInfo updateRegisterStatusIfNeed(Context context2, FragmentManager fragmentManager, RegisterUserInfo registerUserInfo, QueryPhoneInfoParams queryPhoneInfoParams) {
        return new InNetDateHelper(context2, fragmentManager).updateRegisterStatusIfNeed(registerUserInfo, queryPhoneInfoParams);
    }
