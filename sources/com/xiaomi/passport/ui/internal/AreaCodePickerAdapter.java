...
public final class AreaCodePickerAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public AreaCodePickerAdapter(@NotNull Context context) {
        Intrinsics.f(context, "mContext");
    ...
    private final void buildPickerSectionList() {
        ...
        Intrinsics.b(countryPhoneNumDataList, "totalList");
        list.addAll(countryPhoneNumDataList);
        String[] stringArray = this.mContext.getResources().getStringArray(R.array.alphabet_table);
        Intrinsics.b(stringArray, "mContext.resources.getSt…y(R.array.alphabet_table)");
        ...
        for (int i5 = 0; i5 < count; i5++) {
            if (i5 >= recommendCountryPhoneNumDataList.size()) {
                ...
                Intrinsics.b(str, "getItem(i).countryName");
                if (str != null) {
                    ...
                    if (substring != null) {
                        ...
                        i = ArraysKt.c((T[]) strArr2, upperCase);
                    } else {
            ...
            if (iArr3 == null) {
                Intrinsics.c("mSectionForPosition");
            }
            iArr3[i5] = i;
            if (i4 != i) {
                while (i4 < i) {
                    ...
                    if (iArr4 == null) {
                        Intrinsics.c("mPositionForSection");
                    }
                    i4++;
                    iArr4[i4] = i5;
                }
    ...
    public View getView(int i, @Nullable View view, @NotNull ViewGroup viewGroup) {
        ...
        if (view == null) {
            View inflate = View.inflate(this.mContext, R.layout.passport_area_code_list_item_internal, (ViewGroup) null);
            if (inflate != null) {
        ...
        areaCodePickerListItem.bind(getItem(i), (String) null);
