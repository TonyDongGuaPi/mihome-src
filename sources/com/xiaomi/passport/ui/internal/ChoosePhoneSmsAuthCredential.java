...
public final class ChoosePhoneSmsAuthCredential extends PhoneSmsAuthCredential {
    ...
    public ChoosePhoneSmsAuthCredential(@NotNull PhoneSmsAuthCredential phoneSmsAuthCredential, @NotNull RegisterUserInfo registerUserInfo, boolean z) {
        super(phoneSmsAuthCredential.getPhone(), phoneSmsAuthCredential.getTicket(), phoneSmsAuthCredential.getSid());
        Intrinsics.f(phoneSmsAuthCredential, "originAuthCredential");
