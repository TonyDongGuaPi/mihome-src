...
final class PswSignInPresenter$signInWithAuthCredential$1 extends Lambda implements Function1<AccountInfo, Unit> {
    final /* synthetic */ IdPswBaseAuthCredential $authCredential;
    final /* synthetic */ PswSignInPresenter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PswSignInPresenter$signInWithAuthCredential$1(PswSignInPresenter pswSignInPresenter, IdPswBaseAuthCredential idPswBaseAuthCredential) {
        super(1);
    ...
    public final void invoke(@NotNull AccountInfo accountInfo) {
        ...
        this.this$0.saveSignedInUserId(this.$authCredential);
    }
}
