...
public class QuickLoginFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        ((TextView) inflate.findViewById(R.id.passport_account_name)).setText(getString(R.string.passport_account_name, new Object[]{this.mUserId}));
    ...
    public void onStart() {
        super.onStart();
        ((NotificationManager) getActivity().getSystemService(PushManager.MESSAGE_TYPE_NOTI)).cancel(1000);
    }
    ...
    public void loginByPassword(String str, String str2, String str3, String str4, String str5) {
        this.mLoginUIController.loginByPassword(new PasswordLoginParams.Builder().setUserId(str).setCaptCode(str3).setCaptIck(str4).setPassword(str2).setServiceId(str5).setIsReturnStsUrl(this.mReturnStsUrl).build(), new LoginUIController.PasswordLoginCallback() {
            ...
            public void onNeedCaptchaCode(boolean z, String str) {
                if (QuickLoginFragment.this.mCaptchaView.getVisibility() != 0) {
                    QuickLoginFragment.this.applyCaptchaUrl(str);
                } else {
                    QuickLoginFragment.this.applyCaptchaUrl(str);
                }
            }
            ...
            public void onNeedNotification(String str, String str2) {
                QuickLoginFragment.this.startNotificationActivityForResult(str2, str);
            }
    ...
    public void showNoPwdUserDialog() {
        ...
        create.setPositiveButton(17039370, (DialogInterface.OnClickListener) null);
    ...
    public void loginByStep2(String str, String str2, boolean z, String str3) {
        this.mLoginUIController.loginByStep2(new Step2LoginParams.Builder().setUserId(str).setServiceId(str3).setStep1Token(this.mStep1Token).setMetaLoginData(this.mMetaLoginDataStep2).setTrust(z).setStep2code(str2).build(), new LoginUIController.Step2LoginCallback() {
            public void onLoginSuccess(AccountInfo accountInfo) {
                QuickLoginFragment.this.onLoginSuccess(accountInfo);
            }

            public void onPwdError() {
                QuickLoginFragment.this.showAlertDialog(QuickLoginFragment.this.getString(R.string.passport_bad_authentication));
            }
