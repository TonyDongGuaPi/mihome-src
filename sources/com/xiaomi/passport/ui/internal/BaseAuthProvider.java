...
public abstract class BaseAuthProvider extends AuthProvider {
    ...
    public BaseAuthProvider(@NotNull String str) {
        super(str);
    ...
    @NotNull
    public final BaseSignInFragment getFragment(@NotNull String str, @Nullable String str2) {
        Intrinsics.f(str, "sid");
        BaseSignInFragment fragment = getFragment(str);
        fragment.setDefaultCountryCodeWithPrefix(str2);
        return fragment;
    }
}
