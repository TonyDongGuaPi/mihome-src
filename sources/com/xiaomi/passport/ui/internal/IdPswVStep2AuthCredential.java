...
public final class IdPswVStep2AuthCredential extends IdPswBaseAuthCredential {
    ...
    public IdPswVStep2AuthCredential(@NotNull String str, @NotNull String str2, @NotNull MetaLoginData metaLoginData2, @NotNull String str3, boolean z, @NotNull String str4) {
        super(str, str4);
        Intrinsics.f(str, "id");
        Intrinsics.f(str2, "step1Token");
        Intrinsics.f(metaLoginData2, "metaLoginData");
