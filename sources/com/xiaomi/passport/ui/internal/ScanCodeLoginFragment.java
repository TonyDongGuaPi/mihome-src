...
public class ScanCodeLoginFragment extends Fragment {
    ...
    final WebChromeClient mWebChromeClient = new WebChromeClient() {
        public void onCloseWindow(WebView webView) {
            ...
            boolean access$000 = ScanCodeLoginFragment.this.isScanResultSuccess(webView.getUrl());
            AccountLog.i(ScanCodeLoginFragment.TAG, "onCloseWindow " + access$000);
            ScanCodeLoginFragment.this.finishActivityAndHandleResponse(access$000);
        }
    };
    ...
    final WebViewClient mWebViewClient = new WebViewClient() {
        public void onPageFinished(WebView webView, String str) {
            ...
            if (str.contains("#closewebview")) {
                boolean access$000 = ScanCodeLoginFragment.this.isScanResultSuccess(str);
                AccountLog.i(ScanCodeLoginFragment.TAG, "onPageFinished " + access$000);
                ScanCodeLoginFragment.this.finishActivityAndHandleResponse(access$000);
            }
        }
        ...
        public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
            ...
            if (str.contains("#closewebview")) {
                boolean access$000 = ScanCodeLoginFragment.this.isScanResultSuccess(str);
                AccountLog.i(ScanCodeLoginFragment.TAG, "onPageStarted " + access$000);
                ScanCodeLoginFragment.this.finishActivityAndHandleResponse(access$000);
            }
        }
    };
    ...
    private void loginByWebView(Account account) {
        if (account != null) {
            ...
            instance.setCookie(AbstractAccountWebViewSingleCookieUtil.DOMAIN_URL_SET_COOKIE, getCookie("userId", account.name));
            instance.setCookie(AbstractAccountWebViewSingleCookieUtil.DOMAIN_URL_SET_COOKIE, getCookie("passToken", passToken));
    ...
    private void startAddAccountIntent() {
        Intent newAddAccountIntent = AuthenticatorUtil.newAddAccountIntent(getActivity(), (String) null, new Bundle(), (Parcelable) null);
