...
public class GoogleAuthProvider extends SNSAuthProvider {
    ...
    public String getAppId(@NotNull Context context2) {
        ...
        String string = context2.getString(R.string.google_application_id);
        Intrinsics.b(string, "context.getString(R.string.google_application_id)");
        return string;
    }
    ...
    public void startLogin(@NotNull Activity activity) {
        ...
        Intrinsics.b(client, "googleSignInClient");
