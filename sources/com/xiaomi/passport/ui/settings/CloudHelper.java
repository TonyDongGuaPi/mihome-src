...
class CloudHelper {
    ...
    static void modifySafePhone(PassportInfo passportInfo, String str, String str2, MiuiActivatorInfo miuiActivatorInfo, boolean z, String str3, String str4) throws AccessDeniedException, AuthenticationFailureException, InvalidResponseException, CipherException, IOException, InvalidVerifyCodeException, UserRestrictedException, InvalidPhoneNumException, NeedVerificationException {
        ...
        if (postAsMap != null) {
            ...
            String str5 = "code: " + fromBody + "; description: " + postAsMap.getFromBody("description");
            ...
            if (fromBody instanceof Integer) {
                ...
                if (intValue == 20023) {
                    ...
                    throw new NeedVerificationException((String) null);
                } else if (intValue == 70014) {
                    throw new InvalidVerifyCodeException(str5);
                }
            }
            throw new InvalidResponseException(str5);
        }
    ...
    static void sendModifySafePhoneTicket(PassportInfo passportInfo, String str, String str2, String str3, String str4) throws AccessDeniedException, AuthenticationFailureException, InvalidResponseException, CipherException, IOException, ReachLimitException, NeedCaptchaException, InvalidPhoneNumException {
        if (passportInfo == null) {
            AccountLog.i(TAG, "passport info should be not null");
            return;
        }
    ...
    static GetUserBindIdAndLimitTask.UserBindIdAndLimitResult getUserBindIdAndLimit(PassportInfo passportInfo, String str) throws InvalidResponseException, CipherException, IOException, AuthenticationFailureException, AccessDeniedException, InvalidPhoneNumException {
        ...
        if (passportInfo != null) {
            ...
            if (asMap != null) {
                ...
                if (intValue == 0) {
                    ...
                    throw new InvalidResponseException(intValue, str3);
                }
