...
public final class AMAuthTokenConverter {
    ...
    public static Exception toAMException(ServiceTokenResult serviceTokenResult) {
        ...
        String substring = serviceTokenResult.errorMessage.substring(ERROR_MSG_PREFIX.length());
    ...
    public static ServiceTokenResult fromAMBundle(Bundle bundle, String str) {
        ...
        if (bundle.containsKey("authtoken")) {
            ...
            return new ServiceTokenResult.Builder(str).errorCode(ServiceTokenResult.ErrorCode.ERROR_AUTHENTICATOR_ERROR).errorMessage("invalid auth token").build();
        }
    ...
    static String buildAMAuthToken(ServiceTokenResult serviceTokenResult) {
        if (serviceTokenResult == null) {
            return null;
        }
        if (serviceTokenResult.security == null) {
            return serviceTokenResult.serviceToken;
        }
        return String.format("%s%s%s", new Object[]{serviceTokenResult.serviceToken, ",", serviceTokenResult.security});
    }

    static ServiceTokenResult parseAMAuthToken(String str, String str2, boolean z) {
        String str3;
        String str4 = null;
