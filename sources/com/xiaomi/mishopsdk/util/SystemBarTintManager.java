...
public class SystemBarTintManager {
    ...
    private static final String TAG = "SystemBarTintManager";
    private static boolean sIsMiuiV6V7;
    ...
    static {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            try {
                ...
                str = (String) declaredMethod.invoke(cls, new Object[]{"ro.miui.ui.version.name"});
                if (str.length() >= 2 && str.startsWith("V")) {
                ...
                Log.e(TAG, "get miui version failed, miuiVersion=%s.", str, e);
