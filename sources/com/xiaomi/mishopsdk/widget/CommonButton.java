...
public class CommonButton extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attributeSet, int i) {
        ...
        try {
            ...
            float f = 14.0f;
            if (!TextUtils.isEmpty(obtainStyledAttributes.getString(R.styleable.mishopsdk_v6CommonButton_android_textSize))) {
                f = obtainStyledAttributes.getDimension(R.styleable.mishopsdk_v6CommonButton_android_textSize, 14.0f);
            }
            ...
            if (!TextUtils.isEmpty(obtainStyledAttributes.getString(R.styleable.mishopsdk_v6CommonButton_mishopsdk_cb_stroke_width))) {
                ...
                obtainStyledAttributes.getDimension(R.styleable.mishopsdk_v6CommonButton_mishopsdk_cb_stroke_width, (float) 0);
            ...
            if (!TextUtils.isEmpty(obtainStyledAttributes.getString(R.styleable.mishopsdk_v6CommonButton_mishopsdk_cb_corners_radius))) {
                gradientDrawable.setCornerRadius((float) obtainStyledAttributes.getDimensionPixelOffset(R.styleable.mishopsdk_v6CommonButton_mishopsdk_cb_corners_radius, 0));
                gradientDrawable2.setCornerRadius((float) obtainStyledAttributes.getDimensionPixelOffset(R.styleable.mishopsdk_v6CommonButton_mishopsdk_cb_corners_radius, 0));
                gradientDrawable3.setCornerRadius((float) obtainStyledAttributes.getDimensionPixelOffset(R.styleable.mishopsdk_v6CommonButton_mishopsdk_cb_corners_radius, 0));
            } else {
                ...
                float dimensionPixelSize = (float) obtainStyledAttributes.getDimensionPixelSize(R.styleable.mishopsdk_v6CommonButton_mishopsdk_cb_corners_left_radius, 0);
                float dimensionPixelSize2 = (float) obtainStyledAttributes.getDimensionPixelSize(R.styleable.mishopsdk_v6CommonButton_mishopsdk_cb_corners_right_radius, 0);
