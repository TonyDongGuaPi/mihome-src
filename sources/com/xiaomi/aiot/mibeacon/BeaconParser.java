...
public class BeaconParser implements IBeaconParser {
    public MiBeacon a(byte[] bArr, int i, BluetoothDevice bluetoothDevice) {
        ...
        for (Pdu a2 : new BleAdvertisement(bArr).a()) {
            MiPacket a3 = a(a2);
            if (a3 != null) {
                miBeacon = new MiBeacon.Builder().b(bluetoothDevice.getAddress()).a(bluetoothDevice.getName()).a((double) i).a(a3.b).c(a3.f9962a).a();
            }
        }
        return miBeacon;
    }
    ...
    private MiPacket a(Pdu pdu) {
        ...
        if (packetReader.b() != 143 || packetReader.b() != 3 || packetReader.b() != 1 || packetReader.b() != 96) {
            return null;
        }
        ...
        miPacket.f9962a = StringUtils.a(strArr, ":");
