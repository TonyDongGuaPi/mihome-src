...
public class RNCWebViewModule extends ReactContextBaseJavaModule implements ActivityEventListener {
    ...
    public void onActivityResult(Activity activity, int i, int i2, Intent intent) {
        if (this.filePathCallback != null || this.filePathCallbackLegacy != null) {
            if (i != 1) {
                ...
                this.filePathCallback.onReceiveValue((Object) null);
            }
    ...
    public void downloadFile() {
        ((DownloadManager) getCurrentActivity().getBaseContext().getSystemService(Constants.TitleMenu.MENU_DOWNLOAD)).enqueue(this.downloadRequest);
    ...
    private Intent getPhotoIntent() {
        ...
        intent.putExtra(AgentOptions.k, this.outputFileUri);
        return intent;
    }
    ...
    private File getCapturedFile(String str) throws IOException {
        ...
        return File.createTempFile(str5, str3, getReactApplicationContext().getExternalFilesDir((String) null));
    }
