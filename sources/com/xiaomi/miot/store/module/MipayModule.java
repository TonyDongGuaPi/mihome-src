...
public class MipayModule extends ReactContextBaseJavaModule {
    public String getName() {
        return "MipayAndroid";
    }

    public MipayModule(ReactApplicationContext reactApplicationContext) {
    ...
    public void pay(String str, final Callback callback) {
        ...
        if (i != null) {
            StoreApiManager.a().b(YPStoreConstant.PAY_MIPAY, i, str, new ICallback() {
        ...
        LogUtils.e("MipayModule", "MipayModule not implement!");
        callback.invoke(-1, "", "");
    }
}
