...
public class XMStringUtils {
    ...
    static class MyOnGlobalLayoutListener implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            this.f11425a.getViewTreeObserver().removeGlobalOnLayoutListener(this);
            if (this.f11425a.getLineCount() > this.c) {
                int lineEnd = this.f11425a.getLayout().getLineEnd(this.c - 1);
                this.f11425a.setText(this.b.subSequence(0, lineEnd - 3) + "...");
            }
        }
    }
}
