...
public class MipayModel extends Model implements IPaytoolModel {
    ...
    private static final String f12188a = "MipayModel";
    ...
    public void a(SortedParameter sortedParameter, IPaytoolTaskListener iPaytoolTaskListener) {
        ...
        MipayTaskListener mipayTaskListener = new MipayTaskListener(l_());
        mipayTaskListener.a().a((ExceptionDispatcher.ExceptionHandler) new ServerErrorCodeExceptionHandler(l_()) {
        ...
        Observable.create(this.d).observeOn(AndroidSchedulers.mainThread()).subscribeOn(Schedulers.io()).subscribeOn(AndroidSchedulers.mainThread()).subscribe(mipayTaskListener);
    }
    ...
    private class MipayTaskListener extends RxBaseErrorHandleTaskListener<RxMipayTask.Result> {
        ...
        public void a(RxMipayTask.Result result) {
            MipayModel.this.a(result.f12428a);
        }
    }
