...
import com.xiaomi.account.openid.utils.Constants;
...
public class OpenIdAuthService extends Service {
    ...
    private static final String TAG = "OpenIdAuthService";
    ...
    private class Transport extends IXiaomiAuthService.Stub {
        private static final int versionNum = 0;
        ...
        public void getAccessTokenInResponse(final IXiaomiAuthResponse iXiaomiAuthResponse, final Bundle bundle, int i, int i2) throws RemoteException {
            Log.v(OpenIdAuthService.TAG, String.format("getAccessToken called from oauth jar version %s.%s", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}));
    ...
    private String makeQueryParams(Bundle bundle) {
        ...
        bundle2.putString("state", bundle.getString(XiaomiOAuthConstants.EXTRA_STATE));
        ...
        String string3 = bundle.getString(Constants.EXTRA_DISPLAY);
