...
public class EncryptLog {
    ...
    private static class EncryptLogSenderHolder {
    ...
    public static int v(String str, String str2) {
        return getEncryptSender().printLog(2, str, str2, (Throwable) null);
    }
    ...
    public static int d(String str, String str2) {
        return getEncryptSender().printLog(3, str, str2, (Throwable) null);
    }
    ...
    public static int i(String str, String str2) {
        return getEncryptSender().printLog(4, str, str2, (Throwable) null);
    }
    ...
    public static int w(String str, String str2) {
        return getEncryptSender().printLog(5, str, str2, (Throwable) null);
    }
    ...
    public static int e(String str, String str2) {
        return getEncryptSender().printLog(6, str, str2, (Throwable) null);
    }
