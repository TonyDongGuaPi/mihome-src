...
public class FDSUploader {
    ...
    public static PutObjectResult upload(File file, String str) {
        ...
        fDSClientConfiguration.a(str);
        fDSClientConfiguration.a(true);
        fDSClientConfiguration.c(false);
        fDSClientConfiguration.g(5242880);
        fDSClientConfiguration.a((GalaxyFDSCredential) new SignatureCredential(d("OUtaT1NwVAs2RlAEeAcEdQV4"), d("PUtCcHIzdy5ZcDZaamQbUmR+d0QIWGZ0ZwVbeWABfHt8SF9oekJXBA==")));
        try {
            return new GalaxyFDSClientImpl(fDSClientConfiguration).b(d("HGlhZ24pcy9z"), file.getName(), file);
