...
final class AlignmentPatternFinder {
    ...
    private final BitMatrix f1767a;
    ...
    public AlignmentPattern a() throws NotFoundException {
        ...
        for (int i6 = 0; i6 < i3; i6++) {
            ...
            iArr[2] = 0;
            int i8 = i2;
            while (i8 < i4 && !this.f1767a.a(i8, i7)) {
                i8++;
            }
            int i9 = 0;
            while (i8 < i4) {
                if (!this.f1767a.a(i8, i7)) {
                    if (i9 == 1) {
                        i9++;
                    }
                    iArr[i9] = iArr[i9] + 1;
    ...
    private float a(int i2, int i3, int i4, int i5) {
        BitMatrix bitMatrix = this.f1767a;
        int g2 = bitMatrix.g();
        int[] iArr = this.h;
        iArr[0] = 0;
        iArr[1] = 0;
        iArr[2] = 0;
        int i6 = i2;
        while (i6 >= 0 && bitMatrix.a(i3, i6) && iArr[1] <= i4) {
            iArr[1] = iArr[1] + 1;
            i6--;
        }
        if (i6 < 0 || iArr[1] > i4) {
        ...
        while (i6 >= 0 && !bitMatrix.a(i3, i6) && iArr[0] <= i4) {
            iArr[0] = iArr[0] + 1;
            i6--;
        }
        if (iArr[0] > i4) {
        ...
        int i7 = i2 + 1;
        while (i7 < g2 && bitMatrix.a(i3, i7) && iArr[1] <= i4) {
            iArr[1] = iArr[1] + 1;
            i7++;
        }
        if (i7 == g2 || iArr[1] > i4) {
        ...
        while (i7 < g2 && !bitMatrix.a(i3, i7) && iArr[2] <= i4) {
            iArr[2] = iArr[2] + 1;
            i7++;
        }
    ...
    private AlignmentPattern a(int[] iArr, int i2, int i3) {
        ...
        for (AlignmentPattern next : this.b) {
            if (next.a(f2, a3, a2)) {
                return next.b(a3, a2, f2);
            }
        }
        AlignmentPattern alignmentPattern = new AlignmentPattern(a2, a3, f2);
        this.b.add(alignmentPattern);
        if (this.i == null) {
            return null;
        }
        this.i.a(alignmentPattern);
        return null;
    }
}
