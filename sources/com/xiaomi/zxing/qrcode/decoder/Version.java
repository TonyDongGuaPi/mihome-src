...
public final class Version {
    ...
    private static final int[] f1763a = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};
    ...
    private Version(int i, int[] iArr, ECBlocks... eCBlocksArr) {
        ...
        this.d = iArr;
        this.e = eCBlocksArr;
        int a2 = eCBlocksArr[0].a();
        int i2 = 0;
        for (ECB ecb : eCBlocksArr[0].d()) {
            i2 += ecb.a() * (ecb.b() + a2);
        }
        this.f = i2;
    }
    ...
    public ECBlocks a(ErrorCorrectionLevel errorCorrectionLevel) {
        return this.e[errorCorrectionLevel.ordinal()];
    }

    public static Version a(int i) throws FormatException {
        if (i % 4 == 1) {
            try {
                return b((i - 17) / 4);
    ...
    static Version c(int i) {
        int i2 = Integer.MAX_VALUE;
        int i3 = 0;
        for (int i4 = 0; i4 < f1763a.length; i4++) {
            int i5 = f1763a[i4];
            if (i5 == i) {
                return b(i4 + 7);
            }
            int a2 = FormatInformation.a(i, i5);
            if (a2 < i2) {
                i3 = i4 + 7;
                i2 = a2;
            }
    ...
    public BitMatrix e() {
        int d2 = d();
        BitMatrix bitMatrix = new BitMatrix(d2);
        bitMatrix.a(0, 0, 9, 9);
        int i = d2 - 8;
        bitMatrix.a(i, 0, 8, 9);
        bitMatrix.a(0, i, 9, 8);
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                if (!((i2 == 0 && (i4 == 0 || i4 == length - 1)) || (i2 == length - 1 && i4 == 0))) {
                    bitMatrix.a(this.d[i4] - 2, i3, 5, 5);
                }
            }
        }
        int i5 = d2 - 17;
        bitMatrix.a(6, 9, 1, i5);
        bitMatrix.a(9, 6, i5, 1);
        if (this.c > 6) {
            int i6 = d2 - 11;
            bitMatrix.a(i6, 0, 3, 6);
            bitMatrix.a(0, i6, 6, 3);
        }
        return bitMatrix;
    }
