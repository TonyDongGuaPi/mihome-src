...
public final class StringUtils {
    ...
    public static final String f1654a = "SJIS";
    ...
    private static final boolean g = ("SJIS".equalsIgnoreCase(c) || d.equalsIgnoreCase(c));
    ...
    public static String a(byte[] bArr, Map<DecodeHintType, ?> map) {
        ...
        if (z2 && z5) {
            return (!(i9 == 2 && i2 == 2) && i10 * 10 < length) ? f : "SJIS";
        }
        if (z2) {
            return f;
        }
