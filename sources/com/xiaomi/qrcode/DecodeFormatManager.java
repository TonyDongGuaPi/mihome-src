...
final class DecodeFormatManager {
    ...
    static final Set<BarcodeFormat> f12957a = EnumSet.of(BarcodeFormat.UPC_A, new BarcodeFormat[]{BarcodeFormat.UPC_E, BarcodeFormat.EAN_13, BarcodeFormat.EAN_8, BarcodeFormat.RSS_14, BarcodeFormat.RSS_EXPANDED});
    ...
    private static final Set<BarcodeFormat> h = EnumSet.copyOf(f12957a);
    private static final Map<String, Set<BarcodeFormat>> i = new HashMap();

    static {
        h.addAll(b);
        i.put("ONE_D_MODE", h);
        i.put("PRODUCT_MODE", f12957a);
