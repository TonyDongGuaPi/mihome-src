...
final class InactivityTimer {
    ...
    public static final String f12964a = "InactivityTimer";
    ...
    public synchronized void b() {
        ...
        if (this.e) {
            ...
            Log.w(f12964a, "PowerStatusReceiver was never registered?");
        }
    }

    public synchronized void c() {
        if (this.e) {
            Log.w(f12964a, "PowerStatusReceiver was already registered?");
        } else {
    ...
    private final class InactivityAsyncTask extends AsyncTask<Object, Object, Object> {
        ...
        public Object doInBackground(Object... objArr) {
            try {
                Thread.sleep(300000);
                Log.i(InactivityTimer.f12964a, "Finishing activity due to inactivity");
