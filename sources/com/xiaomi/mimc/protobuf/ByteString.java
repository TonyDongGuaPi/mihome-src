...
public abstract class ByteString implements Serializable, Iterable<Byte> {
    ...
    private static final ByteArrayCopier f11297a;
    private int hash = 0;
    ...
    static {
        ...
        f11297a = z ? new SystemByteArrayCopier() : new ArraysByteArrayCopier();
    }
    ...
    public final ByteIterator iterator() {
        return new ByteIterator() {
            private int b = 0;
            private final int c = ByteString.this.size();
    ...
    public static ByteString copyFrom(byte[] bArr, int i, int i2) {
        return new LiteralByteString(f11297a.a(bArr, i, i2));
    }
    ...
    public static ByteString copyFromUtf8(String str) {
        return new LiteralByteString(str.getBytes(Internal.f11319a));
    }
    ...
    public final String toStringUtf8() {
        return toString(Internal.f11319a);
    }
    ...
    public static final class Output extends OutputStream {
        ...
        /* renamed from: a  reason: collision with root package name */
        private static final byte[] f11300a = new byte[0];
        private final int b;
        ...
        public synchronized ByteString a() {
            d();
            return ByteString.copyFrom((Iterable<ByteString>) this.c);
        }
        ...
        private void d() {
            if (this.f >= this.e.length) {
                ...
                this.c.add(new LiteralByteString(a(this.e, this.f)));
            }
            this.d += this.f;
            this.f = 0;
        }
    ...
    static final class CodedBuilder {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final CodedOutputStream f11299a;
        private final byte[] b;

        private CodedBuilder(int i) {
            this.b = new byte[i];
            this.f11299a = CodedOutputStream.a(this.b);
        }
    ...
    private static class LiteralByteString extends LeafByteString {
        ...
        public final boolean isValidUtf8() {
            ...
            return Utf8.a(this.bytes, offsetIntoBytes, size() + offsetIntoBytes);
        }
