...
public class ab {
    ...
    private static final String f23012a = "MiStatPref";
    ...
    private ab() {
        ...
        this.g = new a(a2);
        b();
        c(a2.getDatabasePath(a.f23013a).getAbsolutePath());
    }
    ...
    public void b() {
        ...
        try {
            ...
            if (cursor != null) {
                ...
                try {
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        k.c(f23012a, "key=" + string + " ,value=" + string2);
                    }
            ...
            k.c(f23012a, "load data execute failed with " + e2);
        }
    }
    ...
    private static class a extends SQLiteOpenHelper {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final String f23013a = "mistat_pf";
        ...
        public a(Context context) {
            super(context, f23013a, (SQLiteDatabase.CursorFactory) null, 1);
        }
