...
public class l {
    ...
    public static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final int f23010a = 30;
    ...
    public static l a(Throwable th, String str, boolean z, String str2) {
        l lVar = new l();
        lVar.f23009a = "mistat_app_exception";
        lVar.b = a.j;
        lVar.c = "track";
        lVar.e = r.b();
        aj ajVar = new aj();
    ...
    public static l a(int i) {
        l lVar = new l();
        lVar.f23009a = "mistat_app_update";
        lVar.b = a.h;
        lVar.c = "track";
        lVar.e = r.b();
        aj ajVar = new aj();
    ...
    public static l a(String str) {
        ...
        lVar.f23009a = isEmpty ? "mistat_signout" : "mistat_signin";
        lVar.b = a.h;
        lVar.c = "track_signin";
        lVar.e = r.b();
        aj ajVar = new aj();
    ...
    public static l a(HttpEvent httpEvent, String str) {
        l lVar = new l();
        lVar.f23009a = "mistat_net_monitor";
        lVar.b = a.k;
        lVar.c = "track";
        lVar.e = r.b();
        aj ajVar = new aj();
    ...
    public static l a(NetAvailableEvent netAvailableEvent, String str) {
        ...
        ajVar.putInt(NetInfo.KEY_STATUS_CODE, netAvailableEvent.getStatusCode());
        ajVar.putString(NetInfo.KEY_ERROR_CODE, netAvailableEvent.getException());
    ...
    public static l a(int i, int i2, long j, long j2) {
        l lVar = new l();
        lVar.f23009a = "mistat_page_monitor";
        lVar.b = a.h;
        lVar.c = "track";
        lVar.e = r.b();
        aj ajVar = new aj();
