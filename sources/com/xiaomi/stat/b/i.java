...
public class i {
    ...
    private static final String f23031a = "SecretKeyManager";
    ...
    private void d() {
        ...
        String concat = g.a(this.u, true).concat(JSMethod.NOT_SET).concat(String.valueOf(r.b()));
        try {
    ...
    public synchronized byte[] a(byte[] bArr) {
        if (bArr == null) {
            k.b(f23031a, "encrypt content is empty");
            return null;
        }
        return a.a(bArr, e());
    }
    ...
    private boolean b(boolean z) {
        if (Build.VERSION.SDK_INT < 18) {
            k.b(f23031a, "under 4.3,use randomly generated key");
            return false;
        }
        if (j()) {
            k();
        ...
        if (g2 != null) {
            ...
            if (!TextUtils.isEmpty(g2.optString("sk")) && !TextUtils.isEmpty(optString) && !z) {
                k.b(f23031a, "key and sid already requested successfully in recent 7 days!");
                return false;
            }
        }
        JSONObject h2 = h();
        ...
        k.b(f23031a, "request count > max count today, skip...");
        return false;
    }
        ...
        try {
            ...
            if (!TextUtils.isEmpty(a4)) {
                ...
                if (optInt == 1 && optJSONObject != null) {
                    ...
                    k.b(f23031a, "update secret-key failed: " + optString);
                }
            }
            return true;
        } catch (Exception e3) {
            e = e3;
            k.d(f23031a, "updateSecretKey e", e);
            return z;
        }
    }
    ...
    private JSONObject g() {
        ...
        try {
            ...
            k.d(f23031a, "decodeFromAndroidKeyStore e", e2);
            return null;
        }
    }
    ...
    private JSONObject h() {
        try {
            ...
            k.d(f23031a, "getRequestHistory e", e2);
        }
    ...
    private void i() {
        try {
            ...
            k.b(f23031a, "updateSecretKey e", e2);
        }
    }

    private boolean j() {
        long a2 = ab.a().a("last_success_time", 0);
        return a2 != 0 && r.a(a2, DateUtils.d);
    }
