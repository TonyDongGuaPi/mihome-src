...
public class d {
    ...
    private static final Object f23026a = new Object();
    private static String b = " http://data.mistat.xiaomi.com/idservice/deviceid_get";
    ...
    private String f() {
        try {
            ...
            String a2 = c.a(b, (Map<String, String>) h(), true);
            k.b(c, a2);
