...
public class RSACoder {
    ...
    private static final String f12081a = "RSACoder";
    ...
    public static KeyPair a() {
        try {
            ...
            MIMCLog.d(f12081a, "RSA genKeyPair error, ", e);
            return null;
        }
    }
    ...
    public static byte[] a(byte[] bArr, byte[] bArr2, short s, short s2) {
        try {
            ...
            MIMCLog.d(f12081a, String.format("RSA encrypt error, publicKeyParams=%s, moduleLen=%d, publicExponentLen=%d", new Object[]{new String(bArr2), Short.valueOf(s), Short.valueOf(s2)}), e);
            return null;
        }
    }
    ...
    private static byte[] a(byte[] bArr, PublicKey publicKey) {
        ...
        try {
            ...
            try {
                ...
                MIMCLog.d(f12081a, "RSA encrypt close output stream error, ", e);
            }
            return byteArray;
        } catch (Exception e2) {
            MIMCLog.d(f12081a, "RSA encrypt error, ", e2);
            try {
                byteArrayOutputStream.close();
            } catch (Exception e3) {
                MIMCLog.d(f12081a, "RSA encrypt close output stream error, ", e3);
            }
            return null;
        } catch (Throwable th) {
            try {
                ...
                MIMCLog.d(f12081a, "RSA encrypt close output stream error, ", e4);
            }
            throw th;
        }
    }
    ...
    public static byte[] a(byte[] bArr, byte[] bArr2) {
        ...
        try {
            ...
            while (true) {
                ...
                if (i3 > bitLength) {
                    bArr4 = instance.doFinal(bArr, i, bitLength);
                } else {
                    bArr4 = instance.doFinal(bArr, i, i3);
                }
            ...
            MIMCLog.d(f12081a, "RSA decrypt error, ", e2);
            bArr3 = null;
            try {
                byteArrayOutputStream.close();
            } catch (Exception e3) {
            ...
            try {
                ...
                MIMCLog.d(f12081a, "RSA decrypt close output stream error, ", e4);
            }
            MIMCLog.a(f12081a, "finish decrypt!");
            throw th;
        }
        MIMCLog.a(f12081a, "finish decrypt!");
        return bArr3;
        MIMCLog.d(f12081a, "RSA decrypt close output stream error, ", e);
        MIMCLog.a(f12081a, "finish decrypt!");
        return bArr3;
    }
