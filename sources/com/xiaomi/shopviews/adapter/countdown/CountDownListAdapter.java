...
public class CountDownListAdapter extends RecyclerView.Adapter<ProductViewHolder> {
    ...
    public CountDownListAdapter(Context context, PageDataBean pageDataBean, ProviderClickListener providerClickListener) {
        this(context);
        this.d = pageDataBean;
    ...
    public void onBindViewHolder(ProductViewHolder productViewHolder, final int i) {
        ...
        if (this.b.size() == 1) {
            ...
            int a2 = Coder.a(this.f13083a, 220.0f);
            ...
            int a3 = Coder.a(this.f13083a, 7.0f);
            if (i == 0) {
                i7 = Coder.a(this.f13083a, 8.0f);
            }
            i3 = Coder.a(this.f13083a, 285.0f);
            i2 = Coder.a(this.f13083a, 190.0f);
            int i11 = a3;
            i4 = i10;
            i5 = i7;
            i7 = i11;
        ...
        productViewHolder.f13086a.setText(assemblyInfoBean.d);
        ...
        productViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CountDownListAdapter.this.onClick(CountDownListAdapter.this.d.b, (PageDataBean.AssemblyInfoBean) CountDownListAdapter.this.b.get(i));
                CountDownListAdapter.this.a(String.format(EventRecordConstants.EventID.b, new Object[]{Integer.valueOf(i + 1)}), EventRecordConstants.PageID.f);
            }
        });
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ProductViewHolder(LayoutInflater.from(this.f13083a).inflate(R.layout.countdown_list_item, viewGroup, false));
    }
    ...
    static class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        ProductViewHolder(View view) {
            ...
            this.f13086a = (CustomTextView) view.findViewById(R.id.product_name);
