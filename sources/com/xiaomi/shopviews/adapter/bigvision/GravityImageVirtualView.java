...
public class GravityImageVirtualView extends ImageView implements IView {
    ...
    public interface OnPanoramaScrollListener {
        void a(GravityImageVirtualView gravityImageVirtualView, float f, float f2);
    }
    ...
    public void setGyroscopeObserver(GyroscopeVirtualViewObserver gyroscopeVirtualViewObserver) {
        if (gyroscopeVirtualViewObserver != null) {
            gyroscopeVirtualViewObserver.a(this);
        }
    }
