...
public class DiscoverVideoProvider extends BaseItemProvider<PageDataBean, BaseViewHolder> {
    ...
    public DiscoverVideoProvider() {
    }

    public DiscoverVideoProvider(ProviderClickListener providerClickListener) {
    ...
    public void a(BaseViewHolder baseViewHolder, PageDataBean pageDataBean, int i) {
        ...
        if (this.c != null) {
            this.c.a(pageDataBean.b, pageDataBean.v.get(0));
        }
    }
