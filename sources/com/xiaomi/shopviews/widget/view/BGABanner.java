...
public class BGABanner extends RelativeLayout implements ViewPager.OnPageChangeListener, BGAViewPager.AutoPlayDelegate {
    ...
    private static final int f13353a = -1;
    ...
    private BGAOnNoDoubleClickListener aa;
    /* access modifiers changed from: private */
    ...
    public BGABanner(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.Q = true;
        this.U = true;
        this.aa = new BGAOnNoDoubleClickListener() {
    ...
    private void a(int i2, TypedArray typedArray) {
        ...
        } else if (i2 == R.styleable.BGABanner_android_scaleType && (i3 = typedArray.getInt(i2, -1)) >= 0 && i3 < W.length) {
            this.B = W[i3];
        }
    }

    public void setPointTopBottomMargin(int i2) {
        this.q = i2;
        this.V.setPadding(this.r, this.q, this.r, this.q);
    }
    ...
    private static class AutoPlayTask implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final WeakReference<BGABanner> f13355a;

        private AutoPlayTask(BGABanner bGABanner) {
            this.f13355a = new WeakReference<>(bGABanner);
        }

        public void run() {
            BGABanner bGABanner = (BGABanner) this.f13355a.get();
            if (bGABanner != null) {
                bGABanner.d();
