...
public class CustomRecyclerViewUtils {
    ...
    public static RecyclerView.ViewHolder a(@NonNull RecyclerView recyclerView, float f2, float f3) {
        View b2 = b((ViewGroup) recyclerView, f2, f3);
        if (b2 != null) {
            return recyclerView.getChildViewHolder(b2);
        }
        return null;
    }
    ...
    private static View b(@NonNull ViewGroup viewGroup, float f2, float f3) {
    ...
    static int a(View view, int i2, int i3) {
        int left = ((view.getLeft() + view.getRight()) / 2) - i2;
        int top = ((view.getTop() + view.getBottom()) / 2) - i3;
        return (left * left) + (top * top);
    }

    public static View a(@NonNull ViewGroup viewGroup, float f2, float f3) {
        for (int childCount = viewGroup.getChildCount() - 1; childCount >= 0; childCount--) {
            View childAt = viewGroup.getChildAt(childCount);
            if (f2 >= ((float) childAt.getLeft()) && f2 <= ((float) childAt.getRight()) && f3 >= ((float) childAt.getTop()) && f3 <= ((float) childAt.getBottom())) {
                return childAt;
    ...
    public static RecyclerView.ViewHolder c(@NonNull RecyclerView recyclerView, float f2, float f3) {
