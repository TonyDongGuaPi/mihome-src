...
public abstract class GeneralItemAnimator extends BaseItemAnimator {
    ...
    private static final String f10116a = "ARVGeneralItemAnimator";
    private boolean b;
    ...
    public boolean animateRemove(RecyclerView.ViewHolder viewHolder) {
        if (this.b) {
            Log.d(f10116a, "animateRemove(id = " + viewHolder.getItemId() + ", position = " + viewHolder.getLayoutPosition() + Operators.BRACKET_END_STR);
        }
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        if (this.b) {
            Log.d(f10116a, "animateAdd(id = " + viewHolder.getItemId() + ", position = " + viewHolder.getLayoutPosition() + Operators.BRACKET_END_STR);
        }
    ...
    public boolean animateMove(RecyclerView.ViewHolder viewHolder, int i, int i2, int i3, int i4) {
        if (this.b) {
            Log.d(f10116a, "animateMove(id = " + viewHolder.getItemId() + ", position = " + viewHolder.getLayoutPosition() + ", fromX = " + i + ", fromY = " + i2 + ", toX = " + i3 + ", toY = " + i4 + Operators.BRACKET_END_STR);
        }
    ...
    public boolean a() {
        if (this.b && !isRunning()) {
            Log.d(f10116a, "dispatchFinishedWhenDone()");
        }
        return super.a();
    }
