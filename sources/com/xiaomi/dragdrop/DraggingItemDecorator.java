...
public class DraggingItemDecorator extends BaseDraggableItemDecorator {
    ...
    public void a(MotionEvent motionEvent, DraggingItemInfo draggingItemInfo) {
        if (!this.o) {
            ...
            this.g = this.f10091a.getPaddingLeft();
            this.i = this.f10091a.getPaddingTop();
            this.r = CustomRecyclerViewUtils.e(this.f10091a);
            view.setVisibility(4);
            a(motionEvent, true);
            this.f10091a.addItemDecoration(this);
            this.o = true;
        }
    }
    ...
    public boolean b(boolean z) {
        ...
        if (z2 || z) {
            a((float) this.d, this.e);
            ViewCompat.postInvalidateOnAnimation(this.f10091a);
        }
        return z2;
    }
    ...
    private void n() {
        ...
        if (recyclerView.getChildCount() > 0) {
            this.g = (-this.s.f10101a) / 2;
            this.h = recyclerView.getWidth() - (this.s.f10101a / 2);
            this.i = (-this.s.b) / 2;
            this.j = recyclerView.getHeight() - (this.s.b / 2);
            switch (this.r) {
                case 0:
            ...
            if (!this.p) {
                ...
                switch (this.r) {
                    case 0:
                        ...
                        if (b2 != null) {
                            this.h = Math.min(this.h, Math.max(0, b2.getRight() - this.s.f10101a));
                            break;
                        }
                        break;
                    case 1:
    ...
    private void a(float f2, int i2) {
        if (this.b != null) {
            a(this.f10091a, this.b, f2 - ((float) this.b.itemView.getLeft()), (float) (i2 - this.b.itemView.getTop()));
        }
    }
