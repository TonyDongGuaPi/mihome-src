...
public class XQProgressDialogSimple extends AlertDialog {
    ...
    public void onCreate(Bundle bundle) {
        ...
        View inflate = LayoutInflater.from(this.c).inflate(R.layout.yp_xq_progress_dialog_simple, (ViewGroup) null);
        setContentView(inflate);
        this.f1608a = (TextView) inflate.findViewById(R.id.progress_message);
