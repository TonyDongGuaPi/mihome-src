...
public class CommonErrorView extends RelativeLayout implements View.OnClickListener {
    ...
    private void a(AttributeSet attributeSet) {
        LayoutInflater.from(getContext()).inflate(R.layout.yp_common_page_error, this, true);
        this.f1601a = (ImageView) findViewById(R.id.common_error_img);
        ...
        if (attributeSet != null) {
            ...
            ((RelativeLayout.LayoutParams) this.f1601a.getLayoutParams()).setMargins(0, obtainStyledAttributes.getDimensionPixelSize(R.styleable.CommonErrorView_imgMarginTop, getResources().getDimensionPixelSize(R.dimen.error_view_margin_top)), 0, 0);
    ...
    public void setImg(@DrawableRes int i) {
        this.f1601a.setImageResource(i);
    }
