...
public class LazyFileProvider extends ContentProvider {
    ...
    private static final String[] f11107a = {"_display_name", "_size"};
    ...
    private static HashMap<String, PathStrategy> l = new HashMap<>();
    private String m;
    ...
    public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        int i2;
        File a2 = a(getContext(), this.m).a(uri);
        if (strArr == null) {
            strArr = f11107a;
        }
    ...
    public java.lang.String getType(android.net.Uri r3) {
        /*
            ...
            com.xiaomi.market.sdk.LazyFileProvider$PathStrategy r0 = a((android.content.Context) r0, (java.lang.String) r1)
        ...
        L_0x002f:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.market.sdk.LazyFileProvider.getType(android.net.Uri):java.lang.String");
    }
    ...
    public int delete(Uri uri, String str, String[] strArr) {
        return a(getContext(), this.m).a(uri).delete() ? 1 : 0;
    }

    public ParcelFileDescriptor openFile(Uri uri, String str) throws FileNotFoundException {
        return ParcelFileDescriptor.open(a(getContext(), this.m).a(uri), a(str));
    }

    private static PathStrategy a(Context context, String str) {
        PathStrategy pathStrategy;
        synchronized (l) {
            pathStrategy = l.get(str);
            if (pathStrategy == null) {
                try {
                    pathStrategy = b(context, str);
                    l.put(str, pathStrategy);
        ...
        public Uri a(File file) {
            ...
            try {
                ...
                if (entry != null) {
                    ...
                    return new Uri.Builder().scheme("content").authority(this.f11108a).encodedPath(Uri.encode((String) entry.getKey()) + IOUtils.f15883a + Uri.encode(str, "/")).build();
                }
