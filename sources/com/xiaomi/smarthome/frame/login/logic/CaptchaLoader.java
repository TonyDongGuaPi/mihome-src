...
public class CaptchaLoader {
    ...
    private static final JoinPoint.StaticPart f16183a = null;
    ...
    private static void a() {
        ...
        f16183a = factory.a("method-call", (Signature) factory.a("1", "build", "okhttp3.OkHttpClient$Builder", "", "", "", "okhttp3.OkHttpClient"), 35);
    }
    ...
    public static void a(String str, final AsyncCallback<CaptchaResult, Error> asyncCallback) {
        ...
        JoinPoint a2 = Factory.a(f16183a, (Object) null, (Object) cookieJar);
        ((OkHttpClient) OkHttp3Aspect.d().a(new AjcClosure1(new Object[]{cookieJar, a2}).linkClosureAndJoinPoint(16))).newCall(new Request.Builder().url(str).build()).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response == null) {
                    ...
                    captchaResult.f16185a = decodeStream;
                    ...
                    if (a2 != null) {
                        ...
                        Log.e("CaptchaLoader", "Cookie ick is null");
                    }
                    if (asyncCallback != null) {
