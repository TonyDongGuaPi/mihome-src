...
public class SerializedAsyncTaskProcessor {
    ...
    private ProcessPackageThread f16132a;
    ...
    public void a(SerializedAsyncTask serializedAsyncTask) {
        if (this.f16132a == null) {
            this.f16132a = new ProcessPackageThread();
            this.f16132a.setDaemon(this.f);
            this.f16132a.start();
        }
        this.f16132a.a(serializedAsyncTask);
    }

    public void a() {
        if (this.f16132a != null) {
            this.f16132a.b.clear();
        }
    }
