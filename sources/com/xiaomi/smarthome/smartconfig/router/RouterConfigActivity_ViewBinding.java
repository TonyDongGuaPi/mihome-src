...
public class RouterConfigActivity_ViewBinding implements Unbinder {
    ...
    private RouterConfigActivity f22383a;

    @UiThread
    public RouterConfigActivity_ViewBinding(RouterConfigActivity routerConfigActivity) {
        this(routerConfigActivity, routerConfigActivity.getWindow().getDecorView());
    }

    @UiThread
    public RouterConfigActivity_ViewBinding(RouterConfigActivity routerConfigActivity, View view) {
        this.f22383a = routerConfigActivity;
    ...
    @CallSuper
    public void unbind() {
        RouterConfigActivity routerConfigActivity = this.f22383a;
