...
public class CameraResetConnection_ViewBinding implements Unbinder {
    ...
    private CameraResetConnection f22244a;

    @UiThread
    public CameraResetConnection_ViewBinding(CameraResetConnection cameraResetConnection) {
        this(cameraResetConnection, cameraResetConnection.getWindow().getDecorView());
    }

    @UiThread
    public CameraResetConnection_ViewBinding(CameraResetConnection cameraResetConnection, View view) {
        this.f22244a = cameraResetConnection;
    ...
    @CallSuper
    public void unbind() {
        CameraResetConnection cameraResetConnection = this.f22244a;
