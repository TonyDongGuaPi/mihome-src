...
public class RouterDeviceFragment extends BaseCUDFragment {
    private int j = 0;
    ...
    static BaseCUDFragment a(String str) {
        RouterDeviceFragment routerDeviceFragment = new RouterDeviceFragment();
        Bundle bundle = new Bundle();
        bundle.putString("title", str);
        routerDeviceFragment.setArguments(bundle);
        return routerDeviceFragment;
    }
    ...
    public void b() {
        ...
        HashMap hashMap = new HashMap(b2.q() == null ? new HashMap<>() : b2.q());
        ...
        for (Map.Entry entry : hashMap.entrySet()) {
            ...
            if (!arrayList2.isEmpty()) {
                ...
                a(new Router(b2.k(str), (List<String>) null), arrayList2);
            }
        }
        ...
        if (!arrayList3.isEmpty()) {
            a(new Router(getResources().getString(R.string.other_device1), (List<String>) null), arrayList3);
        }
    ...
    class Router implements BaseCUDFragment.ItemData {
        private String b;
        private List<String> c;

        public Router(String str, List<String> list) {
            this.b = str;
            this.c = list;
        }
