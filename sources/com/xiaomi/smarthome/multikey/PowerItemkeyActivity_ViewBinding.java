...
public class PowerItemkeyActivity_ViewBinding implements Unbinder {
    ...
    private PowerItemkeyActivity f20174a;

    @UiThread
    public PowerItemkeyActivity_ViewBinding(PowerItemkeyActivity powerItemkeyActivity) {
        this(powerItemkeyActivity, powerItemkeyActivity.getWindow().getDecorView());
    }

    @UiThread
    public PowerItemkeyActivity_ViewBinding(PowerItemkeyActivity powerItemkeyActivity, View view) {
        this.f20174a = powerItemkeyActivity;
    ...
    @CallSuper
    public void unbind() {
        PowerItemkeyActivity powerItemkeyActivity = this.f20174a;
