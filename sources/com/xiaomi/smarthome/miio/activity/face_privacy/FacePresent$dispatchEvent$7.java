...
final class FacePresent$dispatchEvent$7<T> implements Consumer<FacePrivacyState> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ FacePresent f11874a;

    FacePresent$dispatchEvent$7(FacePresent facePresent) {
        this.f11874a = facePresent;
    }

    /* renamed from: a */
    public final void accept(FacePrivacyState facePrivacyState) {
        this.f11874a.e.onNext(facePrivacyState);
    }
}
