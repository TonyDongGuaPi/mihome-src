...
final class FacePresent$dispatchEvent$3<T> implements Consumer<FacePrivacyState.FaceStatusDataState> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ FacePresent f11870a;

    FacePresent$dispatchEvent$3(FacePresent facePresent) {
        this.f11870a = facePresent;
    }

    /* renamed from: a */
    public final void accept(FacePrivacyState.FaceStatusDataState faceStatusDataState) {
        this.f11870a.e.onNext(faceStatusDataState);
    }
}
