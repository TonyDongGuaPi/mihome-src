...
public class BleGatewayListActivity_ViewBinding implements Unbinder {
    ...
    private BleGatewayListActivity f11708a;

    @UiThread
    public BleGatewayListActivity_ViewBinding(BleGatewayListActivity bleGatewayListActivity) {
        this(bleGatewayListActivity, bleGatewayListActivity.getWindow().getDecorView());
    }

    @UiThread
    public BleGatewayListActivity_ViewBinding(BleGatewayListActivity bleGatewayListActivity, View view) {
        this.f11708a = bleGatewayListActivity;
    ...
    @CallSuper
    public void unbind() {
        BleGatewayListActivity bleGatewayListActivity = this.f11708a;
