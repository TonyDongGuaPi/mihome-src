package com.xiaomi.smarthome.api;
...
public class SmartHomeRc4Api {
    ...
    public static final String f13695a = "SmartHomeApi";
    ...
    private SmartHomeRc4Api(Context context) {
        ...
        this.s = new Dispatcher(new ThreadPoolExecutor(6, Integer.MAX_VALUE, 60, TimeUnit.SECONDS, new LinkedBlockingQueue(), Util.threadFactory("OkHttp Dispatcher", false)));
    ...
    private boolean d(String str) {
        ...
        if (TextUtils.isEmpty(d2.f1530a)) {
            return false;
        }
    ...
    private void e() {
        ...
        if (g2 == null) {
            CookieUtil.a(this.m, c(), "locale", LocaleUtil.a(Locale.getDefault()), ".io.mi.com", "/");
            return;
        }
    ...
    private void g() {
        ...
        L_0x005a:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.smarthome.api.SmartHomeRc4Api.g():void");
    }
    ...
    private android.util.Pair<java.util.List<com.xiaomi.smarthome.core.entity.net.KeyValuePair>, java.lang.String> b(com.xiaomi.smarthome.core.entity.net.NetRequest r12) {
        ...
        L_0x010a:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.smarthome.api.SmartHomeRc4Api.b(com.xiaomi.smarthome.core.entity.net.NetRequest):android.util.Pair");
    }
    ...
    private android.util.Pair<java.util.List<com.xiaomi.smarthome.core.entity.net.KeyValuePair>, java.lang.String> c(com.xiaomi.smarthome.core.entity.net.NetRequest r10) {
        ...
        L_0x00cc:
            ...
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.smarthome.api.SmartHomeRc4Api.c(com.xiaomi.smarthome.core.entity.net.NetRequest):android.util.Pair");
    }
    ...
    /* access modifiers changed from: private */
    /* JADX WARNING: Can't wrap try/catch for region: R(6:36|37|10e|(2:43|44)|45|68) */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:68:?, code lost:
        return;
     */
    /* JADX WARNING: Missing exception handler attribute for start block: B:36:0x010c */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void c(java.lang.String r11, java.lang.String r12) {
        /*
            ...
            r7 = 4
            org.json.JSONObject r1 = new org.json.JSONObject     // Catch:{ JSONException -> 0x0125 }
            r1.<init>(r12)     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r2 = "code"
            int r1 = r1.optInt(r2)     // Catch:{ JSONException -> 0x0125 }
            r8 = 2
            if (r1 != r8) goto L_0x00c9
            java.util.HashMap r2 = new java.util.HashMap     // Catch:{ JSONException -> 0x0125 }
            r2.<init>()     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r4 = "url"
            r2.put(r4, r11)     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r4 = "response"
            r2.put(r4, r12)     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r4 = "uid"
            r2.put(r4, r3)     // Catch:{ JSONException -> 0x0125 }
            com.xiaomi.youpin.login.entity.account.MiServiceTokenInfo r4 = r10.j     // Catch:{ JSONException -> 0x0125 }
            if (r4 != 0) goto L_0x0042
            java.lang.String r4 = ""
            goto L_0x0046
        L_0x0042:
            com.xiaomi.youpin.login.entity.account.MiServiceTokenInfo r4 = r10.j     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r4 = r4.c     // Catch:{ JSONException -> 0x0125 }
        L_0x0046:
            java.lang.String r6 = "serviceToken"
            r2.put(r6, r4)     // Catch:{ JSONException -> 0x0125 }
            com.xiaomi.smarthome.frame.core.CoreApi r6 = com.xiaomi.smarthome.frame.core.CoreApi.a()     // Catch:{ JSONException -> 0x0125 }
            java.util.List r6 = r6.x()     // Catch:{ JSONException -> 0x0125 }
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ JSONException -> 0x0125 }
            r9.<init>()     // Catch:{ JSONException -> 0x0125 }
            r9.append(r11)     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r11 = ";"
            r9.append(r11)     // Catch:{ JSONException -> 0x0125 }
            r9.append(r12)     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r11 = ";"
            r9.append(r11)     // Catch:{ JSONException -> 0x0125 }
            r9.append(r3)     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r11 = ";"
            r9.append(r11)     // Catch:{ JSONException -> 0x0125 }
            r9.append(r4)     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r11 = ";"
            r9.append(r11)     // Catch:{ JSONException -> 0x0125 }
            java.util.Iterator r11 = r6.iterator()     // Catch:{ JSONException -> 0x0125 }
        L_0x007c:
            boolean r12 = r11.hasNext()     // Catch:{ JSONException -> 0x0125 }
            if (r12 == 0) goto L_0x009d
            java.lang.Object r12 = r11.next()     // Catch:{ JSONException -> 0x0125 }
            com.xiaomi.youpin.login.entity.account.MiServiceTokenInfo r12 = (com.xiaomi.youpin.login.entity.account.MiServiceTokenInfo) r12     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r4 = r12.f23514a     // Catch:{ JSONException -> 0x0125 }
            r9.append(r4)     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r4 = ":"
            r9.append(r4)     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r12 = r12.c     // Catch:{ JSONException -> 0x0125 }
            r9.append(r12)     // Catch:{ JSONException -> 0x0125 }
        ...
        L_0x009d:
            ...
            java.lang.String r12 = r9.toString()     // Catch:{ JSONException -> 0x0125 }
            r2.put(r11, r12)     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r11 = "click"
            java.lang.String r12 = "app_401_errorcode2"
            com.xiaomi.mistatistic.sdk.MiStatInterface.a((java.lang.String) r11, (java.lang.String) r12, (java.util.Map<java.lang.String, java.lang.String>) r2)     // Catch:{ JSONException -> 0x0125 }
            com.xiaomi.smarthome.frame.log.MyLogger r11 = com.xiaomi.smarthome.frame.log.MyLogger.a()     // Catch:{ JSONException -> 0x0125 }
            java.lang.StringBuilder r12 = new java.lang.StringBuilder     // Catch:{ JSONException -> 0x0125 }
            r12.<init>()     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r4 = "app_401_errorcode2 "
            r12.append(r4)     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r2 = r2.toString()     // Catch:{ JSONException -> 0x0125 }
            r12.append(r2)     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r12 = r12.toString()     // Catch:{ JSONException -> 0x0125 }
            r11.a((java.lang.String) r12)     // Catch:{ JSONException -> 0x0125 }
        L_0x00c9:
            r11 = 3
        ...
        L_0x00cf:
            ...
            com.xiaomi.smarthome.core.server.internal.account.AccountManager r12 = com.xiaomi.smarthome.core.server.internal.account.AccountManager.a()     // Catch:{ JSONException -> 0x0125 }
            r12.p()     // Catch:{ JSONException -> 0x0125 }
        L_0x00d8:
            r10.a((int) r11)     // Catch:{ JSONException -> 0x0125 }
            goto L_0x0131
        L_0x00dc:
            java.lang.Object r11 = r10.n     // Catch:{ JSONException -> 0x0125 }
            monitor-enter(r11)     // Catch:{ JSONException -> 0x0125 }
            boolean r12 = r10.o     // Catch:{ all -> 0x0122 }
            r1 = 1
            r9 = 0
            if (r12 == 0) goto L_0x00e6
            goto L_0x00e9
        L_0x00e6:
            r10.o = r1     // Catch:{ all -> 0x0122 }
            r1 = 0
        L_0x00e9:
            monitor-exit(r11)     // Catch:{ all -> 0x0122 }
            if (r1 == 0) goto L_0x00ed
            return
        L_0x00ed:
            com.xiaomi.smarthome.core.server.CoreManager r11 = com.xiaomi.smarthome.core.server.CoreManager.a()     // Catch:{ JSONException -> 0x0125 }
            java.lang.String r12 = "com.xiaomi.smarthome"
            com.xiaomi.smarthome.core.client.IClientApi r1 = r11.a((java.lang.String) r12)     // Catch:{ JSONException -> 0x0125 }
            if (r0 == 0) goto L_0x0100
            com.xiaomi.smarthome.core.server.internal.account.AccountManager r11 = com.xiaomi.smarthome.core.server.internal.account.AccountManager.a()     // Catch:{ Exception -> 0x010c }
            r11.p()     // Catch:{ Exception -> 0x010c }
        L_0x0100:
            java.lang.String r2 = "xiaomiio"
            com.xiaomi.smarthome.api.SmartHomeRc4Api$2 r6 = new com.xiaomi.smarthome.api.SmartHomeRc4Api$2     // Catch:{ Exception -> 0x010c }
            r6.<init>()     // Catch:{ Exception -> 0x010c }
            r4 = r0
            r1.refreshServiceToken(r2, r3, r4, r5, r6)     // Catch:{ Exception -> 0x010c }
            goto L_0x0131
        L_0x010c:
            java.lang.Object r11 = r10.n     // Catch:{ JSONException -> 0x0125 }
            monitor-enter(r11)     // Catch:{ JSONException -> 0x0125 }
            r10.o = r9     // Catch:{ all -> 0x011f }
            monitor-exit(r11)     // Catch:{ all -> 0x011f }
            if (r0 == 0) goto L_0x011b
            com.xiaomi.smarthome.core.server.internal.account.AccountManager r11 = com.xiaomi.smarthome.core.server.internal.account.AccountManager.a()     // Catch:{ JSONException -> 0x0125 }
            r11.p()     // Catch:{ JSONException -> 0x0125 }
        L_0x011b:
            r10.a((int) r8)     // Catch:{ JSONException -> 0x0125 }
            goto L_0x0131
        L_0x011f:
            r12 = move-exception
            monitor-exit(r11)     // Catch:{ all -> 0x011f }
            throw r12     // Catch:{ JSONException -> 0x0125 }
        L_0x0122:
            r12 = move-exception
            monitor-exit(r11)     // Catch:{ all -> 0x0122 }
            throw r12     // Catch:{ JSONException -> 0x0125 }
        L_0x0125:
            ...
            com.xiaomi.smarthome.core.server.internal.account.AccountManager r11 = com.xiaomi.smarthome.core.server.internal.account.AccountManager.a()
            r11.p()
        L_0x012e:
            r10.a((int) r7)
        L_0x0131:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.smarthome.api.SmartHomeRc4Api.c(java.lang.String, java.lang.String):void");
    }
    ...
    public com.xiaomi.smarthome.core.server.internal.NetHandle a(com.xiaomi.smarthome.core.entity.net.NetRequest r23, com.xiaomi.smarthome.core.server.internal.NetCallback<com.xiaomi.smarthome.core.entity.net.NetResult, com.xiaomi.smarthome.core.entity.net.NetError> r24) {
        ...
        L_0x02c9:
            com.xiaomi.smarthome.api.SmartHomeRc4Api$RequestRecord r3 = new com.xiaomi.smarthome.api.SmartHomeRc4Api$RequestRecord
            r3.<init>()
            okhttp3.OkHttpClient r0 = r9.l
            okhttp3.Call r0 = r0.newCall(r4)
            com.xiaomi.smarthome.api.SmartHomeRc4Api$3 r10 = new com.xiaomi.smarthome.api.SmartHomeRc4Api$3
            r1 = r10
            r2 = r22
            r5 = r23
            r6 = r24
            ...
            com.xiaomi.smarthome.api.SmartHomeRc4Api$4 r2 = new com.xiaomi.smarthome.api.SmartHomeRc4Api$4
            r2.<init>()
            r3 = 1000(0x3e8, double:4.94E-321)
            r0.postDelayed(r2, r3)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.smarthome.api.SmartHomeRc4Api.a(com.xiaomi.smarthome.core.entity.net.NetRequest, com.xiaomi.smarthome.core.server.internal.NetCallback):com.xiaomi.smarthome.core.server.internal.NetHandle");
    }
    ...
    public void i() {
        ...
        if (ProcessUtil.n(this.t)) {
            ...
            if (z) {
                CoreManager.a().c().post(new Runnable() {
                    public void run() {
