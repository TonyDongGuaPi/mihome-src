...
public class MiRechargeApi {

    /* renamed from: a  reason: collision with root package name */
    public static final String f14069a = "MiRechargeApi";
    public static final String b = "https://web.recharge.mipay.com";
    private static MiRechargeApi c;
    ...
    public class AjcClosure1 extends AroundClosure {
        ...
        public Object run(Object[] objArr) {
            ...
            return MiRechargeApi.a((MiRechargeApi) objArr2[0], (OkHttpClient.Builder) objArr2[1], (JoinPoint) objArr2[2]);
        }
    }

    private static void e() {
        Factory factory = new Factory("MiRechargeApi.java", MiRechargeApi.class);
        k = factory.a("method-call", (Signature) factory.a("1", "build", "okhttp3.OkHttpClient$Builder", "", "", "", "okhttp3.OkHttpClient"), 65);
    }
    ...
    static final OkHttpClient a(MiRechargeApi miRechargeApi, OkHttpClient.Builder builder, JoinPoint joinPoint) {
        HawkEyeAspect.a().a(joinPoint);
        return builder.build();
    }

    public static MiRechargeApi a() {
        if (c == null) {
            synchronized (d) {
                if (c == null) {
                    c = new MiRechargeApi();
    ...
    public void c() {
        ...
        if (!z) {
            ...
            a2.refreshServiceToken("mipaycom", m, n, o, new IServerCallback.Stub() {
                public void onSuccess(Bundle bundle) throws RemoteException {
                    synchronized (MiRechargeApi.this.i) {
                        boolean unused = MiRechargeApi.this.j = false;
                    }
                    ...
                    AccountManager.a().a("mipaycom", refreshServiceTokenResult.c, refreshServiceTokenResult.d, "web.recharge.pay.xiaomi.com", refreshServiceTokenResult.e);
                    AccountManager.a().j();
                    MiRechargeApi.this.a(false);
                }
    ...
    public NetHandle a(NetRequest netRequest, NetCallback<NetResult, NetError> netCallback) {
        ...
        if (netRequest == null) {
            ...
            if (!b()) {
                ...
                String m = AccountManager.a().m();
                this.g = AccountManager.a().a("mipaycom");
                ...
                CookieUtil.a(this.f);
                CookieUtil.a(this.f, b, "userId", m, "web.recharge.pay.xiaomi.com", "/");
