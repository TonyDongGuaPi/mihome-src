...
public class DeviceListApi {
    ...
    private static final String f14556a = "DeviceListApi";
    ...
    public static class AllDeviceData {
        ...
        /* renamed from: a  reason: collision with root package name */
        public ArrayList<Device> f14563a;
    ...
    public NetHandle a(JSONObject jSONObject, final NetCallback<AllDeviceData, NetError> netCallback) {
        ...
        AnonymousClass1 r0 = new NetCallback<AllDeviceData, NetError>() {
            ...
            public void a(AllDeviceData allDeviceData) {
                if (netCallback != null && allDeviceData.f14563a != null && allDeviceData.b != null && allDeviceData.c != null && allDeviceData.d != null) {
    ...
    public NetHandle a(final NetCallback<AllDeviceData, NetError> netCallback) {
        LogUtilGrey.a(f14556a, "updateLocalDeviceList core /v2/home/local_device_list");
        return SmartHomeRc4Api.a().a(a(new JSONObject(), "/v2/home/local_device_list"), (NetCallback<NetResult, NetError>) new NetCallback<NetResult, NetError>() {
            ...
            public void a(NetResult netResult) {
                if (netResult == null || netResult.c == null) {
                    LogUtilGrey.a(DeviceListApi.f14556a, "core /v2/home/local_device_list result.mResponse null");
                    if (netCallback != null) {
                ...
                try {
                    ...
                    if (optJSONObject != null) {
                        ...
                        LogUtilGrey.a(DeviceListApi.f14556a, "core /v2/home/local_device_list onSuccess size:" + arrayList.size());
                    } else {
                        LogUtilGrey.a(DeviceListApi.f14556a, "core /v2/home/local_device_list onSuccess result:" + netResult.c);
                    }
                    if (netCallback != null) {
                    ...
                    LogUtilGrey.a(DeviceListApi.f14556a, "core /v2/home/local_device_list Exception result:" + netResult.c);
                    if (netCallback != null) {
            ...
            public void a(NetError netError) {
                LogUtilGrey.a(DeviceListApi.f14556a, "core /v2/home/local_device_list onFailure error:" + netError);
                if (netCallback != null) {
    ...
    public NetHandle b(final NetCallback<AllDeviceData, NetError> netCallback) {
        LogUtilGrey.a(f14556a, "updateTrialDeviceList core /v2/home/trial_device_info");
        return SmartHomeRc4Api.a().a(a(new JSONObject(), "/v2/home/trial_device_info"), (NetCallback<NetResult, NetError>) new NetCallback<NetResult, NetError>() {
            ...
            public void a(NetResult netResult) {
                if (netResult == null || netResult.c == null) {
                    LogUtilGrey.a(DeviceListApi.f14556a, "core /v2/home/trial_device_info result.mResponse null");
                    if (netCallback != null) {
                        NetError unused = DeviceListApi.this.b.e = new NetError(-1, "result.mResponse null");
                        netCallback.a(DeviceListApi.this.b.e);
                        return;
                ...
                try {
                    ...
                    if (optJSONArray != null) {
                        ...
                        LogUtilGrey.a(DeviceListApi.f14556a, "core /v2/home/trial_device_info onSuccess size:" + arrayList.size());
                    } else {
                        LogUtilGrey.a(DeviceListApi.f14556a, "core /v2/home/trial_device_info onSuccess result:" + netResult.c);
                    }
                    if (netCallback != null) {
                        netCallback.a(DeviceListApi.this.b);
                    }
                } catch (Exception unused2) {
                    LogUtilGrey.a(DeviceListApi.f14556a, "core /v2/home/trial_device_info Exception result:" + netResult.c);
                    if (netCallback != null) {
                        NetError unused3 = DeviceListApi.this.b.e = new NetError(-1, "parse Exception");
                        netCallback.a(DeviceListApi.this.b.e);
                    }
            ...
            public void a(NetError netError) {
                LogUtilGrey.a(DeviceListApi.f14556a, "core /v2/home/trial_device_info onFailure error:" + netError);
                if (netCallback != null) {
    ...
    public NetHandle c(final NetCallback<AllDeviceData, NetError> netCallback) {
        LogUtil.a(f14556a, "updateSharedHomeDeviceList");
        return CoreSharedHomeManager.a().a((NetCallback<ArrayList<Device>, NetError>) new NetCallback<ArrayList<Device>, NetError>() {
            ...
            public void a(ArrayList<Device> arrayList) {
                LogUtil.a(DeviceListApi.f14556a, "updateSharedHomeDeviceList onSuccess");
                if (netCallback != null) {
                    if (arrayList == null) {
            ...
            public void a(NetError netError) {
                ...
                sb.append(str);
                LogUtil.a(DeviceListApi.f14556a, sb.toString());
                if (netCallback != null) {
    ...
    public NetHandle b(final JSONObject jSONObject, final NetCallback<AllDeviceData, NetError> netCallback) {
        LogUtilGrey.a(f14556a, "updateBindDeviceList core /v2/home/device_list_page");
        ...
        netHandleWrap.a(SmartHomeRc4Api.a(this.d).a(a(jSONObject, "/v2/home/device_list_page"), (NetCallback<NetResult, NetError>) new NetCallback<NetResult, NetError>() {
            ...
            public void a(NetResult netResult) {
                if (netHandleWrap.b()) {
                    LogUtilGrey.a(DeviceListApi.f14556a, "core /v2/home/device_list_page isCancel times:" + this.e.size());
                    if (netCallback != null) {
                    ...
                    LogUtilGrey.a(DeviceListApi.f14556a, "core /v2/home/device_list_page no netResult times:" + this.e.size());
                    if (netCallback != null) {
                        DeviceListApi.this.b.f14563a = this.e;
                        netCallback.a(DeviceListApi.this.b);
                    }
                } else {
                    try {
                        ...
                        if (optJSONObject != null) {
                            ...
                            LogUtilGrey.a(DeviceListApi.f14556a, "core /v2/home/device_list_page success times:" + this.e.size());
                            if (netCallback != null) {
                                DeviceListApi.this.b.f14563a = this.e;
                                netCallback.a(DeviceListApi.this.b);
                                return;
                        ...
                        LogUtilGrey.a(DeviceListApi.f14556a, "core /v2/home/device_list_page resultObject null times:" + this.e.size());
                        if (netCallback != null) {
                            DeviceListApi.this.b.f14563a = this.e;
                            netCallback.a(DeviceListApi.this.b);
                        }
                    } catch (JSONException e2) {
                        LogUtilGrey.a(DeviceListApi.f14556a, "core /v2/home/device_list_page JSONException times:" + this.e.size());
                        if (netCallback != null) {
            ...
            public void a(NetError netError) {
                LogUtilGrey.a(DeviceListApi.f14556a, "core /v2/home/device_list_page onFailure times:" + this.e.size());
                if (netCallback != null) {
