...
public class MiotAccountProvider implements IMipayAccountProvider {
    ...
    public static final String f22129a = "passportapi";
    ...
    private final Handler g = new Handler(this.f.getMainLooper());
    ...
    public boolean isUseSystem() {
        Miio.b(c, "isUseSystem(): " + false);
        return CoreApi.a().v();
    }

    public Account[] getAccounts() {
        String s = CoreApi.a().s();
        Miio.b(c, "getAccounts(): " + s);
    ...
    public Account[] getAccountsByType(String str) {
        Miio.b(c, "getAccountsByType(): " + str);
        return getAccounts();
    }

    public void invalidateAuthToken(String str, String str2) {
        Miio.b(c, "invalidateAuthToken(): " + str + ", " + str2);
    }
    ...
    public AccountManagerFuture<Bundle> getAuthToken(Account account, String str, Bundle bundle, Activity activity, AccountManagerCallback<Bundle> accountManagerCallback, Handler handler) {
        ...
        if (account2 == null) {
            ...
            bundle3.putString(AccountManager.KEY_ANDROID_PACKAGE_NAME, this.f.getPackageName());
                ...
                public void a() {
                    new AsyncTask<Void, Void, Void>() {
                        ...
                        public Void doInBackground(Void... voidArr) {
                            MiotAccountProvider.this.a(AnonymousClass1.this.f, account3, str3, false, true, bundle3);
                            return null;
                        }
                    }.execute(new Void[0]);
                }
            ...
            return new AmsTask((Activity) null, handler, accountManagerCallback) {
                public void a() {
                    new AsyncTask<Void, Void, Void>() {
                        ...
                        /* renamed from: a */
                        public Void doInBackground(Void... voidArr) {
                            MiotAccountProvider.this.a(AnonymousClass2.this.f, account3, str3, valueOf.booleanValue(), false, bundle3);
                            return null;
                        }
                    }.execute(new Void[0]);
                }
    ...
    public void a(com.xiaomi.smarthome.shop.MiotAccountProvider.IAccountManagerResponse r5, android.accounts.Account r6, java.lang.String r7, boolean r8, boolean r9, android.os.Bundle r10) {
        /*
            r4 = this;
        ...
        L_0x005f:
            ...
            java.lang.String r10 = "MiotAccountProvider"
            ...
            com.xiaomi.smarthome.miio.Miio.b(r10, r2)     // Catch:{ IOException -> 0x0144, InvalidResponseException -> 0x0130, InvalidCredentialException -> 0x011c, AccessDeniedException -> 0x0108, AuthenticationFailureException -> 0x00f4, InvalidUserNameException -> 0x00e0 }
        ...
        L_0x009b:
            ...
            com.xiaomi.smarthome.miio.Miio.b(r7, r0)     // Catch:{ IOException -> 0x0144, InvalidResponseException -> 0x0130, InvalidCredentialException -> 0x011c, AccessDeniedException -> 0x0108, AuthenticationFailureException -> 0x00f4, InvalidUserNameException -> 0x00e0 }
            java.lang.String r6 = r6.name     // Catch:{ IOException -> 0x0144, InvalidResponseException -> 0x0130, InvalidCredentialException -> 0x011c, AccessDeniedException -> 0x0108, AuthenticationFailureException -> 0x00f4, InvalidUserNameException -> 0x00e0 }
            ...
            return
        L_0x00e0:
            java.lang.String r6 = "MiotAccountProvider"
            java.lang.String r7 = "no such a user"
            com.xiaomi.smarthome.miio.Miio.b(r6, r7)
            java.lang.String r6 = "errorCode"
            r8.putInt(r6, r1)
            java.lang.String r6 = "errorMessage"
        ...
        L_0x017c:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.smarthome.shop.MiotAccountProvider.a(com.xiaomi.smarthome.shop.MiotAccountProvider$IAccountManagerResponse, android.accounts.Account, java.lang.String, boolean, boolean, android.os.Bundle):void");
    }
    ...
    private abstract class AmsTask extends FutureTask<Bundle> implements AccountManagerFuture<Bundle> {
        ...
        public void set(Bundle bundle) {
            if (bundle == null) {
                Miio.b(MiotAccountProvider.c, "the bundle must not be null");
            }
            super.set(bundle);
        }
        ...
        private void d() {
            ...
            if (myLooper != null && myLooper == MiotAccountProvider.this.f.getMainLooper()) {
                ...
                Miio.b(MiotAccountProvider.c, "calling this from your main thread can lead to deadlock and/or ANRs");
        ...
        private Bundle a(Long l, TimeUnit timeUnit) throws OperationCanceledException, IOException, AuthenticatorException {
            ...
            Miio.b(MiotAccountProvider.c, "internalGetResult(): " + l + ", " + timeUnit);
            if (l == null) {
                try {
        ...
        /* access modifiers changed from: protected */
        public void done() {
            Miio.b(MiotAccountProvider.c, "done()");
            if (this.h != null) {
                MiotAccountProvider.this.a(this.g, this.h, (AccountManagerFuture<Bundle>) this);
            }
        }
        ...
        private class Response implements IAccountManagerResponse {
            ...
            public void a(Bundle bundle) {
                ...
                Miio.b(MiotAccountProvider.c, "AmsTask::Response::onResult(): " + bundle.toString());
            ...
            public void a(int i, String str) {
                Miio.b(MiotAccountProvider.c, "onError(): " + i + ", " + str);
                if (i == 4) {
            ...
            public void a() {
                Miio.b(MiotAccountProvider.c, "onRequestContinued()");
            }
        }
    }
}
