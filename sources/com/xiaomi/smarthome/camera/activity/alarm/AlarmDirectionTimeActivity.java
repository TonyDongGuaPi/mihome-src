...
public class AlarmDirectionTimeActivity extends CameraBaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        if (this.mBean.f7967a != 4) {
            this.mCustomTitle.setText(getString(R.string.alarm_direction_custom_subtitle));
        } else {
            this.mCustomTitle.setText(getString(R.string.alarm_direction_custom_title, new Object[]{this.mDf.format((long) (this.mBean.b / 60)) + ":" + this.mDf.format((long) (this.mBean.b % 60)), this.mDf.format((long) (this.mBean.c / 60)) + ":" + this.mDf.format((long) (this.mBean.c % 60))}));
        }
        changeCheck();
    }
    ...
    private void customChoice() {
        ...
        this.mTimeHourBegin = this.mBean.b / 60;
        this.mTimeMinuteBegin = this.mBean.b % 60;
        this.mTimeHourEnd = this.mBean.c / 60;
        this.mTimeMinuteEnd = this.mBean.c % 60;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                AlarmDirectionTimeActivity.this.mBean.b = (AlarmDirectionTimeActivity.this.mTimeHourBegin * 60) + AlarmDirectionTimeActivity.this.mTimeMinuteBegin;
                AlarmDirectionTimeActivity.this.mBean.c = (AlarmDirectionTimeActivity.this.mTimeHourEnd * 60) + AlarmDirectionTimeActivity.this.mTimeMinuteEnd;
                AlarmDirectionTimeActivity.this.mBean.f7967a = 4;
