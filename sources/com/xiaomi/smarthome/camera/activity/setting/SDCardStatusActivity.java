...
public class SDCardStatusActivity extends CameraBaseActivity implements View.OnClickListener {
    ...
    public void doCreate(Bundle bundle) {
        ...
        setContentView(R.layout.camera_activity_sdcard_status);
        initView();
    }
    ...
    private void initView() {
        ...
        this.mStatusView.setText(activity().getString(R.string.sdcard_status, new Object[]{Util.a(getResources(), this.mStatus)}));
            ...
            public void onFailure(int i, String str) {
                if (!SDCardStatusActivity.this.isFinishing()) {
                    ...
                    if (i == -2003) {
                        ...
                        ToastUtil.a((Context) SDCardStatusActivity.this.activity(), (CharSequence) string2);
                    } else if (i == -2000) {
                        ...
                        ToastUtil.a((Context) SDCardStatusActivity.this.activity(), (CharSequence) string3);
                    } else if (i == -2002) {
                        ...
                        SDCardStatusActivity.this.mStatusView.setText(SDCardStatusActivity.this.activity().getString(R.string.sdcard_status, new Object[]{Util.a(SDCardStatusActivity.this.getResources(), 3)}));
                    } else if (i == -2005) {
                        SDCardStatusActivity.this.mlAlertDialog.a((int) R.string.sdcard_tip);
                        ...
                        SDCardStatusActivity.this.mStatusView.setText(SDCardStatusActivity.this.activity().getString(R.string.sdcard_status, new Object[]{Util.a(SDCardStatusActivity.this.getResources(), 5)}));
                    } else {
                        if (i == -1) {
                        ...
                        SDCardStatusActivity.this.mCameraDevice.d().c((Callback<Object>) new Callback<Object>() {
                            public void onSuccess(Object obj) {
                                if (!SDCardStatusActivity.this.isFinishing()) {
                                    ...
                                    ToastUtil.a((Context) SDCardStatusActivity.this.activity(), (int) R.string.sdcard_out_success);
                                    SDCardStatusActivity.this.mStatusView.setText(SDCardStatusActivity.this.activity().getString(R.string.sdcard_status, new Object[]{Util.a(SDCardStatusActivity.this.getResources(), 5)}));
                                    SDCardStatusActivity.this.mStatusLayout.setVisibility(8);
                            ...
                            public void onFailure(int i, String str) {
                                if (!SDCardStatusActivity.this.isFinishing()) {
                                    ToastUtil.a((Context) SDCardStatusActivity.this.activity(), (int) R.string.sdcard_out_fail);
                                    SDCardStatusActivity.this.disProgressDlg();
                                }
                            }
                        });
    ...
    public void parseInfo(SDCardInfo sDCardInfo) {
        ...
        this.mTotalView.setText(activity().getString(R.string.sdcard_size, new Object[]{FileUtil.a(sDCardInfo.f8074a)}));
        ...
        this.mCameraDevice.c().b((Callback<SDCardInfo>) new Callback<SDCardInfo>() {
            public void onSuccess(SDCardInfo sDCardInfo) {
                if (!SDCardStatusActivity.this.isFinishing()) {
                    ...
                    SDCardStatusActivity.this.parseInfo(sDCardInfo);
                    SDCardStatusActivity.this.mStatusLayout.setVisibility(0);
                    ToastUtil.a((Context) SDCardStatusActivity.this.activity(), (int) R.string.sdcard_format_success);
                }
            }
            ...
            public void onFailure(int i, String str) {
                if (!SDCardStatusActivity.this.isFinishing()) {
                    ...
                    ToastUtil.a((Context) SDCardStatusActivity.this.activity(), (int) R.string.sdcard_format_fail);
                }
            }
        }, true);
    }
                        ...
                        public void onFailure(int i, String str) {
                            if (!SDCardStatusActivity.this.isFinishing()) {
                                if (i == -2000) {
                                    SDCardStatusActivity.this.mHandler.removeMessages(SDCardStatusActivity.this.SD_FORMAT_CHECK);
                                    SDCardStatusActivity.this.mHandler.sendEmptyMessageDelayed(SDCardStatusActivity.this.SD_FORMAT_CHECK, (long) SDCardStatusActivity.this.CHECK_DURATION);
                                    ToastUtil.a((Context) SDCardStatusActivity.this.activity(), (int) R.string.sdcard_formating);
                                    return;
                                }
                                if (i == -2003) {
                                    ToastUtil.a((Context) SDCardStatusActivity.this.activity(), (int) R.string.sdcard_no);
                                } else {
            ...
            this.progressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                public void onCancel(DialogInterface dialogInterface) {
                    ...
                    if (!SDCardStatusActivity.this.isFormating) {
                        ToastUtil.a((Context) SDCardStatusActivity.this.activity(), (int) R.string.sdcard_error);
                        SDCardStatusActivity.this.mHandler.removeMessages(SDCardStatusActivity.this.SD_FORMAT_CHECK);
                    }
                }
            });
