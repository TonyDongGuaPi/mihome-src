...
public abstract class ShootModeDialog extends BottomBaseDialog {
    ...
    public static class Builder {
        ...
        public ShootModeDialog build() {
            this.dialog = new ShootModeDialog(this.context, this.isCancelable, (DialogInterface.OnCancelListener) null) {
                public View onCreateView() {
                    ...
                    if (Builder.this.type == 0) {
                        ...
                        if (Build.VERSION.SDK_INT >= 23) {
                            textView.setTextColor(Builder.this.context.getColor(R.color.leave_msg_playing));
                            textView2.setTextColor(Builder.this.context.getColor(R.color.black));
                            textView3.setTextColor(Builder.this.context.getColor(R.color.black));
                        }
                        ...
                        imageView3.setVisibility(4);
                        if (Build.VERSION.SDK_INT >= 23) {
                            textView.setTextColor(Builder.this.context.getColor(R.color.black));
                            textView2.setTextColor(Builder.this.context.getColor(R.color.leave_msg_playing));
                            textView3.setTextColor(Builder.this.context.getColor(R.color.black));
                        }
                        ...
                        if (Build.VERSION.SDK_INT >= 23) {
                            textView.setTextColor(Builder.this.context.getColor(R.color.black));
                            textView2.setTextColor(Builder.this.context.getColor(R.color.black));
                            textView3.setTextColor(Builder.this.context.getColor(R.color.leave_msg_playing));
                        }
                    }
                    return inflate;
                }
