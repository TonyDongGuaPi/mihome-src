...
public class AlarmDayAdapterV2 extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    private class DataViewHolder extends BaseViewHolder {
        ...
        public void bindView(int i) {
            ...
            if (i >= 0 && i <= AlarmDayAdapterV2.this.getItemCount()) {
                AlarmDayBean alarmDayBean = (AlarmDayBean) AlarmDayAdapterV2.this.mData.get(i);
                if (alarmDayBean.item != null) {
                    this.itemView.setTag(alarmDayBean.item);
                    if (alarmDayBean.item.l) {
                        str = alarmDayBean.item.r;
                    } else {
                        str = alarmDayBean.item.a();
                    }
                    ImageLoader.a().a(str, this.imageView, AlarmDayAdapterV2.this.mOptions);
    ...
    public void selectToggle(int i) {
        if (this.mSelectList != null && i >= 0 && i < this.mSelectList.length) {
