...
public class AlarmDirectionTimeV2Activity extends CameraBaseActivity implements View.OnClickListener {
    ...
    public static final String ALL_DAY_END_TIME_OLD = "23:59:00";
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.time_all_day:
                Event.a(Event.I, "type", (Object) 1);
                this.startTime = "00:00:00";
                this.endTime = "23:59:59";
                changeCheck();
                return;
            case R.id.time_custom:
                Event.a(Event.I, "type", (Object) 4);
                customChoice();
                return;
            case R.id.time_day:
                Event.a(Event.I, "type", (Object) 2);
                this.startTime = "08:00:00";
                this.endTime = "20:00:00";
                changeCheck();
                return;
            case R.id.time_night:
                Event.a(Event.I, "type", (Object) 3);
