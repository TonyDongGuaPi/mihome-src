...
public class MultiStateView extends ImageView implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (this.mStatItems != null && this.mCurrentState >= 0 && this.mCurrentState < this.mStatItems.size()) {
            ...
            this.mMainHandler.post(new Runnable() {
                public void run() {
                    ...
                    if (stateItem.topBitmapRes > 0) {
                        MultiStateView.this.setImageDrawable(MultiStateView.this.getResources().getDrawable(stateItem.topBitmapRes));
                    }
                }
            });
        }
