...
public class CameraPullDownRefreshListView extends ListView {
            ...
            setOnScrollListener(new AbsListView.OnScrollListener() {
                ...
                public void onScroll(AbsListView absListView, int i, int i2, int i3) {
                    if (CameraPullDownRefreshListView.this.mOnLastItemVisibleListener != null) {
                        ...
                        boolean unused = cameraPullDownRefreshListView.mLastItemVisible = z;
                    }
                }
            });
        }
    ...
    private static final class BuncingHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            CameraPullDownRefreshListView cameraPullDownRefreshListView = (CameraPullDownRefreshListView) this.mReference.get();
