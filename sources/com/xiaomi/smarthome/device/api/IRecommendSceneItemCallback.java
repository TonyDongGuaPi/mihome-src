...
public interface IRecommendSceneItemCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRecommendSceneItemCallback {
        private static final String DESCRIPTOR = "com.xiaomi.smarthome.device.api.IRecommendSceneItemCallback";
        ...
        private static class Proxy implements IRecommendSceneItemCallback {
