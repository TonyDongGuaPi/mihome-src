...
public class AnotherNameEditActivity_ViewBinding implements Unbinder {
    ...
    private AnotherNameEditActivity f10643a;

    @UiThread
    public AnotherNameEditActivity_ViewBinding(AnotherNameEditActivity anotherNameEditActivity) {
        this(anotherNameEditActivity, anotherNameEditActivity.getWindow().getDecorView());
    }

    @UiThread
    public AnotherNameEditActivity_ViewBinding(AnotherNameEditActivity anotherNameEditActivity, View view) {
        this.f10643a = anotherNameEditActivity;
    ...
    @CallSuper
    public void unbind() {
        AnotherNameEditActivity anotherNameEditActivity = this.f10643a;
