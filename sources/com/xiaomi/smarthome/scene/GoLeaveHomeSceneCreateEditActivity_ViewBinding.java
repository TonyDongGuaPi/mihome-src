...
public class GoLeaveHomeSceneCreateEditActivity_ViewBinding implements Unbinder {
    ...
    private GoLeaveHomeSceneCreateEditActivity f21279a;
    private View b;

    @UiThread
    public GoLeaveHomeSceneCreateEditActivity_ViewBinding(GoLeaveHomeSceneCreateEditActivity goLeaveHomeSceneCreateEditActivity) {
        this(goLeaveHomeSceneCreateEditActivity, goLeaveHomeSceneCreateEditActivity.getWindow().getDecorView());
    }
    ...
    public GoLeaveHomeSceneCreateEditActivity_ViewBinding(final GoLeaveHomeSceneCreateEditActivity goLeaveHomeSceneCreateEditActivity, View view) {
        this.f21279a = goLeaveHomeSceneCreateEditActivity;
    ...
    @CallSuper
    public void unbind() {
        GoLeaveHomeSceneCreateEditActivity goLeaveHomeSceneCreateEditActivity = this.f21279a;
