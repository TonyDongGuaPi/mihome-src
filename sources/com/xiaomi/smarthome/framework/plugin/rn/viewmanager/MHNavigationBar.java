...
public class MHNavigationBar extends SimpleViewManager {
    ...
    public View createViewInstance(ThemedReactContext themedReactContext) {
        this.view = View.inflate(themedReactContext, R.layout.std_titlebar_rn, (ViewGroup) null);
    ...
    public void setColorStyle(View view2, @Nullable String str) {
        this.mStyle = str;
    }

    @ReactProp(name = "title")
    public void setTitle(View view2, @Nullable String str) {
        this.title_bar_title.setText(str);
    }

    @ReactProp(name = "subTitle")
    public void setSubTitle(View view2, @Nullable String str) {
    ...
    public void setSourcePoint(View view2, @Nullable ReadableArray readableArray) {
    ...
    public void setSourceLeft(View view2, @Nullable ReadableArray readableArray) {
        if (readableArray != null) {
    ...
    public void setSourceRight(View view2, @Nullable ReadableArray readableArray) {
        if (readableArray != null) {
    ...
    public void setSourceRight2(View view2, @Nullable ReadableArray readableArray) {
        if (readableArray != null) {
    ...
    public void setSourceLeft2(View view2, @Nullable ReadableArray readableArray) {
        if (readableArray != null) {
    ...
    public void setVisibilityPoint(View view2, @Nullable int i) {
        if (i == 1) {
    ...
    public void setVisibilityLeft(View view2, @Nullable int i) {
        if (i == 1) {
    ...
    public void setVisibilityRight(View view2, @Nullable int i) {
        if (i == 1) {
    ...
    public void setVisibilityRight2(View view2, @Nullable int i) {
        if (i == 1) {
    ...
    public void setVisibilityLeft2(View view2, @Nullable int i) {
        if (i == 1) {
    ...
    public void onAfterUpdateTransaction(View view2) {
        if ("white".equals(this.mStyle)) {
            this.title_bar_title.setTextColor(view2.getContext().getResources().getColor(R.color.std_word_001_white));
            this.sub_title_bar_title.setTextColor(view2.getContext().getResources().getColor(R.color.sub_title_bar_text_color_white));
            ...
            this.title_bar_title.setTextColor(view2.getContext().getResources().getColor(R.color.std_word_001));
            this.sub_title_bar_title.setTextColor(view2.getContext().getResources().getColor(R.color.sub_title_bar_text_color));
    ...
    private void setSource(SimpleDraweeView simpleDraweeView, ReadableArray readableArray) {
        ...
        simpleDraweeView.setTag((Object) null);
