...
public class GeneralOneTimePasswordActivity_ViewBinding implements Unbinder {
    ...
    private GeneralOneTimePasswordActivity f16855a;

    @UiThread
    public GeneralOneTimePasswordActivity_ViewBinding(GeneralOneTimePasswordActivity generalOneTimePasswordActivity) {
        this(generalOneTimePasswordActivity, generalOneTimePasswordActivity.getWindow().getDecorView());
    }
    ...
    public GeneralOneTimePasswordActivity_ViewBinding(GeneralOneTimePasswordActivity generalOneTimePasswordActivity, View view) {
        this.f16855a = generalOneTimePasswordActivity;
    ...
    @CallSuper
    public void unbind() {
        GeneralOneTimePasswordActivity generalOneTimePasswordActivity = this.f16855a;
