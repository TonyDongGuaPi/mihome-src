...
import com.xiaomi.smarthome.library.common.util.XMBaseDragSortListView;
import java.lang.ref.WeakReference;

public class CustomPullDownRefreshDragSortListView extends XMBaseDragSortListView {

    /* renamed from: a  reason: collision with root package name */
    private static final int f18799a = 0;
    ...
    public CustomPullDownRefreshDragSortListView(Context context, AttributeSet attributeSet, int i2) {
    ...
    public static abstract class BottomBounceAdapter extends BaseAdapter {
        ...
        /* renamed from: a  reason: collision with root package name */
        CustomPullDownRefreshDragSortListView f18800a;

        public abstract CustomPullDownRefreshDragSortListView a();
    ...
    public void postRefresh() {
        this.k = false;
        ((TextView) findViewById(R.id.pull_header_txt)).setText(this.B);
    ...
    private void b() {
        ...
        if (!isInEditMode()) {
            ...
            this.B = getContext().getString(R.string.pull_down_refresh);
            this.C = getContext().getString(R.string.release_to_refresh);
            ...
            this.E = LayoutInflater.from(getContext()).inflate(R.layout.pull_footer, (ViewGroup) null);
            super.addFooterView(this.E);
            this.t = this.E.findViewById(R.id.pull_footer);
            this.D = DisplayUtils.a(13.3f);
        }
    }
            ...
            case 2:
                if (this.F == -1.0f) {
                    ...
                    if (getHeight() - heightWithoutFooter2 > DisplayUtils.a(13.3f)) {
                        this.D = getHeight() - heightWithoutFooter2;
                    } else {
                        this.D = DisplayUtils.a(13.3f);
                    }
                    this.F = motionEvent.getY();
                ...
                if (!this.g) {
                    if (!this.h) {
                        if (!this.x || this.g || this.k || getFirstVisiblePosition() > 0 || motionEvent.getY() - this.F <= 0.0f || this.r.getTop() < 0) {
                            if (this.y && !this.h && !this.k && getLastVisiblePosition() >= getCount() - 1 && motionEvent.getY() - this.F < 0.0f) {
                                this.h = true;
                        ...
                        if (y2 - this.i < -10.0f) {
                            ...
                            ViewGroup.LayoutParams layoutParams = this.t.getLayoutParams();
                            layoutParams.height = this.j + this.D;
                            this.t.setLayoutParams(layoutParams);
    ...
    private static final class BuncingHandler extends Handler {
        ...
        /* renamed from: a  reason: collision with root package name */
        private WeakReference<CustomPullDownRefreshDragSortListView> f18801a;

        public BuncingHandler(CustomPullDownRefreshDragSortListView customPullDownRefreshDragSortListView) {
            this.f18801a = new WeakReference<>(customPullDownRefreshDragSortListView);
        }

        public void handleMessage(Message message) {
            CustomPullDownRefreshDragSortListView customPullDownRefreshDragSortListView = (CustomPullDownRefreshDragSortListView) this.f18801a.get();
            if (customPullDownRefreshDragSortListView != null) {
                if (message.what == 0) {
                    customPullDownRefreshDragSortListView.c();
                } else if (message.what == 1) {
                    customPullDownRefreshDragSortListView.d();
                }
