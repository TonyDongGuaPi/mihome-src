...
public class SmartHomePtrHeader extends FrameLayout implements PtrUIHandler {
    ...
    public void initViews(AttributeSet attributeSet) {
        ...
        this.f18932a = (TextView) this.d.findViewById(R.id.pull_header_txt);
    ...
    public void onUIRefreshPrepare(PtrFrameLayout ptrFrameLayout) {
        if (!this.h) {
            ...
            this.b.setVisibility(0);
            this.f18932a.setVisibility(0);
            this.f18932a.setText(getResources().getString(R.string.pull_down_refresh));
        }
    }
    ...
    public void onUIRefreshBegin(PtrFrameLayout ptrFrameLayout) {
        ...
        if (!this.h) {
            ...
            this.f18932a.setVisibility(0);
            this.f18932a.setText(R.string.refreshing);
            this.b.setVisibility(8);
        }
    ...
    public void onUIRefreshComplete(PtrFrameLayout ptrFrameLayout) {
        ...
        if (!this.h) {
            ...
            this.b.setVisibility(0);
            this.f18932a.setVisibility(0);
            this.f18932a.setText(getResources().getString(R.string.refresh_complete));
        }
    }
    ...
    private void a(PtrFrameLayout ptrFrameLayout) {
        if (!ptrFrameLayout.isPullToRefresh()) {
            ...
            this.f18932a.setText(R.string.release_to_refresh);
        }
    }
