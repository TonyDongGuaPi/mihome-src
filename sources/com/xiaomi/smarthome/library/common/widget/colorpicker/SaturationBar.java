...
public class SaturationBar extends View {
    ...
    private static final String f18984a = "parent";
    ...
    private boolean y;
    private OnSaturationChangedListener z;
    ...
    public void setOnSaturationChangedListener(OnSaturationChangedListener onSaturationChangedListener) {
        this.z = onSaturationChangedListener;
    }
    ...
    public void onSizeChanged(int i2, int i3, int i4, int i5) {
        ...
        if (!isInEditMode()) {
            this.r = new LinearGradient((float) this.l, 0.0f, (float) i7, (float) i6, new int[]{-1, Color.HSVToColor(255, this.u)}, (float[]) null, Shader.TileMode.CLAMP);
        } else {
            this.r = new LinearGradient((float) this.l, 0.0f, (float) i7, (float) i6, new int[]{-1, -8257792}, (float[]) null, Shader.TileMode.CLAMP);
        ...
        if (!isInEditMode()) {
            this.m = Math.round((this.w * fArr[1]) + ((float) this.l));
        } else {
            this.m = this.i + this.l;
        }
    }
            ...
            case 2:
                if (this.s) {
                    if (f2 >= ((float) this.l) && f2 <= ((float) (this.l + this.i))) {
                        ...
                        this.o.setColor(this.t);
                        if (this.x != null) {
                            this.x.changeValueBarColor(this.t);
    ...
    public void setColor(int i2) {
        ...
        this.r = new LinearGradient((float) this.l, 0.0f, (float) i4, (float) i3, new int[]{-1, i2}, (float[]) null, Shader.TileMode.CLAMP);
        this.n.setShader(this.r);
        a(this.m);
        this.o.setColor(this.t);
        if (this.x != null) {
            if (this.x.hasValueBar()) {
                this.x.changeValueBarColor(this.t);
            } else if (this.x.hasOpacityBar()) {
                this.x.changeOpacityBarColor(this.t);
            }
        }
        invalidate();
    ...
    public void setSaturation(float f2) {
        this.m = Math.round(this.w * f2) + this.l;
        a(this.m);
        this.o.setColor(this.t);
        if (this.x != null) {
            this.x.changeValueBarColor(this.t);
    ...
    private void a(int i2) {
        ...
        this.t = Color.HSVToColor(new float[]{this.u[0], this.v * ((float) i3), 1.0f});
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        bundle.putParcelable(f18984a, onSaveInstanceState);
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        super.onRestoreInstanceState(bundle.getParcelable(f18984a));
