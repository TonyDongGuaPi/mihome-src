...
public class RoundedImageView extends ImageView {
    ...
    public void setScaleType(ImageView.ScaleType scaleType) {
        if (this.mScaleType != scaleType) {
            ...
            switch (AnonymousClass1.f18924a[scaleType.ordinal()]) {
                case 1:
                case 2:
                case 3:
                case 4:
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static final /* synthetic */ int[] f18924a = new int[ImageView.ScaleType.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f18924a = r0
                int[] r0 = f18924a     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f18924a     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f18924a     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                int[] r0 = f18924a     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                int[] r0 = f18924a     // Catch:{ NoSuchFieldError -> 0x0040 }
            ...
            L_0x0040:
                int[] r0 = f18924a     // Catch:{ NoSuchFieldError -> 0x004b }
            ...
            L_0x004b:
                int[] r0 = f18924a     // Catch:{ NoSuchFieldError -> 0x0056 }
            ...
            L_0x0056:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.smarthome.library.common.widget.RoundedImageView.AnonymousClass1.<clinit>():void");
        }
    }

    public void setImageDrawable(Drawable drawable) {
        this.mResource = 0;
        this.mDrawable = RoundedDrawable.a(drawable);
        updateDrawableAttrs();
    ...
    public void setImageBitmap(Bitmap bitmap) {
        this.mResource = 0;
        this.mDrawable = RoundedDrawable.a(bitmap);
        updateDrawableAttrs();
        super.setImageDrawable(this.mDrawable);
    }
    ...
    private void updateBackgroundDrawableAttrs(boolean z) {
        if (this.mMutateBackground) {
            if (z) {
                this.mBackgroundDrawable = RoundedDrawable.a(this.mBackgroundDrawable);
            }
    ...
    private void updateAttrs(Drawable drawable, ImageView.ScaleType scaleType) {
        if (drawable != null) {
            if (drawable instanceof RoundedDrawable) {
                ...
                roundedDrawable.a(scaleType).b(this.mBorderWidth).a(this.mBorderColor).a(this.mIsOval).a(this.mTileModeX).b(this.mTileModeY);
                if (this.mCornerRadii != null) {
                    roundedDrawable.a(this.mCornerRadii[0], this.mCornerRadii[1], this.mCornerRadii[2], this.mCornerRadii[3]);
                }
                applyColorMod();
