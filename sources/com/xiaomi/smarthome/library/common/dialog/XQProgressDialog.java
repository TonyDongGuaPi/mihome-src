...
public class XQProgressDialog extends MLAlertDialog {
    ...
    private Handler n;
    /* access modifiers changed from: private */
    public OnProgressCancelListener o;
    ...
    public static XQProgressDialog a(Context context, CharSequence charSequence, CharSequence charSequence2, boolean z) {
        return a(context, charSequence, charSequence2, z, true);
    }
    ...
    public void onCreate(Bundle bundle) {
        View inflate = LayoutInflater.from(this.c).inflate(R.layout.xq_progress_dialog, (ViewGroup) null);
        this.n = new Handler() {
        ...
        if (this.m) {
            ...
            this.h.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    if (XQProgressDialog.this.o != null) {
                        XQProgressDialog.this.o.onCancel();
                    }
        ...
        if (this.f18617a > 0) {
            this.e.setProgress(this.f18617a);
        }
        if (this.b > 0) {
