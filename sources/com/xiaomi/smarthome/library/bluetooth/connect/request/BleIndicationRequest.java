...
public class BleIndicationRequest extends BleRequest implements WriteDescriptorListener {
    public BleIndicationRequest(UUID uuid, UUID uuid2, BleResponser bleResponser) {
        super(bleResponser);
        this.k = uuid;
        this.l = uuid2;
    }
