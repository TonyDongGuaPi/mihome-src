...
public class RSACoder {
    ...
    public static PublicKey getPublicKey(byte[] bArr) throws CryptoException {
        if (bArr != null) {
            try {
                return KeyFactory.getInstance(SignUtils.f8267a).generatePublic(new X509EncodedKeySpec(bArr));
            } catch (NoSuchAlgorithmException e) {
                throw new CryptoException("getPublicKey", e.getCause());
    ...
    public static PrivateKey getPrivateKey(byte[] bArr) throws CryptoException {
        if (bArr != null) {
            try {
                return KeyFactory.getInstance(SignUtils.f8267a).generatePrivate(new PKCS8EncodedKeySpec(bArr));
