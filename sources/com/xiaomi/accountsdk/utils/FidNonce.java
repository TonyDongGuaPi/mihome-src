                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                AccountLog.w(FidNonce.TAG, (Throwable) e);
                                return null;
                            }
                        } catch (FidSigningUtil.FidSignException e2) {
                            AccountLog.w(FidNonce.TAG, (Throwable) e2);
                            return null;
                        } catch (UnsupportedEncodingException e3) {
                            AccountLog.w(FidNonce.TAG, (Throwable) e3);
                            return null;
                        }
                    } catch (UnsupportedEncodingException e4) {
                        AccountLog.w(FidNonce.TAG, (Throwable) e4);
                        return null;
                    }
                } catch (FidSigningUtil.FidSignException e5) {
                    AccountLog.w(FidNonce.TAG, (Throwable) e5);
                    return null;
                }
            }
        }
