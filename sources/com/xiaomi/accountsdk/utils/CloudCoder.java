...
public class CloudCoder {
        ...
        if (TextUtils.isDigitsOnly(str)) {
            ...
            if (INT_0.equals(fromBody)) {
                ...
                if (fromBody2 instanceof Map) {
                    Object obj = ((Map) fromBody2).get(cipher_mode == CIPHER_MODE.ENCRYPT ? Constants.XMLNode.KEY_CIPHER : "plainText");
    ...
    /* JADX WARNING: Removed duplicated region for block: B:43:0x005d A[RETURN] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.lang.String getFileSha1Digest(java.lang.String r5) {
        /*
            r0 = 0
            java.lang.String r1 = "SHA1"
            java.security.MessageDigest r1 = java.security.MessageDigest.getInstance(r1)     // Catch:{ Exception -> 0x003f, all -> 0x003c }
            java.io.File r2 = new java.io.File     // Catch:{ Exception -> 0x0039, all -> 0x0037 }
            r2.<init>(r5)     // Catch:{ Exception -> 0x0039, all -> 0x0037 }
            java.io.FileInputStream r5 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0039, all -> 0x0037 }
            r5.<init>(r2)     // Catch:{ Exception -> 0x0039, all -> 0x0037 }
            r2 = 4096(0x1000, float:5.74E-42)
            byte[] r2 = new byte[r2]     // Catch:{ Exception -> 0x0035 }
        L_0x0015:
            int r3 = r5.read(r2)     // Catch:{ Exception -> 0x0035 }
            r4 = -1
            if (r3 == r4) goto L_0x0021
            r4 = 0
            r1.update(r2, r4, r3)     // Catch:{ Exception -> 0x0035 }
            goto L_0x0015
        L_0x0021:
        ...
        L_0x002b:
            byte[] r5 = r1.digest()
            java.lang.String r5 = getHexString(r5)
            return r5
        L_0x0034:
            return r0
        L_0x0035:
        ...
        L_0x005d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.accountsdk.utils.CloudCoder.getFileSha1Digest(java.lang.String):java.lang.String");
    }
