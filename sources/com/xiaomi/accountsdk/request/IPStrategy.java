...
public class IPStrategy {
    ...
    public String getCachedIp(String str) {
        ...
        if (!(ip0 != null || sIpUtilExternal == null || (ip0 = sIpUtilExternal.loadCachedIp(str, networkName, (String) null)) == null)) {
    ...
    public List<String> getBackupIpList(String str) {
        ...
        if (!(ipList != null || sIpUtilExternal == null || (ipList = sIpUtilExternal.loadBackupIpList(str, networkName, (List<String>) null)) == null)) {
            ...
            IPExecutorService.execute(new Runnable() {
                public void run() {
                    ...
                    if (!TextUtils.equals(networkName, networkName)) {
                        ...
                        AccountLog.w(IPStrategy.TAG, String.format("ping: network changed from %s to %s, will NOT update anything", new Object[]{networkName, networkName}));
                    } else if (ping == null) {
        ...
        if (isBackupListExpired(str)) {
            ...
            IPExecutorService.execute(new Runnable() {
                public void run() {
                    String networkName = IPStrategy.this.getNetworkName();
                    if (!TextUtils.equals(networkName, networkName)) {
                        AccountLog.w(IPStrategy.TAG, String.format("backupList: network changed from %s to %s, will NOT update anything", new Object[]{networkName, networkName}));
            ...
            IPExecutorService.execute(new Runnable() {
                public void run() {
                    String networkName = IPStrategy.this.getNetworkName();
                    if (!TextUtils.equals(networkName, networkName)) {
                        AccountLog.w(IPStrategy.TAG, String.format("config, network changed from %s to %s, will NOT update anything", new Object[]{networkName, networkName}));
                        return;
                    }
    ...
    public List<String> getBackupIpListOnline(String str) {
        ...
        passportRequestArguments.setUrl(String.format(URLConst.HyperTextTransferProtocol + "resolver.msg.xiaomi.net/gslb/?ver=3.0&list=%s", new Object[]{str}));
        try {
            ...
            AccountLog.w(TAG, "getBackupIpListOnline", e);
            return null;
        } catch (PassportRequestException e2) {
            AccountLog.w(TAG, "getBackupIpListOnline error, cause : ", e2.getCause());
            return null;
    ...
    public Boolean isWifi() {
        ...
        return Boolean.valueOf(sIpUtilExternal.isWifi());
    }
    ...
    public void updateStrategyConfigOnline() {
        ...
        PassportRequestArguments passportRequestArguments = new PassportRequestArguments();
        passportRequestArguments.setUrl(URLConst.HyperTextTransferProtocol + "c.id.mi.com/conn/getParams");
        try {
            ...
            if (!TextUtils.isEmpty(body)) {
                if (body.startsWith(XMPassport.PASSPORT_SAFE_PREFIX)) {
                    body = body.substring(XMPassport.PASSPORT_SAFE_PREFIX.length());
                }
                ...
                if (sIpUtilExternal != null) {
                    sIpUtilExternal.saveCachedIpExpireDuration(cachedIpExpireDurationMs);
            ...
            AccountLog.w(TAG, "updateStrategyConfigOnline", e);
        } catch (PassportRequestException e2) {
            AccountLog.w(TAG, "updateStrategyConfigOnline", e2.getCause());
        } catch (JSONException e3) {
    ...
    public void updateCachedTimeStamp(String str) {
        ...
        if (sIpUtilExternal != null) {
            sIpUtilExternal.saveCachedTimeStamp(str, networkName, currentTimeMillis);
        }
    }
    ...
    public void updateBackupTimeStamp(String str) {
        ...
        if (sIpUtilExternal != null) {
            sIpUtilExternal.saveBackupTimeStamp(str, networkName, currentTimeMillis);
        }
    }
    ...
    public Pair<String, Long> ping(String str, String[] strArr, CachedIpStatHelper cachedIpStatHelper) {
        ...
        for (String str3 : strArr) {
            try {
                ...
                PassportRequestArguments passportRequestArguments = new PassportRequestArguments();
                passportRequestArguments.setUrl(String.format(URLConst.HyperTextTransferProtocol + "%s/conn/echo", new Object[]{str}));
    ...
    public String getNetworkName() {
        ...
        return sIpUtilExternal.getNetworkName();
    }
    ...
    public void updateCachedIp(String str, String str2, String str3) {
        ...
        if (sIpUtilExternal != null) {
            sIpUtilExternal.saveCachedIp(str, str2, str3);
        }
    }
    ...
    public void updateBackupIpList(String str, String str2, List<String> list) {
        ...
        if (sIpUtilExternal != null) {
            sIpUtilExternal.saveBackupIpList(str, str2, list);
        }
    }
    ...
    static class BackupIpStatHelper extends IPStatHelper {
        ...
        public void onPullingBackupIpsSucceeded(List<String> list) {
            ...
            statDummyUrl(String.format(URLConst.HyperTextTransferProtocol + "dummyurl/backupIpDiagonose?_ver=%s&_ips=%s&_nets=%s", new Object[]{PassportCAConstants.IMPL_VERSION, join, getNetworkName()}));
        }
    }
    ...
    static class CachedIpStatHelper extends IPStatHelper {
        ...
        public void putIpPingException(String str) {
            this.pingTimeMap.put(str, Long.valueOf(IP_PING_TIME_EXCEPTION));
        }

        public void onLessThenPingThreshold(long j, long j2) {
            statDummyUrl(String.format(URLConst.HyperTextTransferProtocol + "dummyurl/cachedipDiagonis?_ver=%s&_time=%d&_thres=%d", new Object[]{PassportCAConstants.IMPL_VERSION, Long.valueOf(j), Long.valueOf(j2)}));
        }

        public void onNetworkChanged(String str, String str2) {
            statDummyUrl(String.format(URLConst.HyperTextTransferProtocol + "dummyurl/cachedipDiagonis?_ver=%s&_netOld=%s&_netNew=%s", new Object[]{PassportCAConstants.IMPL_VERSION, str, str2}));
        }

        public void onAllIpPingFinishes(long j) {
            statDummyUrl(String.format(URLConst.HyperTextTransferProtocol + "dummyurl/cachedipDiagonis?_ver=%s&_coef=%d&cachedip=%s&cachediptime=%d&dnsip=%s&dnsiptime=%d&backupip0=%s&backupip0time=%d", new Object[]{PassportCAConstants.IMPL_VERSION, Long.valueOf(j), this.cachedIp, this.pingTimeMap.get(this.cachedIp), this.dnsIp0, this.pingTimeMap.get(this.dnsIp0), this.backupip0, this.pingTimeMap.get(this.backupip0)}));
        }
    }
}
