...
class CALoginStatHelper extends RequestWithIPStatHelper {
    ...
    static class Info {
        ...
        public String timeSpent(Long l) {
            ...
            if (this.startTime != null && this.finishTime != null) {
                return String.format("%d_%d", new Object[]{Long.valueOf(this.startTime.longValue() - l.longValue()), Long.valueOf(this.finishTime.longValue() - l.longValue())});
            } else if (this.startTime != null) {
                return String.format("%d_", new Object[]{Long.valueOf(this.startTime.longValue() - l.longValue())});
            } else if (this.finishTime == null) {
                return null;
            } else {
                return String.format("_%d", new Object[]{Long.valueOf(this.finishTime.longValue() - l.longValue())});
            }
        }
        ...
        public String resultString() {
            ...
            return this.result.booleanValue() ? "1" : "0";
        }
    ...
    public void onHostNameRequestStarted() {
        this.hostNameInfo.start((String) null);
    }
    ...
    public void onDnsResolvingStarted() {
        this.dnsResolvingInfo.start((String) null);
    }
    ...
    public void start() {
        this.overallInfo.start((String) null);
    }
    ...
    public final String buildDummyUrl() {
        ...
        for (Integer next : this.backupIpInfos.keySet()) {
            ...
            if (info != null) {
                String str = "b" + next + JSMethod.NOT_SET;
                linkedHashMap.put(str + IjkMediaPlayer.OnNativeInvokeListener.ARG_IP, info.ip);
        ...
        linkedHashMap.put("all_t", this.overallInfo.timeSpent(this.overallInfo.startTime));
        ...
        StringBuffer stringBuffer = new StringBuffer(URLConst.HyperTextTransferProtocol + "dummyurl/caLoginDiagnosis?");
