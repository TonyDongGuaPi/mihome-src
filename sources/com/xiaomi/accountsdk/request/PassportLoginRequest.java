...
public abstract class PassportLoginRequest extends PassportRequest {
    ...
    public PassportLoginRequest(PassportRequestArguments passportRequestArguments) {
        ...
        if (requestTryCA == null) {
            AccountLog.d(TAG, String.format("CA-Request not ready for login %s, fallback to https way", new Object[]{getLoginType()}));
    ...
    private PassportFallbackableRequest getRequestTryCA(PassportRequestArguments passportRequestArguments, PassportSimpleRequest passportSimpleRequest) {
        ...
        String str2 = (String) copy.params.get("sid");
        copy.setUrl(caUrl);
        ...
        return new PassportFallbackableRequest(makeCARequest(instance, copy), passportSimpleRequest) {
            ...
            public void onRequest1Success() {
                AccountLog.d(PassportLoginRequest.TAG, String.format("login %s with CA-Request succeeded to receive data from server", new Object[]{PassportLoginRequest.this.getLoginType()}));
            }

            /* access modifiers changed from: protected */
            public void onRequest1Failed() {
                AccountLog.d(PassportLoginRequest.TAG, String.format("login %s with CA-Request failed to receive data from server", new Object[]{PassportLoginRequest.this.getLoginType()}));
            }
    ...
    public boolean isResultFromCA() {
        return (this.request instanceof PassportFallbackableRequest) && !((PassportFallbackableRequest) this.request).isRequest2Used();
    }
    ...
    public static class ByPassword extends PassportLoginRequest {
        ...
        public PassportSimpleRequest makeHttpsRequest(PassportRequestArguments passportRequestArguments) {
            return new PassportSimpleRequest.PostAsString(passportRequestArguments) {
                public SimpleRequest.StringContent execute() throws IOException, PassportRequestException {
                    MetaLoginData access$000 = ByPassword.this.mmetaLoginData;
                    if (access$000 == null) {
                        try {
                            access$000 = XMPassport.getMetaLoginData(ByPassword.this.userId, ByPassword.this.serviceId);
                            if (access$000 == null) {
                    ...
                    this.arguments.params.easyPut("_sign", access$000.sign);
                    this.arguments.params.easyPut("qs", access$000.qs);
                    this.arguments.params.easyPut("callback", access$000.callback);
