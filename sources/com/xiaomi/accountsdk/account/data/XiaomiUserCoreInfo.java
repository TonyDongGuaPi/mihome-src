...
public class XiaomiUserCoreInfo {
    ...
    public static class SnsInfo {
        ...
        public SnsInfo(int i, String str, String str2, String str3) {
            this.snsType = i;
        ...
        public static SnsInfo parseSnsInfoMap(Map map) {
            return new SnsInfo(XiaomiUserCoreInfo.getInt(map, J_SNS_TYPE, 0), XiaomiUserCoreInfo.getString(map, J_SNS_TYPE_NAME), XiaomiUserCoreInfo.getString(map, J_SNS_NICKNAME), XiaomiUserCoreInfo.getString(map, J_SNS_ICON));
        }
