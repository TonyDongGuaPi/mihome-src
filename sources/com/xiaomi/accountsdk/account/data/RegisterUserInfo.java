...
public class RegisterUserInfo implements Parcelable {
    public static final Parcelable.Creator<RegisterUserInfo> CREATOR = new Parcelable.Creator<RegisterUserInfo>() {
        public RegisterUserInfo createFromParcel(Parcel parcel) {
            ...
            return new Builder(readBundle.getInt(RegisterUserInfo.KEY_REGISTER_STATUS)).userId(readBundle.getString("user_id")).userName(readBundle.getString("user_name")).avatarAddress(readBundle.getString(RegisterUserInfo.KEY_AVATAR_ADDRESS)).ticketToken(readBundle.getString(RegisterUserInfo.KEY_TICKET_TOKEN)).phone(readBundle.getString("phone")).maskedUserId(readBundle.getString(RegisterUserInfo.KEY_MASKED_USER_ID)).hasPwd(readBundle.getBoolean(RegisterUserInfo.KEY_HAS_PASSWORD)).bindTime(readBundle.getLong(RegisterUserInfo.KEY_BIND_TIME)).needToast(readBundle.getBoolean(RegisterUserInfo.KEY_NEED_TOAST)).needGetActiveTime(readBundle.getBoolean(RegisterUserInfo.KEY_NEED_GET_ACTIVE_TIME)).registerPwd(readBundle.getBoolean(RegisterUserInfo.KEY_REGISTER_PWD)).build();
        }
