...
public class CustomizedUrlStatUtil {
    ...
    public CustomizedUrlStatUtil(String str, String str2) {
        if (str != null) {
            this.url = String.format(URLConst.HyperTextTransferProtocol + "dummyurl/%s/_ver=%s&hdid=%s", new Object[]{str, str2, new HashedDeviceIdUtil(XMPassportSettings.getApplicationContext()).getHashedDeviceIdNoThrow()});
            return;
        }
