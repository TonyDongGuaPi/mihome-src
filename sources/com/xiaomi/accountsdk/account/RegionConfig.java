...
public class RegionConfig {
    ...
    public Long blockingGetCheckSyncTimeout() {
        ...
        return Long.valueOf(this.mSP.getLong(KEY_CHECK_SYNC_TIMEOUT, 10000));
    }
    ...
    public String blockingGetRegHostName(String str) {
        ...
        checkDownloadAndSave();
        String string = this.mSP.getString(KEY_REGION_JSON_STRING, (String) null);
        if (string == null) {
            return null;
        }
        try {
    ...
    private void checkDownloadAndSave() {
        long j = this.mSP.getLong(KEY_LAST_DOWNLOAD_TIME, 0);
        if (Math.abs(System.currentTimeMillis() - j) < this.mSP.getLong(KEY_DOWNLOAD_INTERVAL_TIME, 86400000)) {
    ...
    private String downloadRegionConfig() throws AccessDeniedException, AuthenticationFailureException, IOException, InvalidResponseException {
        ...
        SimpleRequest.StringContent asString = SimpleRequestForAccount.getAsString(URLs.URL_ACCOUNT_BASE + "/regionConfig", (Map<String, String>) null, easyPut, true);
        if (asString != null) {
