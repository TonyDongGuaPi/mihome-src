...
public class ImageLoader {
    ...
    public ImageContainer get(String str, ImageListener imageListener, int i, int i2) {
        ...
        Request<Bitmap> makeImageRequest = makeImageRequest(str, i3, i4, cacheKey);
    ...
    public Request<Bitmap> makeImageRequest(String str, int i, int i2, final String str2) {
        return new ImageRequest(str, new Response.SimpleListener<Bitmap>() {
