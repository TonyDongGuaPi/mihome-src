...
public class ImageRequest extends Request<Bitmap> {
    ...
    public ImageRequest(String str, Response.Listener<Bitmap> listener, int i, int i2, Bitmap.Config config) {
    ...
    public Response<Bitmap> parseNetworkResponse(NetworkResponse networkResponse) throws VolleyError {
