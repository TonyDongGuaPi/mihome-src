...
public class VolleyLog {
    ...
    public static void setTag(String str) {
        ...
        TAG = str;
        DEBUG = android.util.Log.isLoggable(TAG, 2);
    }
    ...
    public static void e(String str, Object... objArr) {
        android.util.Log.e(TAG, buildMessage(str, objArr));
    }

    public static void e(Throwable th, String str, Object... objArr) {
        android.util.Log.e(TAG, buildMessage(str, objArr), th);
    }

    public static void wtf(String str, Object... objArr) {
        android.util.Log.wtf(TAG, buildMessage(str, objArr));
    }

    public static void wtf(Throwable th, String str, Object... objArr) {
        android.util.Log.wtf(TAG, buildMessage(str, objArr), th);
    }
