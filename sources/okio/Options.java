    ...
    private static void buildTrieRecursive(long j, Buffer buffer, int i, List<ByteString> list, int i2, int i3, List<Integer> list2) {
        ...
        if (i8 < i9) {
            ...
            if (byteString.getByte(i7) != byteString2.getByte(i7)) {
                ...
                buffer2.writeInt(i13);
                buffer2.writeInt(i11);
                ...
                while (i16 < i9) {
                    ...
                    if (i17 == i5 && i7 + 1 == list3.get(i16).size()) {
                        ...
                        buffer2.writeInt(list5.get(i16).intValue());
                        i6 = i5;
                        ...
                        buildTrieRecursive(intCount, buffer3, i7 + 1, list, i16, i19, list2);
                    }
                    i16 = i6;
                }
            ...
            long intCount2 = j + ((long) intCount(buffer)) + 2 + ((long) i21) + 1;
            buffer2.writeInt(-i21);
            buffer2.writeInt(i11);
            int i22 = i7;
            while (true) {
                i4 = i7 + i21;
                ...
                buffer2.writeInt((int) byteString.getByte(i22) & 255);
                i22++;
            }
            if (i12 + 1 != i9) {
                Buffer buffer4 = new Buffer();
                buffer2.writeInt((int) ((((long) intCount(buffer4)) + intCount2) * -1));
                buildTrieRecursive(intCount2, buffer4, i4, list, i12, i3, list2);
                buffer2.write(buffer4, buffer4.size());
            } else if (i4 == list3.get(i12).size()) {
                buffer2.writeInt(list8.get(i12).intValue());
            } else {
                throw new AssertionError();
            }
        } else {
