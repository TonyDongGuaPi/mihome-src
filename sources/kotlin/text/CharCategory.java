...
public enum CharCategory {
    ...
    LETTER_NUMBER(10, "Nl"),
    OTHER_NUMBER(11, IntentIntegrator.e),
    ...
    static {
        ...
        categoryMap$delegate = LazyKt.a(CharCategory$Companion$categoryMap$2.INSTANCE);
    }
    ...
    public static final class Companion {
        ...
        static final /* synthetic */ KProperty[] f2898a = null;

        static {
            f2898a = new KProperty[]{Reflection.a((PropertyReference1) new PropertyReference1Impl(Reflection.b(Companion.class), "categoryMap", "getCategoryMap()Ljava/util/Map;"))};
        }

        private final Map<Integer, CharCategory> a() {
        ...
        public final CharCategory a(int i) {
            CharCategory charCategory = a().get(Integer.valueOf(i));
