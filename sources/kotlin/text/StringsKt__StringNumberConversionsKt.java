...
class StringsKt__StringNumberConversionsKt extends StringsKt__StringNumberConversionsJVMKt {
    ...
    @SinceKotlin(version = "1.1")
    @Nullable
    public static final Byte b(@NotNull String str, int i) {
        int intValue;
        Intrinsics.f(str, "receiver$0");
        Integer d = StringsKt.d(str, i);
    ...
    public static final Short g(@NotNull String str) {
        Intrinsics.f(str, "receiver$0");
        return StringsKt.c(str, 10);
    }

    @SinceKotlin(version = "1.1")
    @Nullable
    public static final Short c(@NotNull String str, int i) {
        int intValue;
        Intrinsics.f(str, "receiver$0");
        Integer d = StringsKt.d(str, i);
    ...
    public static final java.lang.Integer d(@org.jetbrains.annotations.NotNull java.lang.String r9, int r10) {
        /*
            java.lang.String r0 = "receiver$0"
            kotlin.jvm.internal.Intrinsics.f(r9, r0)
            kotlin.text.CharsKt.a((int) r10)
            int r0 = r9.length()
            r1 = 0
        ...
        L_0x0037:
            ...
            int r6 = kotlin.text.CharsKt.a(r6, r10)
        ...
        L_0x005e:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.text.StringsKt__StringNumberConversionsKt.d(java.lang.String, int):java.lang.Integer");
    }
    ...
    @org.jetbrains.annotations.Nullable
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final java.lang.Long e(@org.jetbrains.annotations.NotNull java.lang.String r19, int r20) {
        /*
            r0 = r19
            r1 = r20
            java.lang.String r2 = "receiver$0"
            kotlin.jvm.internal.Intrinsics.f(r0, r2)
            kotlin.text.CharsKt.a((int) r20)
            int r2 = r19.length()
            r3 = 0
        ...
        L_0x003f:
            ...
            int r6 = kotlin.text.CharsKt.a(r6, r1)
        ...
        L_0x0073:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.text.StringsKt__StringNumberConversionsKt.e(java.lang.String, int):java.lang.Long");
    }
