...
class StringsKt__StringBuilderKt extends StringsKt__StringBuilderJVMKt {
    ...
    @InlineOnly
    private static final String a(int i, Function1<? super StringBuilder, Unit> function1) {
    ...
    public static final <T extends Appendable> T a(@NotNull T t, @NotNull CharSequence... charSequenceArr) {
        ...
        Intrinsics.f(charSequenceArr, "value");
    ...
    public static final <T> void a(@NotNull Appendable appendable, T t, @Nullable Function1<? super T, ? extends CharSequence> function1) {
