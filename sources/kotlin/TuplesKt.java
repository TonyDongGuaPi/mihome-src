...
public final class TuplesKt {
    ...
    public static final <T> List<T> a(@NotNull Pair<? extends T, ? extends T> pair) {
        Intrinsics.f(pair, "receiver$0");
        return CollectionsKt.b((T[]) new Object[]{pair.getFirst(), pair.getSecond()});
    }

    @NotNull
    public static final <T> List<T> a(@NotNull Triple<? extends T, ? extends T, ? extends T> triple) {
        Intrinsics.f(triple, "receiver$0");
        return CollectionsKt.b((T[]) new Object[]{triple.getFirst(), triple.getSecond(), triple.getThird()});
    }
}
