...
public abstract class SequenceScope<T> {
    ...
    @Nullable
    public final Object a(@NotNull Iterable<? extends T> iterable, @NotNull Continuation<? super Unit> continuation) {
        if (!(iterable instanceof Collection) || !((Collection) iterable).isEmpty()) {
            return a(iterable.iterator(), continuation);
        }
        return Unit.f2693a;
    }
    ...
    public final Object a(@NotNull Sequence<? extends T> sequence, @NotNull Continuation<? super Unit> continuation) {
        return a(sequence.a(), continuation);
    }
}
