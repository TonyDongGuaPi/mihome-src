...
class SequencesKt__SequenceBuilderKt {
    ...
    private static final int f1591a = 0;
    ...
    public static final <T> Sequence<T> a(@NotNull @BuilderInference Function2<? super SequenceScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        Intrinsics.f(function2, MiotApmTask.j);
    ...
    @InlineOnly
    private static final <T> Sequence<T> c(@BuilderInference Function2<? super SequenceScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        return new SequencesKt__SequenceBuilderKt$buildSequence$$inlined$Sequence$1(function2);
    }

    @NotNull
    @SinceKotlin(version = "1.3")
    public static final <T> Iterator<T> b(@NotNull @BuilderInference Function2<? super SequenceScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        Intrinsics.f(function2, MiotApmTask.j);
        SequenceBuilderIterator sequenceBuilderIterator = new SequenceBuilderIterator();
        sequenceBuilderIterator.a(IntrinsicsKt.a(function2, sequenceBuilderIterator, sequenceBuilderIterator));
    ...
    @InlineOnly
    private static final <T> Iterator<T> d(@BuilderInference Function2<? super SequenceScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        return SequencesKt.b(function2);
    }
}
