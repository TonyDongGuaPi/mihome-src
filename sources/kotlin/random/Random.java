...
public abstract class Random {
    ...
    public static final Companion f1590a = Companion.c;
    public static final Default b = new Default((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final Random c = PlatformImplementationsKt.f2786a.a();
    ...
    public long a(long j, long j2) {
        ...
        if (j5 > 0) {
            if (((-j5) & j5) == j5) {
                ...
                int i2 = (int) (j5 >>> 32);
                if (i != 0) {
                    j3 = ((long) a(PlatformRandomKt.a(i))) & MessageHead.SERIAL_MAK;
                } else if (i2 == 1) {
                    j3 = ((long) b()) & MessageHead.SERIAL_MAK;
                } else {
                    j3 = (((long) a(PlatformRandomKt.a(i2))) << 32) + ((long) b());
                }
            } else {
                do {
                    c2 = c() >>> 1;
    ...
    public double a(double r7, double r9) {
        /*
            r6 = this;
            kotlin.random.RandomKt.a((double) r7, (double) r9)
            double r0 = r9 - r7
        ...
        L_0x004b:
            ...
            kotlin.jvm.internal.DoubleCompanionObject r7 = kotlin.jvm.internal.DoubleCompanionObject.f2819a
            double r7 = r7.d()
            double r7 = java.lang.Math.nextAfter(r9, r7)
        L_0x0059:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.random.Random.a(double, double):double");
    }

    public float f() {
        return ((float) a(24)) / ((float) 16777216);
    }
