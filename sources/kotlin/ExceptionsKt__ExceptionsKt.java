...
class ExceptionsKt__ExceptionsKt {
    ...
    @InlineOnly
    private static final void c(@NotNull Throwable th) {
        if (th != null) {
            th.printStackTrace();
            return;
        }
    ...
    @InlineOnly
    private static final void a(@NotNull Throwable th, PrintWriter printWriter) {
        if (th != null) {
    ...
    @InlineOnly
    private static final void a(@NotNull Throwable th, PrintStream printStream) {
        if (th != null) {
    ...
    public static final void a(@NotNull Throwable th, @NotNull Throwable th2) {
        Intrinsics.f(th, "receiver$0");
        Intrinsics.f(th2, LogCategory.CATEGORY_EXCEPTION);
        PlatformImplementationsKt.f2786a.a(th, th2);
    }
}
