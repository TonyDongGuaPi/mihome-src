...
class FilesKt__FileTreeWalkKt extends FilesKt__FileReadWriteKt {
    ...
    public static /* synthetic */ FileTreeWalk a(File file, FileWalkDirection fileWalkDirection, int i, Object obj) {
        ...
        return FilesKt.a(file, fileWalkDirection);
    }
    ...
    @NotNull
    public static final FileTreeWalk f(@NotNull File file) {
        Intrinsics.f(file, "receiver$0");
        return FilesKt.a(file, FileWalkDirection.TOP_DOWN);
    }

    @NotNull
    public static final FileTreeWalk g(@NotNull File file) {
        Intrinsics.f(file, "receiver$0");
        return FilesKt.a(file, FileWalkDirection.BOTTOM_UP);
    }
}
