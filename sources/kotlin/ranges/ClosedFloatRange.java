...
final class ClosedFloatRange implements ClosedFloatingPointRange<Float> {
    ...
    /* renamed from: a */
    public Float g() {
        return Float.valueOf(this.f2846a);
    }
    ...
    public boolean a(float f) {
        return f >= this.f2846a && f <= this.b;
    }

    public boolean e() {
        return this.f2846a > this.b;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj instanceof ClosedFloatRange) {
            if (!e() || !((ClosedFloatRange) obj).e()) {
                ...
                if (!(this.f2846a == closedFloatRange.f2846a && this.b == closedFloatRange.b)) {
                    return false;
                }
            }
            return true;
    ...
    public int hashCode() {
        ...
        return (Float.valueOf(this.f2846a).hashCode() * 31) + Float.valueOf(this.b).hashCode();
    }
