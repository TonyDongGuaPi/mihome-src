...
class RangesKt__RangesKt extends RangesKt__RangesJVMKt {
    ...
    @InlineOnly
    private static final <T, R extends Iterable<? extends T> & ClosedRange<T>> boolean a(@NotNull R r, T t) {
        Intrinsics.f(r, "receiver$0");
        return t != null && ((ClosedRange) r).a((Comparable) t);
    }
