...
public class IntProgression implements Iterable<Integer>, KMappedMarker {
    ...
    public static final Companion f2848a = new Companion((DefaultConstructorMarker) null);
    private final int b;
    private final int c;
    private final int d;
    ...
    public boolean e() {
        ...
        L_0x0015:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.ranges.IntProgression.e():boolean");
    }
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj instanceof IntProgression) {
            if (!e() || !((IntProgression) obj).e()) {
                ...
                if (!(this.b == intProgression.b && this.c == intProgression.c && this.d == intProgression.d)) {
                    return false;
                }
            }
            return true;
