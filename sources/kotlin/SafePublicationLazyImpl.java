...
final class SafePublicationLazyImpl<T> implements Serializable, Lazy<T> {
    ...
    private static final AtomicReferenceFieldUpdater<SafePublicationLazyImpl<?>, Object> f2679a = AtomicReferenceFieldUpdater.newUpdater(SafePublicationLazyImpl.class, Object.class, "_value");
    private volatile Object _value = UNINITIALIZED_VALUE.f2689a;

    /* renamed from: final  reason: not valid java name */
    private final Object f17final = UNINITIALIZED_VALUE.f2689a;
    ...
    public T getValue() {
        ...
        if (function0 != null) {
            ...
            if (f2679a.compareAndSet(this, UNINITIALIZED_VALUE.f2689a, invoke)) {
    ...
    public boolean isInitialized() {
        return this._value != UNINITIALIZED_VALUE.f2689a;
    }
