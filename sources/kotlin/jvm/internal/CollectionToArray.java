...
public final class CollectionToArray {
    ...
    private static final Object[] f2818a = new Object[0];
    private static final int b = 2147483645;

    private static final Object[] a(Collection<?> collection, Function0<Object[]> function0, Function1<? super Integer, Object[]> function1, Function2<? super Object[], ? super Integer, Object[]> function2) {
        ...
        while (true) {
            ...
            if (i2 >= invoke.length) {
                ...
                Intrinsics.b(invoke, "Arrays.copyOf(result, newSize)");
            } else if (!it.hasNext()) {
            ...
            if (it.hasNext()) {
                ...
                while (true) {
                    ...
                    if (i2 >= objArr.length) {
                        ...
                        Intrinsics.b(objArr, "Arrays.copyOf(result, newSize)");
                    } else if (!it.hasNext()) {
                        Object[] copyOf = Arrays.copyOf(objArr, i2);
                        Intrinsics.b(copyOf, "Arrays.copyOf(result, size)");
                        return copyOf;
                    }
                    i = i2;
                }
                ...
                if (it.hasNext()) {
                    ...
                    while (true) {
                        ...
                        if (i2 >= objArr2.length) {
                            ...
                            Intrinsics.b(objArr2, "Arrays.copyOf(result, newSize)");
                        } else if (!it.hasNext()) {
                            if (objArr2 == objArr) {
                                objArr[i2] = null;
                                return objArr;
