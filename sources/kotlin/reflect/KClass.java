...
public interface KClass<T> extends KAnnotatedElement, KClassifier, KDeclarationContainer {
    ...
    @NotNull
    List<KTypeParameter> i();

    @NotNull
    List<KType> k();

    @NotNull
    List<KClass<? extends T>> m();
