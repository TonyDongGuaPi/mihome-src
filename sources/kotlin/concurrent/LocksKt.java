...
public final class LocksKt {
    @InlineOnly
    private static final <T> T a(@NotNull Lock lock, Function0<? extends T> function0) {
        lock.lock();
        try {
    ...
    @InlineOnly
    private static final <T> T a(@NotNull ReentrantReadWriteLock reentrantReadWriteLock, Function0<? extends T> function0) {
    ...
    private static final <T> T b(@org.jetbrains.annotations.NotNull java.util.concurrent.locks.ReentrantReadWriteLock r4, kotlin.jvm.functions.Function0<? extends T> r5) {
        /*
        ...
        L_0x0044:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.concurrent.LocksKt.b(java.util.concurrent.locks.ReentrantReadWriteLock, kotlin.jvm.functions.Function0):java.lang.Object");
    }
}
