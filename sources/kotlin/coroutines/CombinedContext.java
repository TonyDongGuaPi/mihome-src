...
public final class CombinedContext implements Serializable, CoroutineContext {
    ...
    public CombinedContext(@NotNull CoroutineContext coroutineContext, @NotNull CoroutineContext.Element element2) {
        ...
        Intrinsics.f(element2, BindingXConstants.i);
    ...
    private final boolean a(CoroutineContext.Element element2) {
        return Intrinsics.a((Object) get(element2.a()), (Object) element2);
    }
    ...
    public String toString() {
        return Operators.ARRAY_START_STR + ((String) fold("", CombinedContext$toString$1.INSTANCE)) + Operators.ARRAY_END_STR;
    }
    ...
    private final Object writeReplace() {
        ...
        boolean z = false;
        intRef.element = 0;
        fold(Unit.f2693a, new CombinedContext$writeReplace$1(coroutineContextArr, intRef));
    ...
    private static final class Serialized implements Serializable {
        ...
        public Serialized(@NotNull CoroutineContext[] coroutineContextArr) {
            Intrinsics.f(coroutineContextArr, MessengerShareContentUtility.ELEMENTS);
