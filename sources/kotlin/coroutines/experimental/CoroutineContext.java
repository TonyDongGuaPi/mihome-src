...
public interface CoroutineContext {
    ...
    public static final class DefaultImpls {
        ...
        public static CoroutineContext a(CoroutineContext coroutineContext, @NotNull CoroutineContext coroutineContext2) {
            ...
            return coroutineContext2 == EmptyCoroutineContext.f2766a ? coroutineContext : (CoroutineContext) coroutineContext2.a(coroutineContext, CoroutineContext$plus$1.INSTANCE);
        }
    }
    ...
    public interface Element extends CoroutineContext {
        ...
        public static final class DefaultImpls {
            ...
            public static CoroutineContext b(Element element, @NotNull Key<?> key) {
                ...
                Object obj = element;
                if (a2 == key) {
                    obj = EmptyCoroutineContext.f2766a;
                }
