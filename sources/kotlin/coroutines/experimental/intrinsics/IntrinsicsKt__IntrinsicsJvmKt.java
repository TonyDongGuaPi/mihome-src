...
class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    public static final <T> Continuation<Unit> a(@NotNull Function1<? super Continuation<? super T>, ? extends Object> function1, @NotNull Continuation<? super T> continuation) {
        ...
        if (!(function1 instanceof CoroutineImpl)) {
            return CoroutineIntrinsics.a(continuation.getContext(), new IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnchecked$$inlined$buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt$1(continuation, function1, continuation));
        }
    ...
    public static final <R, T> Continuation<Unit> a(@NotNull Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r, @NotNull Continuation<? super T> continuation) {
        ...
        if (!(function2 instanceof CoroutineImpl)) {
            return CoroutineIntrinsics.a(continuation.getContext(), new IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnchecked$$inlined$buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt$2(continuation, function2, r, continuation));
        }
    ...
    private static final <T> Continuation<Unit> a(Continuation<? super T> continuation, Function0<? extends Object> function0) {
        return CoroutineIntrinsics.a(continuation.getContext(), new IntrinsicsKt__IntrinsicsJvmKt$buildContinuationByInvokeCall$continuation$1(continuation, function0));
    }
