...
public final class IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnchecked$$inlined$buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt$2 implements Continuation<Unit> {
    ...
    final /* synthetic */ Continuation f2773a;
    ...
    public void resume(@NotNull Unit unit) {
        ...
        Continuation continuation = this.f2773a;
        try {
            Function2 function2 = this.b;
            if (function2 != null) {
                Object invoke = ((Function2) TypeIntrinsics.b((Object) function2, 2)).invoke(this.c, this.d);
    ...
    public void resumeWithException(@NotNull Throwable th) {
        ...
        this.f2773a.resumeWithException(th);
    }
}
