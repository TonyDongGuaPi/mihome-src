...
public final class Pair<A, B> implements Serializable {
    ...
    @NotNull
    public static /* synthetic */ Pair copy$default(Pair pair, A a2, B b, int i, Object obj) {
        if ((i & 1) != 0) {
            a2 = pair.first;
        }
        if ((i & 2) != 0) {
    ...
    public String toString() {
        return Operators.BRACKET_START + this.first + ", " + this.second + Operators.BRACKET_END;
    }
}
