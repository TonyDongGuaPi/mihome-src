...
class ComparisonsKt__ComparisonsKt {
    public static final <T> int a(T t, T t2, @NotNull Function1<? super T, ? extends Comparable<?>>... function1Arr) {
        Intrinsics.f(function1Arr, "selectors");
    ...
    public static final <T> int c(T t, T t2, Function1<? super T, ? extends Comparable<?>>[] function1Arr) {
        for (Function1<? super T, ? extends Comparable<?>> function1 : function1Arr) {
            int a2 = ComparisonsKt.a((Comparable) function1.invoke(t), (Comparable) function1.invoke(t2));
            if (a2 != 0) {
                return a2;
            }
        }
    ...
    private static final <T> int a(T t, T t2, Function1<? super T, ? extends Comparable<?>> function1) {
        return ComparisonsKt.a((Comparable) function1.invoke(t), (Comparable) function1.invoke(t2));
    }
    ...
    @InlineOnly
    private static final <T> Comparator<T> c(@NotNull Comparator<T> comparator, Function1<? super T, ? extends Comparable<?>> function1) {
        return new ComparisonsKt__ComparisonsKt$thenBy$1<>(comparator, function1);
    }

    @InlineOnly
    private static final <T, K> Comparator<T> a(@NotNull Comparator<T> comparator, Comparator<? super K> comparator2, Function1<? super T, ? extends K> function1) {
        return new ComparisonsKt__ComparisonsKt$thenBy$2<>(comparator, comparator2, function1);
    }

    @InlineOnly
    private static final <T> Comparator<T> d(@NotNull Comparator<T> comparator, Function1<? super T, ? extends Comparable<?>> function1) {
        return new ComparisonsKt__ComparisonsKt$thenByDescending$1<>(comparator, function1);
    }

    @InlineOnly
    private static final <T, K> Comparator<T> b(@NotNull Comparator<T> comparator, Comparator<? super K> comparator2, Function1<? super T, ? extends K> function1) {
        return new ComparisonsKt__ComparisonsKt$thenByDescending$2<>(comparator, comparator2, function1);
    }

    @InlineOnly
    private static final <T> Comparator<T> a(@NotNull Comparator<T> comparator, Function2<? super T, ? super T, Integer> function2) {
    ...
    public static final <T> Comparator<T> a(@NotNull Comparator<T> comparator, @NotNull Comparator<? super T> comparator2) {
        Intrinsics.f(comparator, "receiver$0");
    ...
    public static final <T extends Comparable<? super T>> Comparator<T> a() {
        NaturalOrderComparator naturalOrderComparator = NaturalOrderComparator.f2752a;
    ...
    public static final <T extends Comparable<? super T>> Comparator<T> b() {
        ReverseOrderComparator reverseOrderComparator = ReverseOrderComparator.f2753a;
    ...
    public static final <T> Comparator<T> c(@NotNull Comparator<T> comparator) {
        ...
        if (Intrinsics.a((Object) comparator, (Object) NaturalOrderComparator.f2752a)) {
            ReverseOrderComparator reverseOrderComparator = ReverseOrderComparator.f2753a;
            if (reverseOrderComparator != null) {
                return reverseOrderComparator;
            }
            throw new TypeCastException("null cannot be cast to non-null type kotlin.Comparator<T> /* = java.util.Comparator<T> */");
        } else if (!Intrinsics.a((Object) comparator, (Object) ReverseOrderComparator.f2753a)) {
