...
class ComparisonsKt___ComparisonsJvmKt extends ComparisonsKt__ComparisonsKt {
    ...
    public static final <T extends Comparable<? super T>> T a(@NotNull T t, @NotNull T t2, @NotNull T t3) {
        ...
        Intrinsics.f(t2, "b");
        Intrinsics.f(t3, "c");
        return ComparisonsKt.b(t, (T) ComparisonsKt.b(t2, t3));
    }
    ...
    @NotNull
    @SinceKotlin(version = "1.1")
    public static final <T extends Comparable<? super T>> T b(@NotNull T t, @NotNull T t2, @NotNull T t3) {
        Intrinsics.f(t, "a");
        Intrinsics.f(t2, "b");
        Intrinsics.f(t3, "c");
        return ComparisonsKt.c(t, ComparisonsKt.c(t2, t3));
    }
