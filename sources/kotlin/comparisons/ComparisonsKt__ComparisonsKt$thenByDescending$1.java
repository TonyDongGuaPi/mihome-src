...
public final class ComparisonsKt__ComparisonsKt$thenByDescending$1<T> implements Comparator<T> {
    ...
    final /* synthetic */ Comparator f2748a;
    final /* synthetic */ Function1 b;

    public ComparisonsKt__ComparisonsKt$thenByDescending$1(Comparator comparator, Function1 function1) {
        this.f2748a = comparator;
        this.b = function1;
    }

    public final int compare(T t, T t2) {
        int compare = this.f2748a.compare(t, t2);
        return compare != 0 ? compare : ComparisonsKt.a((Comparable) this.b.invoke(t2), (Comparable) this.b.invoke(t));
    }
}
