...
class StandardKt__StandardKt {
    ...
    @InlineOnly
    private static final <R> R a(Function0<? extends R> function0) {
        return function0.invoke();
    }

    @InlineOnly
    private static final <T, R> R a(T t, Function1<? super T, ? extends R> function1) {
        return function1.invoke(t);
    }

    @InlineOnly
    private static final <T, R> R b(T t, Function1<? super T, ? extends R> function1) {
        return function1.invoke(t);
    }
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final <T> T f(T t, Function1<? super T, Boolean> function1) {
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final <T> T g(T t, Function1<? super T, Boolean> function1) {
        if (!function1.invoke(t).booleanValue()) {
            return t;
        }
        return null;
    ...
    @InlineOnly
    private static final void a(int i, Function1<? super Integer, Unit> function1) {
