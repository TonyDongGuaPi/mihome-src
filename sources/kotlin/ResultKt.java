...
public final class ResultKt {
    ...
    private static final <R> Object a(Function0<? extends R> function0) {
        try {
            ...
            return Result.m39constructorimpl(function0.invoke());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            return Result.m39constructorimpl(a(th));
        }
    }
    ...
    private static final <T, R> Object a(T t, Function1<? super T, ? extends R> function1) {
        try {
            Result.Companion companion = Result.Companion;
            return Result.m39constructorimpl(function1.invoke(t));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            return Result.m39constructorimpl(a(th));
        }
    ...
    private static final <R, T extends R> R b(@NotNull Object obj, Function1<? super Throwable, ? extends R> function1) {
        Throwable r0 = Result.m42exceptionOrNullimpl(obj);
    ...
    private static final <R, T> Object c(@NotNull Object obj, Function1<? super T, ? extends R> function1) {
        ...
        Result.Companion companion = Result.Companion;
        return Result.m39constructorimpl(function1.invoke(obj));
    }
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final <R, T extends R> Object e(@NotNull Object obj, Function1<? super Throwable, ? extends R> function1) {
        Throwable r0 = Result.m42exceptionOrNullimpl(obj);
        if (r0 == null) {
            return obj;
        }
        Result.Companion companion = Result.Companion;
        return Result.m39constructorimpl(function1.invoke(r0));
    }
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final <T> Object g(@NotNull Object obj, Function1<? super Throwable, Unit> function1) {
        Throwable r0 = Result.m42exceptionOrNullimpl(obj);
        if (r0 != null) {
            function1.invoke(r0);
        }
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final <T> Object h(@NotNull Object obj, Function1<? super T, Unit> function1) {
        if (Result.m45isSuccessimpl(obj)) {
