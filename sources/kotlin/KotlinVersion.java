...
public final class KotlinVersion implements Comparable<KotlinVersion> {
    ...
    public static final int f2677a = 255;
    @NotNull
    @JvmField
    public static final KotlinVersion b = new KotlinVersion(1, 3, 10);
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (kotlinVersion == null || this.d != kotlinVersion.d) {
            return false;
        }
        return true;
    }
    ...
    public int compareTo(@NotNull KotlinVersion kotlinVersion) {
        Intrinsics.f(kotlinVersion, "other");
        return this.d - kotlinVersion.d;
    }

    public final boolean a(int i, int i2) {
        return this.e > i || (this.e == i && this.f >= i2);
    }

    public final boolean a(int i, int i2, int i3) {
        return this.e > i || (this.e == i && (this.f > i2 || (this.f == i2 && this.g >= i3)));
    }
