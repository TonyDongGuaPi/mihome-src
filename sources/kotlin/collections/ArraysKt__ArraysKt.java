...
class ArraysKt__ArraysKt extends ArraysKt__ArraysJVMKt {
    ...
    public static final <T> List<T> a(@NotNull T[][] tArr) {
        ...
        for (T[] a2 : tArr) {
            CollectionsKt.a(arrayList, a2);
        }
        return arrayList;
    }

    @NotNull
    public static final <T, R> Pair<List<T>, List<R>> a(@NotNull Pair<? extends T, ? extends R>[] pairArr) {
    ...
    @InlineOnly
    private static final boolean c(@Nullable Object[] objArr) {
        if (objArr != null) {
    ...
    private static final <C extends java.lang.Object & R, R> R a(C r1, kotlin.jvm.functions.Function0<? extends R> r2) {
        /*
            int r0 = r1.length
        ...
        L_0x000c:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.collections.ArraysKt__ArraysKt.a(java.lang.Object[], kotlin.jvm.functions.Function0):java.lang.Object");
    }

    @SinceKotlin(version = "1.3")
    @PublishedApi
    @JvmName(name = "contentDeepEquals")
    public static final <T> boolean a(@NotNull T[] tArr, @NotNull T[] tArr2) {
        Intrinsics.f(tArr, "receiver$0");
        Intrinsics.f(tArr2, "other");
        if (tArr == tArr2) {
            return true;
        }
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                                                        ...
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                if (!(t instanceof ULongArray) || !(t2 instanceof ULongArray)) {
                                                                    if (!Intrinsics.a((Object) t, (Object) t2)) {
                                                                        return false;
                                                                    }
                                                                } else if (!UArraysKt.a(((ULongArray) t).d(), ((ULongArray) t2).d())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.a(((UIntArray) t).d(), ((UIntArray) t2).d())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.a(((UShortArray) t).d(), ((UShortArray) t2).d())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.a(((UByteArray) t).d(), ((UByteArray) t2).d())) {
                                                        return false;
                                                    }
                ...
                } else if (!ArraysKt.a((T[]) (Object[]) t, (T[]) (Object[]) t2)) {
                    return false;
                }
            }
        }
    ...
    public static final <T> String b(@NotNull T[] tArr) {
        Intrinsics.f(tArr, "receiver$0");
        StringBuilder sb = new StringBuilder((RangesKt.d(tArr.length, 429496729) * 5) + 2);
    ...
    private static final <T> void a(@NotNull T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.b(((UByteArray) t).d()));
            } else if (t instanceof UShortArray) {
                sb.append(UArraysKt.b(((UShortArray) t).d()));
            } else if (t instanceof UIntArray) {
                sb.append(UArraysKt.b(((UIntArray) t).d()));
            } else if (t instanceof ULongArray) {
                sb.append(UArraysKt.b(((ULongArray) t).d()));
            } else {
