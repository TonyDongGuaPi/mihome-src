...
public abstract class AbstractMap<K, V> implements Map<K, V>, KMappedMarker {
    ...
    public static final Companion f2699a = new Companion((DefaultConstructorMarker) null);
    ...
    public final boolean a(@Nullable Map.Entry<?, ?> entry) {
        ...
        if (!Intrinsics.a((Object) value, obj)) {
            return false;
        }
    ...
    public Set<K> b() {
        if (this.b == null) {
            this.b = new AbstractMap$keys$1(this);
        }
    ...
    public String toString() {
        return CollectionsKt.a(entrySet(), ", ", Operators.BLOCK_START_STR, "}", 0, (CharSequence) null, new AbstractMap$toString$1(this), 24, (Object) null);
    }

    /* access modifiers changed from: private */
    public final String b(Map.Entry<? extends K, ? extends V> entry) {
        return a((Object) entry.getKey()) + "=" + a((Object) entry.getValue());
    }
    ...
    public Collection<V> c() {
        if (this.c == null) {
            this.c = new AbstractMap$values$1(this);
        }
    ...
    private final Map.Entry<K, V> b(K k) {
        ...
        while (true) {
            ...
            obj = it.next();
            if (Intrinsics.a(((Map.Entry) obj).getKey(), (Object) k)) {
                break;
            }
        }
    ...
    public static final class Companion {
        ...
        public final int a(@NotNull Map.Entry<?, ?> entry) {
            Intrinsics.f(entry, "e");
            Object key = entry.getKey();
            int i = 0;
        ...
        @NotNull
        public final String b(@NotNull Map.Entry<?, ?> entry) {
            Intrinsics.f(entry, "e");
        ...
        public final boolean a(@NotNull Map.Entry<?, ?> entry, @Nullable Object obj) {
            ...
            if (!Intrinsics.a((Object) entry.getKey(), entry2.getKey()) || !Intrinsics.a((Object) entry.getValue(), entry2.getValue())) {
                return false;
            }
            return true;
        }
