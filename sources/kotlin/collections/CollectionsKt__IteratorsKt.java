...
class CollectionsKt__IteratorsKt extends CollectionsKt__IteratorsJVMKt {
    @InlineOnly
    private static final <T> Iterator<T> b(@NotNull Iterator<? extends T> it) {
        Intrinsics.f(it, "receiver$0");
        return it;
    }

    @NotNull
    public static final <T> Iterator<IndexedValue<T>> a(@NotNull Iterator<? extends T> it) {
        Intrinsics.f(it, "receiver$0");
        return new IndexingIterator<>(it);
    }

    public static final <T> void a(@NotNull Iterator<? extends T> it, @NotNull Function1<? super T, Unit> function1) {
        Intrinsics.f(it, "receiver$0");
        Intrinsics.f(function1, HomeManager.v);
        while (it.hasNext()) {
