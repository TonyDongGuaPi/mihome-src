...
class CollectionsKt__CollectionsJVMKt {
    ...
    private static final <T> T[] a(Collection<?> collection, T[] tArr) {
        if (tArr != null) {
            T[] a2 = CollectionToArray.a(collection, tArr);
            if (a2 != null) {
                return a2;
            }
    ...
    public static final <T> Object[] a(@NotNull T[] tArr, boolean z) {
        ...
        if (z && Intrinsics.a((Object) tArr.getClass(), (Object) Object[].class)) {
            return tArr;
        }
        Object[] copyOf = Arrays.copyOf(tArr, tArr.length, Object[].class);
        Intrinsics.b(copyOf, "java.util.Arrays.copyOf(… Array<Any?>::class.java)");
        return copyOf;
    }
