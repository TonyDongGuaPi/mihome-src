...
public abstract class AbstractList<E> extends AbstractCollection<E> implements List<E>, KMappedMarker {
    ...
    public static final Companion f2697a = new Companion((DefaultConstructorMarker) null);
    ...
    private static final class SubList<E> extends AbstractList<E> implements RandomAccess {
        ...
        public SubList(@NotNull AbstractList<? extends E> abstractList, int i, int i2) {
            ...
            this.c = abstractList;
            this.d = i;
            AbstractList.f2697a.a(this.d, i2, this.c.size());
            this.b = i2 - this.d;
        }

        public E get(int i) {
            AbstractList.f2697a.a(i, this.b);
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return f2697a.a((Collection<?>) this, (Collection<?>) (Collection) obj);
    }

    public int hashCode() {
        return f2697a.a(this);
    }
    ...
    private class ListIteratorImpl extends AbstractList<E>.IteratorImpl implements ListIterator<E>, KMappedMarker {
        ...
        public ListIteratorImpl(int i) {
            super();
            AbstractList.f2697a.b(i, AbstractList.this.size());
            a(i);
        }
    ...
    public static final class Companion {
        ...
        public final boolean a(@NotNull Collection<?> collection, @NotNull Collection<?> collection2) {
            ...
            for (Object a2 : collection) {
                if (!Intrinsics.a((Object) a2, (Object) it.next())) {
                    return false;
                }
            }
            return true;
