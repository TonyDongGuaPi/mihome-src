...
class MapsKt__MapsJVMKt extends MapsKt__MapWithDefaultKt {
    ...
    public static final <K, V> V a(@NotNull ConcurrentMap<K, V> concurrentMap, K k, @NotNull Function0<? extends V> function0) {
        Intrinsics.f(concurrentMap, "receiver$0");
    ...
    public static final <K, V> Map<K, V> b(@NotNull Map<? extends K, ? extends V> map) {
        ...
        Intrinsics.b(singletonMap, "java.util.Collections.singletonMap(key, value)");
