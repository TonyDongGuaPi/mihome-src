        ...
        for (int i = 0; i < size; i++) {
            ...
            if (this.mIsInLoading) {
                ...
                if (f == 0.0f) {
                    ...
                    float f5 = ((1.0f - this.mInternalAnimationFactor) * ((float) i)) / ((float) size);
                    float f6 = (1.0f - this.mInternalAnimationFactor) - f5;
                    if (f == 1.0f || f >= 1.0f - f6) {
                        canvas.translate(f2, f3);
                        storeHouseBarItem.setAlpha(this.mBarDarkAlpha);
                    } else {
                        if (f > f5) {
                            f4 = Math.min(1.0f, (f - f5) / this.mInternalAnimationFactor);
                        }
                        float f7 = 1.0f - f4;
