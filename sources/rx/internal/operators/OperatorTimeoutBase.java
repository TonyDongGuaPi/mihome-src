    ...
    static final class TimeoutSubscriber<T> extends Subscriber<T> {
        ...
        public void onNext(T t) {
            ...
            if (z) {
                ...
                this.serial.set((Subscription) this.timeoutStub.call(this, Long.valueOf(this.actual.get()), t, this.inner));
            }
        }
        ...
        public void onTimeout(long j) {
            boolean z;
            synchronized (this.gate) {
                int i = (j > this.actual.get() ? 1 : (j == this.actual.get() ? 0 : -1));
                z = true;
                if (i != 0 || this.terminated.getAndSet(1) != 0) {
                    z = false;
                }
            }
            if (!z) {
