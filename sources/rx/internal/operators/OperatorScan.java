...
public final class OperatorScan<R, T> implements Observable.Operator<R, T> {
    ...
    static final class InitialProducer<R> implements Observer<R>, Producer {
        ...
        public InitialProducer(R r, Subscriber<? super R> subscriber) {
            ...
            this.queue = queue2;
            queue2.offer(NotificationLite.instance().next(r));
        ...
        public void emitLoop() {
            ...
            while (true) {
                ...
                if (!checkTerminated(this.done, queue2.isEmpty(), subscriber)) {
                    long j2 = 0;
                    while (j != 0) {
                        ...
                        if (!checkTerminated(z2, z3, subscriber)) {
                            ...
                            try {
                                ...
                                subscriber.onError(OnErrorThrowable.addValueAsLastCause(th2, value));
                                return;
                            }
                        } else {
                            return;
