...
public final class OnSubscribeRedo<T> implements Observable.OnSubscribe<T> {
    ...
    public static <T> Observable<T> retry(Observable<T> observable, long j) {
        if (j >= 0) {
            return j == 0 ? observable : retry(observable, (Func1<? super Observable<? extends Notification<?>>, ? extends Observable<?>>) new RedoFinite(j));
        }
    ...
    public static <T> Observable<T> retry(Observable<T> observable, Func1<? super Observable<? extends Notification<?>>, ? extends Observable<?>> func1, Scheduler scheduler2) {
        return Observable.create(new OnSubscribeRedo(observable, func1, true, false, scheduler2));
    }
    ...
    public static <T> Observable<T> repeat(Observable<T> observable, Func1<? super Observable<? extends Notification<?>>, ? extends Observable<?>> func1, Scheduler scheduler2) {
        return Observable.create(new OnSubscribeRedo(observable, func1, false, true, scheduler2));
    }
    ...
    public static <T> Observable<T> redo(Observable<T> observable, Func1<? super Observable<? extends Notification<?>>, ? extends Observable<?>> func1, Scheduler scheduler2) {
        return Observable.create(new OnSubscribeRedo(observable, func1, false, false, scheduler2));
    }
                    ...
                    AnonymousClass1 r0 = new Subscriber<T>() {
                        ...
                        public void onCompleted() {
                            if (!this.done) {
                                this.done = true;
                                unsubscribe();
                                behaviorSubject.onNext(Notification.createOnCompleted());
                            }
                        }
                        ...
                        public void onError(Throwable th) {
                            if (!this.done) {
                                this.done = true;
                                unsubscribe();
                                behaviorSubject.onNext(Notification.createOnError(th));
                            }
                        }
