...
public class BGABannerUtil {
    ...
    public static ImageView a(Context context, @DrawableRes int i, BGALocalImageSize bGALocalImageSize, ImageView.ScaleType scaleType) {
    ...
    public static boolean a(int i, Collection collection) {
        return b(collection, new Collection[0]) && i < collection.size();
    }
    ...
    public static android.graphics.Bitmap a(@android.support.annotation.NonNull android.content.Context r2, int r3, int r4, int r5, float r6, float r7) {
        /*
        L_0x0000:
            cn.bingoogolapple.bgabanner.BGABannerUtil$LoadBitmapPair r0 = a((android.content.Context) r2, (int) r3, (int) r4, (int) r5)
        ...
        L_0x0025:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.bingoogolapple.bgabanner.BGABannerUtil.a(android.content.Context, int, int, int, float, float):android.graphics.Bitmap");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static cn.bingoogolapple.bgabanner.BGABannerUtil.LoadBitmapPair<java.lang.Throwable> a(@android.support.annotation.NonNull android.content.Context r8, int r9, int r10, int r11) {
        /*
        ...
        L_0x0029:
            ...
            int r7 = a((int) r10, (int) r11, (int) r5, (int) r6)     // Catch:{ OutOfMemoryError -> 0x0099, Exception -> 0x0096, all -> 0x0093 }
            int r10 = a((int) r11, (int) r10, (int) r6, (int) r5)     // Catch:{ OutOfMemoryError -> 0x0099, Exception -> 0x0096, all -> 0x0093 }
            r11 = 0
            r0.inJustDecodeBounds = r11     // Catch:{ OutOfMemoryError -> 0x0099, Exception -> 0x0096, all -> 0x0093 }
            int r11 = a(r0, r7, r10)     // Catch:{ OutOfMemoryError -> 0x0099, Exception -> 0x0096, all -> 0x0093 }
        ...
        L_0x00cf:
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.bingoogolapple.bgabanner.BGABannerUtil.a(android.content.Context, int, int, int):cn.bingoogolapple.bgabanner.BGABannerUtil$LoadBitmapPair");
    }
