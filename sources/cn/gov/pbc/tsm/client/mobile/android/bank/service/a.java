        ...
        private static class C0024a implements a {
            ...
            public final String a(String str) throws RemoteException {
                ...
                try {
                    ...
                    this.f659a.transact(3, obtain, obtain2, 0);
            ...
            public final Map a(String str, String str2) throws RemoteException {
                ...
                try {
                    ...
                    this.f659a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public final boolean a() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("cn.gov.pbc.tsm.client.mobile.android.bank.service.IServiceForBank");
                    boolean z = false;
                    this.f659a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public final byte[] a(byte[] bArr) throws RemoteException {
                ...
                try {
                    ...
                    this.f659a.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public final byte[] a(byte[] bArr, String str) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeByteArray(bArr);
                    obtain.writeString(str);
                    this.f659a.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.createByteArray();
                } finally {
                    obtain2.recycle();
            ...
            public final boolean b() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("cn.gov.pbc.tsm.client.mobile.android.bank.service.IServiceForBank");
                    boolean z = false;
                    this.f659a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public final boolean b(String str) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    boolean z = false;
                    this.f659a.transact(8, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public final byte[] b(byte[] bArr) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("cn.gov.pbc.tsm.client.mobile.android.bank.service.IServiceForBank");
                    obtain.writeByteArray(bArr);
                    this.f659a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.createByteArray();
                } finally {
                    obtain2.recycle();
            ...
            public final String c() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("cn.gov.pbc.tsm.client.mobile.android.bank.service.IServiceForBank");
                    this.f659a.transact(9, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readString();
                } finally {
                    obtain2.recycle();
            ...
            public final String d() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("cn.gov.pbc.tsm.client.mobile.android.bank.service.IServiceForBank");
                    this.f659a.transact(10, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readString();
                } finally {
                    obtain2.recycle();
