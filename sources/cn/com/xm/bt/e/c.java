...
class c {
    ...
    private static final ExecutorService f573a = Executors.newSingleThreadExecutor();
    ...
    public static void a(Context context, BluetoothDevice bluetoothDevice, a aVar) {
        f573a.execute(new Runnable(context, bluetoothDevice, aVar) {
    ...
    public static /* synthetic */ void b(Context context, BluetoothDevice bluetoothDevice, a aVar) {
        ...
        if (atomicBoolean.get()) {
            ...
            bVar = aVar2.r();
            cn.com.xm.bt.a.a.b("BleScanCenter", "Device info:" + bVar);
        } else {
            bVar = null;
        }
        aVar2.b();
