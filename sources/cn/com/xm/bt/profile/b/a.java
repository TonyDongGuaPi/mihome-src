...
public class a extends b implements d {
    ...
    BluetoothGattCharacteristic f579a = null;
    ...
    public boolean o() {
        ...
        if (a2 != null) {
            ...
            cn.com.xm.bt.a.a.a((Object) this.i);
            this.k = a2.getCharacteristic(g);
            cn.com.xm.bt.a.a.a((Object) this.k);
            this.j = a2.getCharacteristic(e);
            cn.com.xm.bt.a.a.a((Object) this.j);
    ...
    public cn.com.xm.bt.d.c q() {
        ...
        if (g2 != null && g2.length == 8) {
            cVar.f566a = String.format("%02X%02X%02X%02X%02X%02X%02X%02X", new Object[]{Byte.valueOf(g2[0]), Byte.valueOf(g2[1]), Byte.valueOf(g2[2]), Byte.valueOf(g2[3]), Byte.valueOf(g2[4]), Byte.valueOf(g2[5]), Byte.valueOf(g2[6]), Byte.valueOf(g2[7])});
        }
        byte[] g3 = g(this.j);
        ...
        if (g4 != null && g4.length == 7) {
            ...
            dVar.b = g4[0] & 255;
            dVar.f567a = ((g4[2] & 255) << 8) | (g4[1] & 255);
            dVar.c = ((g4[4] & 255) << 8) | (g4[3] & 255);
            dVar.d = (g4[5] & 255) | ((g4[6] & 255) << 8);
            cVar.d = dVar;
        }
        cn.com.xm.bt.a.a.a("BaseProfile", "general device info:" + cVar);
        return cVar;
    }
