...
class c extends b {
    ...
    public boolean a() {
        BluetoothGattService a2 = a(f580a);
        if (a2 == null) {
            return false;
        }
        this.d = a2.getCharacteristic(c);
        if (this.d != null) {
            return a(this.d, (d.b) new d.b() {
    ...
    public /* synthetic */ void b(byte[] bArr) {
        if (!(bArr == null || bArr.length != 2 || bArr[0] != -126 || bArr[1] == 0 || this.f == null)) {
            this.f.onStatusChanged(new HMNFCStatus(bArr[1] & 255));
        }
        if (this.e != null) {
            this.e.notify(bArr);
        }
    ...
    public ApduResponse a(byte[] bArr, int i, boolean z) {
        ...
        if (z2) {
            a((Object) byteArrayOutputStream, 60000);
        }
        a((d.b) null);
    ...
    public /* synthetic */ void a(ByteArrayOutputStream byteArrayOutputStream, byte b, byte b2, AtomicInteger atomicInteger, byte[] bArr) {
        ...
        if (bArr[0] != (b | Byte.MIN_VALUE)) {
            if (bArr[0] == (b2 | Byte.MIN_VALUE)) {
                ...
                a((Object) byteArrayOutputStream);
                return;
            }
            byteArrayOutputStream.reset();
            a((Object) byteArrayOutputStream);
